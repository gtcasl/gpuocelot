...
{
	public:
		//TODO: Make this as a template class, so can use other types instead of node_type, might need to change set and map to unordered and a class to draw them as dot friendly
