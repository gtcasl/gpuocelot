...
namespace executive {
	...
	*/
	...
	public:
		...
		*/
		bool loadModule(std::string name, std::istream & ptx);
	...
	public:
		...
		*/
		ir::Kernel * getKernel(const std::string& moduleName, const std::string& kernelName);

		/*! Gets a pointer to a texture by name
		*/
	...
	protected:
		//
		// Global Variable Syncrhonization
		//
	...
	protected:
		...
		void translateModuleToISA(std::string moduleName, ir::Instruction::Architecture isa);
