# 1 "/tmp/tmpxft_00007b99_00000000-1_malloc.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00007b99_00000000-1_malloc.cudafe1.cpp"
# 1 "malloc.cu"
...
auto int errors = 0;
auto cudaArray *array = (0);
auto cudaArray *array2 = (0);

auto const int width = 256;
auto const int height = 128;
auto size_t bytes = ((width * height) * sizeof(float));

auto float *host = ((float *)malloc(bytes));
auto cudaChannelFormatDesc desc = cudaCreateChannelDesc(32, 0, 0, 0, cudaChannelFormatKindFloat);
...
auto float expected = ((float)((i + j * width) % 128) / (128.0F));
auto float got = (ptr[i]);
...
if (verbose) {
printf("%s\n", (errors) ? ((const char *)"FAILED") : ((const char *)"PASSED"));
fflush(stdout);
}
...
for (int i = 0; (i < width) && (errors < 5); i++) {
auto float got = (ptr[i]);
auto float expected = ((float)(i % 128) / (64.0F) + (2.0F));
...
# 1 "/tmp/tmpxft_00007b99_00000000-1_malloc.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00007b99_00000000-3_malloc.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00007b99_00000000-3_malloc.fatbin.c" 2
...
0x3030305f74667870ull,0x30305f3939623730ull,0x372d303030303030ull,0x2e636f6c6c616d5full,
0x2820692e33707063ull,0x4263632f706d742full,0x61446333492e2349ull,0x2d2d2f2f090a2975ull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x37303030305f7466ull,0x303030305f393962ull,0x6d5f362d30303030ull,0x75632e636f6c6c61ull,
...
0x2f2209363109656cull,0x61636f6c2f727375ull,0x2e32616475632f6cull,0x622f616475632f33ull,
0x6e692f2e2e2f6e69ull,0x72632f6564756c63ull,0x6d5f636e75662f74ull,0x0a22682e6f726361ull,
0x3109656c69662e09ull,0x2f7273752f220937ull,0x75632f6c61636f6cull,0x75632f332e326164ull,
0x2e2f6e69622f6164ull,0x64756c636e692f2eull,0x665f6874616d2f65ull,0x736e6f6974636e75ull,
0x69662e090a22682eull,0x2f2209383109656cull,0x61636f6c2f727375ull,0x2e32616475632f6cull,
...
0x73752f2209313209ull,0x2f6c61636f6c2f72ull,0x2f332e3261647563ull,0x6e69622f61647563ull,
...
0x6e75665f656c6275ull,0x682e736e6f697463ull,0x656c69662e090a22ull,0x73752f2209333209ull,
0x2f6c61636f6c2f72ull,0x2f332e3261647563ull,0x6e69622f61647563ull,0x6c636e692f2e2e2full,
...
0x09656c69662e090aull,0x7273752f22093532ull,0x632f6c61636f6c2full,0x632f332e32616475ull,
0x2f6e69622f616475ull,0x756c636e692f2e2eull,0x5f6874616d2f6564ull,0x6e6f6974636e7566ull,
0x74705f6c62645f73ull,0x0a0a0a22682e3178ull,0x0000000000000000ull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"13298167ba522063",(char*)"malloc.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x8b7546ed};
# 5 "/tmp/tmpxft_00007b99_00000000-1_malloc.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00007b99_00000000-1_malloc.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_41_tmpxft_00007b99_00000000_4_malloc_cpp1_ii_main(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_41_tmpxft_00007b99_00000000_4_malloc_cpp1_ii_main(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);}
