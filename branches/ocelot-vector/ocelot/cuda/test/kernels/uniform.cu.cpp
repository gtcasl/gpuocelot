# 1 "/tmp/tmpxft_000021ad_00000000-1_uniform.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_000021ad_00000000-1_uniform.cudafe1.cpp"
# 1 "uniform.cu"
...
# 1 "/tmp/tmpxft_000021ad_00000000-1_uniform.cudafe1.stub.c"
# 1 "/tmp/tmpxft_000021ad_00000000-1_uniform.cudafe1.stub.c" 1
# 1 "/tmp/tmpxft_000021ad_00000000-3_uniform.fatbin.c" 1
...
# 2 "/tmp/tmpxft_000021ad_00000000-3_uniform.fatbin.c" 2
...
".quad 0x00000000000003c4,0x0000000000000040,0x00380040000a000a,0x0001000700400003\n"
...
".quad 0x0000000100000036,0x0000000000000006,0x0000000000000000,0x000000000000037d\n"
".quad 0x0000000000000038,0x0200000600000003,0x0000000000000004,0x0000000000000000\n"
".quad 0x0000000100000065,0x0000000000000002,0x0000000000000000,0x00000000000003b5\n"
".quad 0x000000000000000c,0x0000000400000000,0x0000000000000001,0x0000000000000000\n"
".quad 0x000000080000004b,0x0000000000000003,0x0000000000000000,0x00000000000003c1\n"
...
".quad 0x766e2e006d726f66,0x656b2e6f666e692e,0x696e755f6c656e72,0x656b00006d726f66\n"
".quad 0x696e755f6c656e72,0x000000006d726f66,0x0000000000000000,0x0000000000000000\n"
...
".quad 0x0000000004000300,0x0000380000000000,0x0000000000000000,0x0000000006000300\n"
...
".quad 0x0000050023c78010,0x014c0104000780a0,0x0000050020478060,0x02000144014780a0\n"
".quad 0x016c04c410078030,0x0e00052100e800c1,0x080b04a0c00781d0,0x0000080000000000\n"
".quad 0x0000000600000000,0x000003c400000005,0x0000000000000000,0x0000000000000000\n"
".quad 0x000000a800000000,0x000000a800000000,0x0000000400000000,0x6000000000000000\n"
".quad 0x0000037d00000905,0x0000000000000000,0x0000000000000000,0x0000004400000000\n"
".quad 0x0000004400000000,0x0000000400000000,0x6000000000000000,0x000003c100000906\n"
...
extern const unsigned long long __deviceText_$sm_10$[142];
...
".quad 0x3030305f74667870,0x30305f6461313230,0x372d303030303030,0x6d726f66696e755f\n"
".quad 0x20692e337070632e,0x63632f706d742f28,0x454179462e234942,0x2d2f2f090a294c31\n"
".quad 0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d\n"
...
".quad 0x303030305f746678,0x3030305f64613132,0x5f362d3030303030,0x2e6d726f66696e75\n"
...
".quad 0x75632f312e336164,0x2e2f6e69622f6164,0x64756c636e692f2e,0x6e6f6d6d6f632f65\n"
...
".quad 0x2f2209313209656c,0x61636f6c2f727375,0x2e33616475632f6c,0x622f616475632f31\n"
...
".quad 0x75632f312e336164,0x2e2f6e69622f6164,0x64756c636e692f2e,0x5f32315f6d732f65\n"
...
".quad 0x3209656c69662e09,0x2f7273752f220934,0x75632f6c61636f6c,0x75632f312e336164\n"
...
".quad 0x7273752f22093732,0x632f6c61636f6c2f,0x632f312e33616475,0x2f6e69622f616475\n"
".quad 0x756c636e692f2e2e,0x5f6874616d2f6564,0x6e6f6974636e7566,0x74705f6c62645f73\n"
".quad 0x2e090a22682e3178,0x09383209656c6966,0x6d726f66696e7522,0x090a0a0a2275632e\n"
...
".quad 0x3009303109383209,0x67656257444c240a,0x656e72656b5f6e69,0x726f66696e755f6c\n"
".quad 0x636f6c2e090a3a6d,0x3009323109383209,0x33752e747663090a,0x2509203631752e32\n"
...
".quad 0x6f6c2e090a3b3366,0x0933310938320963,0x3b74697865090a30,0x646e6557444c240a\n"
".quad 0x5f6c656e72656b5f,0x3a6d726f66696e75,0x6b202f2f207d090a,0x6e755f6c656e7265\n"
".quad 0x000a0a6d726f6669\n"
".text");

extern "C" {

extern const unsigned long long __deviceText_$compute_10$[401];
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000004,0xa14f518d,(char*)"777bb764e248cc0d",(char*)"uniform.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x91b994ce,&__elfEntries1};
# 2 "/tmp/tmpxft_000021ad_00000000-1_uniform.cudafe1.stub.c" 2
...
# 3 "/tmp/tmpxft_000021ad_00000000-1_uniform.cudafe1.stub.c" 2
struct __T20 {float *__par0;float __par1;int __dummy_field;};
extern void __device_stub__Z14kernel_uniformPff(float *, float);
static void __sti____cudaRegisterAll_42_tmpxft_000021ad_00000000_4_uniform_cpp1_ii_a18efc3c(void) __attribute__((__constructor__));
void __device_stub__Z14kernel_uniformPff(float *__par0, float __par1){ struct __T20 *__T21;
