 ...
 *                               cannot be found.
 */
void CONVENTION fatGetCubinForGpuWithPolicy( __cudaFatCudaBinary *binary, __cudaFatCompilationPolicy policy, char* gpuName, char* *cubin, char* *dbgInfoFile );
 ...
 */
unsigned char CONVENTION fatCheckJitForGpuWithPolicy( __cudaFatCudaBinary *binary, __cudaFatCompilationPolicy policy, char* gpuName, char* *ptx );
 ...
 */
void CONVENTION fatFreeCubin( char* cubin, char* dbgInfoFile );
...
extern void** CONVENTION __cudaRegisterFatBinary(void *fatCubin);

extern void CONVENTION __cudaUnregisterFatBinary(void **fatCubinHandle);

extern void CONVENTION __cudaRegisterVar(void **fatCubinHandle, char *hostVar, 
	char *deviceAddress, const char *deviceName, int ext, int size, 
	int constant, int global);

extern void CONVENTION __cudaRegisterTexture(
        void **fatCubinHandle,
...
extern void CONVENTION __cudaRegisterShared(
  void **fatCubinHandle,
  void **devicePtr
);

extern void CONVENTION __cudaRegisterSharedVar(
  void **fatCubinHandle,
  void **devicePtr,
  size_t size,
  size_t alignment,
...
extern void CONVENTION __cudaRegisterFunction(
        void **fatCubinHandle,
  const char *hostFun,
        char *deviceFun,
  const char *deviceName,
...
extern cudaError_t CONVENTION cudaMalloc3D(struct cudaPitchedPtr* pitchedDevPtr, 
	struct cudaExtent extent);
extern cudaError_t CONVENTION cudaMalloc3DArray(struct cudaArray** arrayPtr, 
	const struct cudaChannelFormatDesc* desc, struct cudaExtent extent);
extern cudaError_t CONVENTION cudaMemset3D(struct cudaPitchedPtr pitchedDevPtr, 
	int value, struct cudaExtent extent);
extern cudaError_t CONVENTION cudaMemcpy3D(const struct cudaMemcpy3DParms *p);
extern cudaError_t CONVENTION cudaMemcpy3DAsync(const struct cudaMemcpy3DParms *p, 
	cudaStream_t stream);
...
extern cudaError_t CONVENTION cudaMalloc(void **devPtr, size_t size);
extern cudaError_t CONVENTION cudaMallocHost(void **ptr, size_t size);
extern cudaError_t CONVENTION cudaMallocPitch(void **devPtr, size_t *pitch, 
	size_t width, size_t height);
extern cudaError_t CONVENTION cudaMallocArray(struct cudaArray **array, 
	const struct cudaChannelFormatDesc *desc, size_t width, size_t height = 1);
extern cudaError_t CONVENTION cudaFree(void *devPtr);
extern cudaError_t CONVENTION cudaFreeHost(void *ptr);
extern cudaError_t CONVENTION cudaFreeArray(struct cudaArray *array);

extern cudaError_t CONVENTION cudaHostAlloc(void **pHost, size_t bytes, unsigned int flags);
extern cudaError_t CONVENTION cudaHostGetDevicePointer(void **pDevice, void *pHost, 
	unsigned int flags);
extern cudaError_t CONVENTION cudaHostGetFlags(unsigned int *pFlags, void *pHost);
...
extern cudaError_t CONVENTION cudaMemcpy(void *dst, const void *src, size_t count, 
	enum cudaMemcpyKind kind);
extern cudaError_t CONVENTION cudaMemcpyToArray(struct cudaArray *dst, size_t wOffset, 
	size_t hOffset, const void *src, size_t count, enum cudaMemcpyKind kind);
extern cudaError_t CONVENTION cudaMemcpyFromArray(void *dst, const struct cudaArray *src, 
	size_t wOffset, size_t hOffset, size_t count, enum cudaMemcpyKind kind);
extern cudaError_t CONVENTION cudaMemcpyArrayToArray(struct cudaArray *dst, size_t wOffsetDst, 
...
extern cudaError_t CONVENTION cudaMemcpy2D(void *dst, size_t dpitch, const void *src, 
	size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind);
extern cudaError_t CONVENTION cudaMemcpy2DToArray(struct cudaArray *dst, size_t wOffset, 
	size_t hOffset, const void *src, size_t spitch, size_t width, 
	size_t height, enum cudaMemcpyKind kind);
extern cudaError_t CONVENTION cudaMemcpy2DFromArray(void *dst, size_t dpitch, 
	const struct cudaArray *src, size_t wOffset, size_t hOffset, size_t width, 
	size_t height, enum cudaMemcpyKind kind);
extern cudaError_t CONVENTION cudaMemcpy2DArrayToArray(struct cudaArray *dst, 
...
extern cudaError_t CONVENTION cudaMemcpyToSymbol(const char *symbol, const void *src, 
	size_t count, size_t offset = 0, 
	enum cudaMemcpyKind kind = cudaMemcpyHostToDevice);
extern cudaError_t CONVENTION cudaMemcpyFromSymbol(void *dst, const char *symbol, 
	size_t count, size_t offset = 0, 
...
extern cudaError_t CONVENTION cudaMemcpyAsync(void *dst, const void *src, size_t count, 
	enum cudaMemcpyKind kind, cudaStream_t stream);
extern cudaError_t CONVENTION cudaMemcpyToArrayAsync(struct cudaArray *dst, size_t wOffset,
	size_t hOffset, const void *src, size_t count, enum cudaMemcpyKind kind, 
	cudaStream_t stream);
extern cudaError_t CONVENTION cudaMemcpyFromArrayAsync(void *dst, 
	const struct cudaArray *src, size_t wOffset, size_t hOffset, size_t count, 
	enum cudaMemcpyKind kind, cudaStream_t stream);
extern cudaError_t CONVENTION cudaMemcpy2DAsync(void *dst, size_t dpitch, const void *src, 
	size_t spitch, size_t width, size_t height, enum cudaMemcpyKind kind, 
	cudaStream_t stream);
extern cudaError_t CONVENTION cudaMemcpy2DToArrayAsync(struct cudaArray *dst, 
...
extern cudaError_t CONVENTION cudaMemcpy2DFromArrayAsync(void *dst, size_t dpitch, 
	const struct cudaArray *src, size_t wOffset, size_t hOffset, size_t width, 
	size_t height, enum cudaMemcpyKind kind, cudaStream_t stream);
extern cudaError_t CONVENTION cudaMemcpyToSymbolAsync(const char *symbol, const void *src, 
	size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream);
extern cudaError_t CONVENTION cudaMemcpyFromSymbolAsync(void *dst, const char *symbol, 
	size_t count, size_t offset, enum cudaMemcpyKind kind, cudaStream_t stream);
...
extern cudaError_t CONVENTION cudaMemset(void *devPtr, int value, size_t count);
extern cudaError_t CONVENTION cudaMemset2D(void *devPtr, size_t pitch, int value, 
	size_t width, size_t height);
...
extern cudaError_t CONVENTION cudaGetSymbolAddress(void **devPtr, const char *symbol);
extern cudaError_t CONVENTION cudaGetSymbolSize(size_t *size, const char *symbol);
...
extern cudaError_t CONVENTION cudaGetDeviceCount(int *count);
extern cudaError_t CONVENTION cudaGetDeviceProperties(struct cudaDeviceProp *prop, int device);
extern cudaError_t CONVENTION cudaChooseDevice(int *device, const struct cudaDeviceProp *prop);
extern cudaError_t CONVENTION cudaSetDevice(int device);
extern cudaError_t CONVENTION cudaGetDevice(int *device);
extern cudaError_t CONVENTION cudaSetValidDevices(int *device_arr, int len);
extern cudaError_t CONVENTION cudaSetDeviceFlags( int flags );
...
extern cudaError_t CONVENTION cudaBindTexture(size_t *offset, 
	const struct textureReference *texref, const void *devPtr, 
	const struct cudaChannelFormatDesc *desc, size_t size = UINT_MAX);
extern cudaError_t CONVENTION cudaBindTexture2D(size_t *offset,
	const struct textureReference *texref,const void *devPtr, 
	const struct cudaChannelFormatDesc *desc,size_t width, size_t height, 
	size_t pitch);
extern cudaError_t CONVENTION cudaBindTextureToArray(const struct textureReference *texref, 
	const struct cudaArray *array, const struct cudaChannelFormatDesc *desc);
extern cudaError_t CONVENTION cudaUnbindTexture(const struct textureReference *texref);
extern cudaError_t CONVENTION cudaGetTextureAlignmentOffset(size_t *offset, 
	const struct textureReference *texref);
extern cudaError_t CONVENTION cudaGetTextureReference(const struct textureReference **texref, 
	const char *symbol);
...
extern cudaError_t CONVENTION cudaGetChannelDesc(struct cudaChannelFormatDesc *desc, 
	const struct cudaArray *array);
extern struct cudaChannelFormatDesc CONVENTION cudaCreateChannelDesc(int x, int y, int z, 
...
extern cudaError_t CONVENTION cudaGetLastError(void);
extern const char* CONVENTION cudaGetErrorString(cudaError_t error);
...
extern cudaError_t CONVENTION cudaConfigureCall(dim3 gridDim, dim3 blockDim, 
	size_t sharedMem = 0, cudaStream_t stream = 0);
extern cudaError_t CONVENTION cudaSetupArgument(const void *arg, size_t size, 
	size_t offset);
extern cudaError_t CONVENTION cudaLaunch(const char *entry);
extern cudaError_t CONVENTION cudaFuncGetAttributes(struct cudaFuncAttributes *attr, 
	const char *func);
extern cudaError_t CONVENTION cudaFuncSetCacheConfig(const char *func, 
...
extern cudaError_t CONVENTION cudaStreamCreate(cudaStream_t *pStream);
extern cudaError_t CONVENTION cudaStreamDestroy(cudaStream_t stream);
extern cudaError_t CONVENTION cudaStreamSynchronize(cudaStream_t stream);
extern cudaError_t CONVENTION cudaStreamQuery(cudaStream_t stream);
...
extern cudaError_t CONVENTION cudaEventCreate(cudaEvent_t *event);
extern cudaError_t CONVENTION cudaEventCreateWithFlags(cudaEvent_t *event, int flags);
extern cudaError_t CONVENTION cudaEventRecord(cudaEvent_t event, cudaStream_t stream);
extern cudaError_t CONVENTION cudaEventQuery(cudaEvent_t event);
extern cudaError_t CONVENTION cudaEventSynchronize(cudaEvent_t event);
extern cudaError_t CONVENTION cudaEventDestroy(cudaEvent_t event);
extern cudaError_t CONVENTION cudaEventElapsedTime(float *ms, cudaEvent_t start, cudaEvent_t end);
...
extern cudaError_t CONVENTION cudaGraphicsGLRegisterBuffer(
	struct cudaGraphicsResource **resource, GLuint buffer, unsigned int flags);
extern cudaError_t CONVENTION cudaGraphicsGLRegisterImage(
	struct cudaGraphicsResource **resource, GLuint image, int target, 
	unsigned int flags);

extern cudaError_t CONVENTION cudaGraphicsUnregisterResource(
	struct cudaGraphicsResource *resource);
extern cudaError_t CONVENTION cudaGraphicsResourceSetMapFlags(
	struct cudaGraphicsResource *resource, unsigned int flags); 
extern cudaError_t CONVENTION cudaGraphicsMapResources(int count, 
	struct cudaGraphicsResource **resources, cudaStream_t stream = 0);
extern cudaError_t CONVENTION cudaGraphicsUnmapResources(int count, 
	struct cudaGraphicsResource **resources, cudaStream_t stream = 0);
extern cudaError_t CONVENTION cudaGraphicsResourceGetMappedPointer(void **devPtr, 
	size_t *size, struct cudaGraphicsResource *resource);
extern cudaError_t CONVENTION cudaGraphicsSubResourceGetMappedArray(
	struct cudaArray **arrayPtr, struct cudaGraphicsResource *resource, 
	unsigned int arrayIndex, unsigned int mipLevel);

extern cudaError_t CONVENTION cudaGLMapBufferObject(void **devPtr, GLuint bufObj);
extern cudaError_t CONVENTION cudaGLMapBufferObjectAsync(void **devPtr, 
	GLuint bufObj, cudaStream_t stream);
extern cudaError_t CONVENTION cudaGLRegisterBufferObject(GLuint bufObj);
extern cudaError_t CONVENTION cudaGLSetBufferObjectMapFlags(GLuint bufObj, 
	unsigned int flags);
extern cudaError_t CONVENTION cudaGLSetGLDevice(int device);
extern cudaError_t CONVENTION cudaGLUnmapBufferObject(GLuint bufObj);
extern cudaError_t CONVENTION cudaGLUnmapBufferObjectAsync(GLuint bufObj, cudaStream_t stream);
extern cudaError_t CONVENTION cudaGLUnregisterBufferObject(GLuint bufObj);
...
extern cudaError_t CONVENTION cudaSetDoubleForDevice(double *d);
extern cudaError_t CONVENTION cudaSetDoubleForHost(double *d);
...
extern cudaError_t CONVENTION cudaThreadExit(void);
extern cudaError_t CONVENTION cudaThreadSynchronize(void);
...
extern cudaError_t CONVENTION cudaDriverGetVersion(int *driverVersion);
extern cudaError_t CONVENTION cudaRuntimeGetVersion(int *runtimeVersion);
