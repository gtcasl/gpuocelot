...
void cuda::CudaRuntimeInterface::addInstrumentor( instrumentation::PTXInstrumentor& instrumentor) {
	assert(0 && "unimplemented");
}

instrumentation::KernelProfile cuda::CudaRuntimeInterface::kernelProfile() {
	assert(0 && "unimplemented");
}
