/*! \file CudaRuntimeBase.h
	\author Gregory Diamos <gregory.diamos@gatech.edu>
	\date Saturday September 5, 2009
	\brief The header file for the CudaRuntimeBase class.
*/

#ifndef CUDA_RUNTIME_BASE_H_INCLUDED
#define CUDA_RUNTIME_BASE_H_INCLUDED
...
namespace cuda
{
	...
	class CudaRuntimeBase : public CudaRuntimeInterface
	{
		private:
			/*! \brief CudaRuntime class that handles most calls */
