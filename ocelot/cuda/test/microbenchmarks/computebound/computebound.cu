...
#define GROUP1 BLOCKN BLOCKN BLOCKN BLOCKN			// (4*4)
#define GROUP2 GROUP1 GROUP1 GROUP1 GROUP1			// (4*4*4)
#define GROUP4 GROUP2 GROUP2 GROUP2 GROUP2			// (4*4*4*4)
#define GROUP8 GROUP4 GROUP4 GROUP4 GROUP4			// (4*4*4*4*4)
#define GROUP16 GROUP8 GROUP8 GROUP8 GROUP8			// (4^4^4^4^4^4)
