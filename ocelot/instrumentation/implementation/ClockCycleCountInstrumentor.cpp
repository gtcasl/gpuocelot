...
namespace instrumentation
{
    ...
    void ClockCycleCountInstrumentor::extractResults(std::ostream *out) {
        ...
        for(instrumentation::KernelProfile::ProcessorToClockCyclesMap::const_iterator it = _kernelProfile.processorToClockCyclesMap.begin();
        ...
        switch(fmt) {
            ...
            case json:
                ...
                *out << kernelName << "_processorToThreadBlockCountMap = {";
                    for(instrumentation::KernelProfile::ProcessorToThreadBlockCountMap::const_iterator it = _kernelProfile.processorToThreadBlockCountMap.begin();
