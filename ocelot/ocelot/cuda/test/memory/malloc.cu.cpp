# 1 "/tmp/tmpxft_00004d82_00000000-1_malloc.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00004d82_00000000-1_malloc.cudafe1.cpp"
# 1 "malloc.cu"
...
int *host;
# 396 "malloc.cu"
if (verbose) { printf("[9] mallocing 3D\n"); fflush(stdout); }
# 398 "malloc.cu"
size_t bytes = (((width * height) * depth) * sizeof(int));
# 400 "malloc.cu"
cudaExtent extent = {(0)};
# 401 "malloc.cu"
(extent.width) = ((width) * sizeof(int));
# 402 "malloc.cu"
(extent.height) = (height);
# 403 "malloc.cu"
(extent.depth) = (depth);
# 404 "malloc.cu"
cudaPitchedPtr block;
# 406 "malloc.cu"
if ((cudaMalloc3D(&block, extent)) != (cudaSuccess)) {
# 407 "malloc.cu"
printf("cudaMalloc3D() 0 - failed to malloc %d x %d x %d on device\n", width, height, depth);
# 408 "malloc.cu"
cudaFree(&block);
# 409 "malloc.cu"
return ++errors;
...
# 412 "malloc.cu"
int dBytes = (((block.pitch) * (height)) * (depth));
# 413 "malloc.cu"
host = ((int *)malloc(dBytes));
# 415 "malloc.cu"
int newWidth = ((block.pitch) / sizeof(int));
# 416 "malloc.cu"
...
# 426 "malloc.cu"
(p.srcPtr) = make_cudaPitchedPtr((void *)host, (width) * sizeof(int), width, height);
# 427 "malloc.cu"
(p.dstPtr) = block;
# 428 "malloc.cu"
(p.extent) = extent;
...
# 431 "malloc.cu"
if ((cudaMemcpy(block.ptr, host, dBytes, cudaMemcpyHostToDevice)) != (cudaSuccess)) {
# 432 "malloc.cu"
printf("cudaMemcpy3D() 0 - failed to copy %d x %d x %d on device\n", width, height, depth);
# 433 "malloc.cu"
cudaFree(&block);
# 434 "malloc.cu"
free(host);
...
cudaExtent extent2;
# 439 "malloc.cu"
(extent2.width) = ((1) * sizeof(int));
# 440 "malloc.cu"
(extent2.height) = (4);
# 441 "malloc.cu"
(extent2.depth) = (3);
# 443 "malloc.cu"
if ((cudaMemset3D(p.dstPtr, 15, extent2)) != (cudaSuccess)) {
# 444 "malloc.cu"
printf("cudaMemset3D() HtoD - failed to set %d x %d x %d to block\n", extent.width, extent.height, extent.depth);
# 445 "malloc.cu"
cudaFree(&block);
# 446 "malloc.cu"
free(host);
...
# 450 "malloc.cu"
for (int i = 0; i < ((newWidth * height) * depth); i++) {
# 451 "malloc.cu"
(host[i]) = 0;
# 452 "malloc.cu"
}
...
(p.srcPtr) = block;
# 455 "malloc.cu"
(p.dstPtr) = make_cudaPitchedPtr((void *)host, (width) * sizeof(int), width, height);
# 456 "malloc.cu"
(p.extent) = extent;
# 457 "malloc.cu"
(p.kind) = cudaMemcpyDeviceToHost;
# 459 "malloc.cu"
if ((cudaMemcpy(host, block.ptr, dBytes, cudaMemcpyDeviceToHost)) != (cudaSuccess)) {
# 460 "malloc.cu"
printf("cudaMemcpy() - failed to copy %d bytes from block\n", (int)bytes);
# 461 "malloc.cu"
cudaFree(&block);
...
# 470 "malloc.cu"
int tmp = (host[(k + (j * newWidth)) + ((i * height) * newWidth)]);
# 471 "malloc.cu"
if (i == 3) {
# 472 "malloc.cu"
if (tmp != 1) {
...
# 1 "/tmp/tmpxft_00004d82_00000000-1_malloc.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00004d82_00000000-1_malloc.cudafe1.stub.c" 1
...
#pragma pack()
# 2 "/tmp/tmpxft_00004d82_00000000-1_malloc.cudafe1.stub.c" 2
# 1 "/tmp/tmpxft_00004d82_00000000-3_malloc.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00004d82_00000000-3_malloc.fatbin.c" 2
...
".quad 0x30305f3238643430,0x372d303030303030,0x2e636f6c6c616d5f,0x2820692e33707063\n"
".quad 0x4263632f706d742f,0x7a67754a522e2349,0x2d2d2f2f090a2969,0x2d2d2d2d2d2d2d2d\n"
".quad 0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d\n"
...
".quad 0x662e090a223e656e,0x2f22093209656c69,0x78706d742f706d74,0x34303030305f7466\n"
".quad 0x303030305f323864,0x6d5f362d30303030,0x75632e636f6c6c61,0x70672e3265666164\n"
...
".quad 0x5f6563697665642f,0x6e6f6974636e7566,0x662e090a22682e73,0x2209303209656c69\n"
...
".quad 0x317874705f6c6264,0x00000a0a0a22682e\n"
".text");

extern "C" {

extern const unsigned long long __deviceText_$compute_10$[286];
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000004,0xa14f518d,(char*)"e63ff1b00045039a",(char*)"malloc.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x59d54bc3,&__elfEntries1};
# 3 "/tmp/tmpxft_00004d82_00000000-1_malloc.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_41_tmpxft_00004d82_00000000_4_malloc_cpp1_ii_main(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_41_tmpxft_00004d82_00000000_4_malloc_cpp1_ii_main(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil);}
# 1 "/tmp/tmpxft_00004d82_00000000-1_malloc.cudafe1.stub.c" 2
