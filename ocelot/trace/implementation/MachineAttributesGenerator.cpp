...
namespace trace
{
	...
	unsigned int MachineAttributesGenerator::MachineAttributesGenerator::_counter = 0;

	MachineAttributesGenerator::MachineAttributesGenerator()
	{
	}
	...
	void MachineAttributesGenerator::initialize(const ir::ExecutableKernel& kernel)
	...
	void MachineAttributesGenerator::event( const TraceEvent& event )
	{
	}
	
	void MachineAttributesGenerator::finish()
	{
