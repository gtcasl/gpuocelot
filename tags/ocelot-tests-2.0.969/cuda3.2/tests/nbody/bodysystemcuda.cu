                          ...
                          bool bUsePBO)
{
    ...
    if (bUsePBO)
    {
        ...
        size_t bytes;
        cutilSafeCall(cudaGraphicsResourceGetMappedPointer((void**)&oldPos, &bytes, pgres[currentRead]));
        cutilSafeCall(cudaGraphicsResourceGetMappedPointer((void**)&newPos, &bytes, pgres[1-currentRead]));
    }
...
template void integrateNbodySystem<float>(float* newPos, 
                                          float* oldPos, 
                                          float* vel, 
...
template void integrateNbodySystem<double>(double* newPos, 
                                           double* oldPos, 
                                           double* vel, 
                                           cudaGraphicsResource** pgres,
                                           unsigned int currentRead,
