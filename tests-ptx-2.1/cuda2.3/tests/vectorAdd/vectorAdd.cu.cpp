# 1 "/tmp/tmpxft_000053c6_00000000-1_vectorAdd.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_000053c6_00000000-1_vectorAdd.cudafe1.cpp"
# 1 "/home/rdomingu/gpuocelot/tests/cuda2.3/tests/vectorAdd/vectorAdd.cu"
...
# 43 "/usr/lib/gcc/x86_64-linux-gnu/4.3.4/include/va.h" 3
...
# 28 "/home/rdomingu/gpuocelot/tests/cuda2.3/tests/vectorAdd/vectorAdd.cu"
float *h_A;
float *h_B;
float *h_C;
float *d_A;
...
void VecAdd__entry(const float *A, const float *B, float *C, int N);
# 50 "/home/rdomingu/gpuocelot/tests/cuda2.3/tests/vectorAdd/vectorAdd.cu"
...
cudaConfigureCall(blocksPerGrid, threadsPerBlock) ? ((void)0) : VecAdd__entry(d_A, d_B, d_C, N);
error = cudaGetLastError();
if (error != (cudaSuccess)) { Cleanup(false); }
# 97 "/home/rdomingu/gpuocelot/tests/cuda2.3/tests/vectorAdd/vectorAdd.cu"
...
printf("Test %s \n", (i == N) ? ((const char *)"PASSED") : ((const char *)"FAILED"));
...
# 1 "/tmp/tmpxft_000053c6_00000000-1_vectorAdd.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_000053c6_00000000-3_vectorAdd.fatbin.c" 1
...
# 2 "/tmp/tmpxft_000053c6_00000000-3_vectorAdd.fatbin.c" 2
...
0x30305f3663333530ull,0x372d303030303030ull,0x41726f746365765full,0x2e337070632e6464ull,
0x2f706d742f282069ull,0x51772e2349426363ull,0x2f090a2935424c6eull,0x2d2d2d2d2d2d2d2full,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x305f366333353030ull,0x2d30303030303030ull,0x726f746365765f36ull,0x616475632e646441ull,
0x227570672e326566ull,0x09656c69662e090aull,0x2f7273752f220933ull,0x2f6363672f62696cull,
0x6c2d34365f363878ull,0x756e672d78756e69ull,0x692f342e332e342full,0x732f6564756c636eull,
...
0x656d69742f656475ull,0x69662e090a22682eull,0x2f2209353109656cull,0x6f64722f656d6f68ull,
0x70672f75676e696dull,0x2f746f6c65636f75ull,0x75632f7374736574ull,0x65742f332e326164ull,
0x746365762f737473ull,0x65762f646441726full,0x2e646441726f7463ull,0x69662e090a227563ull,
...
0x5a5f207972746e65ull,0x5064644163655636ull,0x6966505f3053664bull,0x61702e09090a2820ull,
0x3436752e206d6172ull,0x70616475635f5f20ull,0x56365a5f5f6d7261ull,0x664b506464416365ull,
0x415f6966505f3053ull,0x7261702e09090a2cull,0x203436752e206d61ull,0x6170616475635f5full,
0x6556365a5f5f6d72ull,0x53664b5064644163ull,0x2c425f6966505f30ull,0x617261702e09090aull,
0x5f203436752e206dull,0x726170616475635full,0x636556365a5f5f6dull,0x3053664b50646441ull,
0x0a2c435f6966505full,0x6d617261702e0909ull,0x5f5f203233732e20ull,0x6d72617061647563ull,
0x41636556365a5f5full,0x5f3053664b506464ull,0x090a294e5f696650ull,0x206765722e090a7bull,
0x687225203631752eull,0x722e090a3b3e343cull,0x203233752e206765ull,0x090a3b3e363c7225ull,
0x36752e206765722eull,0x30313c6472252034ull,0x6765722e090a3b3eull,0x6625203233662e20ull,
0x722e090a3b3e353cull,0x646572702e206765ull,0x0a3b3e333c702520ull,0x353109636f6c2e09ull,
0x4c240a3009323409ull,0x56365a5f5f314242ull,0x664b506464416365ull,0x0a3a6966505f3053ull,
...
