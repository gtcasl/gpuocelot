# 1 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.cpp"
...
# 53 "convolutionFFT2D.cu"
typedef float2 Complex;
# 61 "convolutionFFT2D.cu"
int iDivUp(int a, int b) {
# 62 "convolutionFFT2D.cu"
return ((a % b) != 0) ? (a / b + 1) : (a / b);
# 63 "convolutionFFT2D.cu"
}
# 66 "convolutionFFT2D.cu"
int iAlignUp(int a, int b) {
# 67 "convolutionFFT2D.cu"
return ((a % b) != 0) ? ((a - a % b) + b) : a;
# 68 "convolutionFFT2D.cu"
}
# 75 "convolutionFFT2D.cu"
extern "C" void convolutionCPU(Complex *, Complex *, Complex *, int, int, int, int, int, int);
# 45 "convolutionFFT2D_kernel.cu"
static texture< float2, 2, cudaReadModeElementType> texKernel;

# 1 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.h" 1

extern "C" {


extern void __device_stub__Z9padKernelP6float2iiiiii(Complex *, int, int, int, int, int, int);
# 14 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.h"
}
# 48 "convolutionFFT2D_kernel.cu" 2
# 71 "convolutionFFT2D_kernel.cu"
...
# 74 "convolutionFFT2D_kernel.cu" 2


# 1 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.h" 1

extern "C" {
# 11 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.h"
extern void __device_stub__Z20modulateAndNormalizeP6float2S0_i(Complex *, Complex *, int);


}
# 77 "convolutionFFT2D_kernel.cu" 2
# 99 "convolutionFFT2D.cu"
int calculateFFTsize(int dataSize) {
# 101 "convolutionFFT2D.cu"
auto int hiBit;
# 103 "convolutionFFT2D.cu"
auto unsigned lowPOT; auto unsigned hiPOT;
# 108 "convolutionFFT2D.cu"
dataSize = iAlignUp(dataSize, 16);
# 111 "convolutionFFT2D.cu"
for (hiBit = 31; hiBit >= 0; hiBit--) {
# 112 "convolutionFFT2D.cu"
if (dataSize & (1U << hiBit)) { break; } }
# 115 "convolutionFFT2D.cu"
lowPOT = 1U << hiBit;
# 116 "convolutionFFT2D.cu"
if (lowPOT == dataSize) { return dataSize; }
# 121 "convolutionFFT2D.cu"
hiPOT = 1U << (hiBit + 1);
# 122 "convolutionFFT2D.cu"
if (hiPOT <= (1024)) {
# 123 "convolutionFFT2D.cu"
return hiPOT; } else {
# 125 "convolutionFFT2D.cu"
return iAlignUp(dataSize, 512); }
# 126 "convolutionFFT2D.cu"
}
# 131 "convolutionFFT2D.cu"
static const int KERNEL_W = 7;
# 132 "convolutionFFT2D.cu"
static const int KERNEL_H = 7;
# 135 "convolutionFFT2D.cu"
static const int KERNEL_X = 1;
# 136 "convolutionFFT2D.cu"
static const int KERNEL_Y = 6;
# 139 "convolutionFFT2D.cu"
static const int PADDING_W = (KERNEL_W - 1);
# 140 "convolutionFFT2D.cu"
static const int PADDING_H = (KERNEL_H - 1);
# 147 "convolutionFFT2D.cu"
static const int DATA_W = 1000;
# 148 "convolutionFFT2D.cu"
static const int DATA_H = 1000;
# 152 "convolutionFFT2D.cu"
static const int FFT_W = calculateFFTsize(DATA_W + PADDING_W);
# 153 "convolutionFFT2D.cu"
static const int FFT_H = calculateFFTsize(DATA_H + PADDING_H);
# 155 "convolutionFFT2D.cu"
static const int FFT_SIZE = ((FFT_W * FFT_H) * sizeof(Complex));
# 156 "convolutionFFT2D.cu"
static const int KERNEL_SIZE = ((KERNEL_W * KERNEL_H) * sizeof(Complex));
# 157 "convolutionFFT2D.cu"
static const int DATA_SIZE = ((DATA_W * DATA_H) * sizeof(Complex));
# 164 "convolutionFFT2D.cu"
int main(int argc, char **argv) {
# 166 "convolutionFFT2D.cu"
auto Complex *h_Kernel;
# 167 "convolutionFFT2D.cu"
auto Complex *h_Data;
# 168 "convolutionFFT2D.cu"
auto Complex *h_ResultCPU;
# 169 "convolutionFFT2D.cu"
auto Complex *h_ResultGPU;
# 172 "convolutionFFT2D.cu"
auto cudaArray *a_Kernel;
# 173 "convolutionFFT2D.cu"
auto cudaArray *a_Data;
# 175 "convolutionFFT2D.cu"
auto cudaChannelFormatDesc float2tex = cudaCreateChannelDesc< float2> ();
# 179 "convolutionFFT2D.cu"
auto Complex *d_PaddedKernel;
# 180 "convolutionFFT2D.cu"
auto Complex *d_PaddedData;
# 182 "convolutionFFT2D.cu"
auto cufftHandle FFTplan;
# 185 "convolutionFFT2D.cu"
auto Complex rCPU; auto Complex rGPU;
# 188 "convolutionFFT2D.cu"
auto double max_delta_ref; auto double delta; auto double ref; auto double sum_delta2; auto double sum_ref2; auto double L2norm;
# 190 "convolutionFFT2D.cu"
auto int i; auto int x; auto int y;
# 192 "convolutionFFT2D.cu"
auto unsigned hTimer;
# 197 "convolutionFFT2D.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 198 "convolutionFFT2D.cu"
cutilDeviceInit(argc, argv); } else {
# 200 "convolutionFFT2D.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 202 "convolutionFFT2D.cu"
__cutilCheckError(cutCreateTimer(&hTimer), "convolutionFFT2D.cu", 202);
# 204 "convolutionFFT2D.cu"
printf("Input data size           : %i x %i\n", DATA_W, DATA_H);
# 205 "convolutionFFT2D.cu"
printf("Convolution kernel size   : %i x %i\n", KERNEL_W, KERNEL_H);
# 206 "convolutionFFT2D.cu"
printf("Padded image size         : %i x %i\n", DATA_W + PADDING_W, DATA_H + PADDING_H);
# 207 "convolutionFFT2D.cu"
printf("Aligned padded image size : %i x %i\n", FFT_W, FFT_H);
# 209 "convolutionFFT2D.cu"
printf("Allocating memory...\n");
# 210 "convolutionFFT2D.cu"
h_Kernel = (Complex *)malloc(KERNEL_SIZE);
# 211 "convolutionFFT2D.cu"
h_Data = (Complex *)malloc(DATA_SIZE);
# 212 "convolutionFFT2D.cu"
h_ResultCPU = (Complex *)malloc(DATA_SIZE);
# 213 "convolutionFFT2D.cu"
h_ResultGPU = (Complex *)malloc(FFT_SIZE);
# 214 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMallocArray(&a_Kernel, &float2tex, KERNEL_W, KERNEL_H), "convolutionFFT2D.cu", 214);
# 215 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMallocArray(&a_Data, &float2tex, DATA_W, DATA_H), "convolutionFFT2D.cu", 215);
# 216 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_PaddedKernel), FFT_SIZE), "convolutionFFT2D.cu", 216);
# 217 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_PaddedData), FFT_SIZE), "convolutionFFT2D.cu", 217);
# 219 "convolutionFFT2D.cu"
printf("Generating random input data...\n");
# 220 "convolutionFFT2D.cu"
srand(2007);
# 221 "convolutionFFT2D.cu"
for (i = 0; i < (KERNEL_W * KERNEL_H); i++) {
# 222 "convolutionFFT2D.cu"
((h_Kernel[i]).x) = (float)rand() / ((float)2147483647);
# 223 "convolutionFFT2D.cu"
((h_Kernel[i]).y) = (0);
# 224 "convolutionFFT2D.cu"
}
# 225 "convolutionFFT2D.cu"
for (i = 0; i < (DATA_W * DATA_H); i++) {
# 226 "convolutionFFT2D.cu"
((h_Data[i]).x) = (float)rand() / ((float)2147483647);
# 227 "convolutionFFT2D.cu"
((h_Data[i]).y) = (0);
# 228 "convolutionFFT2D.cu"
}
# 230 "convolutionFFT2D.cu"
printf("Creating FFT plan for %i x %i...\n", FFT_W, FFT_H);
# 231 "convolutionFFT2D.cu"
__cufftSafeCall(cufftPlan2d(&FFTplan, FFT_H, FFT_W, CUFFT_C2C), "convolutionFFT2D.cu", 231);
# 233 "convolutionFFT2D.cu"
printf("Uploading to GPU and padding convolution kernel and input data...\n");
# 234 "convolutionFFT2D.cu"
printf("...initializing padded kernel and data storage with zeroes...\n");
# 235 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMemset(d_PaddedKernel, 0, FFT_SIZE), "convolutionFFT2D.cu", 235);
# 236 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMemset(d_PaddedData, 0, FFT_SIZE), "convolutionFFT2D.cu", 236);
# 237 "convolutionFFT2D.cu"
printf("...copying input data and convolution kernel from host to CUDA arrays\n");
# 238 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMemcpyToArray(a_Kernel, 0, 0, h_Kernel, KERNEL_SIZE, cudaMemcpyHostToDevice), "convolutionFFT2D.cu", 238);
# 239 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMemcpyToArray(a_Data, 0, 0, h_Data, DATA_SIZE, cudaMemcpyHostToDevice), "convolutionFFT2D.cu", 239);
# 240 "convolutionFFT2D.cu"
printf("...binding CUDA arrays to texture references\n");
# 241 "convolutionFFT2D.cu"
__cudaSafeCall(cudaBindTextureToArray(texKernel, a_Kernel), "convolutionFFT2D.cu", 241);
# 242 "convolutionFFT2D.cu"
__cudaSafeCall(cudaBindTextureToArray(texData, a_Data), "convolutionFFT2D.cu", 242);
# 246 "convolutionFFT2D.cu"
auto dim3 threadBlock(16, 12);
# 247 "convolutionFFT2D.cu"
auto dim3 kernelBlockGrid(iDivUp(KERNEL_W, threadBlock.x), iDivUp(KERNEL_H, threadBlock.y));
# 248 "convolutionFFT2D.cu"
auto dim3 dataBlockGrid(iDivUp(FFT_W, threadBlock.x), iDivUp(FFT_H, threadBlock.y));
# 250 "convolutionFFT2D.cu"
printf("...padding convolution kernel\n");
# 251 "convolutionFFT2D.cu"
cudaConfigureCall(kernelBlockGrid, threadBlock) ? ((void)0) : __device_stub__Z9padKernelP6float2iiiiii(d_PaddedKernel, FFT_W, FFT_H, KERNEL_W, KERNEL_H, KERNEL_X, KERNEL_Y);
# 260 "convolutionFFT2D.cu"
__cutilCheckMsg("padKernel() execution failed\n", "convolutionFFT2D.cu", 260);
# 262 "convolutionFFT2D.cu"
printf("...padding input data array\n");
# 263 "convolutionFFT2D.cu"
cudaConfigureCall(dataBlockGrid, threadBlock) ? ((void)0) : __device_stub__Z7padDataP6float2iiiiiiii(d_PaddedData, FFT_W, FFT_H, DATA_W, DATA_H, KERNEL_W, KERNEL_H, KERNEL_X, KERNEL_Y);
# 274 "convolutionFFT2D.cu"
__cutilCheckMsg("padData() execution failed\n", "convolutionFFT2D.cu", 274);
# 278 "convolutionFFT2D.cu"
printf("Transforming convolution kernel...\n");
# 279 "convolutionFFT2D.cu"
__cufftSafeCall(cufftExecC2C(FFTplan, (cufftComplex *)d_PaddedKernel, (cufftComplex *)d_PaddedKernel, -1), "convolutionFFT2D.cu", 279);
# 281 "convolutionFFT2D.cu"
printf("Running GPU FFT convolution...\n");
# 282 "convolutionFFT2D.cu"
__cudaSafeCall(cudaThreadSynchronize(), "convolutionFFT2D.cu", 282);
# 283 "convolutionFFT2D.cu"
__cutilCheckError(cutResetTimer(hTimer), "convolutionFFT2D.cu", 283);
# 284 "convolutionFFT2D.cu"
__cutilCheckError(cutStartTimer(hTimer), "convolutionFFT2D.cu", 284);
# 285 "convolutionFFT2D.cu"
__cufftSafeCall(cufftExecC2C(FFTplan, (cufftComplex *)d_PaddedData, (cufftComplex *)d_PaddedData, -1), "convolutionFFT2D.cu", 285);
# 286 "convolutionFFT2D.cu"
cudaConfigureCall(16, 128) ? ((void)0) : __device_stub__Z20modulateAndNormalizeP6float2S0_i(d_PaddedData, d_PaddedKernel, FFT_W * FFT_H);
# 291 "convolutionFFT2D.cu"
__cutilCheckMsg("modulateAndNormalize() execution failed\n", "convolutionFFT2D.cu", 291);
# 292 "convolutionFFT2D.cu"
__cufftSafeCall(cufftExecC2C(FFTplan, (cufftComplex *)d_PaddedData, (cufftComplex *)d_PaddedData, 1), "convolutionFFT2D.cu", 292);
# 293 "convolutionFFT2D.cu"
__cudaSafeCall(cudaThreadSynchronize(), "convolutionFFT2D.cu", 293);
# 294 "convolutionFFT2D.cu"
__cutilCheckError(cutStopTimer(hTimer), "convolutionFFT2D.cu", 294);
# 295 "convolutionFFT2D.cu"
auto double gpuTime = (cutGetTimerValue(hTimer));
# 296 "convolutionFFT2D.cu"
printf("GPU time: %f msecs. //%f MPix/s\n", gpuTime, ((DATA_W * DATA_H) * (9.999999999999999547e-07)) / (gpuTime * (0.001000000000000000021)));
# 298 "convolutionFFT2D.cu"
printf("Reading back GPU FFT results...\n");
# 299 "convolutionFFT2D.cu"
__cudaSafeCall(cudaMemcpy(h_ResultGPU, d_PaddedData, FFT_SIZE, cudaMemcpyDeviceToHost), "convolutionFFT2D.cu", 299);
# 302 "convolutionFFT2D.cu"
printf("Checking GPU results...\n");
# 303 "convolutionFFT2D.cu"
printf("...running reference CPU convolution\n");
# 304 "convolutionFFT2D.cu"
convolutionCPU(h_ResultCPU, h_Data, h_Kernel, DATA_W, DATA_H, KERNEL_W, KERNEL_H, KERNEL_X, KERNEL_Y);
# 316 "convolutionFFT2D.cu"
printf("...comparing the results\n");
# 317 "convolutionFFT2D.cu"
sum_delta2 = (0);
# 318 "convolutionFFT2D.cu"
sum_ref2 = (0);
# 319 "convolutionFFT2D.cu"
max_delta_ref = (0);
# 320 "convolutionFFT2D.cu"
for (y = 0; y < DATA_H; y++) {
# 321 "convolutionFFT2D.cu"
for (x = 0; x < DATA_W; x++) {
# 322 "convolutionFFT2D.cu"
rCPU = h_ResultCPU[y * DATA_W + x];
# 323 "convolutionFFT2D.cu"
rGPU = h_ResultGPU[y * FFT_W + x];
# 324 "convolutionFFT2D.cu"
delta = (rCPU.x - rGPU.x) * (rCPU.x - rGPU.x) + (rCPU.y - rGPU.y) * (rCPU.y - rGPU.y);
# 325 "convolutionFFT2D.cu"
ref = rCPU.x * rCPU.x + rCPU.y * rCPU.y;
# 326 "convolutionFFT2D.cu"
if ((delta / ref) > max_delta_ref) { max_delta_ref = delta / ref; }
# 327 "convolutionFFT2D.cu"
sum_delta2 += delta;
# 328 "convolutionFFT2D.cu"
sum_ref2 += ref;
# 329 "convolutionFFT2D.cu"
} }
# 330 "convolutionFFT2D.cu"
L2norm = sqrt(sum_delta2 / sum_ref2);
# 331 "convolutionFFT2D.cu"
printf("Max delta / CPU value %E\n", sqrt(max_delta_ref));
# 332 "convolutionFFT2D.cu"
printf("L2 norm: %E\n", L2norm);
# 333 "convolutionFFT2D.cu"
printf((L2norm < (9.999999999999999547e-07)) ? ((const char *)"TEST PASSED\n") : ((const char *)"TEST FAILED\n"));
# 336 "convolutionFFT2D.cu"
printf("Shutting down...\n");
# 337 "convolutionFFT2D.cu"
__cudaSafeCall(cudaUnbindTexture(texData), "convolutionFFT2D.cu", 337);
# 338 "convolutionFFT2D.cu"
__cudaSafeCall(cudaUnbindTexture(texKernel), "convolutionFFT2D.cu", 338);
# 339 "convolutionFFT2D.cu"
__cufftSafeCall(cufftDestroy(FFTplan), "convolutionFFT2D.cu", 339);
# 340 "convolutionFFT2D.cu"
__cudaSafeCall(cudaFree(d_PaddedData), "convolutionFFT2D.cu", 340);
# 341 "convolutionFFT2D.cu"
__cudaSafeCall(cudaFree(d_PaddedKernel), "convolutionFFT2D.cu", 341);
# 342 "convolutionFFT2D.cu"
__cudaSafeCall(cudaFreeArray(a_Data), "convolutionFFT2D.cu", 342);
# 343 "convolutionFFT2D.cu"
__cudaSafeCall(cudaFreeArray(a_Kernel), "convolutionFFT2D.cu", 343);
# 344 "convolutionFFT2D.cu"
free(h_ResultGPU);
# 345 "convolutionFFT2D.cu"
free(h_ResultCPU);
# 346 "convolutionFFT2D.cu"
free(h_Data);
# 347 "convolutionFFT2D.cu"
free(h_Kernel);
# 349 "convolutionFFT2D.cu"
cudaThreadExit();
# 351 "convolutionFFT2D.cu"
__cutilExit(argc, argv); return 0;
# 352 "convolutionFFT2D.cu"
}

# 1 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00000b9e_00000000-3_convolutionFFT2D.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00000b9e_00000000-3_convolutionFFT2D.fatbin.c" 2
...
0x730a7d0a31203d20ull,0x7b2072656c706d61ull,0x2020656d616e090aull,0x4b786574203d2020ull,
0x74090a6c656e7265ull,0x3d2074696e757865ull,0x646f630a7d0a3020ull,0x6d616e090a7b2065ull,
0x70395a5f203d2065ull,0x6c656e72654b6461ull,0x3274616f6c663650ull,0x090a696969696969ull,
0x30203d206d656d6cull,0x3d206d656d73090aull,0x676572090a383420ull,0x62090a36203d2020ull,
...
0x0a20666633303030ull,0x090a7d090a7d0909ull,0x2065646f636e6962ull,0x3061783009090a7bull,
0x3020353032343030ull,0x3837303032343078ull,0x3030306178302030ull,0x3078302039306334ull,
0x2030383730303234ull,0x303034783009090aull,0x7830203530323032ull,0x3038373831303030ull,
0x3430303061783020ull,0x3430783020393034ull,0x0a20303837303032ull,0x3030306178300909ull,
0x3078302064306534ull,0x2030383730303234ull,0x3230303830647830ull,0x3430307830203132ull,
0x090a203038373030ull,0x3030303061783009ull,0x3430783020313030ull,0x3020303837303030ull,
0x3034303330303478ull,0x3130303078302039ull,0x09090a2030383738ull,0x3031303030617830ull,
0x3034307830206430ull,0x7830203038373030ull,0x3031323830303032ull,0x3833303032783020ull,
0x3009090a20343134ull,0x6631643430303378ull,0x3132633678302064ull,0x3378302038633730ull,
0x2064663364353030ull,0x3230313263367830ull,0x783009090a203863ull,0x3330303030303033ull,
0x3030303030783020ull,0x3033783020303031ull,0x3020643036643030ull,0x6437343132343078ull,
0x33783009090a2030ull,0x2039303464303030ull,0x3730313234307830ull,0x3030317830203063ull,
0x7830203030363832ull,0x3430343830303031ull,0x3032783009090a20ull,0x3020313065633030ull,
0x3839643032343078ull,0x3030303278302030ull,0x3078302035306363ull,0x2030383938303234ull,
0x303061783009090aull,0x7830203930613030ull,0x3038373431303434ull,0x6330303036783020ull,
0x3038783020313063ull,0x0a20303837343032ull,0x3030306178300909ull,0x3478302064303830ull,
0x2030383734313034ull,0x3430303030627830ull,0x6633307830203530ull,0x090a203330303030ull,
0x3033303033783009ull,0x3463783020393030ull,0x3020303837303031ull,0x3036303030306278ull,
0x3066333078302031ull,0x09090a2033303030ull,0x3863303030327830ull,0x3234307830203930ull,
0x7830203038373830ull,0x3130303030343666ull,0x3030303030783020ull,0x3009090a20343837ull,
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"3758ee30e61d4a61",(char*)"convolutionFFT2D.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.c" 2
struct __T20;
struct __T21;
struct __T22;
struct __T20 {Complex *__par0;int __par1;int __par2;int __par3;int __par4;int __par5;int __par6;int __dummy_field;volatile char __dummy[4];};
struct __T21 {Complex *__par0;int __par1;int __par2;int __par3;int __par4;int __par5;int __par6;int __par7;int __par8;int __dummy_field;volatile char __dummy[4];};
struct __T22 {Complex *__par0;Complex *__par1;int __par2;int __dummy_field;};
# 21 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.c"
static void __sti____cudaRegisterAll_51_tmpxft_00000b9e_00000000_7_convolutionFFT2D_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
void __device_stub__Z9padKernelP6float2iiiiii(Complex *__par0, int __par1, int __par2, int __par3, int __par4, int __par5, int __par6){auto struct __T20 *__T23;
char __[256]; *(char**)&__T23 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T23->__par0 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T23->__par1 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T23->__par2 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par3, sizeof(__par3), (size_t)&__T23->__par3 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par4, sizeof(__par4), (size_t)&__T23->__par4 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par5, sizeof(__par5), (size_t)&__T23->__par5 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par6, sizeof(__par6), (size_t)&__T23->__par6 - (size_t)__T23) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z9padKernelP6float2iiiiii); (void)cudaLaunch(((char *)__device_stub__Z9padKernelP6float2iiiiii)); };}
void __device_stub__Z7padDataP6float2iiiiiiii(Complex *__par0, int __par1, int __par2, int __par3, int __par4, int __par5, int __par6, int __par7, int __par8){auto struct __T21 *__T24;
char __[256]; *(char**)&__T24 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T24->__par0 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T24->__par1 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T24->__par2 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par3, sizeof(__par3), (size_t)&__T24->__par3 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par4, sizeof(__par4), (size_t)&__T24->__par4 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par5, sizeof(__par5), (size_t)&__T24->__par5 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par6, sizeof(__par6), (size_t)&__T24->__par6 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par7, sizeof(__par7), (size_t)&__T24->__par7 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par8, sizeof(__par8), (size_t)&__T24->__par8 - (size_t)__T24) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z7padDataP6float2iiiiiiii); (void)cudaLaunch(((char *)__device_stub__Z7padDataP6float2iiiiiiii)); };}
void __device_stub__Z20modulateAndNormalizeP6float2S0_i(Complex *__par0, Complex *__par1, int __par2){auto struct __T22 *__T25;
char __[256]; *(char**)&__T25 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T25->__par0 - (size_t)__T25) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T25->__par1 - (size_t)__T25) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T25->__par2 - (size_t)__T25) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z20modulateAndNormalizeP6float2S0_i); (void)cudaLaunch(((char *)__device_stub__Z20modulateAndNormalizeP6float2S0_i)); };}
# 37 "/tmp/tmpxft_00000b9e_00000000-1_convolutionFFT2D.cudafe1.stub.c"
static void __sti____cudaRegisterAll_51_tmpxft_00000b9e_00000000_7_convolutionFFT2D_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z20modulateAndNormalizeP6float2S0_i, (char*)"_Z20modulateAndNormalizeP6float2S0_i", "_Z20modulateAndNormalizeP6float2S0_i", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z7padDataP6float2iiiiiiii, (char*)"_Z7padDataP6float2iiiiiiii", "_Z7padDataP6float2iiiiiiii", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z9padKernelP6float2iiiiii, (char*)"_Z9padKernelP6float2iiiiii", "_Z9padKernelP6float2iiiiii", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterTexture(__cudaFatCubinHandle, (const struct textureReference*)&texKernel, 0, "texKernel", 2, 0, 0);__cudaRegisterTexture(__cudaFatCubinHandle, (const struct textureReference*)&texData, 0, "texData", 2, 0, 0);}

}
# 354 "convolutionFFT2D.cu" 2
