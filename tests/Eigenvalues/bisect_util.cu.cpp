# 1 "/tmp/tmpxft_00000eb0_00000000-19_bisect_util.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00000eb0_00000000-19_bisect_util.cudafe1.cpp"
# 1 "bisect_util.cu"
...
# 158 "util.h"
# 1 "/tmp/tmpxft_00000eb0_00000000-19_bisect_util.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00000eb0_00000000-21_bisect_util.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00000eb0_00000000-21_bisect_util.fatbin.c" 2
...
0x5f30372d30303030ull,0x755f746365736962ull,0x337070632e6c6974ull,0x706d742f2820692eull,
0x4e2e23494263632full,0x090a293846674d61ull,0x2d2d2d2d2d2d2f2full,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x09656c69662e090aull,0x2f706d742f220932ull,0x305f746678706d74ull,0x5f30626530303030ull,
0x3030303030303030ull,0x657369625f39362dull,0x2e6c6974755f7463ull,0x2e32656661647563ull,
...
0x6573696222093531ull,0x2e6c6974755f7463ull,0x69662e090a227563ull,0x2f2209363109656cull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"dd395744ef9300a3",(char*)"bisect_util.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00000eb0_00000000-19_bisect_util.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00000eb0_00000000-19_bisect_util.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_47_tmpxft_00000eb0_00000000_67_bisect_util_cpp1_ii_7621fe01(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_47_tmpxft_00000eb0_00000000_67_bisect_util_cpp1_ii_7621fe01(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);}
