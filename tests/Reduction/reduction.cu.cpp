# 1 "/tmp/tmpxft_00001889_00000000-1_reduction.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00001889_00000000-1_reduction.cudafe1.cpp"
# 1 "reduction.cu"
...
# 4 "reduction.h"
template<class T> extern void reduce_sm10(int, int, int, int, T *, T *);
# 8 "reduction.h"
template<class T> extern void reduce_sm13(int, int, int, int, T *, T *);
# 71 "reduction.cu"
enum ReduceType {
# 73 "reduction.cu"
REDUCE_INT,
...
# 80 "reduction.cu"
template<class T> extern void runTest(int, char **, ReduceType);
# 94 "reduction.cu"
int main(int argc, char **argv)
# 95 "reduction.cu"
{
# 96 "reduction.cu"
auto char *typeChoice;
# 97 "reduction.cu"
...
# 105 "reduction.cu"
auto ReduceType datatype = REDUCE_INT;
# 107 "reduction.cu"
...
(deviceProp.minor) = 0;
# 119 "reduction.cu"
auto int desiredMinorRevision = 0;
# 121 "reduction.cu"
...
auto int dev;
# 129 "reduction.cu"
__cudaSafeCallNoSync(cudaChooseDevice(&dev, &deviceProp), "reduction.cu", 129);
# 130 "reduction.cu"
__cudaSafeCallNoSync(cudaGetDeviceProperties(&deviceProp, dev), "reduction.cu", 130);
# 132 "reduction.cu"
...
# 135 "reduction.cu"
__cudaSafeCallNoSync(cudaSetDevice(dev), "reduction.cu", 135);
# 136 "reduction.cu"
} else {
# 137 "reduction.cu"
...
# 243 "reduction.cu"
__cutilCheckError(cutStartTimer(timer), "reduction.cu", 243);
# 246 "reduction.cu"
if (useSM13) {
# 247 "reduction.cu"
...
# 252 "reduction.cu"
__cutilCheckMsg("Kernel execution failed", "reduction.cu", 252);
# 254 "reduction.cu"
if (cpuFinalReduction)
# 255 "reduction.cu"
{
# 258 "reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(h_odata, d_odata, numBlocks * sizeof(T), cudaMemcpyDeviceToHost), "reduction.cu", 258);
# 260 "reduction.cu"
...
{
# 270 "reduction.cu"
auto int s = numBlocks;
# 271 "reduction.cu"
auto int kernel = ((whichKernel == 6) ? 5 : whichKernel);
# 272 "reduction.cu"
while (s > cpuFinalThreshold)
# 273 "reduction.cu"
{
# 274 "reduction.cu"
auto int threads = 0; auto int blocks = 0;
# 275 "reduction.cu"
...
{
# 291 "reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(h_odata, d_odata, s * sizeof(T), cudaMemcpyDeviceToHost), "reduction.cu", 291);
# 293 "reduction.cu"
for (int i = 0; i < s; i++)
# 294 "reduction.cu"
{
...
cudaThreadSynchronize();
# 303 "reduction.cu"
__cutilCheckError(cutStopTimer(timer), "reduction.cu", 303);
# 304 "reduction.cu"
}
# 306 "reduction.cu"
if (needReadBack)
...
{
# 309 "reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(&gpu_result, d_odata, sizeof(T), cudaMemcpyDeviceToHost), "reduction.cu", 309);
# 310 "reduction.cu"
}
# 312 "reduction.cu"
return gpu_result;
...
{
# 324 "reduction.cu"
auto bool useSM13 = (datatype == (REDUCE_DOUBLE));
# 327 "reduction.cu"
auto unsigned bytes = (maxN * sizeof(T));
# 329 "reduction.cu"
auto T *h_idata = ((T *)malloc(bytes));
# 331 "reduction.cu"
...
# 339 "reduction.cu"
auto int maxNumBlocks = (maxN / maxThreads);
# 342 "reduction.cu"
auto T *h_odata = ((T *)malloc(maxNumBlocks * sizeof(T)));
# 345 "reduction.cu"
auto T *d_idata = (__null);
# 346 "reduction.cu"
auto T *d_odata = (__null);
# 348 "reduction.cu"
__cudaSafeCallNoSync(cudaMalloc((void **)(&d_idata), bytes), "reduction.cu", 348);
# 349 "reduction.cu"
__cudaSafeCallNoSync(cudaMalloc((void **)(&d_odata), maxNumBlocks * sizeof(T)), "reduction.cu", 349);
# 352 "reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(d_idata, h_idata, bytes, cudaMemcpyHostToDevice), "reduction.cu", 352);
# 353 "reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(d_odata, h_idata, maxNumBlocks * sizeof(T), cudaMemcpyHostToDevice), "reduction.cu", 353);
# 357 "reduction.cu"
...
# 370 "reduction.cu"
__cutilCheckError(cutCreateTimer(&timer), "reduction.cu", 370);
# 373 "reduction.cu"
...
cutResetTimer(timer);
# 388 "reduction.cu"
auto int numBlocks = 0;
# 389 "reduction.cu"
auto int numThreads = 0;
# 390 "reduction.cu"
...
# 396 "reduction.cu"
auto float reduceTime = cutGetAverageTimerValue(timer);
# 397 "reduction.cu"
printf(", %f", reduceTime);
# 398 "reduction.cu"
}
...
# 403 "reduction.cu"
__cutilCheckError(cutDeleteTimer(timer), "reduction.cu", 403);
# 404 "reduction.cu"
free(h_idata);
# 405 "reduction.cu"
free(h_odata);
# 407 "reduction.cu"
__cudaSafeCallNoSync(cudaFree(d_idata), "reduction.cu", 407);
# 408 "reduction.cu"
__cudaSafeCallNoSync(cudaFree(d_odata), "reduction.cu", 408);
# 409 "reduction.cu"
}
# 414 "reduction.cu"
template<class T> void
...
auto int size = (1 << 20);
# 419 "reduction.cu"
auto int maxThreads = 128;
# 420 "reduction.cu"
auto int whichKernel = 6;
# 421 "reduction.cu"
auto int maxBlocks = 64;
# 422 "reduction.cu"
auto bool cpuFinalReduction = false;
# 423 "reduction.cu"
auto int cpuFinalThreshold = 1;
# 425 "reduction.cu"
...
# 436 "reduction.cu"
auto bool runShmoo = ((cutCheckCmdLineFlag(argc, (const char **)argv, "shmoo")) == (CUTTrue));
# 438 "reduction.cu"
if (runShmoo)
# 439 "reduction.cu"
{
...
{
# 446 "reduction.cu"
auto unsigned bytes = (size * sizeof(T));
# 448 "reduction.cu"
auto T *h_idata = ((T *)malloc(bytes));
# 450 "reduction.cu"
...
# 465 "reduction.cu"
auto T *h_odata = ((T *)malloc(numBlocks * sizeof(T)));
# 467 "reduction.cu"
printf("%d blocks\n", numBlocks);
# 470 "reduction.cu"
auto T *d_idata = (__null);
...
auto T *d_odata = (__null);
# 473 "reduction.cu"
__cudaSafeCallNoSync(cudaMalloc((void **)(&d_idata), bytes), "reduction.cu", 473);
# 474 "reduction.cu"
__cudaSafeCallNoSync(cudaMalloc((void **)(&d_odata), numBlocks * sizeof(T)), "reduction.cu", 474);
# 477 "reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(d_idata, h_idata, bytes, cudaMemcpyHostToDevice), "reduction.cu", 477);
# 478 "reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(d_odata, h_idata, numBlocks * sizeof(T), cudaMemcpyHostToDevice), "reduction.cu", 478);
# 482 "reduction.cu"
if (datatype == (REDUCE_DOUBLE)) {
# 483 "reduction.cu"
...
auto unsigned timer = (0);
# 493 "reduction.cu"
__cutilCheckError(cutCreateTimer(&timer), "reduction.cu", 493);
# 495 "reduction.cu"
auto T gpu_result = 0;
# 497 "reduction.cu"
...
# 507 "reduction.cu"
auto T cpu_result = (reduceCPU< T> (h_idata, size));
# 509 "reduction.cu"
if (datatype == (REDUCE_INT))
# 510 "reduction.cu"
{
...
printf("CPU result = %d\n", cpu_result);
# 514 "reduction.cu"
printf("TEST %s\n", (gpu_result == cpu_result) ? ((const char *)"PASSED") : ((const char *)"FAILED"));
# 515 "reduction.cu"
} else
# 517 "reduction.cu"
{
...
# 521 "reduction.cu"
auto double threshold = ((datatype == (REDUCE_FLOAT)) ? ((1.000000000000000021e-08) * size) : (9.999999999999999799e-13));
# 522 "reduction.cu"
auto double diff = abs((double)gpu_result - (double)cpu_result);
# 523 "reduction.cu"
printf("TEST %s\n", (diff < threshold) ? ((const char *)"PASSED") : ((const char *)"FAILED"));
# 524 "reduction.cu"
}
# 529 "reduction.cu"
__cutilCheckError(cutDeleteTimer(timer), "reduction.cu", 529);
# 530 "reduction.cu"
free(h_idata);
# 531 "reduction.cu"
free(h_odata);
# 533 "reduction.cu"
__cudaSafeCallNoSync(cudaFree(d_idata), "reduction.cu", 533);
# 534 "reduction.cu"
__cudaSafeCallNoSync(cudaFree(d_odata), "reduction.cu", 534);
# 535 "reduction.cu"
}
# 536 "reduction.cu"
}

# 1 "/tmp/tmpxft_00001889_00000000-1_reduction.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00001889_00000000-3_reduction.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00001889_00000000-3_reduction.fatbin.c" 2
...
0x5f36312d30303030ull,0x6f69746375646572ull,0x692e337070632e6eull,0x632f706d742f2820ull,
0x4732612e23494263ull,0x2f2f090a296d506aull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x093209656c69662eull,0x6d742f706d742f22ull,0x3030305f74667870ull,0x30305f3938383130ull,
0x312d303030303030ull,0x7463756465725f35ull,0x616475632e6e6f69ull,0x227570672e326566ull,
...
0x2f2209363109656cull,0x6964672f656d6f68ull,0x6d65742f736f6d61ull,0x622f616475632f70ull,
...
0x2e090a22682e736eull,0x09383109656c6966ull,0x672f656d6f682f22ull,0x742f736f6d616964ull,
0x616475632f706d65ull,0x2e2e2f2f6e69622full,0x6564756c636e692full,0x5f6563697665642full,
0x6e6f6974636e7566ull,0x662e090a22682e73ull,0x2209393109656c69ull,0x64672f656d6f682full,
0x65742f736f6d6169ull,0x2f616475632f706dull,0x2f2e2e2f2f6e6962ull,0x2f6564756c636e69ull,
0x6e6f635f6874616dull,0x682e73746e617473ull,0x656c69662e090a22ull,0x6f682f2209303209ull,
...
0x736e6f6974636e75ull,0x69662e090a22682eull,0x2f2209323209656cull,0x6964672f656d6f68ull,
...
0x736e6f6974636e75ull,0x7874705f6c62645full,0x000a0a0a22682e33ull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"d5254446ac2d59fb",(char*)"reduction.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00001889_00000000-1_reduction.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00001889_00000000-1_reduction.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_45_tmpxft_00001889_00000000_13_reduction_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_45_tmpxft_00001889_00000000_13_reduction_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);}
