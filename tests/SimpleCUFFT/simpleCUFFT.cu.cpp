# 1 "/tmp/tmpxft_00001baf_00000000-1_simpleCUFFT.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00001baf_00000000-1_simpleCUFFT.cudafe1.cpp"
# 1 "simpleCUFFT.cu"
...
# 1 "/tmp/tmpxft_00001baf_00000000-1_simpleCUFFT.cudafe1.stub.h" 1
...
if (n < N) {
# 103 "simpleCUFFT.cu"
auto float r = ((data[n]).x); auto float i = ((data[n]).y);
# 104 "simpleCUFFT.cu"
fprintf(file, " %f %s %fi ;\n", r, (i >= (0)) ? ((const char *)"+") : ((const char *)"-"), (float)fabs(i));
# 105 "simpleCUFFT.cu"
} else
# 106 "simpleCUFFT.cu"
{
...
# 178 "simpleCUFFT.cu"
write_vector("T_signal", h_signal, 50, new_size);
# 179 "simpleCUFFT.cu"
write_vector("T_filter", h_filter_kernel, 11, new_size);
# 182 "simpleCUFFT.cu"
auto Complex *d_signal;
# 183 "simpleCUFFT.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_signal), mem_size), "simpleCUFFT.cu", 183);
# 185 "simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(d_signal, h_padded_signal, mem_size, cudaMemcpyHostToDevice), "simpleCUFFT.cu", 186);
# 189 "simpleCUFFT.cu"
auto Complex *d_filter_kernel;
# 190 "simpleCUFFT.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_filter_kernel), mem_size), "simpleCUFFT.cu", 190);
# 193 "simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(d_filter_kernel, h_padded_filter_kernel, mem_size, cudaMemcpyHostToDevice), "simpleCUFFT.cu", 194);
# 197 "simpleCUFFT.cu"
auto cufftHandle plan;
# 198 "simpleCUFFT.cu"
__cufftSafeCall(cufftPlan1d(&plan, new_size, CUFFT_C2C, 1), "simpleCUFFT.cu", 198);
# 201 "simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, -1), "simpleCUFFT.cu", 202);
# 204 "simpleCUFFT.cu"
{
# 205 "simpleCUFFT.cu"
auto Complex *Freq_signal = ((Complex *)malloc(new_size * sizeof(Complex)));
# 206 "simpleCUFFT.cu"
...
# 211 "simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_filter_kernel, (cufftComplex *)d_filter_kernel, -1), "simpleCUFFT.cu", 212);
# 215 "simpleCUFFT.cu"
{
# 216 "simpleCUFFT.cu"
auto Complex *Freq_filter_kernel = ((Complex *)malloc(new_size * sizeof(Complex)));
# 217 "simpleCUFFT.cu"
cudaMemcpy(Freq_filter_kernel, d_filter_kernel, sizeof(Complex) * new_size, cudaMemcpyDeviceToHost);
# 219 "simpleCUFFT.cu"
...
# 224 "simpleCUFFT.cu"
cudaConfigureCall(32, 256) ? ((void)0) : __device_stub__Z27ComplexPointwiseMulAndScaleP6float2PKS_if(d_signal, d_filter_kernel, new_size, (1.0F) / new_size);
# 226 "simpleCUFFT.cu"
{
# 227 "simpleCUFFT.cu"
auto Complex *F_filtered = ((Complex *)malloc(sizeof(Complex) * new_size));
# 228 "simpleCUFFT.cu"
...
# 234 "simpleCUFFT.cu"
__cutilCheckMsg("Kernel execution failed [ ComplexPointwiseMulAndScale ]", "simpleCUFFT.cu", 234);
# 237 "simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, 1), "simpleCUFFT.cu", 238);
# 240 "simpleCUFFT.cu"
{
# 241 "simpleCUFFT.cu"
auto Complex *T_filtered = ((Complex *)malloc(sizeof(Complex) * new_size));
# 242 "simpleCUFFT.cu"
...
# 249 "simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(h_convolved_signal, d_signal, mem_size, cudaMemcpyDeviceToHost), "simpleCUFFT.cu", 250);
# 253 "simpleCUFFT.cu"
...
# 267 "simpleCUFFT.cu"
__cufftSafeCall(cufftDestroy(plan), "simpleCUFFT.cu", 267);
# 270 "simpleCUFFT.cu"
free(h_signal);
# 271 "simpleCUFFT.cu"
...
# 275 "simpleCUFFT.cu"
__cudaSafeCall(cudaFree(d_signal), "simpleCUFFT.cu", 275);
# 276 "simpleCUFFT.cu"
__cudaSafeCall(cudaFree(d_filter_kernel), "simpleCUFFT.cu", 276);
# 278 "simpleCUFFT.cu"
cudaThreadExit();
# 279 "simpleCUFFT.cu"
}
...
# 364 "simpleCUFFT.cu" 2


# 1 "/tmp/tmpxft_00001baf_00000000-1_simpleCUFFT.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00001baf_00000000-3_simpleCUFFT.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00001baf_00000000-3_simpleCUFFT.fatbin.c" 2
...
0x206d656d73090a30ull,0x6572090a3034203dull,0x0a3131203d202067ull,0x203d202072616209ull,
...
0x3030317830203038ull,0x7830203130323030ull,0x3038373430303034ull,0x3033783009090a20ull,
0x3020393032303330ull,0x3837303031346378ull,0x3030313478302030ull,0x3278302034313832ull,
0x2030313865323031ull,0x303032783009090aull,0x7830206431636330ull,0x3038373830323430ull,
0x3033303033783020ull,0x3463783020393161ull,0x0a20303837303031ull,0x3130303278300909ull,
0x3278302030326138ull,0x2034323066353031ull,0x3830653030647830ull,0x3830387830203930ull,
0x090a203038373030ull,0x3065303064783009ull,0x3038783020313065ull,0x3020303837303038ull,
0x3236303130306378ull,0x3030306378302038ull,0x09090a2063303630ull,0x3430303030657830ull,
0x3038307830203130ull,0x7830203038373832ull,0x3530343031303065ull,0x6330303030783020ull,
0x3009090a20303837ull,0x3032373030316378ull,0x3130316378302030ull,0x3278302034303237ull,
0x2031323031303030ull,0x3734313034307830ull,0x783009090a203038ull,0x3130383065303064ull,
0x3030383061783020ull,0x3033783020303837ull,0x3020646631313930ull,0x6337343030633678ull,
0x32783009090a2038ull,0x2063316338373030ull,0x3838363030327830ull,0x3030317830203031ull,
0x7830203330306230ull,0x3038323030303030ull,0x3066783009090a20ull,0x3020313030303030ull,
0x2061726220327025ull,0x375f305f744c2409ull,0x202020202020203bull,0x2f2f092020202020ull,
0x5f305f744c240a20ull,0x636f6c2e090a3a35ull,0x0931373309353109ull,0x3b74697865090a30ull,
0x2020202020202020ull,0x2020202020202020ull,0x2020202020202020ull,0x4c240a202f2f0920ull,
0x5a5f5f646e655744ull,0x656c706d6f433732ull,0x6977746e696f5078ull,0x646e416c754d6573ull,
0x663650656c616353ull,0x534b503274616f6cull,0x207d090a3a66695full,0x4337325a5f202f2full,
0x6f5078656c706d6full,0x4d65736977746e69ull,0x616353646e416c75ull,0x616f6c663650656cull,
0x66695f534b503274ull,0x0000000000000a0aull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"8691274735dce84f",(char*)"simpleCUFFT.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00001baf_00000000-1_simpleCUFFT.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00001baf_00000000-1_simpleCUFFT.cudafe1.stub.c" 2
struct __T20;
struct __T20 {Complex *__par0;const Complex *__par1;int __par2;float __par3;int __dummy_field;volatile char __dummy[4];};



static void __sti____cudaRegisterAll_46_tmpxft_00001baf_00000000_7_simpleCUFFT_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
static void __device_stub__Z27ComplexPointwiseMulAndScaleP6float2PKS_if(Complex *__par0, const Complex *__par1, int __par2, float __par3){auto struct __T20 *__T236;
char __[256]; *(char**)&__T236 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T236->__par0 - (size_t)__T236) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T236->__par1 - (size_t)__T236) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T236->__par2 - (size_t)__T236) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par3, sizeof(__par3), (size_t)&__T236->__par3 - (size_t)__T236) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z27ComplexPointwiseMulAndScaleP6float2PKS_if); (void)cudaLaunch(((char *)__device_stub__Z27ComplexPointwiseMulAndScaleP6float2PKS_if)); };}



static void __sti____cudaRegisterAll_46_tmpxft_00001baf_00000000_7_simpleCUFFT_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z27ComplexPointwiseMulAndScaleP6float2PKS_if, (char*)"_Z27ComplexPointwiseMulAndScaleP6float2PKS_if", "_Z27ComplexPointwiseMulAndScaleP6float2PKS_if", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}

}
# 366 "simpleCUFFT.cu" 2
