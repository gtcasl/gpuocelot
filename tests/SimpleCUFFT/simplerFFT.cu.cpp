...
# 31 "simplerFFT.cu"
auto double Pi = (3.141592653589800221);
# 32 "simplerFFT.cu"
auto double inv_N = ((1.0) / (double)N);
# 34 "simplerFFT.cu"
for (int k = 0; k < N; k++) {
# 35 "simplerFFT.cu"
auto Complex sum = {(0), (0)};
# 36 "simplerFFT.cu"
for (int n = 0; n < N; n++) {
# 37 "simplerFFT.cu"
auto float w = ((float)(((((-(2.0)) * Pi) * inv_N) * (double)k) * (double)n));
# 38 "simplerFFT.cu"
auto Complex x_n = (input[n]);
# 39 "simplerFFT.cu"
auto Complex e = {cos(w), sin(w)};
# 41 "simplerFFT.cu"
...
# 73 "simplerFFT.cu"
auto double norm_squared = (0);
# 75 "simplerFFT.cu"
for (int n = 0; n < N; n++) {
# 76 "simplerFFT.cu"
auto Complex a = (A[n]); auto Complex b = {(0), (0)};
# 77 "simplerFFT.cu"
if (B) {
# 78 "simplerFFT.cu"
b = B[n];
...
# 155 "simplerFFT.cu"
auto const size_t dataSize = (sizeof(Complex) * SIGNAL_LENGTH);
# 157 "simplerFFT.cu"
auto Complex *DFT_signal_host = ((Complex *)malloc(dataSize));
# 158 "simplerFFT.cu"
auto Complex *T_signal_host = ((Complex *)malloc(dataSize));
# 159 "simplerFFT.cu"
auto Complex *T_signal_gpu = (0);
# 160 "simplerFFT.cu"
auto Complex *F_signal_host = ((Complex *)malloc(dataSize));
# 161 "simplerFFT.cu"
auto Complex *F_signal_gpu = (0);
# 163 "simplerFFT.cu"
...
# 183 "simplerFFT.cu"
__cufftSafeCall(cufftPlan1d(&plan, SIGNAL_LENGTH, CUFFT_C2C, 1), "simplerFFT.cu", 183);
# 186 "simplerFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)T_signal_gpu, (cufftComplex *)F_signal_gpu, -1), "simplerFFT.cu", 187);
# 189 "simplerFFT.cu"
cudaMemcpy(F_signal_host, F_signal_gpu, dataSize, cudaMemcpyDeviceToHost);
# 191 "simplerFFT.cu"
auto double L2_error = norm_difference(DFT_signal_host, F_signal_host, SIGNAL_LENGTH);
# 193 "simplerFFT.cu"
if (L2_error > (0.01000000000000000021)) {
# 194 "simplerFFT.cu"
