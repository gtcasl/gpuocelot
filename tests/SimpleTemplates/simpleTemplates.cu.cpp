# 1 "/tmp/tmpxft_00001cee_00000000-1_simpleTemplates.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00001cee_00000000-1_simpleTemplates.cudafe1.cpp"
...
# 1 "/tmp/tmpxft_00001cee_00000000-1_simpleTemplates.cudafe1.stub.h" 1

extern "C" {


extern __attribute__((__weak__)) void __device_stub__Z10testKernelIfEvPT_S1_(float *, float *);

}
template <class T>
void __globfunc_testKernel( T *,T *);
extern "C" {



extern __attribute__((__weak__)) void __device_stub__Z10testKernelIiEvPT_S1_(int *, int *);
...
# 153 "sharedmem.cuh" 2
# 50 "simpleTemplates.cu"
template<class T> extern void runTest(int, char **, int);
# 53 "simpleTemplates.cu"
template<class T> void
# 55 "simpleTemplates.cu"
computeGold(T *reference, T *idata, const unsigned len)
# 56 "simpleTemplates.cu"
{
# 57 "simpleTemplates.cu"
auto const T T_len = (static_cast< T>(len));
# 58 "simpleTemplates.cu"
for (unsigned i = (0); i < len; ++i)
# 59 "simpleTemplates.cu"
{
# 60 "simpleTemplates.cu"
(reference[i]) = idata[i] * T_len;
# 61 "simpleTemplates.cu"
}
# 62 "simpleTemplates.cu"
}
# 68 "simpleTemplates.cu"
int main(int argc, char **argv)
# 69 "simpleTemplates.cu"
{
# 70 "simpleTemplates.cu"
runTest< float> (argc, argv, 32);
# 71 "simpleTemplates.cu"
runTest< int> (argc, argv, 64);
# 73 "simpleTemplates.cu"
__cutilExit(argc, argv); return 0;
# 74 "simpleTemplates.cu"
}
# 81 "simpleTemplates.cu"
template<class T>
# 82 "simpleTemplates.cu"
class ArrayComparator {
# 85 "simpleTemplates.cu"
public: CUTBoolean compare(const T *reference, T *data, unsigned len)
# 86 "simpleTemplates.cu"
{
# 87 "simpleTemplates.cu"
fprintf(stderr, "Error: no comparison function implemented for this type\n");
# 88 "simpleTemplates.cu"
return CUTFalse;
# 89 "simpleTemplates.cu"
}
# 90 "simpleTemplates.cu"
};
# 94 "simpleTemplates.cu"
template<> class ArrayComparator< int> {
# 97 "simpleTemplates.cu"
public: CUTBoolean compare(const int *reference, int *data, unsigned len)
# 98 "simpleTemplates.cu"
{
# 99 "simpleTemplates.cu"
return cutComparei(reference, data, len);
# 100 "simpleTemplates.cu"
}
# 101 "simpleTemplates.cu"
};
# 105 "simpleTemplates.cu"
template<> class ArrayComparator< float> {
# 108 "simpleTemplates.cu"
public: CUTBoolean compare(const float *reference, float *data, unsigned len)
# 109 "simpleTemplates.cu"
{
# 110 "simpleTemplates.cu"
return cutComparef(reference, data, len);
# 111 "simpleTemplates.cu"
}
# 112 "simpleTemplates.cu"
};
# 115 "simpleTemplates.cu"
template<class T>
# 116 "simpleTemplates.cu"
class ArrayFileWriter {
# 119 "simpleTemplates.cu"
public: CUTBoolean write(const char *filename, T *data, unsigned len, float epsilon)
# 120 "simpleTemplates.cu"
{
# 121 "simpleTemplates.cu"
fprintf(stderr, "Error: no file write function implemented for this type\n");
# 122 "simpleTemplates.cu"
return CUTFalse;
# 123 "simpleTemplates.cu"
}
# 124 "simpleTemplates.cu"
};
# 128 "simpleTemplates.cu"
template<> class ArrayFileWriter< int> {
# 131 "simpleTemplates.cu"
public: CUTBoolean write(const char *filename, int *data, unsigned len, float epsilon)
# 132 "simpleTemplates.cu"
{
# 133 "simpleTemplates.cu"
return cutWriteFilei(filename, data, len, epsilon != (0));
# 134 "simpleTemplates.cu"
}
# 135 "simpleTemplates.cu"
};
# 139 "simpleTemplates.cu"
template<> class ArrayFileWriter< float> {
# 142 "simpleTemplates.cu"
public: CUTBoolean write(const char *filename, float *data, unsigned len, float epsilon)
# 143 "simpleTemplates.cu"
{
# 144 "simpleTemplates.cu"
return cutWriteFilef(filename, data, len, epsilon);
# 145 "simpleTemplates.cu"
}
# 146 "simpleTemplates.cu"
};
# 152 "simpleTemplates.cu"
template<class T> void
# 154 "simpleTemplates.cu"
runTest(int argc, char **argv, int len)
# 155 "simpleTemplates.cu"
{
# 157 "simpleTemplates.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device"))
# 158 "simpleTemplates.cu"
{
# 159 "simpleTemplates.cu"
cutilDeviceInit(argc, argv);
# 160 "simpleTemplates.cu"
} else
# 162 "simpleTemplates.cu"
{
# 163 "simpleTemplates.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId());
# 164 "simpleTemplates.cu"
}
# 166 "simpleTemplates.cu"
auto unsigned timer = (0);
# 167 "simpleTemplates.cu"
__cutilCheckError(cutCreateTimer(&timer), "simpleTemplates.cu", 167);
# 168 "simpleTemplates.cu"
__cutilCheckError(cutStartTimer(timer), "simpleTemplates.cu", 168);
# 170 "simpleTemplates.cu"
auto unsigned num_threads = (len);
# 171 "simpleTemplates.cu"
auto unsigned mem_size = (sizeof(float) * num_threads);
# 174 "simpleTemplates.cu"
auto T *h_idata = ((T *)malloc(mem_size));
# 176 "simpleTemplates.cu"
for (unsigned i = (0); i < num_threads; ++i)
# 177 "simpleTemplates.cu"
{
# 178 "simpleTemplates.cu"
(h_idata[i]) = (T)i;
# 179 "simpleTemplates.cu"
}
# 182 "simpleTemplates.cu"
auto T *d_idata;
# 183 "simpleTemplates.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), mem_size), "simpleTemplates.cu", 183);
# 185 "simpleTemplates.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_idata, mem_size, cudaMemcpyHostToDevice), "simpleTemplates.cu", 186);
# 189 "simpleTemplates.cu"
auto T *d_odata;
# 190 "simpleTemplates.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), mem_size), "simpleTemplates.cu", 190);
# 193 "simpleTemplates.cu"
auto dim3 grid(1, 1, 1);
# 194 "simpleTemplates.cu"
auto dim3 threads(num_threads, 1, 1);
# 197 "simpleTemplates.cu"
cudaConfigureCall(grid, threads, mem_size) ? ((void)0) : ((__globfunc_testKernel< T> )(d_idata, d_odata));
# 200 "simpleTemplates.cu"
__cutilCheckMsg("Kernel execution failed", "simpleTemplates.cu", 200);
# 203 "simpleTemplates.cu"
auto T *h_odata = ((T *)malloc(mem_size));
# 205 "simpleTemplates.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_odata, sizeof(T) * num_threads, cudaMemcpyDeviceToHost), "simpleTemplates.cu", 206);
# 208 "simpleTemplates.cu"
__cutilCheckError(cutStopTimer(timer), "simpleTemplates.cu", 208);
# 209 "simpleTemplates.cu"
printf("Processing time: %f (ms)\n", cutGetTimerValue(timer));
# 210 "simpleTemplates.cu"
__cutilCheckError(cutDeleteTimer(timer), "simpleTemplates.cu", 210);
# 213 "simpleTemplates.cu"
auto T *reference = ((T *)malloc(mem_size));
# 214 "simpleTemplates.cu"
computeGold< T> (reference, h_idata, num_threads);
# 216 "simpleTemplates.cu"
auto ArrayComparator< T> comparator;
# 217 "simpleTemplates.cu"
auto ArrayFileWriter< T> writer;
# 220 "simpleTemplates.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "regression"))
# 221 "simpleTemplates.cu"
{
# 223 "simpleTemplates.cu"
__cutilCheckError((writer.write("./data/regression.dat", h_odata, num_threads, (0.0))), "simpleTemplates.cu", 224);
# 225 "simpleTemplates.cu"
} else
# 227 "simpleTemplates.cu"
{
# 230 "simpleTemplates.cu"
auto CUTBoolean res = ((comparator.compare(reference, h_odata, num_threads)));
# 231 "simpleTemplates.cu"
printf("Test %s\n", (1 == res) ? ((const char *)"PASSED") : ((const char *)"FAILED"));
# 232 "simpleTemplates.cu"
}
# 235 "simpleTemplates.cu"
free(h_idata);
# 236 "simpleTemplates.cu"
free(h_odata);
# 237 "simpleTemplates.cu"
free(reference);
# 238 "simpleTemplates.cu"
__cudaSafeCall(cudaFree(d_idata), "simpleTemplates.cu", 238);
# 239 "simpleTemplates.cu"
__cudaSafeCall(cudaFree(d_odata), "simpleTemplates.cu", 239);
# 241 "simpleTemplates.cu"
cudaThreadExit();
# 242 "simpleTemplates.cu"
}

# 1 "/tmp/tmpxft_00001cee_00000000-1_simpleTemplates.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00001cee_00000000-3_simpleTemplates.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00001cee_00000000-3_simpleTemplates.fatbin.c" 2
...
0x20656d616e090a7bull,0x657430315a5f203dull,0x6c656e72654b7473ull,0x535f545076456649ull,
0x6d656d6c090a5f31ull,0x6d73090a30203d20ull,0x0a3233203d206d65ull,0x203d202067657209ull,
0x2020726162090a33ull,0x6e6962090a31203dull,0x090a7b2065646f63ull,0x3030303061783009ull,
0x3430783020353030ull,0x3020303837303030ull,0x3032303230303378ull,0x3031346378302031ull,
0x09090a2030383730ull,0x3863303030327830ull,0x3234307830203930ull,0x7830203038373030ull,
0x3530323032303030ull,0x3030303063783020ull,0x3009090a20303837ull,0x3034306530306478ull,
0x2e090a202f2f0920ull,0x3609353109636f6cull,0x2e646c090a300938ull,0x732e646572616873ull,
0x2c33722509203233ull,0x302b346472255b20ull,0x69202f2f09203b5dull,0x695f732036323a64ull,
0x090a3078302b746eull,0x2e3233752e747663ull,0x3472250920363175ull,0x2e6469746e25202cull,
0x2f09202020203b78ull,0x2e6c756d090a202full,0x09203233732e6f6cull,0x337225202c357225ull,
0x20203b347225202cull,0x090a202f2f092020ull,0x65726168732e7473ull,0x5b09203233732e64ull,
0x2c5d302b34647225ull,0x2f09203b35722520ull,0x2038323a6469202full,0x78302b746e695f73ull,
0x09636f6c2e090a30ull,0x0a30093936093531ull,0x6e79732e72616209ull,0x2020203b30092063ull,
0x2020202020202020ull,0x0920202020202020ull,0x6f6c2e090a202f2full,0x0932370935310963ull,
0x68732e646c090a30ull,0x3233732e64657261ull,0x5b202c3672250920ull,0x3b5d302b34647225ull,
0x3a6469202f2f0920ull,0x746e695f73203932ull,0x646c090a3078302bull,0x752e6d617261702eull,
0x3764722509203436ull,0x6475635f5f5b202cull,0x5a5f5f6d72617061ull,0x654b747365743031ull,
0x764569496c656e72ull,0x675f5f31535f5450ull,0x3b5d617461646f5full,0x333a6469202f2f09ull,
0x616475635f5f2030ull,0x315a5f5f6d726170ull,0x72654b7473657430ull,0x50764569496c656eull,
0x5f675f5f31535f54ull,0x78302b617461646full,0x752e646461090a30ull,0x3864722509203436ull,
0x202c37647225202cull,0x2020203b32647225ull,0x73090a202f2f0920ull,0x6c61626f6c672e74ull,
0x255b09203233732eull,0x202c5d302b386472ull,0x2f2f09203b367225ull,0x090a31333a646920ull,
0x09353109636f6c2eull,0x7865090a30093337ull,0x20202020203b7469ull,0x2020202020202020ull,
0x2020202020202020ull,0x202f2f0920202020ull,0x646e6557444c240aull,0x73657430315a5f5full,
0x496c656e72654b74ull,0x31535f5450764569ull,0x2f2f207d090a3a5full,0x73657430315a5f20ull,
0x496c656e72654b74ull,0x31535f5450764569ull,0x00000000000a0a5full
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"4fdccc8b31d63a04",(char*)"simpleTemplates.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00001cee_00000000-1_simpleTemplates.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00001cee_00000000-1_simpleTemplates.cudafe1.stub.c" 2
struct __T20;
struct __T21;
struct __T20 {float *__par0;float *__par1;int __dummy_field;volatile char __dummy[4];};
...
static void __sti____cudaRegisterAll_50_tmpxft_00001cee_00000000_7_simpleTemplates_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
 __attribute__((__weak__)) void __device_stub__Z10testKernelIfEvPT_S1_(float *__par0, float *__par1){auto struct __T20 *__T238;
char __[256]; *(char**)&__T238 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T238->__par0 - (size_t)__T238) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T238->__par1 - (size_t)__T238) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z10testKernelIfEvPT_S1_); (void)cudaLaunch(((char *)__device_stub__Z10testKernelIfEvPT_S1_)); };}

}
template <>
void __globfunc_testKernel<float> ( float *__cuda_0,float *__cuda_1)
{ __device_stub__Z10testKernelIfEvPT_S1_( __cuda_0,__cuda_1); }
extern "C" {

 __attribute__((__weak__)) void __device_stub__Z10testKernelIiEvPT_S1_(int *__par0, int *__par1){auto struct __T21 *__T239;
char __[256]; *(char**)&__T239 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T239->__par0 - (size_t)__T239) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T239->__par1 - (size_t)__T239) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z10testKernelIiEvPT_S1_); (void)cudaLaunch(((char *)__device_stub__Z10testKernelIiEvPT_S1_)); };}

}
template <>
void __globfunc_testKernel<int> ( int *__cuda_0,int *__cuda_1)
{ __device_stub__Z10testKernelIiEvPT_S1_( __cuda_0,__cuda_1); }
extern "C" {
...
static void __sti____cudaRegisterAll_50_tmpxft_00001cee_00000000_7_simpleTemplates_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z10testKernelIiEvPT_S1_, (char*)"_Z10testKernelIiEvPT_S1_", "_Z10testKernelIiEvPT_S1_", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z10testKernelIfEvPT_S1_, (char*)"_Z10testKernelIfEvPT_S1_", "_Z10testKernelIfEvPT_S1_", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_int");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_uint");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_char");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_uchar");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_short");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_ushort");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_long");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_ulong");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_bool");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_float");__cudaRegisterShared(__cudaFatCubinHandle, (void**)"s_double");}

}
# 244 "simpleTemplates.cu" 2
