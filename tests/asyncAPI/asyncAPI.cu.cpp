# 1 "/tmp/tmpxft_00004bc8_00000000-1_asyncAPI.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00004bc8_00000000-1_asyncAPI.cudafe1.cpp"
# 1 "asyncAPI.cu"
...
# 48 "asyncAPI.cu"
void increment_kernel__entry(int *g_data, int inc_value);
# 54 "asyncAPI.cu"
...
auto int *a = (0);
__cudaSafeCall(cudaMallocHost((void **)(&a), nbytes), "asyncAPI.cu", 79);
memset(a, 0, nbytes);


auto int *d_a = (0);
__cudaSafeCall(cudaMalloc((void **)(&d_a), nbytes), "asyncAPI.cu", 84);
__cudaSafeCall(cudaMemset(d_a, 255, nbytes), "asyncAPI.cu", 85);
...
__cudaSafeCall(cudaEventCreate(&start), "asyncAPI.cu", 93);
__cudaSafeCall(cudaEventCreate(&stop), "asyncAPI.cu", 94);

auto unsigned timer;
__cutilCheckError(cutCreateTimer(&timer), "asyncAPI.cu", 97);
__cutilCheckError(cutResetTimer(timer), "asyncAPI.cu", 98);
__cudaSafeCall(cudaThreadSynchronize(), "asyncAPI.cu", 99);
auto float gpu_time = (0.0F);


__cutilCheckError(cutStartTimer(timer), "asyncAPI.cu", 103);
cudaEventRecord(start, 0);
cudaMemcpyAsync(d_a, a, nbytes, cudaMemcpyHostToDevice, 0);
cudaConfigureCall(blocks, threads, 0, 0) ? ((void)0) : increment_kernel__entry(d_a, value);
cudaMemcpyAsync(a, d_a, nbytes, cudaMemcpyDeviceToHost, 0);
cudaEventRecord(stop, 0);
__cutilCheckError(cutStopTimer(timer), "asyncAPI.cu", 109);
...
__cudaSafeCall(cudaEventElapsedTime(&gpu_time, start, stop), "asyncAPI.cu", 117);
...
__cudaSafeCall(cudaEventDestroy(start), "asyncAPI.cu", 132);
__cudaSafeCall(cudaEventDestroy(stop), "asyncAPI.cu", 133);
__cudaSafeCall(cudaFreeHost(a), "asyncAPI.cu", 134);
__cudaSafeCall(cudaFree(d_a), "asyncAPI.cu", 135);
...
# 1 "/tmp/tmpxft_00004bc8_00000000-1_asyncAPI.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00004bc8_00000000-3_asyncAPI.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00004bc8_00000000-3_asyncAPI.fatbin.c" 2
...
0x303030305f386362ull,0x615f372d30303030ull,0x2e495041636e7973ull,0x2820692e33707063ull,
0x4263632f706d742full,0x446e4c4d492e2349ull,0x2d2d2f2f090a296full,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x303030305f386362ull,0x615f362d30303030ull,0x2e495041636e7973ull,0x2e32656661647563ull,
...
0x0a22682e656d6974ull,0x3109656c69662e09ull,0x636e797361220935ull,0x0a2275632e495041ull,
...
0x6f632f6564756c63ull,0x7079745f6e6f6d6dull,0x2e090a22682e7365ull,0x09353209656c6966ull,
0x6f6c2f7273752f22ull,0x616475632f6c6163ull,0x2f2e2e2f6e69622full,0x2f6564756c636e69ull,
...
0x72746e652e090a0aull,0x6e6936315a5f2079ull,0x5f746e656d657263ull,0x69506c656e72656bull,
0x702e09090a282069ull,0x36752e206d617261ull,0x616475635f5f2034ull,0x315a5f5f6d726170ull,
0x656d6572636e6936ull,0x656e72656b5f746eull,0x645f675f6969506cull,0x2e09090a2c617461ull,
0x732e206d61726170ull,0x6475635f5f203233ull,0x5a5f5f6d72617061ull,0x6d6572636e693631ull,
0x6e72656b5f746e65ull,0x6e695f6969506c65ull,0x2965756c61765f63ull,0x65722e090a7b090aull,
0x25203631752e2067ull,0x090a3b3e343c6872ull,0x33752e206765722eull,0x3b3e383c72252032ull,
0x2e206765722e090aull,0x3c64722520343675ull,0x6f6c2e090a3b3e36ull,0x0938340935310963ull,
0x5f3142424c240a30ull,0x72636e6936315a5full,0x656b5f746e656d65ull,0x3a6969506c656e72ull,
0x3109636f6c2e090aull,0x090a300931350935ull,0x6d617261702e646cull,0x722509203436752eull,
0x635f5f5b202c3164ull,0x5f6d726170616475ull,0x72636e6936315a5full,0x656b5f746e656d65ull,
0x5f6969506c656e72ull,0x3b5d617461645f67ull,0x313a6469202f2f09ull,0x616475635f5f2034ull,
0x315a5f5f6d726170ull,0x656d6572636e6936ull,0x656e72656b5f746eull,0x645f675f6969506cull,
0x0a3078302b617461ull,0x3233752e74766309ull,0x722509203631752eull,0x2e64697425202c31ull,
...
0x3233732e3436752eull,0x202c326472250920ull,0x202020203b337225ull,0x0a202f2f09202020ull,
...
0x0a202f2f09202020ull,0x626f6c672e646c09ull,0x09203233732e6c61ull,0x72255b202c347225ull,
0x09203b5d302b3464ull,0x38313a6469202f2full,0x7261702e646c090aull,0x09203233732e6d61ull,
0x5f5f5b202c357225ull,0x6d72617061647563ull,0x636e6936315a5f5full,0x6b5f746e656d6572ull,
0x6969506c656e7265ull,0x6c61765f636e695full,0x202f2f093b5d6575ull,0x5f5f2039313a6469ull,
0x6d72617061647563ull,0x636e6936315a5f5full,0x6b5f746e656d6572ull,0x6969506c656e7265ull,
0x6c61765f636e695full,0x090a3078302b6575ull,0x203233732e646461ull,0x7225202c36722509ull,
0x203b357225202c34ull,0x2f09202020202020ull,0x672e7473090a202full,0x33732e6c61626f6cull,
0x346472255b092032ull,0x367225202c5d302bull,0x6469202f2f09203bull,0x6f6c2e090a30323aull,
0x0932350935310963ull,0x3b74697865090a30ull,0x2020202020202020ull,0x2020202020202020ull,
0x2020202020202020ull,0x4c240a202f2f0920ull,0x5a5f5f646e655744ull,0x6d6572636e693631ull,
0x6e72656b5f746e65ull,0x090a3a6969506c65ull,0x315a5f202f2f207dull,0x656d6572636e6936ull,
0x656e72656b5f746eull,0x00000a0a6969506cull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"cbf0a94e88eea643",(char*)"asyncAPI.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0,0x9e5fe7dd};
# 5 "/tmp/tmpxft_00004bc8_00000000-1_asyncAPI.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00004bc8_00000000-1_asyncAPI.cudafe1.stub.c" 2
struct __T20 {int *__par0;int __par1;int __dummy_field;};
static void __sti____cudaRegisterAll_43_tmpxft_00004bc8_00000000_4_asyncAPI_cpp1_ii_a7f3d470(void) __attribute__((__constructor__));
void __device_stub__Z16increment_kernelPii(int *__par0, int __par1){auto struct __T20 *__T26;
char __[256]; *(char**)&__T26 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T26->__par0 - (size_t)__T26) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T26->__par1 - (size_t)__T26) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(int *, int))increment_kernel__entry)); (void)cudaLaunch(((char *)((void ( *)(int *, int))increment_kernel__entry))); };}

}
void increment_kernel__entry( int * __cuda_0,int __cuda_1)
...
static void __sti____cudaRegisterAll_43_tmpxft_00004bc8_00000000_4_asyncAPI_cpp1_ii_a7f3d470(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(int *, int))increment_kernel__entry), (char*)"_Z16increment_kernelPii", "_Z16increment_kernelPii", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}
