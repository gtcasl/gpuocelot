...
///////////////////////////////////////////////////////////////////////////////
__global__ void kernel(float* pos, unsigned int width, unsigned int height, float time)
{
...
extern "C" void launch_kernel(float4* pos, unsigned int mesh_width, unsigned int mesh_height, float time)
{
    ...
    kernel<<< grid, block>>>((float*)pos, mesh_width, mesh_height, time);
}
