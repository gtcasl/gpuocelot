# 1 "/tmp/tmpxft_00000763_00000000-1_asyncAPI.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00000763_00000000-1_asyncAPI.cudafe1.cpp"
# 1 "asyncAPI.cu"
...
# 1 "/tmp/tmpxft_00000763_00000000-1_asyncAPI.cudafe1.stub.h" 1
...
auto int *a = (0);
# 80 "asyncAPI.cu"
__cudaSafeCall(cudaMallocHost((void **)(&a), nbytes), "asyncAPI.cu", 80);
# 81 "asyncAPI.cu"
memset(a, 0, nbytes);
# 84 "asyncAPI.cu"
auto int *d_a = (0);
# 85 "asyncAPI.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_a), nbytes), "asyncAPI.cu", 85);
# 86 "asyncAPI.cu"
__cudaSafeCall(cudaMemset(d_a, 255, nbytes), "asyncAPI.cu", 86);
# 89 "asyncAPI.cu"
auto dim3 threads = dim3(512, 1);
# 90 "asyncAPI.cu"
auto dim3 blocks = dim3(n / threads.x, 1);
# 93 "asyncAPI.cu"
auto cudaEvent_t start; auto cudaEvent_t stop;
# 94 "asyncAPI.cu"
__cudaSafeCall(cudaEventCreate(&start), "asyncAPI.cu", 94);
# 95 "asyncAPI.cu"
__cudaSafeCall(cudaEventCreate(&stop), "asyncAPI.cu", 95);
# 97 "asyncAPI.cu"
auto unsigned timer;
# 98 "asyncAPI.cu"
__cutilCheckError(cutCreateTimer(&timer), "asyncAPI.cu", 98);
# 99 "asyncAPI.cu"
__cutilCheckError(cutResetTimer(timer), "asyncAPI.cu", 99);
# 100 "asyncAPI.cu"
__cudaSafeCall(cudaThreadSynchronize(), "asyncAPI.cu", 100);
# 101 "asyncAPI.cu"
auto float gpu_time = (0.0F);
# 104 "asyncAPI.cu"
__cutilCheckError(cutStartTimer(timer), "asyncAPI.cu", 104);
# 105 "asyncAPI.cu"
cudaEventRecord(start, 0);
# 106 "asyncAPI.cu"
cudaMemcpyAsync(d_a, a, nbytes, cudaMemcpyHostToDevice, 0);
# 107 "asyncAPI.cu"
cudaConfigureCall(blocks, threads, 0, 0) ? ((void)0) : __device_stub__Z16increment_kernelPii(d_a, value);
# 108 "asyncAPI.cu"
cudaMemcpyAsync(a, d_a, nbytes, cudaMemcpyDeviceToHost, 0);
# 109 "asyncAPI.cu"
cudaEventRecord(stop, 0);
# 110 "asyncAPI.cu"
__cutilCheckError(cutStopTimer(timer), "asyncAPI.cu", 110);
# 113 "asyncAPI.cu"
...
# 118 "asyncAPI.cu"
__cudaSafeCall(cudaEventElapsedTime(&gpu_time, start, stop), "asyncAPI.cu", 118);
# 121 "asyncAPI.cu"
...
printf("Test FAILED\n"); }
# 133 "asyncAPI.cu"
__cudaSafeCall(cudaEventDestroy(start), "asyncAPI.cu", 133);
# 134 "asyncAPI.cu"
__cudaSafeCall(cudaEventDestroy(stop), "asyncAPI.cu", 134);
# 135 "asyncAPI.cu"
__cudaSafeCall(cudaFreeHost(a), "asyncAPI.cu", 135);
# 136 "asyncAPI.cu"
__cudaSafeCall(cudaFree(d_a), "asyncAPI.cu", 136);
# 138 "asyncAPI.cu"
cudaThreadExit();
# 140 "asyncAPI.cu"
...
# 1 "/tmp/tmpxft_00000763_00000000-1_asyncAPI.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00000763_00000000-3_asyncAPI.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00000763_00000000-3_asyncAPI.fatbin.c" 2
...
0x30303030305f7466ull,0x303030305f333637ull,0x615f372d30303030ull,0x2e495041636e7973ull,
0x3b32687225202c31ull,0x6461090a202f2f09ull,0x2509203233752e64ull,0x2c317225202c3372ull,
0x2020203b32722520ull,0x202f2f0920202020ull,0x36752e747663090aull,0x2509203233732e34ull,
...
0x2e6c61626f6c672eull,0x3472250920323373ull,0x2b346472255b202cull,0x202f2f09203b5d30ull,
0x6c090a38313a6469ull,0x2e6d617261702e64ull,0x3572250920323373ull,0x6475635f5f5b202cull,
0x5a5f5f6d72617061ull,0x6d6572636e693631ull,0x6e72656b5f746e65ull,0x6e695f6969506c65ull,
0x5d65756c61765f63ull,0x3a6469202f2f093bull,0x6475635f5f203931ull,0x5a5f5f6d72617061ull,
0x6d6572636e693631ull,0x6e72656b5f746e65ull,0x6e695f6969506c65ull,0x2b65756c61765f63ull,
0x646461090a307830ull,0x722509203233732eull,0x202c347225202c36ull,0x202020203b357225ull,
0x0a202f2f09202020ull,0x626f6c672e747309ull,0x09203233732e6c61ull,0x5d302b346472255bull,
0x09203b367225202cull,0x30323a6469202f2full,0x3109636f6c2e090aull,0x090a300932350935ull,
0x2020203b74697865ull,0x2020202020202020ull,0x2020202020202020ull,0x2f09202020202020ull,
0x6557444c240a202full,0x6936315a5f5f646eull,0x746e656d6572636eull,0x506c656e72656b5full,
0x2f207d090a3a6969ull,0x6e6936315a5f202full,0x5f746e656d657263ull,0x69506c656e72656bull,
...
0x20656d616e090a7bull,0x6e6936315a5f203dull,0x5f746e656d657263ull,0x69506c656e72656bull,
...
0x2031303030323030ull,0x3730303134637830ull,0x783009090a203038ull,0x3530386330303032ull,
0x3030323430783020ull,0x3064783020303837ull,0x3020313032306530ull,0x3837303063303878ull,
0x32783009090a2030ull,0x2031306363303030ull,0x3730303234307830ull,0x3030647830203038ull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"50626c6c7f965080",(char*)"asyncAPI.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00000763_00000000-1_asyncAPI.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00000763_00000000-1_asyncAPI.cudafe1.stub.c" 2
struct __T20;
struct __T20 {int *__par0;int __par1;int __dummy_field;};



static void __sti____cudaRegisterAll_43_tmpxft_00000763_00000000_4_asyncAPI_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
void __device_stub__Z16increment_kernelPii(int *__par0, int __par1){auto struct __T20 *__T21;
char __[256]; *(char**)&__T21 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T21->__par0 - (size_t)__T21) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T21->__par1 - (size_t)__T21) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z16increment_kernelPii); (void)cudaLaunch(((char *)__device_stub__Z16increment_kernelPii)); };}



static void __sti____cudaRegisterAll_43_tmpxft_00000763_00000000_4_asyncAPI_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z16increment_kernelPii, (char*)"_Z16increment_kernelPii", "_Z16increment_kernelPii", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}
