# 1 "/tmp/tmpxft_000007a4_00000000-1_bandwidthTest.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_000007a4_00000000-1_bandwidthTest.cudafe1.cpp"
# 1 "bandwidthTest.cu"
...
# 88 "bandwidthTest.cu"
extern void testBandwidth(unsigned, unsigned, unsigned, testMode, memcpyKind, printMode, memoryMode, int, int);
# 90 "bandwidthTest.cu"
extern void testBandwidthQuick(unsigned, memcpyKind, printMode, memoryMode, int, int);
# 91 "bandwidthTest.cu"
extern void testBandwidthRange(unsigned, unsigned, unsigned, memcpyKind, printMode, memoryMode, int, int);
# 93 "bandwidthTest.cu"
extern void testBandwidthShmoo(memcpyKind, printMode, memoryMode, int, int);
# 94 "bandwidthTest.cu"
extern float testDeviceToHostTransfer(unsigned, memoryMode);
# 95 "bandwidthTest.cu"
extern float testHostToDeviceTransfer(unsigned, memoryMode);
# 96 "bandwidthTest.cu"
...
# 106 "bandwidthTest.cu"
int main(int argc, char **argv)
# 107 "bandwidthTest.cu"
{
# 108 "bandwidthTest.cu"
runTest(argc, (const char **)argv);
# 109 "bandwidthTest.cu"
__cutilExit(argc, argv); return 0;
# 110 "bandwidthTest.cu"
}
# 115 "bandwidthTest.cu"
void runTest(const int argc, const char **argv)
# 116 "bandwidthTest.cu"
{
# 117 "bandwidthTest.cu"
auto int start = (32 * (1 << 20));
# 118 "bandwidthTest.cu"
auto int end = (32 * (1 << 20));
# 119 "bandwidthTest.cu"
auto int startDevice = 0;
# 120 "bandwidthTest.cu"
auto int endDevice = 0;
# 121 "bandwidthTest.cu"
auto int increment = (1 << 22);
# 122 "bandwidthTest.cu"
auto testMode mode = QUICK_MODE;
# 123 "bandwidthTest.cu"
auto bool htod = false;
# 124 "bandwidthTest.cu"
auto bool dtoh = false;
# 125 "bandwidthTest.cu"
auto bool dtod = false;
# 126 "bandwidthTest.cu"
auto char *modeStr;
# 127 "bandwidthTest.cu"
auto char *device = (__null);
# 128 "bandwidthTest.cu"
auto printMode printmode = USER_READABLE;
# 129 "bandwidthTest.cu"
auto char *memModeStr = (__null);
# 130 "bandwidthTest.cu"
auto memoryMode memMode = PAGEABLE;
# 133 "bandwidthTest.cu"
if (cutCheckCmdLineFlag(argc, argv, "help"))
# 134 "bandwidthTest.cu"
{
# 135 "bandwidthTest.cu"
printHelp();
# 136 "bandwidthTest.cu"
return;
# 137 "bandwidthTest.cu"
}
# 139 "bandwidthTest.cu"
if (cutCheckCmdLineFlag(argc, argv, "csv"))
# 140 "bandwidthTest.cu"
{
# 141 "bandwidthTest.cu"
printmode = CSV;
# 142 "bandwidthTest.cu"
}
# 144 "bandwidthTest.cu"
if (cutGetCmdLineArgumentstr(argc, argv, "memory", &memModeStr))
# 145 "bandwidthTest.cu"
{
# 146 "bandwidthTest.cu"
if (strcmp(memModeStr, "pageable") == 0)
# 147 "bandwidthTest.cu"
{
# 148 "bandwidthTest.cu"
memMode = PAGEABLE;
# 149 "bandwidthTest.cu"
} else {
# 150 "bandwidthTest.cu"
if (strcmp(memModeStr, "pinned") == 0)
# 151 "bandwidthTest.cu"
{
# 152 "bandwidthTest.cu"
memMode = PINNED;
# 153 "bandwidthTest.cu"
} else
# 155 "bandwidthTest.cu"
{
# 156 "bandwidthTest.cu"
printf("Invalid memory mode - valid modes are pageable or pinned\n");
# 157 "bandwidthTest.cu"
printf("See --help for more information\n");
# 158 "bandwidthTest.cu"
return;
# 159 "bandwidthTest.cu"
} }
# 160 "bandwidthTest.cu"
} else
# 162 "bandwidthTest.cu"
{
# 164 "bandwidthTest.cu"
memMode = PAGEABLE;
# 165 "bandwidthTest.cu"
}
# 167 "bandwidthTest.cu"
if (cutGetCmdLineArgumentstr(argc, argv, "device", &device))
# 168 "bandwidthTest.cu"
{
# 169 "bandwidthTest.cu"
auto int deviceCount;
# 170 "bandwidthTest.cu"
cudaGetDeviceCount(&deviceCount);
# 171 "bandwidthTest.cu"
if (deviceCount == 0)
# 172 "bandwidthTest.cu"
{
# 173 "bandwidthTest.cu"
printf("!!!!!No devices found!!!!!\n");
# 174 "bandwidthTest.cu"
return;
# 175 "bandwidthTest.cu"
}
# 176 "bandwidthTest.cu"
if (strcmp(device, "all") == 0)
# 177 "bandwidthTest.cu"
{
# 178 "bandwidthTest.cu"
printf("\n!!!!!Cumulative Bandwidth to be computed from all the devices !!!!!!\n\n");
# 179 "bandwidthTest.cu"
startDevice = 0;
# 180 "bandwidthTest.cu"
endDevice = deviceCount - 1;
# 181 "bandwidthTest.cu"
} else
# 183 "bandwidthTest.cu"
{
# 184 "bandwidthTest.cu"
startDevice = (endDevice = atoi(device));
# 185 "bandwidthTest.cu"
if ((startDevice >= deviceCount) || (startDevice < 0))
# 186 "bandwidthTest.cu"
{
# 187 "bandwidthTest.cu"
printf("\n!!!!!Invalid GPU number %d given hence default gpu %d will be used !!!!!\n", startDevice, 0);
# 188 "bandwidthTest.cu"
startDevice = (endDevice = 0);
# 189 "bandwidthTest.cu"
}
# 190 "bandwidthTest.cu"
}
# 191 "bandwidthTest.cu"
}
# 192 "bandwidthTest.cu"
printf("Running on......\n");
# 193 "bandwidthTest.cu"
for (int currentDevice = startDevice; currentDevice <= endDevice; currentDevice++)
# 194 "bandwidthTest.cu"
{
# 195 "bandwidthTest.cu"
auto cudaDeviceProp deviceProp;
# 196 "bandwidthTest.cu"
cudaGetDeviceProperties(&deviceProp, currentDevice);
# 197 "bandwidthTest.cu"
printf("      device %d:%s\n", currentDevice, deviceProp.name);
# 198 "bandwidthTest.cu"
}
# 200 "bandwidthTest.cu"
if (cutGetCmdLineArgumentstr(argc, argv, "mode", &modeStr))
# 201 "bandwidthTest.cu"
{
# 203 "bandwidthTest.cu"
if (strcmp(modeStr, "quick") == 0)
# 204 "bandwidthTest.cu"
{
# 205 "bandwidthTest.cu"
mode = QUICK_MODE;
# 206 "bandwidthTest.cu"
} else {
# 207 "bandwidthTest.cu"
if (strcmp(modeStr, "shmoo") == 0)
# 208 "bandwidthTest.cu"
{
# 209 "bandwidthTest.cu"
mode = SHMOO_MODE;
# 210 "bandwidthTest.cu"
} else {
# 211 "bandwidthTest.cu"
if (strcmp(modeStr, "range") == 0)
# 212 "bandwidthTest.cu"
{
# 213 "bandwidthTest.cu"
mode = RANGE_MODE;
# 214 "bandwidthTest.cu"
} else
# 216 "bandwidthTest.cu"
{
# 217 "bandwidthTest.cu"
printf("Invalid mode - valid modes are quick, range, or shmoo\n");
# 218 "bandwidthTest.cu"
printf("See --help for more information\n");
# 219 "bandwidthTest.cu"
return;
# 220 "bandwidthTest.cu"
} } }
# 221 "bandwidthTest.cu"
} else
# 223 "bandwidthTest.cu"
{
# 225 "bandwidthTest.cu"
mode = QUICK_MODE;
# 226 "bandwidthTest.cu"
}
# 228 "bandwidthTest.cu"
if (cutCheckCmdLineFlag(argc, argv, "htod")) {
# 229 "bandwidthTest.cu"
htod = true; }
# 230 "bandwidthTest.cu"
if (cutCheckCmdLineFlag(argc, argv, "dtoh")) {
# 231 "bandwidthTest.cu"
dtoh = true; }
# 232 "bandwidthTest.cu"
if (cutCheckCmdLineFlag(argc, argv, "dtod")) {
# 233 "bandwidthTest.cu"
dtod = true; }
# 235 "bandwidthTest.cu"
if (((!htod) && (!dtoh)) && (!dtod))
# 236 "bandwidthTest.cu"
{
# 238 "bandwidthTest.cu"
htod = true;
# 239 "bandwidthTest.cu"
dtoh = true;
# 240 "bandwidthTest.cu"
dtod = true;
# 241 "bandwidthTest.cu"
}
# 243 "bandwidthTest.cu"
if ((RANGE_MODE) == mode)
# 244 "bandwidthTest.cu"
{
# 245 "bandwidthTest.cu"
if (cutGetCmdLineArgumenti(argc, argv, "start", &start))
# 246 "bandwidthTest.cu"
{
# 247 "bandwidthTest.cu"
if (start <= 0)
# 248 "bandwidthTest.cu"
{
# 249 "bandwidthTest.cu"
printf("Illegal argument - start must be greater than zero\n");
# 250 "bandwidthTest.cu"
return;
# 251 "bandwidthTest.cu"
}
# 252 "bandwidthTest.cu"
} else
# 254 "bandwidthTest.cu"
{
# 255 "bandwidthTest.cu"
printf("Must specify a starting size in range mode\n");
# 256 "bandwidthTest.cu"
printf("See --help for more information\n");
# 257 "bandwidthTest.cu"
return;
# 258 "bandwidthTest.cu"
}
# 260 "bandwidthTest.cu"
if (cutGetCmdLineArgumenti(argc, argv, "end", &end))
# 261 "bandwidthTest.cu"
{
# 262 "bandwidthTest.cu"
if (end <= 0)
# 263 "bandwidthTest.cu"
{
# 264 "bandwidthTest.cu"
printf("Illegal argument - end must be greater than zero\n");
# 265 "bandwidthTest.cu"
return;
# 266 "bandwidthTest.cu"
}
# 268 "bandwidthTest.cu"
if (start > end)
# 269 "bandwidthTest.cu"
{
# 270 "bandwidthTest.cu"
printf("Illegal argument - start is greater than end\n");
# 271 "bandwidthTest.cu"
return;
# 272 "bandwidthTest.cu"
}
# 273 "bandwidthTest.cu"
} else
# 275 "bandwidthTest.cu"
{
# 276 "bandwidthTest.cu"
printf("Must specify an end size in range mode.\n");
# 277 "bandwidthTest.cu"
printf("See --help for more information\n");
# 278 "bandwidthTest.cu"
return;
# 279 "bandwidthTest.cu"
}
# 282 "bandwidthTest.cu"
if (cutGetCmdLineArgumenti(argc, argv, "increment", &increment))
# 283 "bandwidthTest.cu"
{
# 284 "bandwidthTest.cu"
if (increment <= 0)
# 285 "bandwidthTest.cu"
{
# 286 "bandwidthTest.cu"
printf("Illegal argument - increment must be greater than zero\n");
# 287 "bandwidthTest.cu"
return;
# 288 "bandwidthTest.cu"
}
# 289 "bandwidthTest.cu"
} else
# 291 "bandwidthTest.cu"
{
# 292 "bandwidthTest.cu"
printf("Must specify an increment in user mode\n");
# 293 "bandwidthTest.cu"
printf("See --help for more information\n");
# 294 "bandwidthTest.cu"
return;
# 295 "bandwidthTest.cu"
}
# 296 "bandwidthTest.cu"
}
# 298 "bandwidthTest.cu"
if (htod)
# 299 "bandwidthTest.cu"
{
# 300 "bandwidthTest.cu"
testBandwidth((unsigned)start, (unsigned)end, (unsigned)increment, mode, HOST_TO_DEVICE, printmode, memMode, startDevice, endDevice);
# 302 "bandwidthTest.cu"
}
# 303 "bandwidthTest.cu"
if (dtoh)
# 304 "bandwidthTest.cu"
{
# 305 "bandwidthTest.cu"
testBandwidth((unsigned)start, (unsigned)end, (unsigned)increment, mode, DEVICE_TO_HOST, printmode, memMode, startDevice, endDevice);
# 307 "bandwidthTest.cu"
}
# 308 "bandwidthTest.cu"
if (dtod)
# 309 "bandwidthTest.cu"
{
# 310 "bandwidthTest.cu"
testBandwidth((unsigned)start, (unsigned)end, (unsigned)increment, mode, DEVICE_TO_DEVICE, printmode, memMode, startDevice, endDevice);
# 312 "bandwidthTest.cu"
}
# 314 "bandwidthTest.cu"
printf("&&&& Test PASSED\n");
# 316 "bandwidthTest.cu"
cutFree(memModeStr);
# 319 "bandwidthTest.cu"
}
# 325 "bandwidthTest.cu"
void testBandwidth(unsigned start, unsigned end, unsigned increment, testMode
# 326 "bandwidthTest.cu"
mode, memcpyKind kind, printMode printmode, memoryMode memMode, int startDevice, int endDevice)
# 327 "bandwidthTest.cu"
{
# 328 "bandwidthTest.cu"
switch (mode)
# 329 "bandwidthTest.cu"
{
# 330 "bandwidthTest.cu"
case QUICK_MODE:
# 331 "bandwidthTest.cu"
printf("Quick Mode\n");
# 332 "bandwidthTest.cu"
testBandwidthQuick(32 * (1 << 20), kind, printmode, memMode, startDevice, endDevice);
# 333 "bandwidthTest.cu"
break;
# 334 "bandwidthTest.cu"
case RANGE_MODE:
# 335 "bandwidthTest.cu"
printf("Range Mode\n");
# 336 "bandwidthTest.cu"
testBandwidthRange(start, end, increment, kind, printmode, memMode, startDevice, endDevice);
# 337 "bandwidthTest.cu"
break;
# 338 "bandwidthTest.cu"
case SHMOO_MODE:
# 339 "bandwidthTest.cu"
printf("Shmoo Mode\n");
# 340 "bandwidthTest.cu"
testBandwidthShmoo(kind, printmode, memMode, startDevice, endDevice);
# 341 "bandwidthTest.cu"
break;
# 342 "bandwidthTest.cu"
default:
# 343 "bandwidthTest.cu"
printf("Invalid testing mode\n");
# 344 "bandwidthTest.cu"
break;
# 345 "bandwidthTest.cu"
}
# 347 "bandwidthTest.cu"
}
# 353 "bandwidthTest.cu"
void testBandwidthQuick(unsigned size, memcpyKind kind, printMode printmode, memoryMode memMode, int startDevice, int endDevice)
# 354 "bandwidthTest.cu"
{
# 355 "bandwidthTest.cu"
testBandwidthRange(size, size, 1 << 22, kind, printmode, memMode, startDevice, endDevice);
# 356 "bandwidthTest.cu"
}
# 362 "bandwidthTest.cu"
void testBandwidthRange(unsigned start, unsigned end, unsigned increment, memcpyKind
# 363 "bandwidthTest.cu"
kind, printMode printmode, memoryMode memMode, int startDevice, int endDevice)
# 364 "bandwidthTest.cu"
{
# 366 "bandwidthTest.cu"
auto unsigned count = ((1) + (end - start) / increment);
# 368 "bandwidthTest.cu"
auto unsigned *memSizes = ((unsigned *)malloc(count * sizeof(unsigned)));
# 369 "bandwidthTest.cu"
auto float *bandwidths = ((float *)malloc(count * sizeof(float)));
# 372 "bandwidthTest.cu"
switch (kind)
# 373 "bandwidthTest.cu"
{
# 374 "bandwidthTest.cu"
case DEVICE_TO_HOST: printf("Device to Host Bandwidth for ");
# 375 "bandwidthTest.cu"
break;
# 376 "bandwidthTest.cu"
case HOST_TO_DEVICE: printf("Host to Device Bandwidth for ");
# 377 "bandwidthTest.cu"
break;
# 378 "bandwidthTest.cu"
case DEVICE_TO_DEVICE: printf("Device to Device Bandwidth\n");
# 379 "bandwidthTest.cu"
break;
# 380 "bandwidthTest.cu"
}
# 381 "bandwidthTest.cu"
if ((DEVICE_TO_DEVICE) != kind)
# 382 "bandwidthTest.cu"
{ switch (memMode)
# 383 "bandwidthTest.cu"
{
# 384 "bandwidthTest.cu"
case PAGEABLE: printf("Pageable memory\n");
# 385 "bandwidthTest.cu"
break;
# 386 "bandwidthTest.cu"
case PINNED: printf("Pinned memory\n");
# 387 "bandwidthTest.cu"
break;
# 388 "bandwidthTest.cu"
}
# 389 "bandwidthTest.cu"
}
# 392 "bandwidthTest.cu"
for (int i = 0; i < count; i++) {
# 393 "bandwidthTest.cu"
(bandwidths[i]) = (0.0F); }
# 396 "bandwidthTest.cu"
for (int currentDevice = startDevice; currentDevice <= endDevice; currentDevice++)
# 397 "bandwidthTest.cu"
{
# 399 "bandwidthTest.cu"
cudaSetDevice(currentDevice);
# 401 "bandwidthTest.cu"
for (unsigned i = (0); i < count; i++)
# 402 "bandwidthTest.cu"
{
# 403 "bandwidthTest.cu"
(memSizes[i]) = start + i * increment;
# 404 "bandwidthTest.cu"
switch (kind)
# 405 "bandwidthTest.cu"
{
# 406 "bandwidthTest.cu"
case DEVICE_TO_HOST: (bandwidths[i]) += testDeviceToHostTransfer(memSizes[i], memMode);
# 407 "bandwidthTest.cu"
break;
# 408 "bandwidthTest.cu"
case HOST_TO_DEVICE: (bandwidths[i]) += testHostToDeviceTransfer(memSizes[i], memMode);
# 409 "bandwidthTest.cu"
break;
# 410 "bandwidthTest.cu"
case DEVICE_TO_DEVICE: (bandwidths[i]) += testDeviceToDeviceTransfer(memSizes[i]);
# 411 "bandwidthTest.cu"
break;
# 412 "bandwidthTest.cu"
}
# 413 "bandwidthTest.cu"
printf(".");
# 414 "bandwidthTest.cu"
}
# 416 "bandwidthTest.cu"
cudaThreadExit();
# 417 "bandwidthTest.cu"
}
# 419 "bandwidthTest.cu"
printf("\n");
# 421 "bandwidthTest.cu"
if (printmode == (CSV))
# 422 "bandwidthTest.cu"
{
# 423 "bandwidthTest.cu"
printResultsCSV(memSizes, bandwidths, count);
# 424 "bandwidthTest.cu"
} else
# 426 "bandwidthTest.cu"
{
# 427 "bandwidthTest.cu"
printResultsReadable(memSizes, bandwidths, count);
# 428 "bandwidthTest.cu"
}
# 431 "bandwidthTest.cu"
free(memSizes);
# 432 "bandwidthTest.cu"
free(bandwidths);
# 433 "bandwidthTest.cu"
}
# 439 "bandwidthTest.cu"
void testBandwidthShmoo(memcpyKind kind, printMode printmode, memoryMode memMode, int startDevice, int endDevice)
# 440 "bandwidthTest.cu"
{
# 442 "bandwidthTest.cu"
switch (kind)
# 443 "bandwidthTest.cu"
{
# 444 "bandwidthTest.cu"
case DEVICE_TO_HOST: printf("Device to Host Bandwidth for ");
# 445 "bandwidthTest.cu"
break;
# 446 "bandwidthTest.cu"
case HOST_TO_DEVICE: printf("Host to Device Bandwidth for ");
# 447 "bandwidthTest.cu"
break;
# 448 "bandwidthTest.cu"
case DEVICE_TO_DEVICE: printf("Device to Device Bandwidth\n");
# 449 "bandwidthTest.cu"
break;
# 450 "bandwidthTest.cu"
}
# 451 "bandwidthTest.cu"
if ((DEVICE_TO_DEVICE) != kind)
# 452 "bandwidthTest.cu"
{ switch (memMode)
# 453 "bandwidthTest.cu"
{
# 454 "bandwidthTest.cu"
case PAGEABLE: printf("Pageable memory\n");
# 455 "bandwidthTest.cu"
break;
# 456 "bandwidthTest.cu"
case PINNED: printf("Pinned memory\n");
# 457 "bandwidthTest.cu"
break;
# 458 "bandwidthTest.cu"
}
# 459 "bandwidthTest.cu"
}
# 462 "bandwidthTest.cu"
...
# 470 "bandwidthTest.cu"
auto unsigned *memSizes = ((unsigned *)malloc(count * sizeof(unsigned)));
# 471 "bandwidthTest.cu"
auto float *bandwidths = ((float *)malloc(count * sizeof(float)));
# 475 "bandwidthTest.cu"
for (int i = 0; i < count; i++) {
# 476 "bandwidthTest.cu"
(bandwidths[i]) = (0.0F); }
# 479 "bandwidthTest.cu"
for (int currentDevice = startDevice; currentDevice <= endDevice; currentDevice++)
# 480 "bandwidthTest.cu"
{
# 481 "bandwidthTest.cu"
cudaSetDevice(currentDevice);
# 483 "bandwidthTest.cu"
auto int iteration = 0;
# 484 "bandwidthTest.cu"
auto unsigned memSize = (0);
# 485 "bandwidthTest.cu"
while (memSize <= (1 << 26))
# 486 "bandwidthTest.cu"
{
# 487 "bandwidthTest.cu"
if (memSize < (20 * (1 << 10)))
# 488 "bandwidthTest.cu"
{
# 489 "bandwidthTest.cu"
memSize += (1 << 10);
# 490 "bandwidthTest.cu"
} else {
# 491 "bandwidthTest.cu"
if (memSize < (50 * (1 << 10)))
# 492 "bandwidthTest.cu"
{
# 493 "bandwidthTest.cu"
memSize += (1 << 11);
# 494 "bandwidthTest.cu"
} else { if (memSize < (100 * (1 << 10)))
# 495 "bandwidthTest.cu"
{
# 496 "bandwidthTest.cu"
memSize += (10 * (1 << 10));
# 497 "bandwidthTest.cu"
} else { if (memSize < (1 << 20))
# 498 "bandwidthTest.cu"
{
# 499 "bandwidthTest.cu"
memSize += (100 * (1 << 10));
# 500 "bandwidthTest.cu"
} else { if (memSize < (1 << 24))
# 501 "bandwidthTest.cu"
{
# 502 "bandwidthTest.cu"
memSize += (1 << 20);
# 503 "bandwidthTest.cu"
} else { if (memSize < (1 << 25))
# 504 "bandwidthTest.cu"
{
# 505 "bandwidthTest.cu"
memSize += (1 << 21);
# 506 "bandwidthTest.cu"
} else
# 507 "bandwidthTest.cu"
{
# 508 "bandwidthTest.cu"
memSize += (1 << 22);
# 509 "bandwidthTest.cu"
} } } } } }
# 511 "bandwidthTest.cu"
(memSizes[iteration]) = memSize;
# 512 "bandwidthTest.cu"
switch (kind)
# 513 "bandwidthTest.cu"
{
# 514 "bandwidthTest.cu"
case DEVICE_TO_HOST: (bandwidths[iteration]) += testDeviceToHostTransfer(memSizes[iteration], memMode);
# 515 "bandwidthTest.cu"
break;
# 516 "bandwidthTest.cu"
case HOST_TO_DEVICE: (bandwidths[iteration]) += testHostToDeviceTransfer(memSizes[iteration], memMode);
# 517 "bandwidthTest.cu"
break;
# 518 "bandwidthTest.cu"
case DEVICE_TO_DEVICE: (bandwidths[iteration]) += testDeviceToDeviceTransfer(memSizes[iteration]);
# 519 "bandwidthTest.cu"
break;
# 520 "bandwidthTest.cu"
}
# 521 "bandwidthTest.cu"
iteration++;
# 522 "bandwidthTest.cu"
printf(".");
# 523 "bandwidthTest.cu"
}
# 524 "bandwidthTest.cu"
}
# 526 "bandwidthTest.cu"
printf("\n");
# 528 "bandwidthTest.cu"
if ((CSV) == printmode)
# 529 "bandwidthTest.cu"
{
# 530 "bandwidthTest.cu"
printResultsCSV(memSizes, bandwidths, count);
# 531 "bandwidthTest.cu"
} else
# 533 "bandwidthTest.cu"
{
# 534 "bandwidthTest.cu"
printResultsReadable(memSizes, bandwidths, count);
# 535 "bandwidthTest.cu"
}
# 538 "bandwidthTest.cu"
free(memSizes);
# 539 "bandwidthTest.cu"
free(bandwidths);
# 540 "bandwidthTest.cu"
}
# 546 "bandwidthTest.cu"
float testDeviceToHostTransfer(unsigned memSize, memoryMode memMode)
# 547 "bandwidthTest.cu"
{
# 548 "bandwidthTest.cu"
auto unsigned timer = (0);
# 549 "bandwidthTest.cu"
auto float elapsedTimeInMs = (0.0F);
# 550 "bandwidthTest.cu"
auto float bandwidthInMBs = (0.0F);
# 551 "bandwidthTest.cu"
auto unsigned char *h_idata = (__null);
# 552 "bandwidthTest.cu"
auto unsigned char *h_odata = (__null);
# 554 "bandwidthTest.cu"
__cutilCheckError(cutCreateTimer(&timer), "bandwidthTest.cu", 554);
# 557 "bandwidthTest.cu"
if ((PINNED) == memMode)
# 558 "bandwidthTest.cu"
{
# 560 "bandwidthTest.cu"
__cudaSafeCall(cudaMallocHost((void **)(&h_idata), memSize), "bandwidthTest.cu", 560);
# 561 "bandwidthTest.cu"
__cudaSafeCall(cudaMallocHost((void **)(&h_odata), memSize), "bandwidthTest.cu", 561);
# 562 "bandwidthTest.cu"
} else
# 564 "bandwidthTest.cu"
{
# 566 "bandwidthTest.cu"
h_idata = (unsigned char *)malloc(memSize);
# 567 "bandwidthTest.cu"
h_odata = (unsigned char *)malloc(memSize);
# 568 "bandwidthTest.cu"
}
# 570 "bandwidthTest.cu"
for (unsigned i = (0); i < (memSize / sizeof(unsigned char)); i++)
# 571 "bandwidthTest.cu"
{
# 572 "bandwidthTest.cu"
(h_idata[i]) = (unsigned char)(i & (255));
# 573 "bandwidthTest.cu"
}
# 576 "bandwidthTest.cu"
auto unsigned char *d_idata;
# 577 "bandwidthTest.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), memSize), "bandwidthTest.cu", 577);
# 580 "bandwidthTest.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_idata, memSize, cudaMemcpyHostToDevice), "bandwidthTest.cu", 581);
# 584 "bandwidthTest.cu"
__cutilCheckError(cutStartTimer(timer), "bandwidthTest.cu", 584);
# 585 "bandwidthTest.cu"
for (unsigned i = (0); i < (10); i++)
# 586 "bandwidthTest.cu"
{
# 587 "bandwidthTest.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_idata, memSize, cudaMemcpyDeviceToHost), "bandwidthTest.cu", 588);
# 589 "bandwidthTest.cu"
}
# 595 "bandwidthTest.cu"
__cutilCheckError(cutStopTimer(timer), "bandwidthTest.cu", 595);
# 596 "bandwidthTest.cu"
elapsedTimeInMs = cutGetTimerValue(timer);
# 599 "bandwidthTest.cu"
bandwidthInMBs = (((1000.0F) * memSize) * ((float)10)) / (elapsedTimeInMs * ((float)(1 << 20)));
# 603 "bandwidthTest.cu"
__cutilCheckError(cutDeleteTimer(timer), "bandwidthTest.cu", 603);
# 604 "bandwidthTest.cu"
if ((PINNED) == memMode)
# 605 "bandwidthTest.cu"
{
# 606 "bandwidthTest.cu"
__cudaSafeCall(cudaFreeHost(h_idata), "bandwidthTest.cu", 606);
# 607 "bandwidthTest.cu"
__cudaSafeCall(cudaFreeHost(h_odata), "bandwidthTest.cu", 607);
# 608 "bandwidthTest.cu"
} else
# 610 "bandwidthTest.cu"
{
# 611 "bandwidthTest.cu"
free(h_idata);
# 612 "bandwidthTest.cu"
free(h_odata);
# 613 "bandwidthTest.cu"
}
# 614 "bandwidthTest.cu"
__cudaSafeCall(cudaFree(d_idata), "bandwidthTest.cu", 614);
# 616 "bandwidthTest.cu"
return bandwidthInMBs;
# 617 "bandwidthTest.cu"
}
# 623 "bandwidthTest.cu"
float testHostToDeviceTransfer(unsigned memSize, memoryMode memMode)
# 624 "bandwidthTest.cu"
{
# 625 "bandwidthTest.cu"
auto unsigned timer = (0);
# 626 "bandwidthTest.cu"
auto float elapsedTimeInMs = (0.0F);
# 627 "bandwidthTest.cu"
auto float bandwidthInMBs = (0.0F);
# 628 "bandwidthTest.cu"
__cutilCheckError(cutCreateTimer(&timer), "bandwidthTest.cu", 628);
# 631 "bandwidthTest.cu"
auto unsigned char *h_odata = (__null);
# 632 "bandwidthTest.cu"
if ((PINNED) == memMode)
# 633 "bandwidthTest.cu"
{
# 635 "bandwidthTest.cu"
__cudaSafeCall(cudaMallocHost((void **)(&h_odata), memSize), "bandwidthTest.cu", 635);
# 636 "bandwidthTest.cu"
} else
# 638 "bandwidthTest.cu"
{
# 640 "bandwidthTest.cu"
h_odata = (unsigned char *)malloc(memSize);
# 641 "bandwidthTest.cu"
}
# 642 "bandwidthTest.cu"
auto unsigned char *h_cacheClear1 = ((unsigned char *)malloc(1 << 24));
# 643 "bandwidthTest.cu"
auto unsigned char *h_cacheClear2 = ((unsigned char *)malloc(1 << 24));
# 645 "bandwidthTest.cu"
for (unsigned i = (0); i < (memSize / sizeof(unsigned char)); i++)
# 646 "bandwidthTest.cu"
{
# 647 "bandwidthTest.cu"
(h_odata[i]) = (unsigned char)(i & (255));
# 648 "bandwidthTest.cu"
}
# 649 "bandwidthTest.cu"
for (unsigned i = (0); i < ((1 << 24) / sizeof(unsigned char)); i++)
# 650 "bandwidthTest.cu"
{
# 651 "bandwidthTest.cu"
(h_cacheClear1[i]) = (unsigned char)(i & (255));
# 652 "bandwidthTest.cu"
(h_cacheClear2[i]) = (unsigned char)((255) - (i & (255)));
# 653 "bandwidthTest.cu"
}
# 656 "bandwidthTest.cu"
auto unsigned char *d_idata;
# 657 "bandwidthTest.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), memSize), "bandwidthTest.cu", 657);
# 660 "bandwidthTest.cu"
for (unsigned i = (0); i < (10); i++)
# 661 "bandwidthTest.cu"
{
# 662 "bandwidthTest.cu"
__cutilCheckError(cutStartTimer(timer), "bandwidthTest.cu", 662);
# 663 "bandwidthTest.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_odata, memSize, cudaMemcpyHostToDevice), "bandwidthTest.cu", 664);
# 670 "bandwidthTest.cu"
__cutilCheckError(cutStopTimer(timer), "bandwidthTest.cu", 670);
# 671 "bandwidthTest.cu"
elapsedTimeInMs += cutGetTimerValue(timer);
# 672 "bandwidthTest.cu"
__cutilCheckError(cutResetTimer(timer), "bandwidthTest.cu", 672);
# 675 "bandwidthTest.cu"
for (unsigned j = (0); j < ((1 << 24) / sizeof(unsigned char)); j++)
# 676 "bandwidthTest.cu"
{
# 677 "bandwidthTest.cu"
(h_cacheClear1[i]) = (h_cacheClear2[i]) & i;
# 678 "bandwidthTest.cu"
}
# 679 "bandwidthTest.cu"
}
# 682 "bandwidthTest.cu"
bandwidthInMBs = (((1000.0F) * memSize) * ((float)10)) / (elapsedTimeInMs * ((float)(1 << 20)));
# 686 "bandwidthTest.cu"
__cutilCheckError(cutDeleteTimer(timer), "bandwidthTest.cu", 686);
# 687 "bandwidthTest.cu"
if ((PINNED) == memMode)
# 688 "bandwidthTest.cu"
{
# 689 "bandwidthTest.cu"
__cudaSafeCall(cudaFreeHost(h_odata), "bandwidthTest.cu", 689);
# 690 "bandwidthTest.cu"
} else
# 692 "bandwidthTest.cu"
{
# 693 "bandwidthTest.cu"
free(h_odata);
# 694 "bandwidthTest.cu"
}
# 695 "bandwidthTest.cu"
free(h_cacheClear1);
# 696 "bandwidthTest.cu"
free(h_cacheClear2);
# 697 "bandwidthTest.cu"
__cudaSafeCall(cudaFree(d_idata), "bandwidthTest.cu", 697);
# 699 "bandwidthTest.cu"
return bandwidthInMBs;
# 700 "bandwidthTest.cu"
}
# 706 "bandwidthTest.cu"
float testDeviceToDeviceTransfer(unsigned memSize)
# 707 "bandwidthTest.cu"
{
# 708 "bandwidthTest.cu"
auto unsigned timer = (0);
# 709 "bandwidthTest.cu"
auto float elapsedTimeInMs = (0.0F);
# 710 "bandwidthTest.cu"
auto float bandwidthInMBs = (0.0F);
# 711 "bandwidthTest.cu"
__cutilCheckError(cutCreateTimer(&timer), "bandwidthTest.cu", 711);
# 714 "bandwidthTest.cu"
auto unsigned char *h_idata = ((unsigned char *)malloc(memSize));
# 716 "bandwidthTest.cu"
for (unsigned i = (0); i < (memSize / sizeof(unsigned char)); i++)
# 717 "bandwidthTest.cu"
{
# 718 "bandwidthTest.cu"
(h_idata[i]) = (unsigned char)(i & (255));
# 719 "bandwidthTest.cu"
}
# 722 "bandwidthTest.cu"
auto unsigned char *d_idata;
# 723 "bandwidthTest.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), memSize), "bandwidthTest.cu", 723);
# 724 "bandwidthTest.cu"
auto unsigned char *d_odata;
# 725 "bandwidthTest.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), memSize), "bandwidthTest.cu", 725);
# 728 "bandwidthTest.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_idata, memSize, cudaMemcpyHostToDevice), "bandwidthTest.cu", 729);
# 732 "bandwidthTest.cu"
__cutilCheckError(cutStartTimer(timer), "bandwidthTest.cu", 732);
# 733 "bandwidthTest.cu"
for (unsigned i = (0); i < (10); i++)
# 734 "bandwidthTest.cu"
{
# 735 "bandwidthTest.cu"
__cudaSafeCall(cudaMemcpy(d_odata, d_idata, memSize, cudaMemcpyDeviceToDevice), "bandwidthTest.cu", 736);
# 737 "bandwidthTest.cu"
}
# 742 "bandwidthTest.cu"
__cudaSafeCall(cudaThreadSynchronize(), "bandwidthTest.cu", 742);
# 745 "bandwidthTest.cu"
__cutilCheckError(cutStopTimer(timer), "bandwidthTest.cu", 745);
# 746 "bandwidthTest.cu"
elapsedTimeInMs = cutGetTimerValue(timer);
# 749 "bandwidthTest.cu"
bandwidthInMBs = ((2.0F) * (((1000.0F) * memSize) * ((float)10))) / (elapsedTimeInMs * ((float)(1 << 20)));
# 753 "bandwidthTest.cu"
__cutilCheckError(cutDeleteTimer(timer), "bandwidthTest.cu", 753);
# 754 "bandwidthTest.cu"
free(h_idata);
# 755 "bandwidthTest.cu"
__cudaSafeCall(cudaFree(d_idata), "bandwidthTest.cu", 755);
# 756 "bandwidthTest.cu"
__cudaSafeCall(cudaFree(d_odata), "bandwidthTest.cu", 756);
# 758 "bandwidthTest.cu"
return bandwidthInMBs;
# 759 "bandwidthTest.cu"
}
# 764 "bandwidthTest.cu"
void printResultsReadable(unsigned *memSizes, float *bandwidths, unsigned count)
# 765 "bandwidthTest.cu"
{
# 766 "bandwidthTest.cu"
printf("Transfer Size (Bytes)\tBandwidth(MB/s)\n");
# 767 "bandwidthTest.cu"
for (unsigned i = (0); i < count; i++)
# 768 "bandwidthTest.cu"
{
# 769 "bandwidthTest.cu"
printf("%9u\t\t%.1f\n", memSizes[i], bandwidths[i]);
# 770 "bandwidthTest.cu"
}
# 771 "bandwidthTest.cu"
printf("\n");
# 772 "bandwidthTest.cu"
fflush(stdout);
# 773 "bandwidthTest.cu"
}
# 778 "bandwidthTest.cu"
void printResultsCSV(unsigned *memSizes, float *bandwidths, unsigned count)
# 779 "bandwidthTest.cu"
{
# 780 "bandwidthTest.cu"
printf("Transfer size (Bytes),");
# 781 "bandwidthTest.cu"
for (unsigned i = (0); i < count; i++)
# 782 "bandwidthTest.cu"
{
# 783 "bandwidthTest.cu"
printf("%u,", memSizes[i]);
# 784 "bandwidthTest.cu"
}
# 785 "bandwidthTest.cu"
printf("\n");
# 787 "bandwidthTest.cu"
printf("Bandwidth (MB/s),");
# 788 "bandwidthTest.cu"
for (unsigned i = (0); i < count; i++)
# 789 "bandwidthTest.cu"
{
# 790 "bandwidthTest.cu"
printf("%.1f,", bandwidths[i]);
# 791 "bandwidthTest.cu"
}
# 792 "bandwidthTest.cu"
printf("\n\n");
# 793 "bandwidthTest.cu"
fflush(stdout);
# 794 "bandwidthTest.cu"
}
# 799 "bandwidthTest.cu"
void printHelp()
# 800 "bandwidthTest.cu"
{
# 801 "bandwidthTest.cu"
printf("Usage:  bandwidthTest [OPTION]...\n");
# 802 "bandwidthTest.cu"
printf("Test the bandwidth for device to host, host to device, and device to device transfers\n");
# 803 "bandwidthTest.cu"
printf("\n");
# 804 "bandwidthTest.cu"
...
# 2 "/tmp/tmpxft_000007a4_00000000-3_bandwidthTest.fatbin.c" 2
...
0x30303030305f7466ull,0x303030305f346137ull,0x625f372d30303030ull,0x6874646977646e61ull,
0x7070632e74736554ull,0x6d742f2820692e33ull,0x2e23494263632f70ull,0x0a29424c4747796dull,
...
0x5f746678706d742full,0x3461373030303030ull,0x303030303030305full,0x646e61625f362d30ull,
0x7365546874646977ull,0x6566616475632e74ull,0x090a227570672e32ull,0x093309656c69662eull,
...
0x2e317874705f6c62ull,0x0000000a0a0a2268ull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"117cb623092684c6",(char*)"bandwidthTest.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_000007a4_00000000-1_bandwidthTest.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_000007a4_00000000-1_bandwidthTest.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_48_tmpxft_000007a4_00000000_4_bandwidthTest_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_48_tmpxft_000007a4_00000000_4_bandwidthTest_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);}

}
# 832 "bandwidthTest.cu" 2
