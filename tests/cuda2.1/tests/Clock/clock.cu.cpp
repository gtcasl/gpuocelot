# 1 "/tmp/tmpxft_00000aef_00000000-1_clock.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00000aef_00000000-1_clock.cudafe1.cpp"
# 1 "clock.cu"
...
# 1 "/tmp/tmpxft_00000aef_00000000-1_clock.cudafe1.stub.h" 1
...
# 80 "clock.cu"
auto float *dinput = (__null);
# 81 "clock.cu"
auto float *doutput = (__null);
# 82 "clock.cu"
auto clock_t *dtimer = (__null);
# 84 "clock.cu"
auto clock_t timer[(64 * 2)];
# 85 "clock.cu"
auto float input[(256 * 2)];
# 87 "clock.cu"
...
# 92 "clock.cu"
__cudaSafeCall(cudaMalloc((void **)(&dinput), (sizeof(float) * (256)) * (2)), "clock.cu", 92);
# 93 "clock.cu"
__cudaSafeCall(cudaMalloc((void **)(&doutput), sizeof(float) * (64)), "clock.cu", 93);
# 94 "clock.cu"
__cudaSafeCall(cudaMalloc((void **)(&dtimer), (sizeof(clock_t) * (64)) * (2)), "clock.cu", 94);
# 96 "clock.cu"
__cudaSafeCall(cudaMemcpy(dinput, input, (sizeof(float) * (256)) * (2), cudaMemcpyHostToDevice), "clock.cu", 96);
# 98 "clock.cu"
cudaConfigureCall(64, 256, (sizeof(float) * (2)) * (256)) ? ((void)0) : __device_stub__Z14timedReductionPKfPfPl(dinput, doutput, dtimer);
# 101 "clock.cu"
__cudaSafeCall(cudaMemcpy(timer, dtimer, (sizeof(clock_t) * (64)) * (2), cudaMemcpyDeviceToHost), "clock.cu", 101);
# 103 "clock.cu"
__cudaSafeCall(cudaFree(dinput), "clock.cu", 103);
# 104 "clock.cu"
__cudaSafeCall(cudaFree(doutput), "clock.cu", 104);
# 105 "clock.cu"
__cudaSafeCall(cudaFree(dtimer), "clock.cu", 105);
# 108 "clock.cu"
printf("Test PASSED\n");
# 111 "clock.cu"
auto clock_t minStart = ((timer)[0]);
# 112 "clock.cu"
auto clock_t maxEnd = ((timer)[64]);
# 114 "clock.cu"
for (int i = 1; i < 64; i++)
# 115 "clock.cu"
{
...
# 117 "clock.cu"
maxEnd = (((timer)[64 + i]) > maxEnd) ? ((timer)[64 + i]) : maxEnd;
# 118 "clock.cu"
}
# 120 "clock.cu"
printf("time = %d\n", maxEnd - minStart);
...
# 1 "/tmp/tmpxft_00000aef_00000000-1_clock.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00000aef_00000000-3_clock.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00000aef_00000000-3_clock.fatbin.c" 2
...
0x20656d616e090a7bull,0x697434315a5f203dull,0x637564655264656dull,0x50664b506e6f6974ull,
0x656d6c090a6c5066ull,0x73090a30203d206dull,0x3834203d206d656dull,0x3d2020676572090aull,
0x20726162090a3520ull,0x6f63090a31203d20ull,0x09090a7b2074736eull,0x656d616e67657309ull,
...
0x3030303061783009ull,0x3430783020393030ull,0x3020306437303030ull,0x3030623030306178ull,
0x3030303078302033ull,0x09090a2030303030ull,0x3530633730337830ull,0x3063367830206466ull,
0x7830203863373830ull,0x3330306230303031ull,0x3130303030783020ull,0x3009090a20303836ull,
0x782e64696174636eull,0x090a202f2f09203bull,0x203233752e646461ull,0x25202c3931722509ull,
0x317225202c373172ull,0x2f09202020203b38ull,0x2e747663090a202full,0x203233752e343675ull,
0x202c373264722509ull,0x2020203b39317225ull,0x090a202f2f092020ull,0x752e6f6c2e6c756dull,
0x3264722509203436ull,0x3732647225202c38ull,0x2f0920203b38202cull,0x2e646461090a202full,
0x6472250920343675ull,0x32647225202c3932ull,0x3832647225202c36ull,0x090a202f2f09203bull,
0x61626f6c672e7473ull,0x5b09203436732e6cull,0x5d302b3932647225ull,0x3b3532647225202cull,
0x363a6469202f2f09ull,0x5f305f744c240a39ull,0x6f6c2e090a3a3233ull,0x0938370935310963ull,
0x3b74697865090a30ull,0x2020202020202020ull,0x2020202020202020ull,0x2020202020202020ull,
0x4c240a202f2f0920ull,0x5a5f5f646e655744ull,0x5264656d69743431ull,0x6e6f697463756465ull,
0x3a6c506650664b50ull,0x5f202f2f207d090aull,0x64656d697434315aull,0x6f69746375646552ull,
0x6c506650664b506eull,0x0000000000000a0aull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"afc789768e8faec1",(char*)"clock.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00000aef_00000000-1_clock.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00000aef_00000000-1_clock.cudafe1.stub.c" 2
struct __T20;
struct __T20 {const float *__par0;float *__par1;clock_t *__par2;int __dummy_field;volatile char __dummy[4];};



static void __sti____cudaRegisterAll_40_tmpxft_00000aef_00000000_7_clock_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
static void __device_stub__Z14timedReductionPKfPfPl(const float *__par0, float *__par1, clock_t *__par2){auto struct __T20 *__T21;
char __[256]; *(char**)&__T21 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T21->__par0 - (size_t)__T21) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T21->__par1 - (size_t)__T21) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T21->__par2 - (size_t)__T21) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z14timedReductionPKfPfPl); (void)cudaLaunch(((char *)__device_stub__Z14timedReductionPKfPfPl)); };}



static void __sti____cudaRegisterAll_40_tmpxft_00000aef_00000000_7_clock_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z14timedReductionPKfPfPl, (char*)"_Z14timedReductionPKfPfPl", "_Z14timedReductionPKfPfPl", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterShared(__cudaFatCubinHandle, (void**)"shared");}
