# 1 "/tmp/tmpxft_00000cd6_00000000-1_cppIntegration.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00000cd6_00000000-1_cppIntegration.cudafe1.cpp"
# 1 "cppIntegration.cu"
...
# 1 "/tmp/tmpxft_00000cd6_00000000-1_cppIntegration.cudafe1.stub.h" 1
...
# 58 "cppIntegration.cu"
extern "C" void computeGold(char *, char *, const unsigned);
# 60 "cppIntegration.cu"
extern "C" void computeGold2(int2 *, int2 *, const unsigned);
# 70 "cppIntegration.cu"
extern "C" void runTest(const int argc, const char **argv, char *data, int2 *data_int2, unsigned len)
# 71 "cppIntegration.cu"
{
# 74 "cppIntegration.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 75 "cppIntegration.cu"
cutilDeviceInit(argc, (char **)argv); } else {
# 77 "cppIntegration.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 79 "cppIntegration.cu"
auto const unsigned num_threads = (len / (4));
# 80 "cppIntegration.cu"
__cutilCondition((0) == (len % (4)), (char *)("cppIntegration.cu"), 80);
# 81 "cppIntegration.cu"
auto const unsigned mem_size = (sizeof(char) * len);
# 82 "cppIntegration.cu"
auto const unsigned mem_size_int2 = (sizeof(int2) * len);
# 85 "cppIntegration.cu"
auto char *d_data;
# 86 "cppIntegration.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_data), mem_size), "cppIntegration.cu", 86);
# 88 "cppIntegration.cu"
__cudaSafeCall(cudaMemcpy(d_data, data, mem_size, cudaMemcpyHostToDevice), "cppIntegration.cu", 89);
# 91 "cppIntegration.cu"
auto int2 *d_data_int2;
# 92 "cppIntegration.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_data_int2), mem_size_int2), "cppIntegration.cu", 92);
# 94 "cppIntegration.cu"
__cudaSafeCall(cudaMemcpy(d_data_int2, data_int2, mem_size_int2, cudaMemcpyHostToDevice), "cppIntegration.cu", 95);
# 98 "cppIntegration.cu"
auto dim3 grid(1, 1, 1);
# 99 "cppIntegration.cu"
auto dim3 threads(num_threads, 1, 1);
# 100 "cppIntegration.cu"
auto dim3 threads2(len, 1, 1);
# 102 "cppIntegration.cu"
cudaConfigureCall(grid, threads) ? ((void)0) : __device_stub__Z6kernelPi((int *)d_data);
# 103 "cppIntegration.cu"
cudaConfigureCall(grid, threads2) ? ((void)0) : __device_stub__Z7kernel2P4int2(d_data_int2);
# 106 "cppIntegration.cu"
__cutilCheckMsg("Kernel execution failed", "cppIntegration.cu", 106);
# 109 "cppIntegration.cu"
auto char *reference = ((char *)malloc(mem_size));
# 110 "cppIntegration.cu"
computeGold(reference, data, len);
# 111 "cppIntegration.cu"
auto int2 *reference2 = ((int2 *)malloc(mem_size_int2));
# 112 "cppIntegration.cu"
computeGold2(reference2, data_int2, len);
# 115 "cppIntegration.cu"
__cudaSafeCall(cudaMemcpy(data, d_data, mem_size, cudaMemcpyDeviceToHost), "cppIntegration.cu", 116);
# 117 "cppIntegration.cu"
__cudaSafeCall(cudaMemcpy(data_int2, d_data_int2, mem_size_int2, cudaMemcpyDeviceToHost), "cppIntegration.cu", 118);
# 121 "cppIntegration.cu"
auto bool success = true;
# 122 "cppIntegration.cu"
for (unsigned i = (0); i < len; i++)
# 123 "cppIntegration.cu"
{
# 124 "cppIntegration.cu"
if ((((reference[i]) != (data[i])) || (((reference2[i]).x) != ((data_int2[i]).x))) || (((reference2[i]).y) != ((data_int2[i]).y))) {
# 127 "cppIntegration.cu"
success = false; }
# 128 "cppIntegration.cu"
}
# 129 "cppIntegration.cu"
printf("Test %s\n", success ? ((const char *)"PASSED") : ((const char *)"FAILED"));
# 132 "cppIntegration.cu"
__cudaSafeCall(cudaFree(d_data), "cppIntegration.cu", 132);
# 133 "cppIntegration.cu"
__cudaSafeCall(cudaFree(d_data_int2), "cppIntegration.cu", 133);
# 134 "cppIntegration.cu"
free(reference);
# 135 "cppIntegration.cu"
free(reference2);
# 137 "cppIntegration.cu"
cudaThreadExit();
# 138 "cppIntegration.cu"
}

# 1 "/tmp/tmpxft_00000cd6_00000000-1_cppIntegration.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00000cd6_00000000-3_cppIntegration.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00000cd6_00000000-3_cppIntegration.fatbin.c" 2
...
0x203d206d656d7309ull,0x20676572090a3432ull,0x6162090a36203d20ull,0x090a30203d202072ull,
0x2065646f636e6962ull,0x3061783009090a7bull,0x3020313030303030ull,0x3837303030343078ull,
0x3230303378302030ull,0x6378302031303030ull,0x2030383730303134ull,0x303032783009090aull,
0x7830203130386330ull,0x3038373030323430ull,0x3065303064783020ull,0x3038783020353030ull,
0x0a20303837303063ull,0x3031303378300909ull,0x6378302064303230ull,0x2030383730303134ull,
0x3230383030337830ull,0x3134637830203531ull,0x090a203038373030ull,0x3038313033783009ull,
0x3463783020393032ull,0x3020303837303031ull,0x3132303831303378ull,0x3031636578302031ull,
0x09090a2030383730ull,0x3630383130337830ull,0x3163657830206430ull,0x7830203038373030ull,
0x3531613038313033ull,0x3030316365783020ull,0x3009090a20303837ull,0x3034303831303378ull,
0x3031636578302035ull,0x3278302030383730ull,0x2031313838363330ull,0x6666666666307830ull,
0x783009090a206666ull,0x3930363836333032ull,0x6666666630783020ull,0x3032783020666666ull,
0x3020353161383633ull,0x6666666666663078ull,0x32783009090a2066ull,0x2035303238363330ull,
0x6666666666307830ull,0x3130337830206666ull,0x7830206430383038ull,0x3038373030313463ull,
0x3033783009090a20ull,0x3020393034303830ull,0x3837303031346378ull,0x3031303378302030ull,
0x6378302031316130ull,0x2030383730303134ull,0x303064783009090aull,0x7830203530323032ull,
0x3038373430303430ull,0x3034303064783020ull,0x3430783020393036ull,0x0a20303837343030ull,
0x3230306478300909ull,0x3078302035303230ull,0x2030383734303034ull,0x3030653030647830ull,
0x6330617830203530ull,0x090a203138373030ull,0x65646f630a7d0a7dull,0x656d616e090a7b20ull,
0x3372252c3272257bull,0x346472255b202c7dull,0x202f2f093b5d302bull,0x33732e627573090aull,
0x202c347225092032ull,0x337225202c327225ull,0x202020202020203bull,0x7473090a202f2f09ull,
0x2e6c61626f6c672eull,0x72255b0920323373ull,0x25202c5d302b3464ull,0x202f2f09203b3472ull,
0x2e090a32323a6469ull,0x3809353109636f6cull,0x697865090a300939ull,0x2020202020203b74ull,
0x2020202020202020ull,0x2020202020202020ull,0x0a202f2f09202020ull,0x5f646e6557444c24ull,
0x656e72656b375a5full,0x32746e693450326cull,0x202f2f207d090a3aull,0x656e72656b375a5full,
0x32746e693450326cull,0x0000000000000a0aull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"6c4f337776d2142e",(char*)"cppIntegration.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00000cd6_00000000-1_cppIntegration.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00000cd6_00000000-1_cppIntegration.cudafe1.stub.c" 2
struct __T20;
struct __T21;
struct __T20 {int *__par0;int __dummy_field;volatile char __dummy[4];};
struct __T21 {int2 *__par0;int __dummy_field;volatile char __dummy[4];};
...
static void __sti____cudaRegisterAll_49_tmpxft_00000cd6_00000000_7_cppIntegration_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
void __device_stub__Z6kernelPi(int *__par0){auto struct __T20 *__T22;
char __[256]; *(char**)&__T22 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T22->__par0 - (size_t)__T22) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z6kernelPi); (void)cudaLaunch(((char *)__device_stub__Z6kernelPi)); };}
void __device_stub__Z7kernel2P4int2(int2 *__par0){auto struct __T21 *__T23;
char __[256]; *(char**)&__T23 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T23->__par0 - (size_t)__T23) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z7kernel2P4int2); (void)cudaLaunch(((char *)__device_stub__Z7kernel2P4int2)); };}
...
static void __sti____cudaRegisterAll_49_tmpxft_00000cd6_00000000_7_cppIntegration_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z7kernel2P4int2, (char*)"_Z7kernel2P4int2", "_Z7kernel2P4int2", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z6kernelPi, (char*)"_Z6kernelPi", "_Z6kernelPi", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}

}
# 140 "cppIntegration.cu" 2
