# 1 "/tmp/tmpxft_00000d94_00000000-1_deviceQuery.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00000d94_00000000-1_deviceQuery.cudafe1.cpp"
# 1 "deviceQuery.cu"
...
auto int deviceCount;
# 53 "deviceQuery.cu"
__cudaSafeCall(cudaGetDeviceCount(&deviceCount), "deviceQuery.cu", 53);
# 54 "deviceQuery.cu"
if (deviceCount == 0) {
# 55 "deviceQuery.cu"
...
auto cudaDeviceProp deviceProp;
# 59 "deviceQuery.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, dev), "deviceQuery.cu", 59);
# 60 "deviceQuery.cu"
if (dev == 0) {
# 61 "deviceQuery.cu"
...
# 103 "deviceQuery.cu"
printf("  Clock rate:                                    %.2f GHz\n", deviceProp.clockRate * (9.999999975e-07F));
# 106 "deviceQuery.cu"
...
# 1 "/tmp/tmpxft_00000d94_00000000-1_deviceQuery.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00000d94_00000000-3_deviceQuery.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00000d94_00000000-3_deviceQuery.fatbin.c" 2
...
0x2f20676e696c6970ull,0x78706d742f706d74ull,0x30303030305f7466ull,0x303030305f343964ull,
0x645f372d30303030ull,0x6575516563697665ull,0x2e337070632e7972ull,0x2f706d742f282069ull,
0x43662e2349426363ull,0x2f090a296e77584cull,0x2d2d2d2d2d2d2d2full,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x3209656c69662e09ull,0x742f706d742f2209ull,0x30305f746678706dull,0x305f343964303030ull,
0x2d30303030303030ull,0x6563697665645f36ull,0x75632e7972657551ull,0x70672e3265666164ull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"d5254446ac2d59fb",(char*)"deviceQuery.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00000d94_00000000-1_deviceQuery.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00000d94_00000000-1_deviceQuery.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_46_tmpxft_00000d94_00000000_4_deviceQuery_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_46_tmpxft_00000d94_00000000_4_deviceQuery_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);}

}
# 114 "deviceQuery.cu" 2
