# 1 "/tmp/tmpxft_00006e15_00000000-1_reduction.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00006e15_00000000-1_reduction.cudafe1.cpp"
# 1 "reduction.cu"
...
# 1 "/tmp/tmpxft_00006e15_00000000-1_reduction.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00006e15_00000000-3_reduction.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00006e15_00000000-3_reduction.fatbin.c" 2
...
0x30305f3531653630ull,0x372d303030303030ull,0x697463756465725full,0x2e337070632e6e6full,
0x2f706d742f282069ull,0x34722e2349426363ull,0x2f090a2959417665ull,0x2d2d2d2d2d2d2d2full,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x305f353165363030ull,0x2d30303030303030ull,0x7463756465725f36ull,0x616475632e6e6f69ull,
...
0x682e317874705f6cull,0x000000000a0a0a22ull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"405b4751bab279ee",(char*)"reduction.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x1e89ac6f};
# 5 "/tmp/tmpxft_00006e15_00000000-1_reduction.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00006e15_00000000-1_reduction.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_44_tmpxft_00006e15_00000000_4_reduction_cpp1_ii_main(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_44_tmpxft_00006e15_00000000_4_reduction_cpp1_ii_main(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);}
