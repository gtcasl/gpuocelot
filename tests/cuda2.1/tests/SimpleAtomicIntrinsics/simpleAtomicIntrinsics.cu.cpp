# 1 "/tmp/tmpxft_00001b2e_00000000-1_simpleAtomicIntrinsics.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00001b2e_00000000-1_simpleAtomicIntrinsics.cudafe1.cpp"
...
# 1 "/tmp/tmpxft_00001b2e_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.h" 1
...
# 54 "simpleAtomicIntrinsics.cu"
extern void runTest(int, char **);
# 57 "simpleAtomicIntrinsics.cu"
extern "C" int computeGold(int *, const int);
# 63 "simpleAtomicIntrinsics.cu"
int main(int argc, char **argv)
# 64 "simpleAtomicIntrinsics.cu"
{
# 65 "simpleAtomicIntrinsics.cu"
runTest(argc, argv);
# 67 "simpleAtomicIntrinsics.cu"
__cutilExit(argc, argv); return 0;
# 68 "simpleAtomicIntrinsics.cu"
}
# 74 "simpleAtomicIntrinsics.cu"
void runTest(int argc, char **argv)
# 75 "simpleAtomicIntrinsics.cu"
{
# 76 "simpleAtomicIntrinsics.cu"
auto cudaDeviceProp deviceProp;
# 77 "simpleAtomicIntrinsics.cu"
(deviceProp.major) = 0;
# 78 "simpleAtomicIntrinsics.cu"
(deviceProp.minor) = 0;
# 79 "simpleAtomicIntrinsics.cu"
auto int dev;
# 82 "simpleAtomicIntrinsics.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 83 "simpleAtomicIntrinsics.cu"
cutilDeviceInit(argc, argv); } else {
# 85 "simpleAtomicIntrinsics.cu"
cudaSetDevice(dev = cutGetMaxGflopsDeviceId()); }
# 87 "simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaChooseDevice(&dev, &deviceProp), "simpleAtomicIntrinsics.cu", 87);
# 88 "simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, dev), "simpleAtomicIntrinsics.cu", 88);
# 90 "simpleAtomicIntrinsics.cu"
if (((deviceProp.major) > 1) || ((deviceProp.minor) > 0))
# 91 "simpleAtomicIntrinsics.cu"
{
# 92 "simpleAtomicIntrinsics.cu"
printf("Using Device %d: \"%s\"\n", dev, deviceProp.name);
# 93 "simpleAtomicIntrinsics.cu"
} else
# 95 "simpleAtomicIntrinsics.cu"
{
# 96 "simpleAtomicIntrinsics.cu"
printf("There is no device supporting CUDA compute capability 1.1.\n");
# 97 "simpleAtomicIntrinsics.cu"
printf("TEST PASSED");
# 98 "simpleAtomicIntrinsics.cu"
cudaThreadExit();
# 99 "simpleAtomicIntrinsics.cu"
__cutilExit(argc, argv);
# 100 "simpleAtomicIntrinsics.cu"
}
# 102 "simpleAtomicIntrinsics.cu"
auto unsigned timer = (0);
# 103 "simpleAtomicIntrinsics.cu"
__cutilCheckError(cutCreateTimer(&timer), "simpleAtomicIntrinsics.cu", 103);
# 104 "simpleAtomicIntrinsics.cu"
__cutilCheckError(cutStartTimer(timer), "simpleAtomicIntrinsics.cu", 104);
# 106 "simpleAtomicIntrinsics.cu"
auto unsigned numThreads = (256);
# 107 "simpleAtomicIntrinsics.cu"
auto unsigned numBlocks = (64);
# 108 "simpleAtomicIntrinsics.cu"
auto unsigned numData = (11);
# 109 "simpleAtomicIntrinsics.cu"
auto unsigned memSize = (sizeof(int) * numData);
# 112 "simpleAtomicIntrinsics.cu"
auto int *h_odata = ((int *)malloc(memSize));
# 115 "simpleAtomicIntrinsics.cu"
for (unsigned i = (0); i < numData; i++) {
# 116 "simpleAtomicIntrinsics.cu"
(h_odata[i]) = 0; }
# 119 "simpleAtomicIntrinsics.cu"
(h_odata[8]) = ((h_odata[10]) = 255);
# 122 "simpleAtomicIntrinsics.cu"
auto int *d_odata;
# 123 "simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), memSize), "simpleAtomicIntrinsics.cu", 123);
# 125 "simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(d_odata, h_odata, memSize, cudaMemcpyHostToDevice), "simpleAtomicIntrinsics.cu", 125);
# 129 "simpleAtomicIntrinsics.cu"
cudaConfigureCall(numBlocks, numThreads) ? ((void)0) : __device_stub__Z10testKernelPi(d_odata);
# 130 "simpleAtomicIntrinsics.cu"
__cutilCheckMsg("Kernel execution failed", "simpleAtomicIntrinsics.cu", 130);
# 132 "simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_odata, memSize, cudaMemcpyDeviceToHost), "simpleAtomicIntrinsics.cu", 132);
# 134 "simpleAtomicIntrinsics.cu"
__cutilCheckError(cutStopTimer(timer), "simpleAtomicIntrinsics.cu", 134);
# 135 "simpleAtomicIntrinsics.cu"
printf("Processing time: %f (ms)\n", cutGetTimerValue(timer));
# 136 "simpleAtomicIntrinsics.cu"
__cutilCheckError(cutDeleteTimer(timer), "simpleAtomicIntrinsics.cu", 136);
# 139 "simpleAtomicIntrinsics.cu"
if (computeGold(h_odata, numThreads * numBlocks)) {
# 140 "simpleAtomicIntrinsics.cu"
printf("Test PASSED\n"); } else {
# 142 "simpleAtomicIntrinsics.cu"
printf("Test FAILED\n"); }
# 145 "simpleAtomicIntrinsics.cu"
free(h_odata);
# 146 "simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaFree(d_odata), "simpleAtomicIntrinsics.cu", 146);
# 148 "simpleAtomicIntrinsics.cu"
cudaThreadExit();
# 149 "simpleAtomicIntrinsics.cu"
}

# 1 "/tmp/tmpxft_00001b2e_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00001b2e_00000000-3_simpleAtomicIntrinsics.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00001b2e_00000000-3_simpleAtomicIntrinsics.fatbin.c" 2
...
0x20656d616e090a7bull,0x657430315a5f203dull,0x6c656e72654b7473ull,0x6d656d6c090a6950ull,
0x6d73090a30203d20ull,0x0a3432203d206d65ull,0x203d202067657209ull,0x2020726162090a34ull,
0x6e6962090a30203dull,0x090a7b2065646f63ull,0x3030303031783009ull,0x3434783020353038ull,
0x2c30317225092032ull,0x3b37202c39722520ull,0x2020202020202020ull,0x7461090a202f2f09ull,
0x61626f6c672e6d6full,0x33622e646e612e6cull,0x2c31767225092032ull,0x2c5d396472255b20ull,
0x2f093b3031722520ull,0x636f6c2e090a202full,0x0938373109353109ull,0x752e646461090a30ull,
0x3164722509203436ull,0x2c31647225202c30ull,0x202020203b363320ull,0x73090a202f2f0920ull,
0x09203233622e6c68ull,0x2c31202c31317225ull,0x2020203b35722520ull,0x2f2f092020202020ull,
0x2e6d6f7461090a20ull,0x6f2e6c61626f6c67ull,0x2509203233622e72ull,0x72255b202c317672ull,
0x7225202c5d303164ull,0x0a202f2f093b3131ull,0x353109636f6c2e09ull,0x090a300938383109ull,
0x203436752e646461ull,0x202c313164722509ull,0x3034202c31647225ull,0x2f0920202020203bull,
0x6d6f7461090a202full,0x2e6c61626f6c672eull,0x203233622e726f78ull,0x5b202c3176722509ull,
0x202c5d3131647225ull,0x202f2f093b357225ull,0x3109636f6c2e090aull,0x090a300930390936ull,
0x2020203b74697865ull,0x2020202020202020ull,0x2020202020202020ull,0x2f09202020202020ull,
0x6557444c240a202full,0x7430315a5f5f646eull,0x656e72654b747365ull,0x207d090a3a69506cull,
0x7430315a5f202f2full,0x656e72654b747365ull,0x0000000a0a69506cull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"e65118981bb15b9e",(char*)"simpleAtomicIntrinsics.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00001b2e_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00001b2e_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c" 2
struct __T20;
struct __T20 {int *__par0;int __dummy_field;volatile char __dummy[4];};



static void __sti____cudaRegisterAll_57_tmpxft_00001b2e_00000000_7_simpleAtomicIntrinsics_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
void __device_stub__Z10testKernelPi(int *__par0){auto struct __T20 *__T21;
char __[256]; *(char**)&__T21 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T21->__par0 - (size_t)__T21) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z10testKernelPi); (void)cudaLaunch(((char *)__device_stub__Z10testKernelPi)); };}



static void __sti____cudaRegisterAll_57_tmpxft_00001b2e_00000000_7_simpleAtomicIntrinsics_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z10testKernelPi, (char*)"_Z10testKernelPi", "_Z10testKernelPi", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}

}
# 151 "simpleAtomicIntrinsics.cu" 2
