# 1 "/tmp/tmpxft_00004111_00000000-1_simpleStreams.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00004111_00000000-1_simpleStreams.cudafe1.cpp"
# 1 "simpleStreams.cu"
...
# 1 "/tmp/tmpxft_00004111_00000000-1_simpleStreams.cudafe1.stub.h" 1
...
{
# 81 "simpleStreams.cu"
auto int cuda_device = 0;
# 82 "simpleStreams.cu"
auto int nstreams = 4;
# 83 "simpleStreams.cu"
auto int nreps = 10;
# 84 "simpleStreams.cu"
auto int n = ((16 * 1024) * 1024);
# 85 "simpleStreams.cu"
auto int nbytes = (n * sizeof(int));
# 86 "simpleStreams.cu"
auto dim3 threads; auto dim3 blocks;
# 87 "simpleStreams.cu"
auto float elapsed_time; auto float time_memcpy; auto float time_kernel;
# 89 "simpleStreams.cu"
auto int niterations;
# 91 "simpleStreams.cu"
if (argc > 1) {
# 92 "simpleStreams.cu"
...
n = 4096;
# 99 "simpleStreams.cu"
auto int num_devices = 0;
# 100 "simpleStreams.cu"
__cudaSafeCall(cudaGetDeviceCount(&num_devices), "simpleStreams.cu", 100);
# 101 "simpleStreams.cu"
if (0 == num_devices)
# 102 "simpleStreams.cu"
{
# 103 "simpleStreams.cu"
printf("your system does not have a CUDA capable device\n");
# 104 "simpleStreams.cu"
return 1;
# 105 "simpleStreams.cu"
}
# 108 "simpleStreams.cu"
if (cuda_device >= num_devices)
# 109 "simpleStreams.cu"
{
# 110 "simpleStreams.cu"
printf("choose device ID between 0 and %d\n", num_devices - 1);
# 111 "simpleStreams.cu"
return 1;
# 112 "simpleStreams.cu"
}
# 114 "simpleStreams.cu"
cudaSetDevice(cuda_device);
# 116 "simpleStreams.cu"
auto cudaDeviceProp device_properties;
# 118 "simpleStreams.cu"
__cudaSafeCall(cudaGetDeviceProperties(&device_properties, cuda_device), "simpleStreams.cu", 118);
# 119 "simpleStreams.cu"
if ((1 == (device_properties.major)) && ((device_properties.minor) < 1)) {
# 120 "simpleStreams.cu"
printf("%s does not have compute capability 1.1 or later\n\n", device_properties.name); }
# 121 "simpleStreams.cu"
if ((device_properties.minor) > 1) {
# 122 "simpleStreams.cu"
niterations = 5; } else {
# 124 "simpleStreams.cu"
niterations = 1; }
# 126 "simpleStreams.cu"
printf("running on: %s\n\n", device_properties.name);
# 129 "simpleStreams.cu"
auto int c = 5;
# 130 "simpleStreams.cu"
auto int *a = (0);
# 132 "simpleStreams.cu"
__cudaSafeCall(cudaMallocHost((void **)(&a), nbytes), "simpleStreams.cu", 132);
# 135 "simpleStreams.cu"
auto int *d_a = (0); auto int *d_c = (0);
# 136 "simpleStreams.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_a), nbytes), "simpleStreams.cu", 136);
# 137 "simpleStreams.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_c), sizeof(int)), "simpleStreams.cu", 137);
# 138 "simpleStreams.cu"
__cudaSafeCall(cudaMemcpy(d_c, &c, sizeof(int), cudaMemcpyHostToDevice), "simpleStreams.cu", 138);
# 141 "simpleStreams.cu"
auto cudaStream_t *streams = ((cudaStream_t *)malloc(nstreams * sizeof(cudaStream_t)));
# 142 "simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 143 "simpleStreams.cu"
__cudaSafeCall(cudaStreamCreate(streams + i), "simpleStreams.cu", 143); }
# 146 "simpleStreams.cu"
auto cudaEvent_t start_event; auto cudaEvent_t stop_event;
# 147 "simpleStreams.cu"
__cudaSafeCall(cudaEventCreate(&start_event), "simpleStreams.cu", 147);
# 148 "simpleStreams.cu"
__cudaSafeCall(cudaEventCreate(&stop_event), "simpleStreams.cu", 148);
# 151 "simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 152 "simpleStreams.cu"
cudaMemcpyAsync(a, d_a, nbytes, cudaMemcpyDeviceToHost, streams[0]);
# 153 "simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 154 "simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 155 "simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&time_memcpy, start_event, stop_event), "simpleStreams.cu", 155);
# 156 "simpleStreams.cu"
printf("memcopy:\t%.2f\n", time_memcpy);
# 159 "simpleStreams.cu"
threads = dim3(512, 1);
# 160 "simpleStreams.cu"
blocks = dim3(n / threads.x, 1);
# 161 "simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 162 "simpleStreams.cu"
cudaConfigureCall(blocks, threads, 0, streams[0]) ? ((void)0) : __device_stub__Z10init_arrayPiS_i(d_a, d_c, niterations);
# 163 "simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 164 "simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 165 "simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&time_kernel, start_event, stop_event), "simpleStreams.cu", 165);
# 166 "simpleStreams.cu"
printf("kernel:\t\t%.2f\n", time_kernel);
# 170 "simpleStreams.cu"
threads = dim3(512, 1);
# 171 "simpleStreams.cu"
blocks = dim3(n / threads.x, 1);
# 172 "simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 173 "simpleStreams.cu"
for (int k = 0; k < nreps; k++)
# 174 "simpleStreams.cu"
{
# 175 "simpleStreams.cu"
cudaConfigureCall(blocks, threads) ? ((void)0) : __device_stub__Z10init_arrayPiS_i(d_a, d_c, niterations);
# 176 "simpleStreams.cu"
cudaMemcpy(a, d_a, nbytes, cudaMemcpyDeviceToHost);
# 177 "simpleStreams.cu"
}
# 178 "simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 179 "simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 180 "simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&elapsed_time, start_event, stop_event), "simpleStreams.cu", 180);
# 181 "simpleStreams.cu"
printf("non-streamed:\t%.2f (%.2f expected)\n", elapsed_time / nreps, time_kernel + time_memcpy);
# 185 "simpleStreams.cu"
threads = dim3(512, 1);
# 186 "simpleStreams.cu"
blocks = dim3(n / (nstreams * threads.x), 1);
# 187 "simpleStreams.cu"
memset(a, 255, nbytes);
# 188 "simpleStreams.cu"
cudaMemset(d_a, 0, nbytes);
# 189 "simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 190 "simpleStreams.cu"
for (int k = 0; k < nreps; k++)
# 191 "simpleStreams.cu"
{
# 193 "simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 194 "simpleStreams.cu"
cudaConfigureCall(blocks, threads, 0, streams[i]) ? ((void)0) : __device_stub__Z10init_arrayPiS_i(d_a + (i * n) / nstreams, d_c, niterations); }
# 198 "simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 199 "simpleStreams.cu"
cudaMemcpyAsync(a + (i * n) / nstreams, d_a + (i * n) / nstreams, nbytes / nstreams, cudaMemcpyDeviceToHost, streams[i]); }
# 200 "simpleStreams.cu"
}
# 201 "simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 202 "simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 203 "simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&elapsed_time, start_event, stop_event), "simpleStreams.cu", 203);
# 204 "simpleStreams.cu"
...
# 207 "simpleStreams.cu"
printf("-------------------------------\n");
# 208 "simpleStreams.cu"
if (correct_data(a, n, (c * nreps) * niterations)) {
# 209 "simpleStreams.cu"
printf("Test PASSED\n"); } else {
# 211 "simpleStreams.cu"
printf("Test FAILED\n"); }
# 214 "simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 215 "simpleStreams.cu"
cudaStreamDestroy(streams[i]); }
# 216 "simpleStreams.cu"
cudaEventDestroy(start_event);
# 217 "simpleStreams.cu"
cudaEventDestroy(stop_event);
# 218 "simpleStreams.cu"
cudaFreeHost(a);
# 219 "simpleStreams.cu"
cudaFree(d_a);
# 220 "simpleStreams.cu"
cudaFree(d_c);
# 222 "simpleStreams.cu"
cudaThreadExit();
# 224 "simpleStreams.cu"
__cutilExit(argc, argv);
# 226 "simpleStreams.cu"
return 0;
# 227 "simpleStreams.cu"
}

# 1 "/tmp/tmpxft_00004111_00000000-1_simpleStreams.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00004111_00000000-3_simpleStreams.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00004111_00000000-3_simpleStreams.fatbin.c" 2
...
0x20656d616e090a7bull,0x6e6930315a5f203dull,0x79617272615f7469ull,0x6c090a695f536950ull,
0x25202c3031722520ull,0x20202020203b3772ull,0x73090a202f2f0920ull,0x6c61626f6c672e74ull,
0x255b09203233732eull,0x202c5d302b346472ull,0x2f2f09203b377225ull,0x090a39323a646920ull,
0x203233732e646461ull,0x7225202c38722509ull,0x2020203b31202c38ull,0x2f09202020202020ull,
0x70746573090a202full,0x203233732e656e2eull,0x7225202c32702509ull,0x203b387225202c31ull,
0x090a202f2f092020ull,0x6172622032702540ull,0x5f305f744c240920ull,0x2020202020203b37ull,
0x2f09202020202020ull,0x305f744c240a202full,0x6f6c2e090a3a355full,0x0935360935310963ull,
0x3b74697865090a30ull,0x2020202020202020ull,0x2020202020202020ull,0x2020202020202020ull,
0x4c240a202f2f0920ull,0x5a5f5f646e655744ull,0x615f74696e693031ull,0x5f53695079617272ull,
0x2f2f207d090a3a69ull,0x696e6930315a5f20ull,0x5079617272615f74ull,0x00000a0a695f5369ull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"e34d8dff9c7571a4",(char*)"simpleStreams.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00004111_00000000-1_simpleStreams.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00004111_00000000-1_simpleStreams.cudafe1.stub.c" 2
struct __T20;
struct __T20 {int *__par0;int *__par1;int __par2;int __dummy_field;};



static void __sti____cudaRegisterAll_48_tmpxft_00004111_00000000_4_simpleStreams_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
void __device_stub__Z10init_arrayPiS_i(int *__par0, int *__par1, int __par2){auto struct __T20 *__T21;
char __[256]; *(char**)&__T21 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T21->__par0 - (size_t)__T21) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T21->__par1 - (size_t)__T21) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T21->__par2 - (size_t)__T21) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z10init_arrayPiS_i); (void)cudaLaunch(((char *)__device_stub__Z10init_arrayPiS_i)); };}



static void __sti____cudaRegisterAll_48_tmpxft_00004111_00000000_4_simpleStreams_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z10init_arrayPiS_i, (char*)"_Z10init_arrayPiS_i", "_Z10init_arrayPiS_i", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}

}
# 229 "simpleStreams.cu" 2
