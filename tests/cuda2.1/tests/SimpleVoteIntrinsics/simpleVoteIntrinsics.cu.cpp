# 1 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.cpp"
...
# 1 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.stub.h" 1

extern "C" {


extern void __device_stub__Z14VoteAnyKernel1PjS_i(unsigned *, unsigned *, int);
# 14 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.stub.h"
}
...
extern "C" {
# 11 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.stub.h"
extern void __device_stub__Z14VoteAnyKernel3Pbi(bool *, int);


}
# 27 "/usr/local/NVIDIA_CUDA_SDK/common/inc/cutil_inline.h" 2
# 53 "simpleVoteIntrinsics.cu"
void genVoteTestPattern(unsigned *VOTE_PATTERN, int size)
# 54 "simpleVoteIntrinsics.cu"
{
# 56 "simpleVoteIntrinsics.cu"
for (int i = 0; i < (size / 4); i++) {
# 57 "simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = (0); }
# 60 "simpleVoteIntrinsics.cu"
for (int i = ((2 * size) / 8); i < ((4 * size) / 8); i++) {
# 61 "simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = (i & 1) ? i : 0; }
# 64 "simpleVoteIntrinsics.cu"
for (int i = ((2 * size) / 4); i < ((3 * size) / 4); i++) {
# 65 "simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = (i & 1) ? 0 : i; }
# 68 "simpleVoteIntrinsics.cu"
for (int i = ((3 * size) / 4); i < ((4 * size) / 4); i++) {
# 69 "simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = 4294967295U; }
# 70 "simpleVoteIntrinsics.cu"
}
# 72 "simpleVoteIntrinsics.cu"
int checkErrors1(unsigned *h_result, int start, int end, int warp_size, char *voteType)
# 73 "simpleVoteIntrinsics.cu"
{
# 74 "simpleVoteIntrinsics.cu"
auto int i; auto int sum = 0;
# 76 "simpleVoteIntrinsics.cu"
for ((sum = 0), (i = start); i < end; i++) {
# 77 "simpleVoteIntrinsics.cu"
sum += h_result[i];
# 78 "simpleVoteIntrinsics.cu"
}
# 79 "simpleVoteIntrinsics.cu"
if (sum > 0) {
# 80 "simpleVoteIntrinsics.cu"
printf("\t<%s>[%d - %d] = ", voteType, start, end - 1);
# 81 "simpleVoteIntrinsics.cu"
for (i = start; i < end; i++) {
# 82 "simpleVoteIntrinsics.cu"
printf("%d", h_result[i]);
# 83 "simpleVoteIntrinsics.cu"
}
# 84 "simpleVoteIntrinsics.cu"
printf(" - FAILED!\n", sum);
# 85 "simpleVoteIntrinsics.cu"
}
# 86 "simpleVoteIntrinsics.cu"
return sum > 0;
# 87 "simpleVoteIntrinsics.cu"
}
# 89 "simpleVoteIntrinsics.cu"
int checkErrors2(unsigned *h_result, int start, int end, int warp_size, char *voteType)
# 90 "simpleVoteIntrinsics.cu"
{
# 91 "simpleVoteIntrinsics.cu"
auto int i; auto int sum = 0;
# 93 "simpleVoteIntrinsics.cu"
for ((sum = 0), (i = start); i < end; i++) {
# 94 "simpleVoteIntrinsics.cu"
sum += h_result[i];
# 95 "simpleVoteIntrinsics.cu"
}
# 96 "simpleVoteIntrinsics.cu"
if (sum != warp_size) {
# 97 "simpleVoteIntrinsics.cu"
printf("\t<%s>[%d - %d] = ", voteType, start, end - 1);
# 98 "simpleVoteIntrinsics.cu"
for (i = start; i < end; i++) {
# 99 "simpleVoteIntrinsics.cu"
printf("%d", h_result[i]);
# 100 "simpleVoteIntrinsics.cu"
}
# 101 "simpleVoteIntrinsics.cu"
printf(" - FAILED!\n");
# 102 "simpleVoteIntrinsics.cu"
}
# 103 "simpleVoteIntrinsics.cu"
return sum != warp_size;
# 104 "simpleVoteIntrinsics.cu"
}
# 108 "simpleVoteIntrinsics.cu"
int checkResultsVoteAnyKernel1(unsigned *h_result, int size, int warp_size)
# 109 "simpleVoteIntrinsics.cu"
{
# 110 "simpleVoteIntrinsics.cu"
auto int error_count = 0;
# 112 "simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, 0, (4 * warp_size) / 4, warp_size, (char *)("Vote.Any"));
# 113 "simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, (4 * warp_size) / 4, ((2 * 4) * warp_size) / 4, warp_size, (char *)("Vote.Any"));
# 114 "simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, ((2 * 4) * warp_size) / 4, ((3 * 4) * warp_size) / 4, warp_size, (char *)("Vote.Any"));
# 115 "simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, ((3 * 4) * warp_size) / 4, ((4 * 4) * warp_size) / 4, warp_size, (char *)("Vote.Any"));
# 117 "simpleVoteIntrinsics.cu"
return error_count;
# 118 "simpleVoteIntrinsics.cu"
}
# 121 "simpleVoteIntrinsics.cu"
int checkResultsVoteAllKernel2(unsigned *h_result, int size, int warp_size)
# 122 "simpleVoteIntrinsics.cu"
{
# 123 "simpleVoteIntrinsics.cu"
auto int error_count = 0;
# 131 "simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, 0, (4 * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 132 "simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, (4 * warp_size) / 4, ((2 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 133 "simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, ((2 * 4) * warp_size) / 4, ((3 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 134 "simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, ((3 * 4) * warp_size) / 4, ((4 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 136 "simpleVoteIntrinsics.cu"
return error_count;
# 137 "simpleVoteIntrinsics.cu"
}
# 140 "simpleVoteIntrinsics.cu"
int checkResultsVoteAnyKernel3(bool *hinfo, int size)
# 141 "simpleVoteIntrinsics.cu"
{
# 142 "simpleVoteIntrinsics.cu"
auto int i; auto int error_count = 0;
# 162 "simpleVoteIntrinsics.cu"
for (i = 0; i < (size * 3); i++) {
# 163 "simpleVoteIntrinsics.cu"
switch (i % 3) {
# 164 "simpleVoteIntrinsics.cu"
case 0:
# 166 "simpleVoteIntrinsics.cu"
if ((hinfo[i]) != (i >= (size * 1))) {
# 167 "simpleVoteIntrinsics.cu"
error_count++;
# 168 "simpleVoteIntrinsics.cu"
}
# 169 "simpleVoteIntrinsics.cu"
break;
# 170 "simpleVoteIntrinsics.cu"
case 1:
# 172 "simpleVoteIntrinsics.cu"
if ((hinfo[i]) != (i >= ((size * 3) / 2))) {
# 173 "simpleVoteIntrinsics.cu"
error_count++;
# 174 "simpleVoteIntrinsics.cu"
}
# 175 "simpleVoteIntrinsics.cu"
break;
# 176 "simpleVoteIntrinsics.cu"
case 2:
# 178 "simpleVoteIntrinsics.cu"
if ((hinfo[i]) != (i >= (size * 2))) {
# 179 "simpleVoteIntrinsics.cu"
error_count++;
# 180 "simpleVoteIntrinsics.cu"
}
# 181 "simpleVoteIntrinsics.cu"
break;
# 182 "simpleVoteIntrinsics.cu"
}
# 183 "simpleVoteIntrinsics.cu"
}
# 185 "simpleVoteIntrinsics.cu"
printf((error_count == 0) ? ((const char *)"\tPASSED!\n") : ((const char *)"\tFAILED!\n"));
# 186 "simpleVoteIntrinsics.cu"
return error_count;
# 187 "simpleVoteIntrinsics.cu"
}
# 189 "simpleVoteIntrinsics.cu"
int main(int argc, char **argv)
# 190 "simpleVoteIntrinsics.cu"
{
# 191 "simpleVoteIntrinsics.cu"
auto unsigned *h_input; auto unsigned *h_result;
# 192 "simpleVoteIntrinsics.cu"
auto unsigned *d_input; auto unsigned *d_result;
# 194 "simpleVoteIntrinsics.cu"
auto bool *dinfo = (__null); auto bool *hinfo = (__null);
# 195 "simpleVoteIntrinsics.cu"
auto int error_count[3] = {0, 0, 0};
# 197 "simpleVoteIntrinsics.cu"
auto cudaDeviceProp deviceProp;
# 198 "simpleVoteIntrinsics.cu"
auto int dev; auto int warp_size;
# 201 "simpleVoteIntrinsics.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 202 "simpleVoteIntrinsics.cu"
cutilDeviceInit(argc, argv); } else {
# 204 "simpleVoteIntrinsics.cu"
cudaSetDevice(dev = cutGetMaxGflopsDeviceId()); }
# 206 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaChooseDevice(&dev, &deviceProp), "simpleVoteIntrinsics.cu", 206);
# 207 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, 0), "simpleVoteIntrinsics.cu", 207);
# 212 "simpleVoteIntrinsics.cu"
if (((deviceProp.major) > 1) || ((deviceProp.minor) >= 2))
# 213 "simpleVoteIntrinsics.cu"
{
# 214 "simpleVoteIntrinsics.cu"
printf("simpleVoteIntrinsics: Using Device %d: \"%s\"\n", dev, deviceProp.name);
# 215 "simpleVoteIntrinsics.cu"
} else
# 216 "simpleVoteIntrinsics.cu"
{
# 217 "simpleVoteIntrinsics.cu"
printf("simpleVoteIntrinsics: requires Compute Capability 1.2 or higher\n");
# 218 "simpleVoteIntrinsics.cu"
printf("Aborting test\n");
# 219 "simpleVoteIntrinsics.cu"
printf("TEST PASSED\n");
# 220 "simpleVoteIntrinsics.cu"
__cutilExit(argc, argv);
# 221 "simpleVoteIntrinsics.cu"
}
# 222 "simpleVoteIntrinsics.cu"
warp_size = deviceProp.warpSize;
# 225 "simpleVoteIntrinsics.cu"
h_input = (unsigned *)malloc((4 * warp_size) * sizeof(unsigned));
# 226 "simpleVoteIntrinsics.cu"
h_result = (unsigned *)malloc((4 * warp_size) * sizeof(unsigned));
# 227 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_input), (4 * warp_size) * sizeof(unsigned)), "simpleVoteIntrinsics.cu", 227);
# 228 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_result), (4 * warp_size) * sizeof(unsigned)), "simpleVoteIntrinsics.cu", 228);
# 229 "simpleVoteIntrinsics.cu"
genVoteTestPattern(h_input, 4 * warp_size);
# 230 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(d_input, h_input, (4 * warp_size) * sizeof(unsigned), cudaMemcpyHostToDevice), "simpleVoteIntrinsics.cu", 230);
# 233 "simpleVoteIntrinsics.cu"
printf("[VOTE Kernel Test 1/3]\n");
# 234 "simpleVoteIntrinsics.cu"
printf("\tRunning <<Vote.Any>> kernel1 ...\n");
# 235 "simpleVoteIntrinsics.cu"
{
# 236 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 236);
# 237 "simpleVoteIntrinsics.cu"
auto dim3 gridBlock(4, 1);
# 238 "simpleVoteIntrinsics.cu"
auto dim3 threadBlock(warp_size, 1);
# 239 "simpleVoteIntrinsics.cu"
cudaConfigureCall(gridBlock, threadBlock) ? ((void)0) : __device_stub__Z14VoteAnyKernel1PjS_i(d_input, d_result, 4 * warp_size);
# 240 "simpleVoteIntrinsics.cu"
__cutilCheckMsg("VoteAnyKernel() execution failed\n", "simpleVoteIntrinsics.cu", 240);
# 241 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 241);
# 242 "simpleVoteIntrinsics.cu"
}
# 243 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(h_result, d_result, (4 * warp_size) * sizeof(unsigned), cudaMemcpyDeviceToHost), "simpleVoteIntrinsics.cu", 243);
# 244 "simpleVoteIntrinsics.cu"
((error_count)[0]) += checkResultsVoteAnyKernel1(h_result, 4 * warp_size, warp_size);
# 247 "simpleVoteIntrinsics.cu"
printf("\n[VOTE Kernel Test 2/3]\n");
# 248 "simpleVoteIntrinsics.cu"
printf("\tRunning <<Vote.All>> kernel2 ...\n");
# 249 "simpleVoteIntrinsics.cu"
{
# 250 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 250);
# 251 "simpleVoteIntrinsics.cu"
auto dim3 gridBlock(4, 1);
# 252 "simpleVoteIntrinsics.cu"
auto dim3 threadBlock(warp_size, 1);
# 253 "simpleVoteIntrinsics.cu"
cudaConfigureCall(gridBlock, threadBlock) ? ((void)0) : __device_stub__Z14VoteAllKernel2PjS_i(d_input, d_result, 4 * warp_size);
# 254 "simpleVoteIntrinsics.cu"
__cutilCheckMsg("VoteAllKernel() execution failed\n", "simpleVoteIntrinsics.cu", 254);
# 255 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 255);
# 256 "simpleVoteIntrinsics.cu"
}
# 257 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(h_result, d_result, (4 * warp_size) * sizeof(unsigned), cudaMemcpyDeviceToHost), "simpleVoteIntrinsics.cu", 257);
# 258 "simpleVoteIntrinsics.cu"
((error_count)[1]) += checkResultsVoteAllKernel2(h_result, 4 * warp_size, warp_size);
# 261 "simpleVoteIntrinsics.cu"
hinfo = (bool *)calloc((warp_size * 3) * 3, sizeof(bool));
# 262 "simpleVoteIntrinsics.cu"
cudaMalloc((void **)(&dinfo), ((warp_size * 3) * 3) * sizeof(bool));
# 263 "simpleVoteIntrinsics.cu"
cudaMemcpy(dinfo, hinfo, ((warp_size * 3) * 3) * sizeof(bool), cudaMemcpyHostToDevice);
# 266 "simpleVoteIntrinsics.cu"
printf("\n[VOTE Kernel Test 3/3]\n");
# 267 "simpleVoteIntrinsics.cu"
printf("\tRunning <<Vote.Any>> kernel3 ...\n");
# 268 "simpleVoteIntrinsics.cu"
{
# 269 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 269);
# 270 "simpleVoteIntrinsics.cu"
cudaConfigureCall(3, warp_size) ? ((void)0) : __device_stub__Z14VoteAnyKernel3Pbi(dinfo, warp_size);
# 271 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 271);
# 272 "simpleVoteIntrinsics.cu"
}
# 274 "simpleVoteIntrinsics.cu"
cudaMemcpy(hinfo, dinfo, ((warp_size * 3) * 3) * sizeof(bool), cudaMemcpyDeviceToHost);
# 277 "simpleVoteIntrinsics.cu"
((error_count)[2]) = checkResultsVoteAnyKernel3(hinfo, warp_size * 3);
# 279 "simpleVoteIntrinsics.cu"
printf("\n");
# 280 "simpleVoteIntrinsics.cu"
if (((((error_count)[0]) == 0) && (((error_count)[1]) == 0)) && (((error_count)[2]) == 0))
# 283 "simpleVoteIntrinsics.cu"
{
# 284 "simpleVoteIntrinsics.cu"
printf("TEST PASSED\n");
# 285 "simpleVoteIntrinsics.cu"
} else
# 286 "simpleVoteIntrinsics.cu"
{
# 287 "simpleVoteIntrinsics.cu"
printf("TEST FAILED\n");
# 288 "simpleVoteIntrinsics.cu"
}
# 291 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaFree(d_input), "simpleVoteIntrinsics.cu", 291);
# 292 "simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaFree(d_result), "simpleVoteIntrinsics.cu", 292);
# 293 "simpleVoteIntrinsics.cu"
free(h_input);
# 294 "simpleVoteIntrinsics.cu"
free(h_result);
# 297 "simpleVoteIntrinsics.cu"
free(hinfo); cudaFree(dinfo);
# 299 "simpleVoteIntrinsics.cu"
printf("\tShutting down...\n");
# 300 "simpleVoteIntrinsics.cu"
cudaThreadExit();
# 301 "simpleVoteIntrinsics.cu"
__cutilExit(argc, argv); return 0;
# 302 "simpleVoteIntrinsics.cu"
}

# 1 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00001e33_00000000-3_simpleVoteIntrinsics.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00001e33_00000000-3_simpleVoteIntrinsics.fatbin.c" 2
...
0x20656d616e090a7bull,0x6f5634315a5f203dull,0x72654b6c6c416574ull,0x5f536a50326c656eull,
0x206d656d6c090a69ull,0x656d73090a30203dull,0x090a3633203d206dull,0x33203d2020676572ull,
...
0x3032303030303178ull,0x3030303478302035ull,0x6178302030383734ull,0x2035303030303030ull,
0x3730303034307830ull,0x783009090a203038ull,0x3130633431303036ull,0x3430323030783020ull,
0x3033783020303837ull,0x3020353030303230ull,0x3837303031346378ull,0x32783009090a2030ull,
0x2031303863303030ull,0x3734303234307830ull,0x3030647830203038ull,0x7830203130303065ull,
0x3038373030633038ull,0x3033783009090a20ull,0x3020313030306337ull,0x3837343130343678ull,
0x3030306178302030ull,0x3278302031303030ull,0x2030383734313063ull,0x303033783009090aull,
0x7830203130303830ull,0x3330303030303030ull,0x3030303061783020ull,0x6330783020646631ull,
0x0a20386337343030ull,0x3030303178300909ull,0x3078302031303866ull,0x2030383763333034ull,
0x3430303030317830ull,0x3030367830203130ull,0x090a203063323030ull,0x3030303031783009ull,
0x3432783020313030ull,0x3020303832633034ull,0x3030306337303378ull,0x3130633678302039ull,
0x09090a2030383734ull,0x6363303030327830ull,0x3234307830203130ull,0x7830203038373430ull,
0x3530343030303061ull,0x3431306332783020ull,0x3009090a20303837ull,0x3030306530306478ull,
0x3063306178302035ull,0x7d090a2031383730ull,0x2065646f630a7d0aull,0x20656d616e090a7bull,
0x6f5634315a5f203dull,0x72654b796e416574ull,0x0a696250336c656eull,0x203d206d656d6c09ull,
0x202c5d312b336472ull,0x2f09203b31317225ull,0x0a32333a6469202full,0x353109636f6c2e09ull,
0x6d090a3009383709ull,0x09203233752e766full,0x3b30202c38317225ull,0x2020202020202020ull,
0x2f2f092020202020ull,0x2e70746573090a20ull,0x09203233752e656eull,0x317225202c347025ull,
0x3b38317225202c31ull,0x76090a202f2f0920ull,0x2e6c6c612e65746full,0x7025092064657270ull,
0x203b347025202c35ull,0x2f2f092020202020ull,0x2e706c6573090a20ull,0x7672250920323375ull,
0x2c30202c31202c31ull,0x2020203b35702520ull,0x6d090a202f2f0920ull,0x09203233732e766full,
0x7225202c39317225ull,0x20202020203b3176ull,0x2f2f092020202020ull,0x752e766f6d090a20ull,
0x3032722509203233ull,0x202020203b30202cull,0x2020202020202020ull,0x73090a202f2f0920ull,
0x732e71652e707465ull,0x2c36702509203233ull,0x25202c3931722520ull,0x2f2f09203b303272ull,
0x2036702540090a20ull,0x744c240920617262ull,0x2020203b345f325full,0x2020202020202020ull,
0x2e090a202f2f0920ull,0x3709353109636f6cull,0x766f6d090a300939ull,0x722509203631732eull,
0x20203b31202c3368ull,0x2020202020202020ull,0x0a202f2f09202020ull,0x626f6c672e747309ull,
0x5b092038732e6c61ull,0x2c5d322b33647225ull,0x09203b3368722520ull,0x33333a6469202f2full,
0x345f325f744c240aull,0x09636f6c2e090a3aull,0x0a30093138093531ull,0x20203b7469786509ull,
0x2020202020202020ull,0x2020202020202020ull,0x0920202020202020ull,0x57444c240a202f2full,
0x34315a5f5f646e65ull,0x4b796e4165746f56ull,0x6250336c656e7265ull,0x2f2f207d090a3a69ull,
0x746f5634315a5f20ull,0x6e72654b796e4165ull,0x0a0a696250336c65ull,0x0000000000000000ull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"89470d9bc2699610",(char*)"simpleVoteIntrinsics.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0};
# 5 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 2
struct __T20;
struct __T21;
struct __T22;
...
# 21 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c"
static void __sti____cudaRegisterAll_55_tmpxft_00001e33_00000000_7_simpleVoteIntrinsics_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
void __device_stub__Z14VoteAnyKernel1PjS_i(unsigned *__par0, unsigned *__par1, int __par2){auto struct __T20 *__T23;
char __[256]; *(char**)&__T23 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T23->__par0 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T23->__par1 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T23->__par2 - (size_t)__T23) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z14VoteAnyKernel1PjS_i); (void)cudaLaunch(((char *)__device_stub__Z14VoteAnyKernel1PjS_i)); };}
void __device_stub__Z14VoteAllKernel2PjS_i(unsigned *__par0, unsigned *__par1, int __par2){auto struct __T21 *__T24;
char __[256]; *(char**)&__T24 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T24->__par0 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T24->__par1 - (size_t)__T24) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T24->__par2 - (size_t)__T24) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z14VoteAllKernel2PjS_i); (void)cudaLaunch(((char *)__device_stub__Z14VoteAllKernel2PjS_i)); };}
void __device_stub__Z14VoteAnyKernel3Pbi(bool *__par0, int __par1){auto struct __T22 *__T25;
char __[256]; *(char**)&__T25 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T25->__par0 - (size_t)__T25) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T25->__par1 - (size_t)__T25) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z14VoteAnyKernel3Pbi); (void)cudaLaunch(((char *)__device_stub__Z14VoteAnyKernel3Pbi)); };}
# 37 "/tmp/tmpxft_00001e33_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c"
static void __sti____cudaRegisterAll_55_tmpxft_00001e33_00000000_7_simpleVoteIntrinsics_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z14VoteAnyKernel3Pbi, (char*)"_Z14VoteAnyKernel3Pbi", "_Z14VoteAnyKernel3Pbi", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z14VoteAllKernel2PjS_i, (char*)"_Z14VoteAllKernel2PjS_i", "_Z14VoteAllKernel2PjS_i", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z14VoteAnyKernel1PjS_i, (char*)"_Z14VoteAnyKernel1PjS_i", "_Z14VoteAnyKernel1PjS_i", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}

}
# 304 "simpleVoteIntrinsics.cu" 2
