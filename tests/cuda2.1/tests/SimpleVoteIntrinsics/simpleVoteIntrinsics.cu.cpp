# 1 "/tmp/tmpxft_0000616f_00000000-1_simpleVoteIntrinsics.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_0000616f_00000000-1_simpleVoteIntrinsics.cudafe1.cpp"
...
__cudaSafeCall(cudaChooseDevice(&dev, &deviceProp), "simpleVoteIntrinsics.cu", 212);
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, 0), "simpleVoteIntrinsics.cu", 213);
...
__cudaSafeCall(cudaMalloc((void **)(&d_input), (4 * warp_size) * sizeof(unsigned)), "simpleVoteIntrinsics.cu", 229);
__cudaSafeCall(cudaMalloc((void **)(&d_result), (4 * warp_size) * sizeof(unsigned)), "simpleVoteIntrinsics.cu", 230);
genVoteTestPattern(h_input, 4 * warp_size);
__cudaSafeCall(cudaMemcpy(d_input, h_input, (4 * warp_size) * sizeof(unsigned), cudaMemcpyHostToDevice), "simpleVoteIntrinsics.cu", 232);


printf("[VOTE Kernel Test 1/3]\n");
printf("\tRunning <<Vote.Any>> kernel1 ...\n");
{
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 238);
...
__cutilCheckMsg("VoteAnyKernel() execution failed\n", "simpleVoteIntrinsics.cu", 242);
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 243);
}
__cudaSafeCall(cudaMemcpy(h_result, d_result, (4 * warp_size) * sizeof(unsigned), cudaMemcpyDeviceToHost), "simpleVoteIntrinsics.cu", 245);
...
{
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 252);
auto dim3 gridBlock(4, 1);
auto dim3 threadBlock(warp_size, 1);
cudaConfigureCall(gridBlock, threadBlock) ? ((void)0) : VoteAllKernel2__entry(d_input, d_result, 4 * warp_size);
__cutilCheckMsg("VoteAllKernel() execution failed\n", "simpleVoteIntrinsics.cu", 256);
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 257);
}
__cudaSafeCall(cudaMemcpy(h_result, d_result, (4 * warp_size) * sizeof(unsigned), cudaMemcpyDeviceToHost), "simpleVoteIntrinsics.cu", 259);
...
__cudaSafeCall(cudaThreadSynchronize(), "simpleVoteIntrinsics.cu", 273);
}
...
__cudaSafeCall(cudaFree(d_input), "simpleVoteIntrinsics.cu", 293);
__cudaSafeCall(cudaFree(d_result), "simpleVoteIntrinsics.cu", 294);
free(h_input);
free(h_result);
...
# 1 "/tmp/tmpxft_0000616f_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_0000616f_00000000-3_simpleVoteIntrinsics.fatbin.c" 1
...
# 2 "/tmp/tmpxft_0000616f_00000000-3_simpleVoteIntrinsics.fatbin.c" 2
...
0x6d742f706d742f20ull,0x3030305f74667870ull,0x30305f6636313630ull,0x372d303030303030ull,
0x56656c706d69735full,0x6972746e4965746full,0x70632e736369736eull,0x742f2820692e3370ull,
0x23494263632f706dull,0x29525a744c38502eull,0x2d2d2d2d2f2f090aull,0x2d2d2d2d2d2d2d2dull,
0x202c31202c317672ull,0x0a3b337025202c30ull,0x3233732e766f6d09ull,0x202c333172250920ull,
0x6d090a3b31767225ull,0x33732e6f6c2e6c75ull,0x2c34317225092032ull,0x33202c3031722520ull,
0x752e747663090a3bull,0x09203233752e3436ull,0x7225202c31647225ull,0x2e646c090a3b3431ull,
0x36752e6d61726170ull,0x2c32647225092034ull,0x616475635f5f5b20ull,0x315a5f5f6d726170ull,
0x796e4165746f5634ull,0x50336c656e72654bull,0x5d6f666e695f6962ull,0x752e646461090a3bull,
0x3364722509203436ull,0x202c31647225202cull,0x6d090a3b32647225ull,0x09203233732e766full,
0x3b30202c35317225ull,0x656e2e746573090aull,0x3233732e3233752eull,0x202c363172250920ull,
0x7225202c33317225ull,0x67656e090a3b3531ull,0x722509203233732eull,0x36317225202c3731ull,
0x6c672e7473090a3bull,0x2038732e6c61626full,0x302b336472255b09ull,0x3b37317225202c5dull,
0x3109636f6c2e090aull,0x090a300936370935ull,0x61626f6c672e7473ull,0x255b092038732e6cull,
0x202c5d312b336472ull,0x2e090a3b31317225ull,0x3709353109636f6cull,0x766f6d090a300938ull,
0x722509203233752eull,0x090a3b30202c3831ull,0x2e656e2e70746573ull,0x3470250920323375ull,
0x202c31317225202cull,0x76090a3b38317225ull,0x2e6c6c612e65746full,0x7025092064657270ull,
0x0a3b347025202c35ull,0x33752e706c657309ull,0x2c31767225092032ull,0x25202c30202c3120ull,
0x766f6d090a3b3570ull,0x722509203233732eull,0x31767225202c3931ull,0x752e766f6d090a3bull,
0x3032722509203233ull,0x6573090a3b30202cull,0x33732e71652e7074ull,0x202c367025092032ull,
0x7225202c39317225ull,0x702540090a3b3032ull,0x2409206172622036ull,0x3230315f325f744cull,
0x636f6c2e090a3b36ull,0x3009393709353109ull,0x31732e766f6d090aull,0x2c33687225092036ull,
0x2e7473090a3b3120ull,0x732e6c61626f6c67ull,0x336472255b092038ull,0x687225202c5d322bull,
0x325f744c240a3b33ull,0x090a3a363230315full,0x09353109636f6c2eull,0x7865090a30093138ull,
0x57444c240a3b7469ull,0x34315a5f5f646e65ull,0x4b796e4165746f56ull,0x6250336c656e7265ull,
0x2f2f207d090a3a69ull,0x746f5634315a5f20ull,0x6e72654b796e4165ull,0x0a0a696250336c65ull,
0x0000000000000000ull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"cbc0d298d18e4642",(char*)"simpleVoteIntrinsics.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0xfc39fe81};
# 5 "/tmp/tmpxft_0000616f_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_0000616f_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 2
...
static void __sti____cudaRegisterAll_55_tmpxft_0000616f_00000000_4_simpleVoteIntrinsics_cpp1_ii_9a59ed6c(void) __attribute__((__constructor__));
