# 1 "/tmp/tmpxft_00001f1c_00000000-1_transpose.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00001f1c_00000000-1_transpose.cudafe1.cpp"
# 1 "transpose.cu"
...
# 1 "/tmp/tmpxft_00001f1c_00000000-1_transpose.cudafe1.stub.h" 1
...
{
# 86 "transpose.cu"
auto const unsigned size_x = (256);
# 87 "transpose.cu"
auto const unsigned size_y = (4096);
# 90 "transpose.cu"
auto const unsigned mem_size = ((sizeof(float) * (size_x)) * (size_y));
# 92 "transpose.cu"
auto unsigned timer;
# 93 "transpose.cu"
...
auto float *d_odata;
# 113 "transpose.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), mem_size), "transpose.cu", 113);
# 114 "transpose.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), mem_size), "transpose.cu", 114);
# 117 "transpose.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_idata, mem_size, cudaMemcpyHostToDevice), "transpose.cu", 118);
# 121 "transpose.cu"
auto dim3 grid(size_x / (16), size_y / (16), 1);
# 122 "transpose.cu"
auto dim3 threads(16, 16, 1);
# 125 "transpose.cu"
cudaConfigureCall(grid, threads) ? ((void)0) : __device_stub__Z15transpose_naivePfS_ii(d_odata, d_idata, size_x, size_y);
# 126 "transpose.cu"
cudaConfigureCall(grid, threads) ? ((void)0) : __device_stub__Z9transposePfS_ii(d_odata, d_idata, size_x, size_y);
# 128 "transpose.cu"
auto int numIterations = 1;
# 130 "transpose.cu"
...
cutStopTimer(timer);
# 140 "transpose.cu"
auto float naiveTime = cutGetTimerValue(timer);
# 144 "transpose.cu"
cutResetTimer(timer);
# 145 "transpose.cu"
cutStartTimer(timer);
...
cutStopTimer(timer);
# 152 "transpose.cu"
auto float optimizedTime = cutGetTimerValue(timer);
# 154 "transpose.cu"
...
# 158 "transpose.cu"
__cutilCheckMsg("Kernel execution failed", "transpose.cu", 158);
# 161 "transpose.cu"
auto float *h_odata = ((float *)malloc(mem_size));
# 162 "transpose.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_odata, mem_size, cudaMemcpyDeviceToHost), "transpose.cu", 163);
# 166 "transpose.cu"
auto float *reference = ((float *)malloc(mem_size));
# 168 "transpose.cu"
computeGold(reference, h_idata, size_x, size_y);
# 171 "transpose.cu"
auto CUTBoolean res = cutComparef(reference, h_odata, size_x * size_y);
# 172 "transpose.cu"
...
free(reference);
# 178 "transpose.cu"
__cudaSafeCall(cudaFree(d_idata), "transpose.cu", 178);
# 179 "transpose.cu"
__cudaSafeCall(cudaFree(d_odata), "transpose.cu", 179);
# 180 "transpose.cu"
__cutilCheckError(cutDeleteTimer(timer), "transpose.cu", 180);
# 182 "transpose.cu"
cudaThreadExit();
# 183 "transpose.cu"
}

# 1 "/tmp/tmpxft_00001f1c_00000000-1_transpose.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00001f1c_00000000-3_transpose.fatbin.c" 1
...
# 5 "/tmp/tmpxft_00001f1c_00000000-1_transpose.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00001f1c_00000000-1_transpose.cudafe1.stub.c" 2
struct __T20;
struct __T21;
struct __T20 {float *__par0;float *__par1;int __par2;int __par3;int __dummy_field;volatile char __dummy[4];};
struct __T21 {float *__par0;float *__par1;int __par2;int __par3;int __dummy_field;volatile char __dummy[4];};
...
static void __sti____cudaRegisterAll_44_tmpxft_00001f1c_00000000_7_transpose_cpp1_ii_c14de7b3(void) __attribute__((__constructor__));
void __device_stub__Z9transposePfS_ii(float *__par0, float *__par1, int __par2, int __par3){auto struct __T20 *__T22;
char __[256]; *(char**)&__T22 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T22->__par0 - (size_t)__T22) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T22->__par1 - (size_t)__T22) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T22->__par2 - (size_t)__T22) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par3, sizeof(__par3), (size_t)&__T22->__par3 - (size_t)__T22) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z9transposePfS_ii); (void)cudaLaunch(((char *)__device_stub__Z9transposePfS_ii)); };}
void __device_stub__Z15transpose_naivePfS_ii(float *__par0, float *__par1, int __par2, int __par3){auto struct __T21 *__T23;
char __[256]; *(char**)&__T23 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T23->__par0 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T23->__par1 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T23->__par2 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par3, sizeof(__par3), (size_t)&__T23->__par3 - (size_t)__T23) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)__device_stub__Z15transpose_naivePfS_ii); (void)cudaLaunch(((char *)__device_stub__Z15transpose_naivePfS_ii)); };}
...
static void __sti____cudaRegisterAll_44_tmpxft_00001f1c_00000000_7_transpose_cpp1_ii_c14de7b3(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z15transpose_naivePfS_ii, (char*)"_Z15transpose_naivePfS_ii", "_Z15transpose_naivePfS_ii", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)__device_stub__Z9transposePfS_ii, (char*)"_Z9transposePfS_ii", "_Z9transposePfS_ii", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}
