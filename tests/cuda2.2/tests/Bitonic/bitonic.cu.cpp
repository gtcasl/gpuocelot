# 1 "/tmp/tmpxft_00005706_00000000-1_bitonic.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005706_00000000-1_bitonic.cudafe1.cpp"
...
# 41 "tests/Bitonic/bitonic_kernel.cu"
__attribute__((unused)) inline void swap(int &a, int &b)
# 42 "tests/Bitonic/bitonic_kernel.cu"
{int volatile ___ = 1;(void)a;(void)b;
# 51 "tests/Bitonic/bitonic_kernel.cu"
exit(___);}
# 53 "tests/Bitonic/bitonic_kernel.cu"
static void bitonicSort(int *values) ;
# 58 "tests/Bitonic/bitonic.cu"
int main(int argc, char **argv)
# 59 "tests/Bitonic/bitonic.cu"
{
# 60 "tests/Bitonic/bitonic.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 61 "tests/Bitonic/bitonic.cu"
cutilDeviceInit(argc, argv); } else {
# 63 "tests/Bitonic/bitonic.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 65 "tests/Bitonic/bitonic.cu"
int values[256];
# 67 "tests/Bitonic/bitonic.cu"
for (int i = 0; i < 256; i++)
# 68 "tests/Bitonic/bitonic.cu"
{
# 69 "tests/Bitonic/bitonic.cu"
((values)[i]) = rand();
# 70 "tests/Bitonic/bitonic.cu"
}
# 72 "tests/Bitonic/bitonic.cu"
int *dvalues;
# 73 "tests/Bitonic/bitonic.cu"
__cudaSafeCall(cudaMalloc((void **)(&dvalues), sizeof(int) * (256)), "tests/Bitonic/bitonic.cu", 73);
# 74 "tests/Bitonic/bitonic.cu"
__cudaSafeCall(cudaMemcpy(dvalues, values, sizeof(int) * (256), cudaMemcpyHostToDevice), "tests/Bitonic/bitonic.cu", 74);
# 76 "tests/Bitonic/bitonic.cu"
cudaConfigureCall(1, 256, sizeof(int) * (256)) ? ((void)0) : bitonicSort(dvalues);
# 79 "tests/Bitonic/bitonic.cu"
__cutilCheckMsg("Kernel execution failed", "tests/Bitonic/bitonic.cu", 79);
# 81 "tests/Bitonic/bitonic.cu"
__cudaSafeCall(cudaMemcpy(values, dvalues, sizeof(int) * (256), cudaMemcpyDeviceToHost), "tests/Bitonic/bitonic.cu", 81);
# 83 "tests/Bitonic/bitonic.cu"
__cudaSafeCall(cudaFree(dvalues), "tests/Bitonic/bitonic.cu", 83);
# 85 "tests/Bitonic/bitonic.cu"
bool passed = true;
# 86 "tests/Bitonic/bitonic.cu"
for (int i = 1; i < 256; i++)
# 87 "tests/Bitonic/bitonic.cu"
{
# 88 "tests/Bitonic/bitonic.cu"
if (((values)[i - 1]) > ((values)[i]))
# 89 "tests/Bitonic/bitonic.cu"
{
# 90 "tests/Bitonic/bitonic.cu"
passed = false;
# 91 "tests/Bitonic/bitonic.cu"
}
# 92 "tests/Bitonic/bitonic.cu"
}
# 94 "tests/Bitonic/bitonic.cu"
printf("Test %s\n", passed ? ("PASSED") : ("FAILED"));
# 96 "tests/Bitonic/bitonic.cu"
cudaThreadExit();
# 98 "tests/Bitonic/bitonic.cu"
__cutilExit(argc, argv); return 0;
# 99 "tests/Bitonic/bitonic.cu"
}
# 1 "tmpxft_00005706_00000000-1_bitonic.cudafe1.stub.c"
# 1 "tmpxft_00005706_00000000-1_bitonic.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00005706_00000000-1_bitonic.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00005706_00000000-1_bitonic.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_00005706_00000000-3_bitonic.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000d12,0x0000005801000002,0x0000000000000624\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000001800000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x69422f7374736574,0x69622f63696e6f74,0x75632e63696e6f74\n"
".quad 0x0000000000000000,0x33010102464c457f,0x0000000000000004,0x0000000100be0002\n"
".quad 0x0000000000000000,0x00000000000005b4,0x0000000000000040,0x0038004000140514\n"
...
".quad 0x0000000000000240,0x0000000000000092,0x0000000000000000,0x0000000000000004\n"
".quad 0x0000000000000000,0x000000030000000b,0x0000000000000000,0x0000000000000000\n"
".quad 0x00000000000002d2,0x0000000000000013,0x0000000000000000,0x0000000000000001\n"
".quad 0x0000000000000000,0x0000000200000013,0x0000000000000000,0x0000000000000000\n"
".quad 0x00000000000002e5,0x0000000000000108,0x0000000a00000002,0x0000000000000001\n"
".quad 0x0000000000000018,0x0000000100000036,0x0000000000100006,0x0000000000000000\n"
".quad 0x00000000000003ed,0x0000000000000158,0x0b00000600000003,0x0000000000000004\n"
".quad 0x0000000000000000,0x0000000100000072,0x0000000000000002,0x0000000000000000\n"
".quad 0x0000000000000545,0x0000000000000028,0x0000000400000000,0x0000000000000004\n"
".quad 0x0000000000000000,0x000000010000004e,0x0000000000000002,0x0000000000000000\n"
".quad 0x000000000000056d,0x000000000000002c,0x0000000400000000,0x0000000000000001\n"
".quad 0x0000000000000000,0x0000000100000069,0x0000000000000002,0x0000000000000000\n"
".quad 0x0000000000000599,0x0000000000000018,0x0000000000000000,0x0000000000000001\n"
...
".quad 0x31315a5f2e747865,0x5363696e6f746962,0x6e2e00695074726f,0x5f2e6f666e692e76\n"
".quad 0x6e6f74696231315a,0x695074726f536369,0x666e692e766e2e00,0x6f632e766e2e006f\n"
".quad 0x2e30746e6174736e,0x6f74696231315a5f,0x5074726f5363696e,0x6231315a5f000069\n"
".quad 0x6f5363696e6f7469,0x0000000069507472,0x0000000000000000,0x0000000000000000\n"
...
".quad 0x0000000004000300,0x0001580000000000,0x0000000000000000,0x0000000006000300\n"
...
".quad 0x0000000004101200,0x0001580000000000,0x005de40000000000,0x019c042800440400\n"
".quad 0x1fdc032c00000084,0x61de03207e0000fc,0x601c436000c00008,0x709c035000c00010\n"
".quad 0x00dc434801400080,0x201c854800400090,0x701c858400000000,0xffdc04c900000000\n"
".quad 0x001de250ee0000ff,0x011de41800000008,0x015c0328000000fc,0x51dc235800c00004\n"
".quad 0x0001e7190e0000fc,0x021c0340000002a0,0x81dc236800000018,0x521c83190e0000fc\n"
".quad 0x0000076800000018,0x83dc0360000001a0,0x0005f4198e000018,0x829e034000000000\n"
".quad 0x725c856000c00008,0xa21c85c100000000,0x0001e7c100000000,0x93dc234000000060\n"
".quad 0x0005f41b0e000020,0x001de74000000000,0x93dc234000000040,0x0005f4198e000020\n"
".quad 0x721c854000000000,0xa25c95c900000000,0xffdc04c900000000,0x515c0350ee0000ff\n"
".quad 0x53dc235800c00004,0x0005e71a8e0000fc,0x411c034003fffda0,0x001c034800c00004\n"
".quad 0x41dc236000c00004,0x0001e71a8ec00020,0x701c854003fffc80,0x201c85c100000000\n"
".quad 0x001de79400000000,0x0000008000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x080a040000000000,0x0800200000000900\n"
".quad 0x0c17040008190300,0x0000000000000000,0x080d040021f00000,0x0000030004003000\n"
".quad 0x00000a0008120400,0x0811040000000000,0x0000000000000a00,0x0000000600000000\n"
".quad 0x000005b400000005,0x0000000000000000,0x0000000000000000,0x0000007000000000\n"
".quad 0x0000007000000000,0x0000000400000000,0x6000000000000000,0x000003ed00000a05\n"
".quad 0x0000000000000000,0x0000000000000000,0x000001ac00000000,0x000001ac00000000\n"
".quad 0x0000000400000000,0x0100000100000000,0x0000063600000060,0x0000000000000000\n"
".quad 0x0003000000000038,0x0000004000000014,0x0000001500000018,0x0000000000000000\n"
...
".quad 0x22203109656c6966,0x706d742f706d742f,0x303030305f746678,0x3030305f36303735\n"
...
".quad 0x3b5d5b6465726168,0x7972746e652e0a0a,0x74696231315a5f20,0x74726f5363696e6f\n"
".quad 0x7261702e0a286950,0x203436752e206d61,0x6f74696231315a5f,0x5074726f5363696e\n"
".quad 0x5f6d617261705f69,0x722e0a7b0a290a30,0x646572702e206765,0x0a3b3e383c702520\n"
".quad 0x33732e206765722e,0x3e30333c72252032,0x2e206765722e0a3b,0x3c6c722520343673\n"
".quad 0x6c0a0a0a3b3e3031,0x2e6d617261702e64,0x346c722520343675,0x6231315a5f5b202c\n"
".quad 0x6f5363696e6f7469,0x7261705f69507472,0x630a3b5d305f6d61,0x672e6f742e617476\n"
".quad 0x36752e6c61626f6c,0x202c356c72252034,0x6c2e0a3b346c7225,0x203735203220636f\n"
".quad 0x33752e766f6d0a31,0x25202c3172252032,0x2e0a3b782e646974,0x3036203220636f6c\n"
".quad 0x772e6c756d0a3120,0x203233752e656469,0x7225202c366c7225,0x64610a3b34202c31\n"
".quad 0x7225203436732e64,0x356c7225202c316c,0x0a3b366c7225202c,0x203436752e766f6d\n"
".quad 0x6873202c376c7225,0x64610a3b64657261,0x7225203436732e64,0x376c7225202c326c\n"
".quad 0x0a3b366c7225202c,0x36203220636f6c2e,0x672e646c0a312030,0x33752e6c61626f6c\n"
".quad 0x202c323172252032,0x0a3b5d316c72255b,0x65726168732e7473,0x255b203233752e64\n"
".quad 0x7225202c5d326c72,0x636f6c2e0a3b3231,0x0a31203236203220,0x636e79732e726162\n"
".quad 0x2e766f6d0a3b3020,0x3832722520323375,0x766f6d0a3b32202c,0x327225203233752e\n"
".quad 0x420a0a3b30202c37,0x68730a3a315f3042,0x7225203233752e72,0x38327225202c3932\n"
".quad 0x7465730a3b31202c,0x3233732e71652e70,0x7225202c32702520,0x2e0a3b30202c3932\n"
".quad 0x3836203220636f6c,0x20327025400a3120,0x5f30424220617262,0x636f6c2e0a0a3b39\n"
".quad 0x0a31203437203220,0x203233622e646e61,0x7225202c37317225,0x3b317225202c3832\n"
".quad 0x71652e707465730a,0x317025203233732e,0x202c37317225202c,0x5f3042420a0a3b30\n"
".quad 0x20636f6c2e0a3a33,0x780a312030372032,0x25203233622e726f,0x39327225202c3672\n"
".quad 0x2e0a3b317225202c,0x3237203220636f6c,0x2e707465730a3120,0x25203233752e656c\n"
".quad 0x2c367225202c3370,0x25400a3b31722520,0x4220617262203370,0x2e0a0a3b385f3042\n"
".quad 0x3637203220636f6c,0x68732e646c0a3120,0x3233752e64657261,0x255b202c37722520\n"
".quad 0x756d0a3b5d326c72,0x752e656469772e6c,0x2c386c7225203233,0x3b34202c36722520\n"
".quad 0x3436732e6464610a,0x25202c336c722520,0x6c7225202c376c72,0x20636f6c2e0a3b38\n"
".quad 0x6c0a312036372032,0x6465726168732e64,0x387225203233752e,0x5d336c72255b202c\n"
".quad 0x3220636f6c2e0a3b,0x25400a3120343720,0x4220617262203170,0x2e0a0a3b365f3042\n"
".quad 0x3338203220636f6c,0x2e707465730a3120,0x25203233732e6567,0x2c377225202c3470\n"
".quad 0x25400a3b38722520,0x4220617262203470,0x72620a3b385f3042,0x424220696e752e61\n"
".quad 0x42420a0a3b375f30,0x6f6c2e0a3a365f30,0x3120363720322063,0x656c2e707465730a\n"
".quad 0x357025203233732e,0x25202c377225202c,0x357025400a3b3872,0x3042422061726220\n"
".quad 0x3042420a0a3b385f,0x636f6c2e0a3a375f,0x0a31203837203220,0x65726168732e7473\n"
".quad 0x255b203233752e64,0x7225202c5d326c72,0x68732e74730a3b38,0x3233752e64657261\n"
".quad 0x2c5d336c72255b20,0x420a0a3b37722520,0x6c2e0a3a385f3042,0x203039203220636f\n"
".quad 0x79732e7261620a31,0x68730a3b3020636e,0x7225203233752e72,0x39327225202c3932\n"
".quad 0x6f6c2e0a3b31202c,0x3120383620322063,0x656e2e707465730a,0x367025203233732e\n"
".quad 0x202c39327225202c,0x20367025400a3b30,0x5f30424220617262,0x5f3042420a0a3b33\n"
".quad 0x622e6c68730a3a39,0x2c38327225203233,0x31202c3832722520,0x33732e6464610a3b\n"
".quad 0x202c373272252032,0x3b31202c37327225,0x203220636f6c2e0a,0x7465730a31203536\n"
".quad 0x3233732e656e2e70,0x7225202c37702520,0x400a3b38202c3732,0x2061726220377025\n"
".quad 0x0a0a3b315f304242,0x39203220636f6c2e,0x732e646c0a312035,0x33752e6465726168\n"
".quad 0x202c343272252032,0x0a3b5d326c72255b,0x61626f6c672e7473,0x255b203233752e6c\n"
".quad 0x7225202c5d316c72,0x636f6c2e0a3b3432,0x0a32203639203220,0x0a0a7d0a3b746572\n"
...
# 3 "/tmp/tmpxft_00005706_00000000-1_bitonic.cudafe1.stub.c" 2 3
static void __device_stub__Z11bitonicSortPi(int *);
static void __sti____cudaRegisterAll_42_tmpxft_00005706_00000000_4_bitonic_cpp1_ii_main(void) __attribute__((__constructor__));
