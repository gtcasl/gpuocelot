# 1 "/tmp/tmpxft_0000570c_00000000-1_BlackScholes.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_0000570c_00000000-1_BlackScholes.cudafe1.cpp"
...
# 55 "tests/BlackScholes/BlackScholes.cu"
extern "C" void BlackScholesCPU(float * , float * , float * , float * , float * , float , float , int );
# 41 "tests/BlackScholes/BlackScholes_kernel.cuh"
__attribute__((unused)) inline float cndGPU(float d) {int volatile ___ = 1;(void)d;
# 60 "tests/BlackScholes/BlackScholes_kernel.cuh"
exit(___);}
# 66 "tests/BlackScholes/BlackScholes_kernel.cuh"
__attribute__((unused)) inline void BlackScholesBodyGPU(float &
# 67 "tests/BlackScholes/BlackScholes_kernel.cuh"
CallResult, float &
# 68 "tests/BlackScholes/BlackScholes_kernel.cuh"
PutResult, float
# 69 "tests/BlackScholes/BlackScholes_kernel.cuh"
S, float
# 70 "tests/BlackScholes/BlackScholes_kernel.cuh"
X, float
# 71 "tests/BlackScholes/BlackScholes_kernel.cuh"
T, float
# 72 "tests/BlackScholes/BlackScholes_kernel.cuh"
R, float
# 73 "tests/BlackScholes/BlackScholes_kernel.cuh"
V)
# 74 "tests/BlackScholes/BlackScholes_kernel.cuh"
{int volatile ___ = 1;(void)CallResult;(void)PutResult;(void)S;(void)X;(void)T;(void)R;(void)V;
# 89 "tests/BlackScholes/BlackScholes_kernel.cuh"
exit(___);}
# 95 "tests/BlackScholes/BlackScholes_kernel.cuh"
void BlackScholesGPU(float *
# 96 "tests/BlackScholes/BlackScholes_kernel.cuh"
d_CallResult, float *
# 97 "tests/BlackScholes/BlackScholes_kernel.cuh"
d_PutResult, float *
# 98 "tests/BlackScholes/BlackScholes_kernel.cuh"
d_StockPrice, float *
# 99 "tests/BlackScholes/BlackScholes_kernel.cuh"
d_OptionStrike, float *
# 100 "tests/BlackScholes/BlackScholes_kernel.cuh"
d_OptionYears, float
# 101 "tests/BlackScholes/BlackScholes_kernel.cuh"
Riskfree, float
# 102 "tests/BlackScholes/BlackScholes_kernel.cuh"
Volatility, int
# 103 "tests/BlackScholes/BlackScholes_kernel.cuh"
optN) ;
# 79 "tests/BlackScholes/BlackScholes.cu"
float RandFloat(float low, float high) {
# 80 "tests/BlackScholes/BlackScholes.cu"
float t = (((float)rand()) / ((float)2147483647));
# 81 "tests/BlackScholes/BlackScholes.cu"
return (((1.0F) - t) * low) + (t * high);
# 82 "tests/BlackScholes/BlackScholes.cu"
}
# 89 "tests/BlackScholes/BlackScholes.cu"
static const int OPT_N = 4000000;
# 92 "tests/BlackScholes/BlackScholes.cu"
static const int NUM_ITERATIONS = 1;
# 98 "tests/BlackScholes/BlackScholes.cu"
static const int OPT_SZ = (OPT_N * sizeof(float));
# 99 "tests/BlackScholes/BlackScholes.cu"
static const float RISKFREE = (0.01999999955F);
# 100 "tests/BlackScholes/BlackScholes.cu"
static const float VOLATILITY = (0.3000000119F);
# 106 "tests/BlackScholes/BlackScholes.cu"
int main(int argc, char **argv) {
# 110 "tests/BlackScholes/BlackScholes.cu"
float *h_CallResultCPU,
# 111 "tests/BlackScholes/BlackScholes.cu"
*h_PutResultCPU,
# 113 "tests/BlackScholes/BlackScholes.cu"
*h_CallResultGPU,
# 114 "tests/BlackScholes/BlackScholes.cu"
*h_PutResultGPU,
# 116 "tests/BlackScholes/BlackScholes.cu"
*h_StockPrice,
# 117 "tests/BlackScholes/BlackScholes.cu"
*h_OptionStrike,
# 118 "tests/BlackScholes/BlackScholes.cu"
*h_OptionYears;
# 123 "tests/BlackScholes/BlackScholes.cu"
float *d_CallResult,
# 124 "tests/BlackScholes/BlackScholes.cu"
*d_PutResult,
# 126 "tests/BlackScholes/BlackScholes.cu"
*d_StockPrice,
# 127 "tests/BlackScholes/BlackScholes.cu"
*d_OptionStrike,
# 128 "tests/BlackScholes/BlackScholes.cu"
*d_OptionYears;
# 131 "tests/BlackScholes/BlackScholes.cu"
double delta, ref, sum_delta, sum_ref, max_delta, L1norm, gpuTime;
# 133 "tests/BlackScholes/BlackScholes.cu"
unsigned hTimer;
# 134 "tests/BlackScholes/BlackScholes.cu"
int i;
# 137 "tests/BlackScholes/BlackScholes.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 138 "tests/BlackScholes/BlackScholes.cu"
cutilDeviceInit(argc, argv); } else {
# 140 "tests/BlackScholes/BlackScholes.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 142 "tests/BlackScholes/BlackScholes.cu"
__cutilCheckError(cutCreateTimer(&hTimer), "tests/BlackScholes/BlackScholes.cu", 142);
# 144 "tests/BlackScholes/BlackScholes.cu"
printf("Initializing data...\n");
# 145 "tests/BlackScholes/BlackScholes.cu"
printf("...allocating CPU memory for options.\n");
# 146 "tests/BlackScholes/BlackScholes.cu"
h_CallResultCPU = ((float *)malloc(OPT_SZ));
# 147 "tests/BlackScholes/BlackScholes.cu"
h_PutResultCPU = ((float *)malloc(OPT_SZ));
# 148 "tests/BlackScholes/BlackScholes.cu"
h_CallResultGPU = ((float *)malloc(OPT_SZ));
# 149 "tests/BlackScholes/BlackScholes.cu"
h_PutResultGPU = ((float *)malloc(OPT_SZ));
# 150 "tests/BlackScholes/BlackScholes.cu"
h_StockPrice = ((float *)malloc(OPT_SZ));
# 151 "tests/BlackScholes/BlackScholes.cu"
h_OptionStrike = ((float *)malloc(OPT_SZ));
# 152 "tests/BlackScholes/BlackScholes.cu"
h_OptionYears = ((float *)malloc(OPT_SZ));
# 154 "tests/BlackScholes/BlackScholes.cu"
printf("...allocating GPU memory for options.\n");
# 155 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_CallResult), OPT_SZ), "tests/BlackScholes/BlackScholes.cu", 155);
# 156 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_PutResult), OPT_SZ), "tests/BlackScholes/BlackScholes.cu", 156);
# 157 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_StockPrice), OPT_SZ), "tests/BlackScholes/BlackScholes.cu", 157);
# 158 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_OptionStrike), OPT_SZ), "tests/BlackScholes/BlackScholes.cu", 158);
# 159 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_OptionYears), OPT_SZ), "tests/BlackScholes/BlackScholes.cu", 159);
# 161 "tests/BlackScholes/BlackScholes.cu"
printf("...generating input data in CPU mem.\n");
# 162 "tests/BlackScholes/BlackScholes.cu"
srand(5347);
# 164 "tests/BlackScholes/BlackScholes.cu"
for (i = 0; i < OPT_N; i++) {
# 165 "tests/BlackScholes/BlackScholes.cu"
(h_CallResultCPU[i]) = (0.0F);
# 166 "tests/BlackScholes/BlackScholes.cu"
(h_PutResultCPU[i]) = (-(1.0F));
# 167 "tests/BlackScholes/BlackScholes.cu"
(h_StockPrice[i]) = RandFloat((5.0F), (30.0F));
# 168 "tests/BlackScholes/BlackScholes.cu"
(h_OptionStrike[i]) = RandFloat((1.0F), (100.0F));
# 169 "tests/BlackScholes/BlackScholes.cu"
(h_OptionYears[i]) = RandFloat((0.25F), (10.0F));
# 170 "tests/BlackScholes/BlackScholes.cu"
}
# 172 "tests/BlackScholes/BlackScholes.cu"
printf("...copying input data to GPU mem.\n");
# 174 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMemcpy(d_StockPrice, h_StockPrice, OPT_SZ, cudaMemcpyHostToDevice), "tests/BlackScholes/BlackScholes.cu", 174);
# 175 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMemcpy(d_OptionStrike, h_OptionStrike, OPT_SZ, cudaMemcpyHostToDevice), "tests/BlackScholes/BlackScholes.cu", 175);
# 176 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMemcpy(d_OptionYears, h_OptionYears, OPT_SZ, cudaMemcpyHostToDevice), "tests/BlackScholes/BlackScholes.cu", 176);
# 177 "tests/BlackScholes/BlackScholes.cu"
printf("Data init done.\n");
# 180 "tests/BlackScholes/BlackScholes.cu"
printf("Executing Black-Scholes GPU kernel (%i iterations)...\n", NUM_ITERATIONS);
# 181 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/BlackScholes/BlackScholes.cu", 181);
# 182 "tests/BlackScholes/BlackScholes.cu"
__cutilCheckError(cutResetTimer(hTimer), "tests/BlackScholes/BlackScholes.cu", 182);
# 183 "tests/BlackScholes/BlackScholes.cu"
__cutilCheckError(cutStartTimer(hTimer), "tests/BlackScholes/BlackScholes.cu", 183);
# 184 "tests/BlackScholes/BlackScholes.cu"
for (i = 0; i < NUM_ITERATIONS; i++) {
# 185 "tests/BlackScholes/BlackScholes.cu"
...
# 195 "tests/BlackScholes/BlackScholes.cu"
__cutilCheckMsg("BlackScholesGPU() execution failed\n", "tests/BlackScholes/BlackScholes.cu", 195);
# 196 "tests/BlackScholes/BlackScholes.cu"
}
# 197 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/BlackScholes/BlackScholes.cu", 197);
# 198 "tests/BlackScholes/BlackScholes.cu"
__cutilCheckError(cutStopTimer(hTimer), "tests/BlackScholes/BlackScholes.cu", 198);
# 199 "tests/BlackScholes/BlackScholes.cu"
gpuTime = (cutGetTimerValue(hTimer) / NUM_ITERATIONS);
# 201 "tests/BlackScholes/BlackScholes.cu"
printf("Options count             : %i     \n", 2 * OPT_N);
# 202 "tests/BlackScholes/BlackScholes.cu"
printf("BlackScholesGPU() time    : %f msec\n", gpuTime);
# 203 "tests/BlackScholes/BlackScholes.cu"
printf("Effective memory bandwidth: %f GB/s\n", (((double)((5 * OPT_N) * sizeof(float))) * (1.000000000000000062e-09)) / (gpuTime * (0.001000000000000000021)));
# 204 "tests/BlackScholes/BlackScholes.cu"
printf("Gigaoptions per second    : %f     \n", (((double)(2 * OPT_N)) * (1.000000000000000062e-09)) / (gpuTime * (0.001000000000000000021)));
# 207 "tests/BlackScholes/BlackScholes.cu"
printf("Reading back GPU results...\n");
# 209 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMemcpy(h_CallResultGPU, d_CallResult, OPT_SZ, cudaMemcpyDeviceToHost), "tests/BlackScholes/BlackScholes.cu", 209);
# 210 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaMemcpy(h_PutResultGPU, d_PutResult, OPT_SZ, cudaMemcpyDeviceToHost), "tests/BlackScholes/BlackScholes.cu", 210);
# 213 "tests/BlackScholes/BlackScholes.cu"
printf("Checking the results...\n");
# 214 "tests/BlackScholes/BlackScholes.cu"
printf("...running CPU calculations.\n");
# 216 "tests/BlackScholes/BlackScholes.cu"
BlackScholesCPU(h_CallResultCPU, h_PutResultCPU, h_StockPrice, h_OptionStrike, h_OptionYears, RISKFREE, VOLATILITY, OPT_N);
# 227 "tests/BlackScholes/BlackScholes.cu"
printf("Comparing the results...\n");
# 230 "tests/BlackScholes/BlackScholes.cu"
sum_delta = (0);
# 231 "tests/BlackScholes/BlackScholes.cu"
sum_ref = (0);
# 232 "tests/BlackScholes/BlackScholes.cu"
max_delta = (0);
# 233 "tests/BlackScholes/BlackScholes.cu"
for (i = 0; i < OPT_N; i++) {
# 234 "tests/BlackScholes/BlackScholes.cu"
ref = (h_CallResultCPU[i]);
# 235 "tests/BlackScholes/BlackScholes.cu"
delta = (fabs((h_CallResultCPU[i]) - (h_CallResultGPU[i])));
# 236 "tests/BlackScholes/BlackScholes.cu"
if (delta > max_delta) { max_delta = delta; }
# 237 "tests/BlackScholes/BlackScholes.cu"
sum_delta += delta;
# 238 "tests/BlackScholes/BlackScholes.cu"
sum_ref += fabs(ref);
# 239 "tests/BlackScholes/BlackScholes.cu"
}
# 240 "tests/BlackScholes/BlackScholes.cu"
L1norm = (sum_delta / sum_ref);
# 241 "tests/BlackScholes/BlackScholes.cu"
printf("L1 norm: %E\n", L1norm);
# 242 "tests/BlackScholes/BlackScholes.cu"
printf("Max absolute error: %E\n", max_delta);
# 243 "tests/BlackScholes/BlackScholes.cu"
printf((L1norm < (9.999999999999999547e-07)) ? ("TEST PASSED\n") : ("TEST FAILED\n"));
# 246 "tests/BlackScholes/BlackScholes.cu"
printf("Shutting down...\n");
# 247 "tests/BlackScholes/BlackScholes.cu"
printf("...releasing GPU memory.\n");
# 248 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaFree(d_OptionYears), "tests/BlackScholes/BlackScholes.cu", 248);
# 249 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaFree(d_OptionStrike), "tests/BlackScholes/BlackScholes.cu", 249);
# 250 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaFree(d_StockPrice), "tests/BlackScholes/BlackScholes.cu", 250);
# 251 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaFree(d_PutResult), "tests/BlackScholes/BlackScholes.cu", 251);
# 252 "tests/BlackScholes/BlackScholes.cu"
__cudaSafeCall(cudaFree(d_CallResult), "tests/BlackScholes/BlackScholes.cu", 252);
# 254 "tests/BlackScholes/BlackScholes.cu"
printf("...releasing CPU memory.\n");
# 255 "tests/BlackScholes/BlackScholes.cu"
free(h_OptionYears);
# 256 "tests/BlackScholes/BlackScholes.cu"
free(h_OptionStrike);
# 257 "tests/BlackScholes/BlackScholes.cu"
free(h_StockPrice);
# 258 "tests/BlackScholes/BlackScholes.cu"
free(h_PutResultGPU);
# 259 "tests/BlackScholes/BlackScholes.cu"
free(h_CallResultGPU);
# 260 "tests/BlackScholes/BlackScholes.cu"
free(h_PutResultCPU);
# 261 "tests/BlackScholes/BlackScholes.cu"
free(h_CallResultCPU);
# 262 "tests/BlackScholes/BlackScholes.cu"
__cutilCheckError(cutDeleteTimer(hTimer), "tests/BlackScholes/BlackScholes.cu", 262);
# 263 "tests/BlackScholes/BlackScholes.cu"
printf("Shutdown done.\n");
# 265 "tests/BlackScholes/BlackScholes.cu"
cudaThreadExit();
# 267 "tests/BlackScholes/BlackScholes.cu"
__cutilExit(argc, argv); return 0;
# 268 "tests/BlackScholes/BlackScholes.cu"
}
# 1 "tmpxft_0000570c_00000000-1_BlackScholes.cudafe1.stub.c"
# 1 "tmpxft_0000570c_00000000-1_BlackScholes.cudafe1.stub.c"
# 1 "/tmp/tmpxft_0000570c_00000000-1_BlackScholes.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_0000570c_00000000-1_BlackScholes.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_0000570c_00000000-3_BlackScholes.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x00000000000024b7,0x0000006001000002,0x000000000000126c\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000002200000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x6c422f7374736574,0x6c6f6863536b6361,0x6b63616c422f7365\n"
".quad 0x2e73656c6f686353,0x0000000000007563,0x33010102464c457f,0x0000000000000004\n"
".quad 0x0000000100be0002,0x0000000000000000,0x00000000000011fc,0x0000000000000040\n"
...
".quad 0x730a3b3834662520,0x662e74672e707465,0x202c337025203233,0x6630202c37316625\n"
".quad 0x3030303030303030,0x33662e67656e0a3b,0x202c303566252032,0x6d660a3b33346625\n"
".quad 0x3233662e6e722e61,0x25202c3135662520,0x346625202c303566,0x3b30326625202c38\n"
".quad 0x33662e706c65730a,0x202c323566252032,0x6625202c31356625,0x3b337025202c3934\n"
".quad 0x203220636f6c2e0a,0x756d0a3120333131,0x6625203233662e6c,0x2c366625202c3335\n"
".quad 0x6c2e0a3b34662520,0x383231203420636f,0x2e6c756d0a332033,0x3435662520323366\n"
".quad 0x202c33356625202c,0x4141384246336630,0x636f6c2e0a3b4233,0x3520313335203320\n"
".quad 0x7070612e3278650a,0x203233662e786f72,0x6625202c35356625,0x636f6c2e0a3b3435\n"
".quad 0x3120333131203220,0x3233662e6c756d0a,0x25202c3635662520,0x35336625202c3966\n"
".quad 0x33662e6c756d0a3b,0x202c373566252032,0x356625202c386625,0x662e67656e0a3b35\n"
".quad 0x2c38356625203233,0x660a3b3735662520,0x33662e6e722e616d,0x202c393566252032\n"
".quad 0x6625202c38356625,0x36356625202c3235,0x36732e6464610a3b,0x2c35316c72252034\n"
".quad 0x25202c326c722520,0x74730a3b31316c72,0x2e6c61626f6c672e,0x6c72255b20323366\n"
".quad 0x356625202c5d3531,0x662e6275730a3b39,0x2c30366625203233,0x25202c3032662520\n"
".quad 0x6c756d0a3b323566,0x366625203233662e,0x2c37356625202c31,0x730a3b3036662520\n"
".quad 0x25203233662e6275,0x326625202c323666,0x3b35336625202c30,0x3233662e67656e0a\n"
".quad 0x25202c3336662520,0x2e616d660a3b3966,0x25203233662e6e72,0x366625202c343666\n"
".quad 0x2c32366625202c33,0x610a3b3136662520,0x25203436732e6464,0x7225202c36316c72\n"
".quad 0x316c7225202c316c,0x6c672e74730a3b31,0x3233662e6c61626f,0x5d36316c72255b20\n"
".quad 0x0a3b34366625202c,0x31203220636f6c2e,0x64610a3232203231,0x7225203233732e64\n"
".quad 0x36317225202c3631,0x6c0a3b337225202c,0x2e6d617261702e64,0x3531722520323375\n"
".quad 0x4235315a5f5b202c,0x6f6863536b63616c,0x665055504773656c,0x5f535f535f535f53\n"
".quad 0x617261705f696666,0x6c2e0a3b5d375f6d,0x323131203220636f,0x2e707465730a3120\n"
".quad 0x25203233732e746c,0x36317225202c3470,0x0a3b35317225202c,0x6172622034702540\n"
".quad 0x0a3b325f30424220,0x0a3a335f3042420a,0x31203220636f6c2e,0x7465720a32203232\n"
".quad 0x00000a0a0a7d0a3b\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[1177];
...
# 3 "/tmp/tmpxft_0000570c_00000000-1_BlackScholes.cudafe1.stub.c" 2 3
extern void __device_stub__Z15BlackScholesGPUPfS_S_S_S_ffi(float *, float *, float *, float *, float *, float, float, int);
static void __sti____cudaRegisterAll_47_tmpxft_0000570c_00000000_4_BlackScholes_cpp1_ii_cec09074(void) __attribute__((__constructor__));
...
# 104 "tests/BlackScholes/BlackScholes_kernel.cuh"
