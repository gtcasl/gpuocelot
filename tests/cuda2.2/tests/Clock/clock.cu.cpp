# 1 "/tmp/tmpxft_000057bd_00000000-1_clock.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_000057bd_00000000-1_clock.cudafe1.cpp"
...
# 42 "tests/Clock/clock_kernel.cu"
static void timedReduction(const float *input, float *output, clock_t *timer) ;
# 69 "tests/Clock/clock.cu"
int main(int argc, char **argv)
# 71 "tests/Clock/clock.cu"
{
# 74 "tests/Clock/clock.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 75 "tests/Clock/clock.cu"
cutilDeviceInit(argc, argv); } else {
# 77 "tests/Clock/clock.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 80 "tests/Clock/clock.cu"
float *dinput = (__null);
# 81 "tests/Clock/clock.cu"
float *doutput = (__null);
# 82 "tests/Clock/clock.cu"
clock_t *dtimer = (__null);
# 84 "tests/Clock/clock.cu"
clock_t timer[64 * 2];
# 85 "tests/Clock/clock.cu"
float input[256 * 2];
# 87 "tests/Clock/clock.cu"
for (int i = 0; i < (256 * 2); i++)
# 88 "tests/Clock/clock.cu"
{
# 89 "tests/Clock/clock.cu"
((input)[i]) = ((float)i);
# 90 "tests/Clock/clock.cu"
}
# 92 "tests/Clock/clock.cu"
__cudaSafeCall(cudaMalloc((void **)(&dinput), (sizeof(float) * (256)) * (2)), "tests/Clock/clock.cu", 92);
# 93 "tests/Clock/clock.cu"
__cudaSafeCall(cudaMalloc((void **)(&doutput), sizeof(float) * (64)), "tests/Clock/clock.cu", 93);
# 94 "tests/Clock/clock.cu"
__cudaSafeCall(cudaMalloc((void **)(&dtimer), (sizeof(clock_t) * (64)) * (2)), "tests/Clock/clock.cu", 94);
# 96 "tests/Clock/clock.cu"
__cudaSafeCall(cudaMemcpy(dinput, input, (sizeof(float) * (256)) * (2), cudaMemcpyHostToDevice), "tests/Clock/clock.cu", 96);
# 98 "tests/Clock/clock.cu"
cudaConfigureCall(64, 256, (sizeof(float) * (2)) * (256)) ? ((void)0) : timedReduction(dinput, doutput, dtimer);
# 101 "tests/Clock/clock.cu"
__cudaSafeCall(cudaMemcpy(timer, dtimer, (sizeof(clock_t) * (64)) * (2), cudaMemcpyDeviceToHost), "tests/Clock/clock.cu", 101);
# 103 "tests/Clock/clock.cu"
__cudaSafeCall(cudaFree(dinput), "tests/Clock/clock.cu", 103);
# 104 "tests/Clock/clock.cu"
__cudaSafeCall(cudaFree(doutput), "tests/Clock/clock.cu", 104);
# 105 "tests/Clock/clock.cu"
__cudaSafeCall(cudaFree(dtimer), "tests/Clock/clock.cu", 105);
# 108 "tests/Clock/clock.cu"
printf("Test PASSED\n");
# 111 "tests/Clock/clock.cu"
clock_t minStart = ((timer)[0]);
# 112 "tests/Clock/clock.cu"
clock_t maxEnd = ((timer)[64]);
# 114 "tests/Clock/clock.cu"
for (int i = 1; i < 64; i++)
# 115 "tests/Clock/clock.cu"
{
# 116 "tests/Clock/clock.cu"
minStart = ((((timer)[i]) < minStart) ? ((timer)[i]) : minStart);
# 117 "tests/Clock/clock.cu"
maxEnd = ((((timer)[64 + i]) > maxEnd) ? ((timer)[64 + i]) : maxEnd);
# 118 "tests/Clock/clock.cu"
}
# 120 "tests/Clock/clock.cu"
printf("time = %d\n", maxEnd - minStart);
# 122 "tests/Clock/clock.cu"
cudaThreadExit();
# 124 "tests/Clock/clock.cu"
__cutilExit(argc, argv); return 0;
# 125 "tests/Clock/clock.cu"
}
# 1 "tmpxft_000057bd_00000000-1_clock.cudafe1.stub.c"
# 1 "tmpxft_000057bd_00000000-1_clock.cudafe1.stub.c"
# 1 "/tmp/tmpxft_000057bd_00000000-1_clock.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_000057bd_00000000-1_clock.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_000057bd_00000000-3_clock.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000001261,0x0000005001000002,0x0000000000000754\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000001400000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x6c432f7374736574,0x636f6c632f6b636f,0x0000000075632e6b\n"
".quad 0x33010102464c457f,0x0000000000000004,0x0000000100be0002,0x0000000000000000\n"
".quad 0x00000000000006e4,0x0000000000000040,0x0038004000140514,0x0001000800400002\n"
...
".quad 0x0000000000000238,0x0a00000600000003,0x0000000000000004,0x0000000000000000\n"
".quad 0x0000000100000082,0x0000000000000002,0x0000000000000000,0x0000000000000645\n"
...
".quad 0x0000000100000079,0x0000000000000002,0x0000000000000000,0x00000000000006c9\n"
...
".quad 0x0002380000000000,0x0000000000000000,0x0000000006000300,0x0000000000000000\n"
...
".quad 0x0002380000000000,0x005de40000000000,0x001c042800440400,0x0000072c00000084\n"
".quad 0x03dc236000000180,0x01dc231a8e0000fc,0x0005f4190e0000fc,0x009c044000000000\n"
".quad 0x219e032c00000140,0x009c046000c00004,0x00dde42c00000094,0x61dc2328004000c0\n"
".quad 0x211ca37000c0047c,0x209ce32007c00020,0x215c435000c00020,0x419cb548004000d0\n"
".quad 0x00dc049400000000,0x309e032c00000084,0x315c036000c00008,0x30dce34800400020\n"
".quad 0x211c035000c00010,0x519e034801400080,0x51dc436000c00008,0x315c435000c00010\n"
".quad 0x621c034800400090,0x00dde44801400080,0x415c852800400020,0x725c438400000000\n"
".quad 0x33dc234800400090,0x811c85188ec00004,0x215c858400000000,0x611c85c900000000\n"
".quad 0x0005e7c900000000,0x1fdc034000000240,0x000007207e0000fc,0xffdc046000000140\n"
".quad 0x03dc2350ee0000ff,0x0005f41b0e00000c,0x311c034000000000,0x415e034800000000\n"
".quad 0x211c856000c00008,0x515c85c100000000,0x53dc00c100000000,0x216485270e000010\n"
".quad 0x001df4c900000000,0x311c034000000000,0x33dc235800c0007c,0x311c031a0ec00004\n"
".quad 0x411c234800000010,0x00dde45800c00004,0x0005e72800000010,0x0000044003fffdc0\n"
".quad 0x0081e42c00000094,0x1fdc0328004000a0,0x0100a3207e0000fc,0x0080e32005c00010\n"
".quad 0xf000855000c00010,0x214043c100000003,0x40008548004000b0,0xffdc049400000000\n"
".quad 0x0021e750ee0000ff,0x001c048000000000,0x011e032c00000140,0x001c046000c00004\n"
".quad 0x009de42c00000094,0x415c2328004000c0,0x001c037000c0047c,0x009c034800400050\n"
".quad 0x001c432005c00020,0x00dc435000c00020,0x211ca548004000d0,0x001de79400000000\n"
...
".quad 0x1800200000000900,0x0c17040018190300,0x1000020000000000,0x0c17040021f00000\n"
...
".quad 0x0000000600000000,0x000006e400000005,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000007000000000,0x0000007000000000,0x0000000400000000,0x6000000000000000\n"
".quad 0x0000040d00000a05,0x0000000000000000,0x0000000000000000,0x000002bc00000000\n"
".quad 0x000002bc00000000,0x0000000400000000,0x0100000100000000,0x00000a6500000058\n"
".quad 0x0000000000000000,0x0003000000000038,0x0000004000000014,0x0000001500000014\n"
".quad 0x0000000000000000,0x0000000000000000,0x7473657400000000,0x2f6b636f6c432f73\n"
".quad 0x75632e6b636f6c63,0x0a0a0a0a00000000,0x69737265762e0a0a,0x2e0a302e33206e6f\n"
".quad 0x7320746567726174,0x64612e0a30325f6d,0x69735f7373657264,0x2e0a0a343620657a\n"
".quad 0x22203109656c6966,0x706d742f706d742f,0x303030305f746678,0x3030305f64623735\n"
".quad 0x5f372d3030303030,0x70632e6b636f6c63,0x662e0a22692e3370,0x7422203209656c69\n"
".quad 0x6f6c432f73747365,0x6b636f6c632f6b63,0x2e6c656e72656b5f,0x6c69662e0a227563\n"
".quad 0x73752f2220330965,0x2f6c61636f6c2f72,0x2f312e3461647563,0x76766e2f61647563\n"
".quad 0x636e695f69632f6d,0x0a22682e6564756c,0x206e72657478652e,0x206465726168732e\n"
".quad 0x34206e67696c612e,0x6168732038622e20,0x0a0a3b5d5b646572,0x5f207972746e652e\n"
".quad 0x64656d697434315a,0x6f69746375646552,0x6c506650664b506e,0x6d617261702e0a28\n"
".quad 0x5a5f203436752e20,0x5264656d69743431,0x6e6f697463756465,0x5f6c506650664b50\n"
".quad 0x2c305f6d61726170,0x206d617261702e0a,0x315a5f203436752e,0x655264656d697434\n"
".quad 0x506e6f6974637564,0x705f6c506650664b,0x0a2c315f6d617261,0x2e206d617261702e\n"
".quad 0x34315a5f20343675,0x64655264656d6974,0x4b506e6f69746375,0x61705f6c50665066\n"
".quad 0x0a290a325f6d6172,0x2e206765722e0a7b,0x363c662520323366,0x206765722e0a3b3e\n"
".quad 0x702520646572702e,0x65722e0a3b3e373c,0x25203233732e2067,0x2e0a3b3e30333c72\n"
".quad 0x3436732e20676572,0x3e35323c6c722520,0x702e646c0a0a0a3b,0x3436752e6d617261\n"
".quad 0x5b202c356c722520,0x656d697434315a5f,0x6974637564655264,0x506650664b506e6f\n"
".quad 0x5f6d617261705f6c,0x702e646c0a3b5d30,0x3436752e6d617261,0x5b202c366c722520\n"
".quad 0x656d697434315a5f,0x6974637564655264,0x506650664b506e6f,0x5f6d617261705f6c\n"
".quad 0x702e646c0a3b5d31,0x3436752e6d617261,0x5b202c376c722520,0x656d697434315a5f\n"
".quad 0x6974637564655264,0x506650664b506e6f,0x5f6d617261705f6c,0x617476630a3b5d32\n"
".quad 0x626f6c672e6f742e,0x25203436752e6c61,0x6c7225202c316c72,0x2e617476630a3b37\n"
".quad 0x61626f6c672e6f74,0x7225203436752e6c,0x366c7225202c326c,0x742e617476630a3b\n"
".quad 0x6c61626f6c672e6f,0x6c7225203436752e,0x3b356c7225202c33,0x203220636f6c2e0a\n"
".quad 0x766f6d0a31203734,0x327225203233752e,0x782e64697425202c,0x3220636f6c2e0a3b\n"
".quad 0x65730a3120303520,0x33732e71652e7074,0x25202c3170252032,0x730a3b30202c3272\n"
".quad 0x732e656e2e707465,0x202c327025203233,0x0a3b30202c327225,0x6172622032702540\n"
".quad 0x0a3b325f30424220,0x752e766f6d090a0a,0x202c367225203233,0x0a3b6b636f6c6325\n"
".quad 0x3220636f6c2e090a,0x76630a3120303520,0x33732e3436732e74,0x202c386c72252032\n"
".quad 0x6f6c2e0a3b367225,0x3120383420322063,0x3233752e766f6d0a,0x25202c3632722520\n"
".quad 0x3b782e6469617463,0x203220636f6c2e0a,0x6c756d0a31203035,0x33732e656469772e\n"
".quad 0x202c396c72252032,0x3b38202c36327225,0x3436732e6464610a,0x202c30316c722520\n"
".quad 0x7225202c316c7225,0x672e74730a3b396c,0x36752e6c61626f6c,0x30316c72255b2034\n"
".quad 0x3b386c7225202c5d,0x3a325f3042420a0a,0x203220636f6c2e0a,0x766f6d0a31203734\n"
".quad 0x327225203233752e,0x2e64697425202c38,0x20636f6c2e0a3b78,0x6d0a312033352032\n"
".quad 0x2e656469772e6c75,0x316c722520323373,0x2c38327225202c31,0x2e6464610a3b3420\n"
".quad 0x316c722520343673,0x2c336c7225202c32,0x0a3b31316c722520,0x203436752e766f6d\n"
".quad 0x73202c33316c7225,0x610a3b6465726168,0x25203436732e6464,0x6c7225202c346c72\n"
".quad 0x316c7225202c3331,0x20636f6c2e0a3b31,0x6c0a312033352032,0x6c61626f6c672e64\n"
".quad 0x326625203233662e,0x32316c72255b202c,0x68732e74730a3b5d,0x3233662e64657261\n"
".quad 0x2c5d346c72255b20,0x6c2e0a3b32662520,0x203435203220636f,0x33752e766f6d0a31\n"
".quad 0x202c393272252032,0x3b782e6469746e25,0x3233732e6464610a,0x25202c3031722520\n"
".quad 0x327225202c393272,0x772e6c756d0a3b38,0x203233752e656469,0x25202c34316c7225\n"
".quad 0x0a3b34202c303172,0x203436732e646461,0x25202c35316c7225,0x6c7225202c336c72\n"
".quad 0x2e6464610a3b3431,0x316c722520343673,0x33316c7225202c36,0x3b34316c7225202c\n"
".quad 0x203220636f6c2e0a,0x2e646c0a31203435,0x662e6c61626f6c67,0x202c336625203233\n"
".quad 0x3b5d35316c72255b,0x726168732e74730a,0x5b203233662e6465,0x202c5d36316c7225\n"
".quad 0x6f6c2e0a3b336625,0x3120373520322063,0x746c2e707465730a,0x337025203233732e\n"
".quad 0x202c39327225202c,0x20337025400a3b31,0x5f30424220617262,0x5f3042420a0a3b37\n"
".quad 0x752e766f6d0a3a33,0x202c347225203233,0x6c2e0a3b39327225,0x203935203220636f\n"
".quad 0x79732e7261620a31,0x6c2e0a3b3020636e,0x203136203220636f,0x672e707465730a31\n"
".quad 0x7025203233732e65,0x202c327225202c34,0x7025400a3b347225,0x4242206172622034\n"
".quad 0x6c2e0a0a3b365f30,0x203436203220636f,0x33732e6464610a31,0x202c333172252032\n"
".quad 0x327225202c347225,0x69772e6c756d0a3b,0x25203233732e6564,0x7225202c37316c72\n"
".quad 0x610a3b34202c3331,0x25203436732e6464,0x7225202c39316c72,0x6c7225202c33316c\n"
".quad 0x636f6c2e0a3b3731,0x0a31203436203220,0x65726168732e646c,0x6625203233662e64\n"
".quad 0x316c72255b202c31,0x636f6c2e0a3b5d39,0x0a31203336203220,0x65726168732e646c\n"
".quad 0x6625203233662e64,0x346c72255b202c34,0x20636f6c2e0a3b5d,0x730a312036362032\n"
".quad 0x2e7565672e707465,0x2c35702520323366,0x6625202c31662520,0x20357025400a3b34\n"
".quad 0x5f30424220617262,0x636f6c2e0a0a3b36,0x0a31203736203220,0x65726168732e7473\n"
".quad 0x255b203233662e64,0x6625202c5d346c72,0x5f3042420a0a3b31,0x20636f6c2e0a3a36\n"
".quad 0x0a37312037352032,0x203233752e726873,0x7225202c37317225,0x610a3b3133202c34\n"
".quad 0x25203233732e6464,0x347225202c383172,0x0a3b37317225202c,0x203233732e726873\n"
".quad 0x317225202c357225,0x65730a3b31202c38,0x33732e74672e7074,0x25202c3670252032\n"
".quad 0x6d0a3b31202c3472,0x25203233752e766f,0x357225202c393272,0x3220636f6c2e0a3b\n"
".quad 0x25400a3120373520,0x4220617262203670,0x420a0a3b335f3042,0x6c2e0a3a375f3042\n"
".quad 0x203337203220636f,0x2031702521400a31,0x5f30424220617262,0x636f6c2e0a0a3b39\n"
".quad 0x0a31203337203220,0x65726168732e646c,0x6625203233662e64,0x726168735b202c35\n"
".quad 0x6f6c2e0a3b5d6465,0x3120383420322063,0x3233752e766f6d0a,0x25202c3532722520\n"
".quad 0x3b782e6469617463,0x203220636f6c2e0a,0x6c756d0a31203337,0x33732e656469772e\n"
".quad 0x2c30326c72252032,0x34202c3532722520,0x36732e6464610a3b,0x2c31326c72252034\n"
".quad 0x25202c326c722520,0x74730a3b30326c72,0x2e6c61626f6c672e,0x6c72255b20323366\n"
".quad 0x356625202c5d3132,0x395f3042420a0a3b,0x3220636f6c2e0a3a,0x61620a3120353720\n"
".quad 0x3020636e79732e72,0x3220636f6c2e0a3b,0x25400a3120373720,0x4220617262203170\n"
".quad 0x0a0a3b31315f3042,0x37203220636f6c2e,0x3b7465720a322038,0x31315f3042420a0a\n"
".quad 0x2e766f6d090a0a3a,0x3032722520323375,0x6b636f6c6325202c,0x636f6c2e090a0a3b\n"
".quad 0x0a31203737203220,0x2e3436732e747663,0x326c722520323373,0x3b30327225202c32\n"
".quad 0x3233752e766f6d0a,0x25202c3132722520,0x782e64696174636e,0x3220636f6c2e0a3b\n"
".quad 0x6f6d0a3120383420,0x7225203233752e76,0x61746325202c3432,0x6c2e0a3b782e6469\n"
".quad 0x203737203220636f,0x33732e6464610a31,0x202c323272252032,0x7225202c31327225\n"
".quad 0x2e6c756d0a3b3432,0x3233752e65646977,0x202c33326c722520,0x3b38202c32327225\n"
".quad 0x3436732e6464610a,0x202c34326c722520,0x7225202c316c7225,0x2e74730a3b33326c\n"
".quad 0x752e6c61626f6c67,0x326c72255b203436,0x326c7225202c5d34,0x20636f6c2e0a3b32\n"
".quad 0x720a322038372032,0x0a0a0a7d0a3b7465,0x0000000000000000\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[591];
...
# 3 "/tmp/tmpxft_000057bd_00000000-1_clock.cudafe1.stub.c" 2 3
static void __device_stub__Z14timedReductionPKfPfPl(const float *, float *, clock_t *);
static void __sti____cudaRegisterAll_40_tmpxft_000057bd_00000000_4_clock_cpp1_ii_main(void) __attribute__((__constructor__));
