# 1 "/tmp/tmpxft_0000548d_00000000-1_convolutionFFT2D.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_0000548d_00000000-1_convolutionFFT2D.cudafe1.cpp"
...
# 53 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
...
# 45 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
static texture< float2, 2, cudaReadModeElementType> texKernel;
# 47 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
void padKernel(Complex *
# 48 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
d_PaddedKernel, int
# 49 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
fftW, int
# 50 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
fftH, int
# 51 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
kernelW, int
# 52 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
kernelH, int
# 53 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
kernelX, int
# 54 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
kernelY) ;
# 71 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
static texture< float2, 2, cudaReadModeElementType> texData;
# 73 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
void padData(Complex *
# 74 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
d_PaddedData, int
# 75 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
fftW, int
# 76 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
fftH, int
# 77 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
dataW, int
# 78 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
dataH, int
# 79 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
kernelW, int
# 80 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
kernelH, int
# 81 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
kernelX, int
# 82 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
kernelY) ;
# 110 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
__attribute__((unused)) void complexMulAndScale(Complex &a, Complex b, float c) {int volatile ___ = 1;(void)a;(void)b;(void)c;
# 113 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
exit(___);}
# 115 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
void modulateAndNormalize(Complex *
# 116 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
d_PaddedData, Complex *
# 117 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
d_PaddedKernel, int
# 118 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
dataN) ;
...
# 108 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
dataSize = iAlignUp(dataSize, 16);
# 111 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
for (hiBit = 31; hiBit >= 0; hiBit--) {
# 112 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
if (dataSize & (1U << hiBit)) { break; } }
# 115 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
lowPOT = (1U << hiBit);
# 116 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
...
if (hiPOT <= (1024)) {
# 123 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
return hiPOT; } else {
...
# 135 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
...
# 140 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
static const int PADDING_H = (KERNEL_H - 1);
# 144 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
...
# 166 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
Complex *h_Kernel,
...
*h_ResultGPU;
# 172 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
cudaArray *a_Kernel,
# 173 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
*a_Data;
# 175 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
cudaChannelFormatDesc float2tex = cudaCreateChannelDesc< float2> ();
# 179 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
Complex *d_PaddedKernel,
# 180 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
*d_PaddedData;
# 182 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
cufftHandle FFTplan;
# 185 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
Complex rCPU, rGPU;
# 188 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
double max_delta_ref, delta, ref, sum_delta2, sum_ref2, L2norm;
# 190 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
int i, x, y;
...
# 200 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 202 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cutilCheckError(cutCreateTimer(&hTimer), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 202);
...
# 214 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMallocArray(&a_Kernel, &float2tex, KERNEL_W, KERNEL_H), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 214);
# 215 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMallocArray(&a_Data, &float2tex, DATA_W, DATA_H), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 215);
# 216 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_PaddedKernel), FFT_SIZE), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 216);
# 217 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_PaddedData), FFT_SIZE), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 217);
# 219 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Generating random input data...\n");
# 220 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
srand(2007);
...
# 223 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
((h_Kernel[i]).y) = (0);
# 224 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
}
# 225 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
for (i = 0; i < (DATA_W * DATA_H); i++) {
# 226 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
((h_Data[i]).x) = (((float)rand()) / ((float)2147483647));
# 227 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
((h_Data[i]).y) = (0);
# 228 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
}
# 230 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Creating FFT plan for %i x %i...\n", FFT_W, FFT_H);
# 231 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cufftSafeCall(cufftPlan2d(&FFTplan, FFT_H, FFT_W, CUFFT_C2C), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 231);
# 233 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Uploading to GPU and padding convolution kernel and input data...\n");
# 234 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("...initializing padded kernel and data storage with zeroes...\n");
# 235 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMemset(d_PaddedKernel, 0, FFT_SIZE), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 235);
# 236 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMemset(d_PaddedData, 0, FFT_SIZE), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 236);
# 237 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("...copying input data and convolution kernel from host to CUDA arrays\n");
# 238 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMemcpyToArray(a_Kernel, 0, 0, h_Kernel, KERNEL_SIZE, cudaMemcpyHostToDevice), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 238);
# 239 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMemcpyToArray(a_Data, 0, 0, h_Data, DATA_SIZE, cudaMemcpyHostToDevice), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 239);
# 240 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("...binding CUDA arrays to texture references\n");
# 241 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaBindTextureToArray(texKernel, a_Kernel), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 241);
# 242 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaBindTextureToArray(texData, a_Data), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 242);
# 246 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
dim3 threadBlock(16, 12);
# 247 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
dim3 kernelBlockGrid(iDivUp(KERNEL_W, threadBlock.x), iDivUp(KERNEL_H, threadBlock.y));
# 248 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
dim3 dataBlockGrid(iDivUp(FFT_W, threadBlock.x), iDivUp(FFT_H, threadBlock.y));
# 250 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("...padding convolution kernel\n");
# 251 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
...
# 260 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cutilCheckMsg("padKernel() execution failed\n", "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 260);
# 262 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("...padding input data array\n");
# 263 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
...
# 274 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cutilCheckMsg("padData() execution failed\n", "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 274);
# 278 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Transforming convolution kernel...\n");
# 279 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cufftSafeCall(cufftExecC2C(FFTplan, (cufftComplex *)d_PaddedKernel, (cufftComplex *)d_PaddedKernel, -1), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 279);
# 281 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Running GPU FFT convolution...\n");
# 282 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 282);
# 283 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cutilCheckError(cutResetTimer(hTimer), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 283);
# 284 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cutilCheckError(cutStartTimer(hTimer), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 284);
# 285 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cufftSafeCall(cufftExecC2C(FFTplan, (cufftComplex *)d_PaddedData, (cufftComplex *)d_PaddedData, -1), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 285);
# 286 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
cudaConfigureCall(16, 128) ? ((void)0) : modulateAndNormalize(d_PaddedData, d_PaddedKernel, FFT_W * FFT_H);
# 291 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cutilCheckMsg("modulateAndNormalize() execution failed\n", "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 291);
# 292 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cufftSafeCall(cufftExecC2C(FFTplan, (cufftComplex *)d_PaddedData, (cufftComplex *)d_PaddedData, 1), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 292);
# 293 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 293);
# 294 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cutilCheckError(cutStopTimer(hTimer), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 294);
# 295 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
double gpuTime = (cutGetTimerValue(hTimer));
# 296 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("GPU time: %f msecs. //%f MPix/s\n", gpuTime, ((DATA_W * DATA_H) * (9.999999999999999547e-07)) / (gpuTime * (0.001000000000000000021)));
# 298 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Reading back GPU FFT results...\n");
# 299 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaMemcpy(h_ResultGPU, d_PaddedData, FFT_SIZE, cudaMemcpyDeviceToHost), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 299);
# 302 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Checking GPU results...\n");
# 303 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("...running reference CPU convolution\n");
# 304 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
convolutionCPU(h_ResultCPU, h_Data, h_Kernel, DATA_W, DATA_H, KERNEL_W, KERNEL_H, KERNEL_X, KERNEL_Y);
# 316 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("...comparing the results\n");
# 317 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
sum_delta2 = (0);
# 318 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
sum_ref2 = (0);
# 319 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
max_delta_ref = (0);
# 320 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
for (y = 0; y < DATA_H; y++) {
# 321 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
for (x = 0; x < DATA_W; x++) {
# 322 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
rCPU = (h_ResultCPU[(y * DATA_W) + x]);
# 323 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
rGPU = (h_ResultGPU[(y * FFT_W) + x]);
# 324 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
delta = ((((rCPU.x) - (rGPU.x)) * ((rCPU.x) - (rGPU.x))) + (((rCPU.y) - (rGPU.y)) * ((rCPU.y) - (rGPU.y))));
# 325 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
ref = (((rCPU.x) * (rCPU.x)) + ((rCPU.y) * (rCPU.y)));
# 326 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
if ((delta / ref) > max_delta_ref) { max_delta_ref = (delta / ref); }
# 327 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
sum_delta2 += delta;
# 328 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
sum_ref2 += ref;
# 329 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
} }
# 330 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
L2norm = sqrt(sum_delta2 / sum_ref2);
# 331 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Max delta / CPU value %E\n", sqrt(max_delta_ref));
# 332 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("L2 norm: %E\n", L2norm);
# 333 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf((L2norm < (9.999999999999999547e-07)) ? ("TEST PASSED\n") : ("TEST FAILED\n"));
# 336 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
printf("Shutting down...\n");
# 337 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaUnbindTexture(texData), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 337);
# 338 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaUnbindTexture(texKernel), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 338);
# 339 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cufftSafeCall(cufftDestroy(FFTplan), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 339);
# 340 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaFree(d_PaddedData), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 340);
# 341 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaFree(d_PaddedKernel), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 341);
# 342 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaFreeArray(a_Data), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 342);
# 343 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cudaSafeCall(cudaFreeArray(a_Kernel), "tests/ConvolutionFFT2D/convolutionFFT2D.cu", 343);
# 344 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
free(h_ResultGPU);
# 345 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
free(h_ResultCPU);
# 346 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
free(h_Data);
# 347 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
free(h_Kernel);
# 349 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
cudaThreadExit();
# 351 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
__cutilExit(argc, argv); return 0;
# 352 "tests/ConvolutionFFT2D/convolutionFFT2D.cu"
}
# 1 "tmpxft_0000548d_00000000-1_convolutionFFT2D.cudafe1.stub.c"
# 1 "tmpxft_0000548d_00000000-1_convolutionFFT2D.cudafe1.stub.c"
# 1 "/tmp/tmpxft_0000548d_00000000-1_convolutionFFT2D.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_0000548d_00000000-1_convolutionFFT2D.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_0000548d_00000000-3_convolutionFFT2D.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
...
".quad 0x672e766e2e007469,0x742e006c61626f6c,0x70375a5f2e747865,0x3650617461446461\n"
".quad 0x69693274616f6c66,0x2e00696969696969,0x2e6f666e692e766e,0x6144646170375a5f\n"
".quad 0x616f6c6636506174,0x6969696969693274,0x692e766e2e006969,0x7865742e006f666e\n"
".quad 0x6f6d30325a5f2e74,0x6e416574616c7564,0x696c616d726f4e64,0x616f6c663650657a\n"
".quad 0x2e00695f30533274,0x2e6f666e692e766e,0x75646f6d30325a5f,0x4e646e416574616c\n"
".quad 0x657a696c616d726f,0x3274616f6c663650,0x65742e00695f3053,0x6170395a5f2e7478\n"
".quad 0x506c656e72654b64,0x693274616f6c6636,0x6e2e006969696969,0x5f2e6f666e692e76\n"
".quad 0x72654b646170395a,0x6f6c6636506c656e,0x6969696969327461,0x6f632e766e2e0069\n"
".quad 0x2e30746e6174736e,0x654b646170395a5f,0x6c6636506c656e72,0x696969693274616f\n"
".quad 0x632e766e2e006969,0x30746e6174736e6f,0x44646170375a5f2e,0x6f6c663650617461\n"
".quad 0x6969696969327461,0x2e766e2e00696969,0x746e6174736e6f63,0x6d30325a5f2e3631\n"
".quad 0x416574616c75646f,0x6c616d726f4e646e,0x6f6c663650657a69,0x00695f3053327461\n"
".quad 0x736e6f632e766e2e,0x5a5f2e30746e6174,0x616c75646f6d3032,0x726f4e646e416574\n"
".quad 0x3650657a696c616d,0x30533274616f6c66,0x70375a5f0000695f,0x3650617461446461\n"
".quad 0x69693274616f6c66,0x5f00696969696969,0x6c75646f6d30325a,0x6f4e646e41657461\n"
".quad 0x50657a696c616d72,0x533274616f6c6636,0x75635f5f00695f30,0x5f30326d735f6164\n"
".quad 0x665f6e725f706372,0x6475635f5f003233,0x725f30326d735f61,0x33665f6e725f7063\n"
".quad 0x6170776f6c735f32,0x6170395a5f006874,0x506c656e72654b64,0x693274616f6c6636\n"
".quad 0x6574006969696969,0x006c656e72654b78,0x0061746144786574,0x0000000000000000\n"
...
".quad 0x0000000000000000,0x000b000300000000,0x0000000000000000,0x0000000000000170\n"
".quad 0x000d000300000000,0x0000000000000000,0x0000000000000000,0x000e000300000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0007000300000000,0x0000000000000000\n"
".quad 0x00000000000002e8,0x000a000300000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0004000300000000,0x0000000000000000,0x0000000000000138,0x0006000300000000\n"
...
".quad 0x0000000000000000,0x0000000000000000,0x000b101200000001,0x0000000000000000\n"
".quad 0x0000000000000170,0x000710120000001c,0x0000000000000000,0x0000000000000110\n"
".quad 0x0007001200000041,0x0000000000000110,0x0000000000000050,0x0007001200000058\n"
".quad 0x0000000000000160,0x0000000000000188,0x0004101200000078,0x0000000000000000\n"
".quad 0x0000000000000138,0x0000001a00000093,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000001a0000009d,0x0000000000000000,0x0000000000000000,0x2800440400005de4\n"
".quad 0x2c0000009800dc04,0x2800400030015de4,0x2c00000094009c04,0x280040002001dde4\n"
".quad 0x2c00000088011c04,0x7000c06000319c23,0x7000c06000515c23,0x7000c0600020dc23\n"
".quad 0x2c00000084001c04,0x7000c06000709c23,0x2008000018511ca3,0x200000000c201ca3\n"
".quad 0x188e4000d041dc23,0x18804000c001dc23,0x40000002c000a1e7,0x1800000001208204\n"
".quad 0x180000001120c204,0x5000cfc000208000,0x5000cfc00030c000,0x8010c000fc208086\n"
".quad 0x48004000f0414103,0x48004000e0000103,0x28004000a001c1e4,0x5800c0007c518023\n"
".quad 0x5800c0007c010023,0x68004000b0618003,0x68004000a0410003,0x4800000014614003\n"
".quad 0x4800000000400003,0x7000c06000718023,0x7000c06000510023,0x28004000800141e4\n"
".quad 0x20000000184000a3,0x200bc000200100a3,0x5000c000200000e3,0x4800400090014043\n"
".quad 0x94000000004080a5,0x8000000000001de7,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000001600080204,0x00080a0400000000\n"
".quad 0x002000200000000d,0x000c170400201903,0x001c000600000000,0x000c17040011f000\n"
".quad 0x0018000500000000,0x000c17040011f000,0x0014000400000000,0x000c17040011f000\n"
".quad 0x0010000300000000,0x000c17040011f000,0x000c000200000000,0x000c17040011f000\n"
".quad 0x0008000100000000,0x000c17040011f000,0x0000000000000000,0x00080d040021f000\n"
".quad 0x000000010001000c,0x2800440400005de4,0x2c00000094009c04,0x2800400020015de4\n"
".quad 0x2800400050011de4,0x7000c0600020dc23,0x7000c06000509c23,0x2c00000084001c04\n"
".quad 0x7000c06000415c23,0x18004000c1211e04,0x200000000c201ca3,0x5000000014215ca3\n"
".quad 0x50000002c0010007,0x1b0e4000c001dc23,0x80000000000001e7,0x1800000020031de2\n"
".quad 0x5000c00020009ce3,0x20198000a0021ca3,0x48004000b0225c43,0x2019800080019ca3\n"
".quad 0x4800000014001c03,0x480040009021dc43,0x8400000000809ca5,0x188e4000c001dc23\n"
".quad 0x8400000000629c85,0x840000001062dc85,0x5800000008a21c00,0x580000000ca29c00\n"
".quad 0x301000000cb21e00,0x3014000008b09c00,0x5800000020421c00,0x5800000008425c00\n"
".quad 0x9400000000621ca5,0x4003fffdc00001e7,0x8000000000001de7,0x0806000000409c02\n"
".quad 0x39fe000000209c02,0x1a0e40000421dc03,0x40000000400001e7,0x50000000a0010007\n"
".quad 0x4000000060001de7,0xc800000010409c00,0x300480001440dc00,0x300400000c211e00\n"
".quad 0x9000000000001de7,0x6000c00004409c03,0x5800c0006020dc03,0x1a8e0000fc31dc03\n"
".quad 0x40000001600001e7,0x6000c00004409c03,0x1a8e0000fc21dc23,0x40000000400001e7\n"
".quad 0xc800000010411c00,0x40000004e0001de7,0x307ed7e000409c00,0xc80000001020dc00\n"
".quad 0x3006800014209c00,0x3006000008309e00,0x307ed7e000211c00,0x4000000420001de7\n"
".quad 0x4800fffc0c31dc03,0x1a0ec0000471dc03,0x40000003a00001e7,0x3801fffffc409c02\n"
".quad 0x180000000c021de2,0x3a00000000411c02,0x38fe000000219c42,0x600000001c821c03\n"
".quad 0xc800000010625c00,0x3012800014629c00,0x309200002892de00,0x3112000028929e00\n"
".quad 0x3801fffffcb19c02,0x2e8e000028b1dc00,0x3802000000619c42,0x2010c00007f25c04\n"
".quad 0x6800000018821c03,0x580000001c821c03,0x680000001871dc03,0x6800c00008829c03\n"
".quad 0x680000001c91dc43,0x4800fffc10325c03,0x1a8e0000fca1dc03,0x6800c0000480dc03\n"
".quad 0x5800000024619c03,0x1aa00000fc71dc03,0x1a800000fc31dc23,0x4800c00004618003\n"
".quad 0x6000c0000460dc03,0x3104000018309c03,0x6800000010211c43,0x4000000020001de7\n"
".quad 0xc800000010411c00,0x9000000000001de7,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x01ffffff00000000,0x00080a04bf800000,0x0014002000000010,0x000c170400141903\n"
".quad 0x0010000200000000,0x000c17040011f000,0x0008000100000000,0x000c17040021f000\n"
".quad 0x0000000000000000,0x00080d040021f000,0x0000002000200180,0x2800440400005de4\n"
".quad 0x2c00000098015c04,0x280040003001dde4,0x2c00000094011c04,0x7000c06000519c23\n"
".quad 0x280040002000dde4,0x2c00000088001c04,0x7000c06000715c23,0x2c00000084009c04\n"
".quad 0x7000c06000411c23,0x7000c0600030dc23,0x2000000018501ca3,0x2004000010309ca3\n"
".quad 0x188e4000b001dc23,0x280040010000dde4,0x2800400110011de4,0x18804000a021dc23\n"
".quad 0x48004000c030dc03,0x48004000d0411c03,0x400000032000a1e7,0x188e00001005c023\n"
".quad 0x1bfffffffc0101e2,0x188e00000c29c023,0x1b044000d007c023,0x48004000c040c003\n"
".quad 0x1b084000c023c023,0x48004000d0410003,0x200200000830c004,0x2006000000410004\n"
".quad 0x180000000d20c204,0x1800000011210204,0x20080000fc30c004,0x20040000fc410004\n"
".quad 0x5000cfc000318000,0x5000cfc00041c000,0x8010c000fc610086,0x28004000a000c1e4\n"
".quad 0x7000c06000000023,0x28004000800181e4,0x7000c0600030c023,0x200400000c0080a3\n"
".quad 0x200dc000202180a3,0x5000c000202000e3,0x480040009001c043,0x94000000006100a5\n"
...
".quad 0x002800200000000e,0x000c170400281903,0x0024000800000000,0x000c17040011f000\n"
".quad 0x0020000700000000,0x000c17040011f000,0x001c000600000000,0x000c17040011f000\n"
".quad 0x0018000500000000,0x000c17040011f000,0x0014000400000000,0x000c17040011f000\n"
".quad 0x0010000300000000,0x000c17040011f000,0x000c000200000000,0x000c17040011f000\n"
".quad 0x0008000100000000,0x000c17040011f000,0x0000000000000000,0x00080d040021f000\n"
".quad 0x000000010001000c,0x0000001700100704,0xffffffffffffffff,0x00100704ffffffff\n"
".quad 0xffffffff00000016,0xffffffffffffffff,0x0000001500081204,0x0008110400000000\n"
".quad 0x0000000000000015,0x0000001400081204,0x0008110400000000,0x0000000000000014\n"
".quad 0x0000001300081204,0x0008110400000000,0x0000000000000013,0x0000001200081204\n"
".quad 0x3233732e6f6c2e34,0x7225202c33722520,0x3b30317225202c37,0x203220636f6c2e0a\n"
".quad 0x76630a3120323231,0x3233662e6e722e74,0x326625203233732e,0x720a3b317225202c\n"
".quad 0x33662e6e722e7063,0x25202c3166252032,0x636f6c2e0a3b3266,0x3120343231203220\n"
".quad 0x65672e707465730a,0x317025203233732e,0x202c36317225202c,0x7025400a3b317225\n"
".quad 0x4242206172622031,0x42420a0a3b325f33,0x6f6c2e0a3a315f33,0x2035323120322063\n"
".quad 0x69772e6c756d0a31,0x25203233732e6564,0x317225202c356c72,0x64610a3b38202c36\n"
".quad 0x7225203436732e64,0x326c7225202c366c,0x0a3b356c7225202c,0x31203220636f6c2e\n"
".quad 0x6464610a31203131,0x6c7225203436732e,0x2c316c7225202c37,0x6c0a3b356c722520\n"
".quad 0x6c61626f6c672e64,0x336625203233662e,0x5d376c72255b202c,0x3220636f6c2e0a3b\n"
".quad 0x6c0a312035323120,0x6c61626f6c672e64,0x203233662e32762e,0x25202c343166257b\n"
".quad 0x255b202c7d353166,0x6c2e0a3b5d366c72,0x313131203220636f,0x662e6c756d0a3120\n"
".quad 0x202c356625203233,0x316625202c336625,0x6c672e646c0a3b34,0x3233662e6c61626f\n"
".quad 0x255b202c36662520,0x0a3b5d342b376c72,0x203233662e67656e,0x366625202c386625\n"
".quad 0x6e722e616d660a3b,0x396625203233662e,0x25202c386625202c,0x356625202c353166\n"
".quad 0x33662e6c756d0a3b,0x202c303166252032,0x396625202c316625,0x33662e6c756d0a3b\n"
".quad 0x202c313166252032,0x316625202c336625,0x722e616d660a3b35,0x6625203233662e6e\n"
".quad 0x2c366625202c3231,0x25202c3431662520,0x6c756d0a3b313166,0x316625203233662e\n"
".quad 0x202c316625202c33,0x6c2e0a3b32316625,0x323131203220636f,0x6c672e74730a3120\n"
".quad 0x2e32762e6c61626f,0x6c72255b20323366,0x3166257b202c5d37,0x7d33316625202c30\n"
".quad 0x3220636f6c2e0a3b,0x0a31322034323120,0x203233732e646461,0x7225202c36317225\n"
".quad 0x3b337225202c3631,0x617261702e646c0a,0x7225203233752e6d,0x325a5f5b202c3531\n"
".quad 0x74616c75646f6d30,0x6d726f4e646e4165,0x663650657a696c61,0x5f30533274616f6c\n"
".quad 0x5f6d617261705f69,0x636f6c2e0a3b5d32,0x3120343231203220,0x746c2e707465730a\n"
".quad 0x327025203233732e,0x202c36317225202c,0x25400a3b35317225,0x4220617262203270\n"
".quad 0x420a0a3b315f3342,0x6c2e0a3a325f3342,0x363231203220636f,0x0a3b7465720a3220\n"
".quad 0x000000000a0a0a7d\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[1501];
...
# 3 "/tmp/tmpxft_0000548d_00000000-1_convolutionFFT2D.cudafe1.stub.c" 2 3
...
static void __sti____cudaRegisterAll_51_tmpxft_0000548d_00000000_4_convolutionFFT2D_cpp1_ii_7d260802(void) __attribute__((__constructor__));
void __device_stub__Z9padKernelP6float2iiiiii(Complex *__par0, int __par1, int __par2, int __par3, int __par4, int __par5, int __par6){if (cudaSetupArgument((void *)(char *)&__par0, sizeof(__par0), (size_t)0UL) != cudaSuccess) return;if (cudaSetupArgument((void *)(char *)&__par1, sizeof(__par1), (size_t)8UL) != cudaSuccess) return;if (cudaSetupArgument((void *)(char *)&__par2, sizeof(__par2), (size_t)12UL) != cudaSuccess) return;if (cudaSetupArgument((void *)(char *)&__par3, sizeof(__par3), (size_t)16UL) != cudaSuccess) return;if (cudaSetupArgument((void *)(char *)&__par4, sizeof(__par4), (size_t)20UL) != cudaSuccess) return;if (cudaSetupArgument((void *)(char *)&__par5, sizeof(__par5), (size_t)24UL) != cudaSuccess) return;if (cudaSetupArgument((void *)(char *)&__par6, sizeof(__par6), (size_t)28UL) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(Complex *, int, int, int, int, int, int))padKernel)); (void)cudaLaunch(((char *)((void ( *)(Complex *, int, int, int, int, int, int))padKernel))); };}
# 47 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
void padKernel( Complex *__cuda_0,int __cuda_1,int __cuda_2,int __cuda_3,int __cuda_4,int __cuda_5,int __cuda_6)
# 55 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
{__device_stub__Z9padKernelP6float2iiiiii( __cuda_0,__cuda_1,__cuda_2,__cuda_3,__cuda_4,__cuda_5,__cuda_6);
# 65 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
}
# 1 "/tmp/tmpxft_0000548d_00000000-1_convolutionFFT2D.cudafe1.stub.c"
void __device_stub__Z7padDataP6float2iiiiiiii( Complex *__par0, int __par1, int __par2, int __par3, int __par4, int __par5, int __par6, int __par7, int __par8) { if (cudaSetupArgument((void *)(char *)&__par0, sizeof(__par0), (size_t)0UL) != cudaSuccess) return; if (cudaSetupArgument((void *)(char *)&__par1, sizeof(__par1), (size_t)8UL) != cudaSuccess) return; if (cudaSetupArgument((void *)(char *)&__par2, sizeof(__par2), (size_t)12UL) != cudaSuccess) return; if (cudaSetupArgument((void *)(char *)&__par3, sizeof(__par3), (size_t)16UL) != cudaSuccess) return; if (cudaSetupArgument((void *)(char *)&__par4, sizeof(__par4), (size_t)20UL) != cudaSuccess) return; if (cudaSetupArgument((void *)(char *)&__par5, sizeof(__par5), (size_t)24UL) != cudaSuccess) return; if (cudaSetupArgument((void *)(char *)&__par6, sizeof(__par6), (size_t)28UL) != cudaSuccess) return; if (cudaSetupArgument((void *)(char *)&__par7, sizeof(__par7), (size_t)32UL) != cudaSuccess) return; if (cudaSetupArgument((void *)(char *)&__par8, sizeof(__par8), (size_t)36UL) != cudaSuccess) return; { volatile static char *__f; __f = ((char *)((void ( *)(Complex *, int, int, int, int, int, int, int, int))padData)); (void)cudaLaunch(((char *)((void ( *)(Complex *, int, int, int, int, int, int, int, int))padData))); }; }
# 73 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
...
# 83 "tests/ConvolutionFFT2D/convolutionFFT2D_kernel.cuh"
