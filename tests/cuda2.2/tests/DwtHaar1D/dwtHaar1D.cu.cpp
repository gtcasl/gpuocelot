...
# 105 "tests/DwtHaar1D/dwtHaar1D.cu"
static const unsigned LOG_NUM_BANKS = (4);
# 106 "tests/DwtHaar1D/dwtHaar1D.cu"
...
# 109 "./tests/DwtHaar1D/dwtHaar1D_kernel.cuh"
dlevels, const unsigned
# 110 "./tests/DwtHaar1D/dwtHaar1D_kernel.cuh"
slength_step_half, const int
# 111 "./tests/DwtHaar1D/dwtHaar1D_kernel.cuh"
bdim) ;
# 114 "tests/DwtHaar1D/dwtHaar1D.cu"
void runTest(int , char ** );
# 115 "tests/DwtHaar1D/dwtHaar1D.cu"
CUTBoolean getLevels(unsigned , unsigned * );
# 121 "tests/DwtHaar1D/dwtHaar1D.cu"
int main(int argc, char **argv)
# 122 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 124 "tests/DwtHaar1D/dwtHaar1D.cu"
runTest(argc, argv);
# 126 "tests/DwtHaar1D/dwtHaar1D.cu"
__cutilExit(argc, argv); return 0;
# 127 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 133 "tests/DwtHaar1D/dwtHaar1D.cu"
void runTest(int argc, char **argv)
# 134 "tests/DwtHaar1D/dwtHaar1D.cu"
{
...
char *r_gold_fname;
# 138 "tests/DwtHaar1D/dwtHaar1D.cu"
...
# 153 "tests/DwtHaar1D/dwtHaar1D.cu"
...
# 175 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 178 "tests/DwtHaar1D/dwtHaar1D.cu"
unsigned slength = (0);
# 179 "tests/DwtHaar1D/dwtHaar1D.cu"
float *signal = (__null);
# 180 "tests/DwtHaar1D/dwtHaar1D.cu"
if (s_fname == (0))
# 181 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 182 "tests/DwtHaar1D/dwtHaar1D.cu"
fprintf(stderr, "Cannot find the file containing the signal.\n%s", usage);
# 183 "tests/DwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 184 "tests/DwtHaar1D/dwtHaar1D.cu"
exit(1);
# 185 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 186 "tests/DwtHaar1D/dwtHaar1D.cu"
if ((cutReadFilef(s_fname, &signal, &slength)) == (CUTTrue)) {
# 187 "tests/DwtHaar1D/dwtHaar1D.cu"
printf("Reading signal from %s\n", s_fname);
# 188 "tests/DwtHaar1D/dwtHaar1D.cu"
} else {
# 189 "tests/DwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 190 "tests/DwtHaar1D/dwtHaar1D.cu"
exit(1);
...
{
# 198 "tests/DwtHaar1D/dwtHaar1D.cu"
fprintf(stderr, "Signal length not supported.\n");
# 200 "tests/DwtHaar1D/dwtHaar1D.cu"
cutFree(signal);
# 201 "tests/DwtHaar1D/dwtHaar1D.cu"
return;
# 202 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 205 "tests/DwtHaar1D/dwtHaar1D.cu"
float *d_idata = (__null);
# 207 "tests/DwtHaar1D/dwtHaar1D.cu"
float *d_odata = (__null);
# 209 "tests/DwtHaar1D/dwtHaar1D.cu"
float *approx_final = (__null);
# 215 "tests/DwtHaar1D/dwtHaar1D.cu"
int approx_is_input;
# 218 "tests/DwtHaar1D/dwtHaar1D.cu"
const unsigned smem_size = (sizeof(float) * slength);
# 219 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), smem_size), "tests/DwtHaar1D/dwtHaar1D.cu", 219);
# 220 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), smem_size), "tests/DwtHaar1D/dwtHaar1D.cu", 220);
# 221 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMalloc((void **)(&approx_final), smem_size), "tests/DwtHaar1D/dwtHaar1D.cu", 221);
# 223 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(d_idata, signal, smem_size, cudaMemcpyHostToDevice), "tests/DwtHaar1D/dwtHaar1D.cu", 224);
# 227 "tests/DwtHaar1D/dwtHaar1D.cu"
float *tmp = ((float *)malloc(smem_size));
# 228 "tests/DwtHaar1D/dwtHaar1D.cu"
for (unsigned i = (0); i < slength; ++i)
# 229 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 230 "tests/DwtHaar1D/dwtHaar1D.cu"
(tmp[i]) = ((0.0));
# 231 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 232 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(d_odata, tmp, smem_size, cudaMemcpyHostToDevice), "tests/DwtHaar1D/dwtHaar1D.cu", 233);
# 234 "tests/DwtHaar1D/dwtHaar1D.cu"
free(tmp);
# 239 "tests/DwtHaar1D/dwtHaar1D.cu"
unsigned num_threads_total_left = (slength / (2));
# 241 "tests/DwtHaar1D/dwtHaar1D.cu"
unsigned dlevels_step = dlevels_complete;
# 244 "tests/DwtHaar1D/dwtHaar1D.cu"
dim3 block_size;
# 245 "tests/DwtHaar1D/dwtHaar1D.cu"
dim3 grid_size;
# 248 "tests/DwtHaar1D/dwtHaar1D.cu"
unsigned dlevels_left = dlevels_complete;
# 253 "tests/DwtHaar1D/dwtHaar1D.cu"
if (dlevels_complete <= (10))
# 254 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 256 "tests/DwtHaar1D/dwtHaar1D.cu"
(block_size.x) = num_threads_total_left;
# 257 "tests/DwtHaar1D/dwtHaar1D.cu"
approx_is_input = 0;
# 258 "tests/DwtHaar1D/dwtHaar1D.cu"
} else
# 260 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 262 "tests/DwtHaar1D/dwtHaar1D.cu"
(grid_size.x) = (num_threads_total_left / (512));
# 263 "tests/DwtHaar1D/dwtHaar1D.cu"
(block_size.x) = (512);
# 266 "tests/DwtHaar1D/dwtHaar1D.cu"
dlevels_step = (10);
# 267 "tests/DwtHaar1D/dwtHaar1D.cu"
dlevels_left -= (10);
# 269 "tests/DwtHaar1D/dwtHaar1D.cu"
approx_is_input = 1;
# 270 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 273 "tests/DwtHaar1D/dwtHaar1D.cu"
while ((0) != num_threads_total_left)
# 274 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 276 "tests/DwtHaar1D/dwtHaar1D.cu"
unsigned mem_shared = (((2) * (block_size.x)) * sizeof(float));
# 278 "tests/DwtHaar1D/dwtHaar1D.cu"
mem_shared += ((((2) * (block_size.x)) / NUM_BANKS) * sizeof(float));
# 281 "tests/DwtHaar1D/dwtHaar1D.cu"
...
if (approx_is_input)
# 289 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 290 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(d_idata, approx_final, (grid_size.x) * (4), cudaMemcpyDeviceToDevice), "tests/DwtHaar1D/dwtHaar1D.cu", 291);
# 292 "tests/DwtHaar1D/dwtHaar1D.cu"
} else
# 294 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 295 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(d_odata, approx_final, (grid_size.x) * (4), cudaMemcpyDeviceToDevice), "tests/DwtHaar1D/dwtHaar1D.cu", 296);
# 297 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 300 "tests/DwtHaar1D/dwtHaar1D.cu"
if (dlevels_left < (10))
# 301 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 303 "tests/DwtHaar1D/dwtHaar1D.cu"
approx_is_input = 0;
# 304 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 307 "tests/DwtHaar1D/dwtHaar1D.cu"
dlevels_step = ((dlevels_left > (10)) ? (dlevels_left - (10)) : dlevels_left);
# 308 "tests/DwtHaar1D/dwtHaar1D.cu"
dlevels_left -= (10);
...
# 321 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 325 "tests/DwtHaar1D/dwtHaar1D.cu"
float *odata = ((float *)malloc(smem_size));
# 326 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(odata, d_odata, smem_size, cudaMemcpyDeviceToHost), "tests/DwtHaar1D/dwtHaar1D.cu", 327);
...
# 339 "tests/DwtHaar1D/dwtHaar1D.cu"
printf("Writing result to %s\n", r_fname); } else
# 340 "tests/DwtHaar1D/dwtHaar1D.cu"
{
...
# 356 "tests/DwtHaar1D/dwtHaar1D.cu"
...
# 358 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 359 "tests/DwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 360 "tests/DwtHaar1D/dwtHaar1D.cu"
exit(1);
# 361 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 362 "tests/DwtHaar1D/dwtHaar1D.cu"
__cutilCondition(slength == len_reference, (char *)("tests/DwtHaar1D/dwtHaar1D.cu"), 362);
# 365 "tests/DwtHaar1D/dwtHaar1D.cu"
CUTBoolean res = cutComparefe(reference, odata, slength, (0.001000000047F));
# 366 "tests/DwtHaar1D/dwtHaar1D.cu"
printf("Test %s\n", (1 == res) ? ("PASSED") : ("FAILED"));
# 367 "tests/DwtHaar1D/dwtHaar1D.cu"
cutFree(reference);
# 368 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 371 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaFree(d_odata), "tests/DwtHaar1D/dwtHaar1D.cu", 371);
# 372 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaFree(d_idata), "tests/DwtHaar1D/dwtHaar1D.cu", 372);
# 373 "tests/DwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaFree(approx_final), "tests/DwtHaar1D/dwtHaar1D.cu", 373);
# 375 "tests/DwtHaar1D/dwtHaar1D.cu"
cutFree(signal);
# 376 "tests/DwtHaar1D/dwtHaar1D.cu"
free(odata);
# 377 "tests/DwtHaar1D/dwtHaar1D.cu"
cutFree(s_fname);
...
# 397 "tests/DwtHaar1D/dwtHaar1D.cu"
CUTBoolean getLevels(unsigned len, unsigned *levels)
# 398 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 399 "tests/DwtHaar1D/dwtHaar1D.cu"
CUTBoolean retval = CUTFalse;
# 402 "tests/DwtHaar1D/dwtHaar1D.cu"
for (unsigned i = (0); i < (20); ++i)
# 403 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 404 "tests/DwtHaar1D/dwtHaar1D.cu"
if (len == (1 << i))
# 405 "tests/DwtHaar1D/dwtHaar1D.cu"
{
# 406 "tests/DwtHaar1D/dwtHaar1D.cu"
(*levels) = i;
# 407 "tests/DwtHaar1D/dwtHaar1D.cu"
retval = CUTTrue;
# 408 "tests/DwtHaar1D/dwtHaar1D.cu"
break;
# 409 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 410 "tests/DwtHaar1D/dwtHaar1D.cu"
}
# 412 "tests/DwtHaar1D/dwtHaar1D.cu"
return retval;
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000001888,0x0000005801000002,0x0000000000000830\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000001c00000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x77442f7374736574,0x2f44317261614874,0x3172616148747764\n"
".quad 0x0000000075632e44,0x33010102464c457f,0x0000000000000004,0x0000000100be0002\n"
".quad 0x0000000000000000,0x00000000000007c0,0x0000000000000040,0x0038004000140514\n"
".quad 0x0001000800400002,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000300000001,0x0000000000000000,0x0000000000000000\n"
".quad 0x25203233662e6275,0x316625202c313166,0x0a3b396625202c30,0x203233662e6c756d\n"
".quad 0x6625202c32316625,0x46336630202c3131,0x0a3b334634303533,0x656469772e6c756d\n"
".quad 0x6c7225203233752e,0x31347225202c3932,0x6464610a3b34202c,0x6c7225203436732e\n"
".quad 0x336c7225202c3033,0x3b39326c7225202c,0x626f6c672e74730a,0x5b203233662e6c61\n"
".quad 0x202c5d30336c7225,0x6c2e0a3b32316625,0x313132203220636f,0x662e6464610a3120\n"
".quad 0x2c33316625203233,0x25202c3031662520,0x2e6c756d0a3b3966,0x3431662520323366\n"
".quad 0x202c33316625202c,0x3430353346336630,0x732e74730a3b3346,0x33662e6465726168\n"
".quad 0x36326c72255b2032,0x3b34316625202c5d,0x203220636f6c2e0a,0x68730a3120343132\n"
".quad 0x7225203233752e72,0x38367225202c3836,0x6f6c2e0a3b31202c,0x2035313220322063\n"
".quad 0x33622e6c68730a31,0x202c393672252032,0x3b31202c39367225,0x203220636f6c2e0a\n"
".quad 0x68730a3120363132,0x7225203233622e6c,0x37367225202c3736,0x42420a0a3b31202c\n"
".quad 0x6f6c2e0a3a345f30,0x2030323220322063,0x79732e7261620a31,0x6c2e0a3b3020636e\n"
".quad 0x363731203220636f,0x2e6464610a333220,0x3636722520323373,0x202c36367225202c\n"
".quad 0x61702e646c0a3b31,0x203233752e6d6172,0x5f5b202c31357225,0x616148747764395a\n"
".quad 0x535f536650443172,0x7261705f696a6a5f,0x2e0a3b5d335f6d61,0x3731203220636f6c\n"
".quad 0x707465730a312036,0x203233752e746c2e,0x367225202c337025,0x3b31357225202c36\n"
".quad 0x726220337025400a,0x3b325f3042422061,0x3220636f6c2e0a0a,0x6d0a312030323120\n"
".quad 0x25203233752e766f,0x697425202c333672,0x6f6c2e0a3b782e64,0x2035323220322063\n"
".quad 0x652e707465730a31,0x7025203233732e71,0x2c33367225202c34,0x347025400a3b3020\n"
".quad 0x3042422061726220,0x3042420a0a3b375f,0x636f6c2e0a3a365f,0x3220313332203220\n"
".quad 0x420a0a3b7465720a,0x6c2e0a3a375f3042,0x373232203220636f,0x68732e646c0a3120\n"
".quad 0x3233662e64657261,0x5b202c3531662520,0x3b5d646572616873,0x203220636f6c2e0a\n"
".quad 0x6f6d0a3120393131,0x7225203233752e76,0x61746325202c3136,0x6c2e0a3b782e6469\n"
".quad 0x373232203220636f,0x772e6c756d0a3120,0x203233732e656469,0x25202c31336c7225\n"
".quad 0x0a3b34202c313672,0x203436732e646461,0x25202c32336c7225,0x6c7225202c326c72\n"
".quad 0x672e74730a3b3133,0x33662e6c61626f6c,0x32336c72255b2032,0x3b35316625202c5d\n"
".quad 0x203220636f6c2e0a,0x65720a3220313332,0x000a0a0a7d0a3b74\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[787];
...
# 112 "./tests/DwtHaar1D/dwtHaar1D_kernel.cuh"
