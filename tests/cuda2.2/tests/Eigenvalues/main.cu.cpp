# 1 "/tmp/tmpxft_0000595a_00000000-1_main.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_0000595a_00000000-1_main.cudafe1.cpp"
...
# 50 "tests/Eigenvalues/gerschgorin.h"
...
# 54 "tests/Eigenvalues/bisect_large.cuh"
...
# 60 "tests/Eigenvalues/main.cu"
void runTest(int , char ** );
# 66 "tests/Eigenvalues/main.cu"
int main(int argc, char **argv)
# 67 "tests/Eigenvalues/main.cu"
{
# 68 "tests/Eigenvalues/main.cu"
runTest(argc, argv);
# 70 "tests/Eigenvalues/main.cu"
__cutilExit(argc, argv); return 0;
# 71 "tests/Eigenvalues/main.cu"
}
# 82 "tests/Eigenvalues/main.cu"
void initInputData(InputData &input, char *exec_path, const unsigned
# 83 "tests/Eigenvalues/main.cu"
mat_size, const unsigned user_defined)
# 84 "tests/Eigenvalues/main.cu"
{
# 86 "tests/Eigenvalues/main.cu"
(input.a) = ((float *)malloc(sizeof(float) * mat_size));
# 87 "tests/Eigenvalues/main.cu"
(input.b) = ((float *)malloc(sizeof(float) * mat_size));
# 89 "tests/Eigenvalues/main.cu"
if ((1) == user_defined) {
# 92 "tests/Eigenvalues/main.cu"
srand(278217421);
# 94 "tests/Eigenvalues/main.cu"
for (unsigned i = (0); i < mat_size; ++i) {
# 95 "tests/Eigenvalues/main.cu"
((input.a)[i]) = ((float)((2.0) * ((((double)rand()) / ((double)2147483647)) - (0.5))));
# 97 "tests/Eigenvalues/main.cu"
((input.b)[i]) = ((float)((2.0) * ((((double)rand()) / ((double)2147483647)) - (0.5))));
# 99 "tests/Eigenvalues/main.cu"
}
# 104 "tests/Eigenvalues/main.cu"
((input.b)[0]) = (0.0F);
# 105 "tests/Eigenvalues/main.cu"
} else
# 106 "tests/Eigenvalues/main.cu"
{
# 109 "tests/Eigenvalues/main.cu"
unsigned input_data_size = mat_size;
# 110 "tests/Eigenvalues/main.cu"
char *diag_path = cutFindFilePath("diagonal.dat", exec_path);
# 111 "tests/Eigenvalues/main.cu"
__cutilCondition((0) != diag_path, (char *)("tests/Eigenvalues/main.cu"), 111);
# 112 "tests/Eigenvalues/main.cu"
__cutilCheckError(cutReadFilef(diag_path, &(input.a), &input_data_size), "tests/Eigenvalues/main.cu", 112);
# 114 "tests/Eigenvalues/main.cu"
char *sdiag_path = cutFindFilePath("superdiagonal.dat", exec_path);
# 115 "tests/Eigenvalues/main.cu"
__cutilCondition((0) != sdiag_path, (char *)("tests/Eigenvalues/main.cu"), 115);
# 116 "tests/Eigenvalues/main.cu"
__cutilCheckError(cutReadFilef(sdiag_path, &(input.b), &input_data_size, 1), "tests/Eigenvalues/main.cu", 117);
# 119 "tests/Eigenvalues/main.cu"
cutFree(diag_path);
# 120 "tests/Eigenvalues/main.cu"
cutFree(sdiag_path);
# 121 "tests/Eigenvalues/main.cu"
}
# 124 "tests/Eigenvalues/main.cu"
__cudaSafeCall(cudaMalloc((void **)(&(input.g_a)), sizeof(float) * mat_size), "tests/Eigenvalues/main.cu", 124);
# 125 "tests/Eigenvalues/main.cu"
__cudaSafeCall(cudaMalloc((void **)(&(input.g_b_raw)), sizeof(float) * mat_size), "tests/Eigenvalues/main.cu", 125);
# 128 "tests/Eigenvalues/main.cu"
__cudaSafeCall(cudaMemcpy(input.g_a, input.a, sizeof(float) * mat_size, cudaMemcpyHostToDevice), "tests/Eigenvalues/main.cu", 128);
# 129 "tests/Eigenvalues/main.cu"
__cudaSafeCall(cudaMemcpy(input.g_b_raw, input.b, sizeof(float) * mat_size, cudaMemcpyHostToDevice), "tests/Eigenvalues/main.cu", 129);
# 131 "tests/Eigenvalues/main.cu"
(input.g_b) = ((input.g_b_raw) + 1);
# 132 "tests/Eigenvalues/main.cu"
}
# 139 "tests/Eigenvalues/main.cu"
void cleanupInputData(InputData &input) {
# 141 "tests/Eigenvalues/main.cu"
freePtr(input.a);
# 142 "tests/Eigenvalues/main.cu"
freePtr(input.b);
# 144 "tests/Eigenvalues/main.cu"
__cudaSafeCall(cudaFree(input.g_a), "tests/Eigenvalues/main.cu", 144);
# 145 "tests/Eigenvalues/main.cu"
(input.g_a) = (__null);
# 146 "tests/Eigenvalues/main.cu"
__cudaSafeCall(cudaFree(input.g_b_raw), "tests/Eigenvalues/main.cu", 146);
# 147 "tests/Eigenvalues/main.cu"
(input.g_b_raw) = (__null);
# 148 "tests/Eigenvalues/main.cu"
(input.g_b) = (__null);
# 149 "tests/Eigenvalues/main.cu"
}
# 159 "tests/Eigenvalues/main.cu"
void getMatrixSize(int argc, char **argv, unsigned &
# 160 "tests/Eigenvalues/main.cu"
mat_size, unsigned &user_defined)
# 161 "tests/Eigenvalues/main.cu"
{
# 162 "tests/Eigenvalues/main.cu"
int temp = (-1);
# 163 "tests/Eigenvalues/main.cu"
cutGetCmdLineArgumenti(argc, (const char **)argv, "matrix-size", &temp);
# 164 "tests/Eigenvalues/main.cu"
if (temp > 0) {
# 166 "tests/Eigenvalues/main.cu"
mat_size = ((unsigned)temp);
# 168 "tests/Eigenvalues/main.cu"
__cutilCondition(mat_size < (1 << 16), (char *)("tests/Eigenvalues/main.cu"), 168);
# 170 "tests/Eigenvalues/main.cu"
user_defined = (1);
# 171 "tests/Eigenvalues/main.cu"
}
# 173 "tests/Eigenvalues/main.cu"
printf("Matrix size: %i x %i\n", mat_size, mat_size);
# 174 "tests/Eigenvalues/main.cu"
}
# 184 "tests/Eigenvalues/main.cu"
void getPrecision(int argc, char **argv, float &precision) {
# 186 "tests/Eigenvalues/main.cu"
float temp = (-(1.0F));
# 187 "tests/Eigenvalues/main.cu"
cutGetCmdLineArgumentf(argc, (const char **)argv, "precision", &temp);
# 188 "tests/Eigenvalues/main.cu"
if (temp > (0.0F)) {
# 189 "tests/Eigenvalues/main.cu"
precision = temp;
# 190 "tests/Eigenvalues/main.cu"
}
# 192 "tests/Eigenvalues/main.cu"
printf("Precision: %f\n", precision);
# 193 "tests/Eigenvalues/main.cu"
}
# 203 "tests/Eigenvalues/main.cu"
void getItersTiming(int argc, char **argv, unsigned &iters_timing) {
# 205 "tests/Eigenvalues/main.cu"
int temp = (-1);
# 206 "tests/Eigenvalues/main.cu"
cutGetCmdLineArgumenti(argc, (const char **)argv, "iters-timing", &temp);
# 207 "tests/Eigenvalues/main.cu"
if (temp > 0) {
# 208 "tests/Eigenvalues/main.cu"
iters_timing = temp;
# 209 "tests/Eigenvalues/main.cu"
}
# 211 "tests/Eigenvalues/main.cu"
printf("Iterations to be timed: %i\n", iters_timing);
# 212 "tests/Eigenvalues/main.cu"
}
# 223 "tests/Eigenvalues/main.cu"
void getResultFilename(int argc, char **argv, char *&filename) {
# 225 "tests/Eigenvalues/main.cu"
char *temp = (__null);
# 226 "tests/Eigenvalues/main.cu"
cutGetCmdLineArgumentstr(argc, (const char **)argv, "filename-result", &temp);
# 228 "tests/Eigenvalues/main.cu"
if ((__null) != temp) {
# 230 "tests/Eigenvalues/main.cu"
filename = ((char *)malloc(sizeof(char) * strlen(temp)));
# 231 "tests/Eigenvalues/main.cu"
strcpy(filename, temp);
# 233 "tests/Eigenvalues/main.cu"
cutFree(temp);
# 234 "tests/Eigenvalues/main.cu"
}
# 236 "tests/Eigenvalues/main.cu"
printf("Result filename: \'%s\'\n", filename);
# 237 "tests/Eigenvalues/main.cu"
}
# 243 "tests/Eigenvalues/main.cu"
void runTest(int argc, char **argv) {
# 246 "tests/Eigenvalues/main.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 247 "tests/Eigenvalues/main.cu"
cutilDeviceInit(argc, argv); } else {
# 249 "tests/Eigenvalues/main.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 251 "tests/Eigenvalues/main.cu"
unsigned timer = (0);
# 252 "tests/Eigenvalues/main.cu"
unsigned timer_total = (0);
# 253 "tests/Eigenvalues/main.cu"
__cutilCheckError(cutCreateTimer(&timer), "tests/Eigenvalues/main.cu", 253);
# 254 "tests/Eigenvalues/main.cu"
__cutilCheckError(cutCreateTimer(&timer_total), "tests/Eigenvalues/main.cu", 254);
# 257 "tests/Eigenvalues/main.cu"
unsigned mat_size = (2048);
# 259 "tests/Eigenvalues/main.cu"
unsigned user_defined = (0);
# 261 "tests/Eigenvalues/main.cu"
float precision = (9.999999747e-06F);
# 263 "tests/Eigenvalues/main.cu"
unsigned iters_timing = (1);
# 267 "tests/Eigenvalues/main.cu"
char *result_file = ((char *)("eigenvalues.dat"));
# 270 "tests/Eigenvalues/main.cu"
getMatrixSize(argc, argv, mat_size, user_defined);
# 273 "tests/Eigenvalues/main.cu"
getPrecision(argc, argv, precision);
# 276 "tests/Eigenvalues/main.cu"
getItersTiming(argc, argv, iters_timing);
# 279 "tests/Eigenvalues/main.cu"
getResultFilename(argc, argv, result_file);
# 282 "tests/Eigenvalues/main.cu"
InputData input;
# 283 "tests/Eigenvalues/main.cu"
initInputData(input, argv[0], mat_size, user_defined);
# 286 "tests/Eigenvalues/main.cu"
float lg = (3.402823466e+38F);
# 287 "tests/Eigenvalues/main.cu"
float ug = (-(3.402823466e+38F));
# 288 "tests/Eigenvalues/main.cu"
computeGerschgorin(input.a, (input.b) + 1, mat_size, lg, ug);
# 289 "tests/Eigenvalues/main.cu"
printf("Gerschgorin interval: %f / %f\n", lg, ug);
# 292 "tests/Eigenvalues/main.cu"
if (mat_size <= (512)) {
# 295 "tests/Eigenvalues/main.cu"
ResultDataSmall result;
# 296 "tests/Eigenvalues/main.cu"
initResultSmallMatrix(result, mat_size);
# 299 "tests/Eigenvalues/main.cu"
computeEigenvaluesSmallMatrix(input, result, mat_size, lg, ug, precision, iters_timing);
# 304 "tests/Eigenvalues/main.cu"
processResultSmallMatrix(input, result, mat_size, result_file);
# 307 "tests/Eigenvalues/main.cu"
cleanupResultSmallMatrix(result);
# 308 "tests/Eigenvalues/main.cu"
} else
# 309 "tests/Eigenvalues/main.cu"
{
# 312 "tests/Eigenvalues/main.cu"
ResultDataLarge result;
# 313 "tests/Eigenvalues/main.cu"
initResultDataLargeMatrix(result, mat_size);
# 316 "tests/Eigenvalues/main.cu"
computeEigenvaluesLargeMatrix(input, result, mat_size, precision, lg, ug, iters_timing);
# 322 "tests/Eigenvalues/main.cu"
processResultDataLargeMatrix(input, result, mat_size, result_file, user_defined, argv[0]);
# 326 "tests/Eigenvalues/main.cu"
cleanupResultDataLargeMatrix(result);
# 327 "tests/Eigenvalues/main.cu"
}
# 329 "tests/Eigenvalues/main.cu"
cleanupInputData(input);
# 331 "tests/Eigenvalues/main.cu"
cudaThreadExit();
# 332 "tests/Eigenvalues/main.cu"
}
# 1 "tmpxft_0000595a_00000000-1_main.cudafe1.stub.c"
# 1 "tmpxft_0000595a_00000000-1_main.cudafe1.stub.c"
# 1 "/tmp/tmpxft_0000595a_00000000-1_main.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_0000595a_00000000-1_main.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_0000595a_00000000-3_main.fatbin.c" 1 3
...
".quad 0x0000000000000000,0x0000001400010004,0x0000001900000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x69452f7374736574,0x65756c61766e6567,0x632e6e69616d2f73\n"
".quad 0x0000000000000075,0x33010102464c457f,0x0000000000000004,0x0000000100be0002\n"
...
".quad 0x0000001900000040,0x0000000000000015,0x0000000000000000,0x0000000000000000\n"
".quad 0x69452f7374736574,0x65756c61766e6567,0x632e6e69616d2f73,0x0000000000000075\n"
...
# 3 "/tmp/tmpxft_0000595a_00000000-1_main.cudafe1.stub.c" 2 3
static void __sti____cudaRegisterAll_39_tmpxft_0000595a_00000000_4_main_cpp1_ii_main(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_39_tmpxft_0000595a_00000000_4_main_cpp1_ii_main(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil);}
# 2 "tmpxft_0000595a_00000000-1_main.cudafe1.stub.c" 2
# 1 "tmpxft_0000595a_00000000-1_main.cudafe1.stub.c"
