...
# 54 "tests/Histogram64/histogram64.cu"
extern "C" void histogram64CPU(unsigned * , unsigned * , int );
# 69 "tests/Histogram64/histogram64_kernel.cuh"
__attribute__((unused)) inline void addData64(unsigned char *s_Hist, int threadPos, unsigned data) {int volatile ___ = 1;(void)s_Hist;(void)threadPos;(void)data;
# 71 "tests/Histogram64/histogram64_kernel.cuh"
exit(___);}
...
# 148 "tests/Histogram64/histogram64_kernel.cuh"
d_Histogram, unsigned *
# 149 "tests/Histogram64/histogram64_kernel.cuh"
d_PartialHistograms, unsigned
# 150 "tests/Histogram64/histogram64_kernel.cuh"
blockN) ;
# 175 "tests/Histogram64/histogram64_kernel.cuh"
unsigned *d_PartialHistograms;
# 179 "tests/Histogram64/histogram64_kernel.cuh"
static const int MAX_BLOCK_N = 16384;
# 181 "tests/Histogram64/histogram64_kernel.cuh"
void initHistogram64GPU() {
# 185 "tests/Histogram64/histogram64_kernel.cuh"
}
# 188 "tests/Histogram64/histogram64_kernel.cuh"
void closeHistogram64GPU() {
# 192 "tests/Histogram64/histogram64_kernel.cuh"
}
# 195 "tests/Histogram64/histogram64_kernel.cuh"
int iDivUp(int a, int b) {
# 196 "tests/Histogram64/histogram64_kernel.cuh"
return ((a % b) != 0) ? ((a / b) + 1) : (a / b);
# 197 "tests/Histogram64/histogram64_kernel.cuh"
}
# 199 "tests/Histogram64/histogram64_kernel.cuh"
void histogram64GPU(unsigned *
# 200 "tests/Histogram64/histogram64_kernel.cuh"
d_Histogram, unsigned *
# 201 "tests/Histogram64/histogram64_kernel.cuh"
d_Data, int
# 202 "tests/Histogram64/histogram64_kernel.cuh"
dataN)
# 203 "tests/Histogram64/histogram64_kernel.cuh"
{
# 204 "tests/Histogram64/histogram64_kernel.cuh"
const int histogramCount = iDivUp(dataN / 4, 64 * 63);
# 205 "tests/Histogram64/histogram64_kernel.cuh"
if (histogramCount > MAX_BLOCK_N) {
# 206 "tests/Histogram64/histogram64_kernel.cuh"
printf("histogram64GPU(): data size exceeds maximum\n");
# 207 "tests/Histogram64/histogram64_kernel.cuh"
return;
# 208 "tests/Histogram64/histogram64_kernel.cuh"
}
# 226 "tests/Histogram64/histogram64_kernel.cuh"
__cudaSafeCall(cudaMemset(d_Histogram, 0, (64) * sizeof(unsigned)), "tests/Histogram64/histogram64_kernel.cuh", 226);
# 227 "tests/Histogram64/histogram64_kernel.cuh"
cudaConfigureCall(histogramCount, 64) ? ((void)0) : histogram64Kernel(d_Histogram, (unsigned *)d_Data, dataN / 4);
# 232 "tests/Histogram64/histogram64_kernel.cuh"
__cutilCheckMsg("histogram64Kernel() execution failed\n", "tests/Histogram64/histogram64_kernel.cuh", 232);
# 234 "tests/Histogram64/histogram64_kernel.cuh"
}
# 73 "tests/Histogram64/histogram64.cu"
static const int DATA_N = 1000000;
# 74 "tests/Histogram64/histogram64.cu"
static const int DATA_SIZE = (DATA_N * sizeof(unsigned char));
# 78 "tests/Histogram64/histogram64.cu"
static const int NUM_ITERATIONS = 1;
# 80 "tests/Histogram64/histogram64.cu"
int main(int argc, char **argv) {
# 82 "tests/Histogram64/histogram64.cu"
unsigned char *h_Data;
# 85 "tests/Histogram64/histogram64.cu"
unsigned *h_HistogramCPU, *h_HistogramGPU;
# 88 "tests/Histogram64/histogram64.cu"
unsigned char *d_Data;
# 91 "tests/Histogram64/histogram64.cu"
unsigned *d_Histogram;
# 93 "tests/Histogram64/histogram64.cu"
int i, sum, delta, iter;
# 94 "tests/Histogram64/histogram64.cu"
double timerValue;
# 96 "tests/Histogram64/histogram64.cu"
unsigned hTimer;
# 99 "tests/Histogram64/histogram64.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 100 "tests/Histogram64/histogram64.cu"
cutilDeviceInit(argc, argv); } else {
# 102 "tests/Histogram64/histogram64.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 104 "tests/Histogram64/histogram64.cu"
__cutilCheckError(cutCreateTimer(&hTimer), "tests/Histogram64/histogram64.cu", 104);
# 106 "tests/Histogram64/histogram64.cu"
printf("Initializing data...\n");
# 107 "tests/Histogram64/histogram64.cu"
printf("...allocating CPU memory.\n");
# 108 "tests/Histogram64/histogram64.cu"
h_Data = ((unsigned char *)malloc(DATA_SIZE));
# 109 "tests/Histogram64/histogram64.cu"
h_HistogramCPU = ((unsigned *)malloc((64) * sizeof(unsigned)));
# 110 "tests/Histogram64/histogram64.cu"
h_HistogramGPU = ((unsigned *)malloc((64) * sizeof(unsigned)));
# 112 "tests/Histogram64/histogram64.cu"
printf("...generating input data\n");
# 113 "tests/Histogram64/histogram64.cu"
srand(2007);
# 114 "tests/Histogram64/histogram64.cu"
for (i = 0; i < DATA_N; i++) {
# 115 "tests/Histogram64/histogram64.cu"
(h_Data[i]) = (rand() % 256); }
# 117 "tests/Histogram64/histogram64.cu"
printf("...allocating GPU memory and copying input data\n");
# 118 "tests/Histogram64/histogram64.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_Data), DATA_SIZE), "tests/Histogram64/histogram64.cu", 118);
# 119 "tests/Histogram64/histogram64.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_Histogram), (64) * sizeof(unsigned)), "tests/Histogram64/histogram64.cu", 119);
# 120 "tests/Histogram64/histogram64.cu"
__cudaSafeCall(cudaMemcpy(d_Data, h_Data, DATA_SIZE, cudaMemcpyHostToDevice), "tests/Histogram64/histogram64.cu", 120);
# 123 "tests/Histogram64/histogram64.cu"
printf("Running GPU histogram (%i iterations)...\n", NUM_ITERATIONS);
# 124 "tests/Histogram64/histogram64.cu"
initHistogram64GPU();
# 125 "tests/Histogram64/histogram64.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/Histogram64/histogram64.cu", 125);
# 126 "tests/Histogram64/histogram64.cu"
__cutilCheckError(cutResetTimer(hTimer), "tests/Histogram64/histogram64.cu", 126);
# 127 "tests/Histogram64/histogram64.cu"
__cutilCheckError(cutStartTimer(hTimer), "tests/Histogram64/histogram64.cu", 127);
# 128 "tests/Histogram64/histogram64.cu"
for (iter = 0; iter < NUM_ITERATIONS; iter++) { ; }
# 129 "tests/Histogram64/histogram64.cu"
histogram64GPU(d_Histogram, (unsigned *)d_Data, DATA_N);
# 130 "tests/Histogram64/histogram64.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/Histogram64/histogram64.cu", 130);
# 132 "tests/Histogram64/histogram64.cu"
__cutilCheckError(cutStopTimer(hTimer), "tests/Histogram64/histogram64.cu", 132);
# 133 "tests/Histogram64/histogram64.cu"
timerValue = (cutGetTimerValue(hTimer) / NUM_ITERATIONS);
# 134 "tests/Histogram64/histogram64.cu"
closeHistogram64GPU();
# 135 "tests/Histogram64/histogram64.cu"
printf("histogram64GPU() time (average) : %f msec //%f MB/sec\n", timerValue, DATA_SIZE / (((1000000.0) * timerValue) * (0.001000000000000000021)));
# 137 "tests/Histogram64/histogram64.cu"
printf("Reading back GPU results...\n");
# 138 "tests/Histogram64/histogram64.cu"
__cudaSafeCall(cudaMemcpy(h_HistogramGPU, d_Histogram, (64) * sizeof(unsigned), cudaMemcpyDeviceToHost), "tests/Histogram64/histogram64.cu", 138);
# 140 "tests/Histogram64/histogram64.cu"
printf("Comparing the results...\n");
# 141 "tests/Histogram64/histogram64.cu"
printf("...histogramCPU()\n");
# 142 "tests/Histogram64/histogram64.cu"
__cutilCheckError(cutResetTimer(hTimer), "tests/Histogram64/histogram64.cu", 142);
# 143 "tests/Histogram64/histogram64.cu"
__cutilCheckError(cutStartTimer(hTimer), "tests/Histogram64/histogram64.cu", 143);
# 144 "tests/Histogram64/histogram64.cu"
histogram64CPU(h_HistogramCPU, (unsigned *)h_Data, DATA_N / 4);
# 149 "tests/Histogram64/histogram64.cu"
__cutilCheckError(cutStopTimer(hTimer), "tests/Histogram64/histogram64.cu", 149);
# 150 "tests/Histogram64/histogram64.cu"
timerValue = (cutGetTimerValue(hTimer));
# 151 "tests/Histogram64/histogram64.cu"
printf("histogram64CPU() time : %f msec //%f MB/sec\n", timerValue, DATA_SIZE / (((1048576.0) * timerValue) * (0.001000000000000000021)));
# 153 "tests/Histogram64/histogram64.cu"
sum = 0;
# 154 "tests/Histogram64/histogram64.cu"
delta = 0;
# 155 "tests/Histogram64/histogram64.cu"
for (i = 0; i < 64; i++) {
# 156 "tests/Histogram64/histogram64.cu"
sum += (h_HistogramGPU[i]);
# 157 "tests/Histogram64/histogram64.cu"
delta += abs(((int)(h_HistogramGPU[i])) - ((int)(h_HistogramCPU[i])));
# 158 "tests/Histogram64/histogram64.cu"
}
# 160 "tests/Histogram64/histogram64.cu"
printf("Total sum of histogram elements: %i\n", sum);
# 161 "tests/Histogram64/histogram64.cu"
printf("Sum of absolute differences: %i\n", delta);
# 162 "tests/Histogram64/histogram64.cu"
printf((delta == 0) ? ("TEST PASSED\n") : ("TEST FAILED\n"));
# 164 "tests/Histogram64/histogram64.cu"
printf("Shutting down...\n");
# 165 "tests/Histogram64/histogram64.cu"
__cutilCheckError(cutDeleteTimer(hTimer), "tests/Histogram64/histogram64.cu", 165);
# 166 "tests/Histogram64/histogram64.cu"
__cudaSafeCall(cudaFree(d_Histogram), "tests/Histogram64/histogram64.cu", 166);
# 167 "tests/Histogram64/histogram64.cu"
__cudaSafeCall(cudaFree(d_Data), "tests/Histogram64/histogram64.cu", 167);
# 168 "tests/Histogram64/histogram64.cu"
free(h_HistogramGPU);
# 169 "tests/Histogram64/histogram64.cu"
free(h_HistogramCPU);
# 170 "tests/Histogram64/histogram64.cu"
free(h_Data);
# 172 "tests/Histogram64/histogram64.cu"
cudaThreadExit();
# 174 "tests/Histogram64/histogram64.cu"
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x000000000000387d,0x0000006001000002,0x00000000000012d0\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000002000000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x69482f7374736574,0x366d6172676f7473,0x676f747369682f34\n"
".quad 0x75632e34366d6172,0x0000000000000000,0x33010102464c457f,0x0000000000000004\n"
".quad 0x0000000100be0002,0x0000000000000000,0x00000000000011b8,0x0000000000000040\n"
".quad 0x0038004000140514,0x0001000d00400005,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000300000001,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000380,0x000000000000017b,0x0000000000000000\n"
".quad 0x0000000000000004,0x0000000000000000,0x000000030000000b,0x0000000000000000\n"
".quad 0x0000000000000000,0x00000000000004fb,0x000000000000003c,0x0000000000000000\n"
".quad 0x0000000000000001,0x0000000000000000,0x0000000200000013,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000537,0x0000000000000198,0x0000000f00000002\n"
".quad 0x0000000000000001,0x0000000000000018,0x0000000100000084,0x0000000000100006\n"
".quad 0x0000000000000000,0x00000000000006cf,0x00000000000003b8,0x0e00000900000003\n"
".quad 0x0000000000000004,0x0000000000000000,0x000000010000014d,0x0000000000000002\n"
".quad 0x0000000000000000,0x0000000000000a87,0x0000000000000034,0x0000000400000000\n"
".quad 0x0000000000000004,0x0000000000000000,0x00000001000000aa,0x0000000000000002\n"
".quad 0x0000000000000000,0x0000000000000abb,0x000000000000004c,0x0000000400000000\n"
".quad 0x0000000000000001,0x0000000000000000,0x0000000800000122,0x0000000000000003\n"
".quad 0x0000000000000000,0x0000000000000b07,0x0000000000000400,0x0000000400000000\n"
".quad 0x0000000000000004,0x0000000000000000,0x0000000100000036,0x0000000000100006\n"
".quad 0x0000000000000000,0x0000000000000b07,0x0000000000000600,0x0f00000600000003\n"
".quad 0x0000000000000004,0x0000000000000000,0x00000001000000f9,0x0000000000000002\n"
".quad 0x315f314242206172,0x636f6c2e0a0a3b36,0x3120323631203220,0x726168732e646c0a\n"
".quad 0x25203233752e6465,0x72255b202c363472,0x2e646c0a3b5d336c,0x752e646572616873\n"
".quad 0x2c38347225203233,0x312b336c72255b20,0x2e6464610a3b5d36,0x3035722520323373\n"
".quad 0x202c36347225202c,0x74730a3b38347225,0x2e6465726168732e,0x6c72255b20323375\n"
".quad 0x30357225202c5d33,0x315f3142420a0a3b,0x20636f6c2e0a3a36,0x0a31203036312032\n"
".quad 0x636e79732e726162,0x636f6c2e0a3b3020,0x3120313631203220,0x74672e707465730a\n"
".quad 0x397025203233752e,0x202c37377225202c,0x20397025400a3b31,0x5f31424220617262\n"
".quad 0x6f6c2e0a0a3b3831,0x2032363120322063,0x6168732e646c0a31,0x203233752e646572\n"
".quad 0x255b202c32357225,0x646c0a3b5d336c72,0x2e6465726168732e,0x3435722520323375\n"
".quad 0x2b336c72255b202c,0x2e6464610a3b5d38,0x3635722520323373,0x202c32357225202c\n"
".quad 0x74730a3b34357225,0x2e6465726168732e,0x6c72255b20323375,0x36357225202c5d33\n"
".quad 0x315f3142420a0a3b,0x20636f6c2e0a3a38,0x0a31203036312032,0x636e79732e726162\n"
".quad 0x636f6c2e0a3b3020,0x3120313631203220,0x656e2e707465730a,0x317025203233732e\n"
".quad 0x2c37377225202c30,0x317025400a3b3020,0x4242206172622030,0x2e0a0a3b30325f31\n"
".quad 0x3631203220636f6c,0x732e646c0a312032,0x33752e6465726168,0x202c383572252032\n"
".quad 0x0a3b5d336c72255b,0x65726168732e646c,0x7225203233752e64,0x6c72255b202c3036\n"
".quad 0x64610a3b5d342b33,0x7225203233732e64,0x38357225202c3236,0x0a3b30367225202c\n"
".quad 0x65726168732e7473,0x255b203233752e64,0x7225202c5d336c72,0x3142420a0a3b3236\n"
".quad 0x6f6c2e0a3a30325f,0x2035363120322063,0x652e707465730a31,0x7025203233732e71\n"
".quad 0x37377225202c3131,0x7025400a3b30202c,0x4220617262203131,0x0a0a3b32325f3142\n"
".quad 0x31203220636f6c2e,0x7465720a32203736,0x325f3142420a0a3b,0x20636f6c2e0a3a32\n"
".quad 0x0a31203636312032,0x65726168732e646c,0x7225203233752e64,0x635f5f5b202c3436\n"
".quad 0x61636f6c5f616475,0x38315f7261765f6c,0x6e5f32345f313731,0x74736e6f635f6e6f\n"
".quad 0x0a3b5d617461645f,0x203233752e766f6d,0x6325202c35367225,0x0a3b782e64696174\n"
".quad 0x656469772e6c756d,0x6c7225203233752e,0x35367225202c3031,0x6464610a3b34202c\n"
".quad 0x6c7225203436732e,0x316c7225202c3131,0x3b30316c7225202c,0x626f6c672e74730a\n"
".quad 0x5b203233752e6c61,0x202c5d31316c7225,0x6c2e0a3b34367225,0x373631203220636f\n"
".quad 0x0a3b7465720a3220,0x000000000a0a0a7d\n"
".text");
...
# 151 "tests/Histogram64/histogram64_kernel.cuh"
