...
# 17 "tests/MersenneTwister/MersenneTwister.h"
typedef
# 12 "tests/MersenneTwister/MersenneTwister.h"
struct {
# 13 "tests/MersenneTwister/MersenneTwister.h"
unsigned matrix_a;
# 14 "tests/MersenneTwister/MersenneTwister.h"
unsigned mask_b;
# 15 "tests/MersenneTwister/MersenneTwister.h"
unsigned mask_c;
# 16 "tests/MersenneTwister/MersenneTwister.h"
unsigned seed;
# 17 "tests/MersenneTwister/MersenneTwister.h"
} mt_struct_stripped;
# 57 "tests/MersenneTwister/MersenneTwister.cu"
extern "C" int iDivUp(int a, int b) {
# 58 "tests/MersenneTwister/MersenneTwister.cu"
return ((a % b) != 0) ? ((a / b) + 1) : (a / b);
# 59 "tests/MersenneTwister/MersenneTwister.cu"
}
# 62 "tests/MersenneTwister/MersenneTwister.cu"
extern "C" int iDivDown(int a, int b) {
# 63 "tests/MersenneTwister/MersenneTwister.cu"
return a / b;
# 64 "tests/MersenneTwister/MersenneTwister.cu"
}
# 67 "tests/MersenneTwister/MersenneTwister.cu"
extern "C" int iAlignUp(int a, int b) {
# 68 "tests/MersenneTwister/MersenneTwister.cu"
return ((a % b) != 0) ? ((a - (a % b)) + b) : a;
# 69 "tests/MersenneTwister/MersenneTwister.cu"
}
# 72 "tests/MersenneTwister/MersenneTwister.cu"
extern "C" int iAlignDown(int a, int b) {
# 73 "tests/MersenneTwister/MersenneTwister.cu"
return a - (a % b);
# 74 "tests/MersenneTwister/MersenneTwister.cu"
}
# 81 "tests/MersenneTwister/MersenneTwister.cu"
extern "C" void initMTRef(const char * );
# 82 "tests/MersenneTwister/MersenneTwister.cu"
extern "C" void RandomRef(float * , int , unsigned );
# 83 "tests/MersenneTwister/MersenneTwister.cu"
extern "C" void BoxMullerRef(float * , int );
# 40 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
static mt_struct_stripped ds_MT[4096];
# 41 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
static mt_struct_stripped h_MT[4096];
# 45 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
void loadMTGPU(const char *fname) {
# 46 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
FILE *fd = fopen(fname, "rb");
# 47 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
if (!(fd)) {
# 48 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
printf("initMTGPU(): failed to open %s\n", fname);
# 49 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
printf("TEST FAILED\n");
# 50 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
exit(0);
# 51 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
}
# 52 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
if (!(fread(h_MT, sizeof h_MT, 1, fd))) {
# 53 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
printf("initMTGPU(): failed to load %s\n", fname);
# 54 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
printf("TEST FAILED\n");
# 55 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
exit(0);
# 56 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
}
# 57 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
fclose(fd);
# 58 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
}
# 61 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
void seedMTGPU(unsigned seed) {
# 62 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
int i;
# 64 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
mt_struct_stripped *MT = ((mt_struct_stripped *)malloc((4096) * sizeof(mt_struct_stripped)));
# 66 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
for (i = 0; i < 4096; i++) {
# 67 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
(MT[i]) = ((h_MT)[i]);
# 68 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
((MT[i]).seed) = seed;
# 69 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
}
# 70 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
{ cudaError err = cudaMemcpyToSymbol(ds_MT, MT, sizeof h_MT); if ((cudaSuccess) != err) { fprintf(stderr, "Cuda error in file \'%s\' in line %i : %s.\n", "tests/MersenneTwister/MersenneTwister_kernel.cuh", 70, cudaGetErrorString(err)); exit(1); } } ; ;
# 72 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
free(MT);
# 73 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
}
# 85 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
void RandomGPU(float *
# 86 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
d_Random, int
# 87 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
NPerRng) ;
# 144 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
__attribute__((unused)) inline void BoxMuller(float &u1, float &u2) {int volatile ___ = 1;(void)u1;(void)u2;
# 149 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
exit(___);}
# 151 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
void BoxMullerGPU(float *d_Random, int NPerRng) ;
# 97 "tests/MersenneTwister/MersenneTwister.cu"
static const int PATH_N = 24000000;
# 98 "tests/MersenneTwister/MersenneTwister.cu"
static const int N_PER_RNG = iAlignUp(iDivUp(PATH_N, 4096), 2);
# 99 "tests/MersenneTwister/MersenneTwister.cu"
static const int RAND_N = (4096 * N_PER_RNG);
# 101 "tests/MersenneTwister/MersenneTwister.cu"
static const unsigned SEED = (777);
# 109 "tests/MersenneTwister/MersenneTwister.cu"
int main(int argc, char **argv) {
# 111 "tests/MersenneTwister/MersenneTwister.cu"
float *d_Rand;
# 114 "tests/MersenneTwister/MersenneTwister.cu"
float *h_RandCPU,
# 115 "tests/MersenneTwister/MersenneTwister.cu"
*h_RandGPU;
# 118 "tests/MersenneTwister/MersenneTwister.cu"
double rCPU, rGPU, delta, sum_delta, max_delta, sum_ref, L1norm, gpuTime;
# 120 "tests/MersenneTwister/MersenneTwister.cu"
int i, j;
# 121 "tests/MersenneTwister/MersenneTwister.cu"
unsigned hTimer;
# 124 "tests/MersenneTwister/MersenneTwister.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 125 "tests/MersenneTwister/MersenneTwister.cu"
cutilDeviceInit(argc, argv); } else {
# 127 "tests/MersenneTwister/MersenneTwister.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 129 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckError(cutCreateTimer(&hTimer), "tests/MersenneTwister/MersenneTwister.cu", 129);
# 131 "tests/MersenneTwister/MersenneTwister.cu"
printf("Initializing data for %i samples...\n", PATH_N);
# 132 "tests/MersenneTwister/MersenneTwister.cu"
h_RandCPU = ((float *)malloc(RAND_N * sizeof(float)));
# 133 "tests/MersenneTwister/MersenneTwister.cu"
h_RandGPU = ((float *)malloc(RAND_N * sizeof(float)));
# 134 "tests/MersenneTwister/MersenneTwister.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_Rand), RAND_N * sizeof(float)), "tests/MersenneTwister/MersenneTwister.cu", 134);
# 136 "tests/MersenneTwister/MersenneTwister.cu"
printf("Loading CPU and GPU twisters configurations...\n");
# 137 "tests/MersenneTwister/MersenneTwister.cu"
const char *raw_path = (cutFindFilePath("MersenneTwister.raw", argv[0]));
# 138 "tests/MersenneTwister/MersenneTwister.cu"
const char *dat_path = (cutFindFilePath("MersenneTwister.dat", argv[0]));
# 139 "tests/MersenneTwister/MersenneTwister.cu"
initMTRef(raw_path);
# 140 "tests/MersenneTwister/MersenneTwister.cu"
loadMTGPU(dat_path);
# 141 "tests/MersenneTwister/MersenneTwister.cu"
seedMTGPU(SEED);
# 143 "tests/MersenneTwister/MersenneTwister.cu"
printf("Generating random numbers on GPU...\n");
# 144 "tests/MersenneTwister/MersenneTwister.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/MersenneTwister/MersenneTwister.cu", 144);
# 145 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckError(cutResetTimer(hTimer), "tests/MersenneTwister/MersenneTwister.cu", 145);
# 146 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckError(cutStartTimer(hTimer), "tests/MersenneTwister/MersenneTwister.cu", 146);
# 147 "tests/MersenneTwister/MersenneTwister.cu"
cudaConfigureCall(32, 128) ? ((void)0) : RandomGPU(d_Rand, N_PER_RNG);
# 148 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckMsg("RandomGPU() execution failed\n", "tests/MersenneTwister/MersenneTwister.cu", 148);
# 149 "tests/MersenneTwister/MersenneTwister.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/MersenneTwister/MersenneTwister.cu", 149);
# 150 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckError(cutStopTimer(hTimer), "tests/MersenneTwister/MersenneTwister.cu", 150);
# 151 "tests/MersenneTwister/MersenneTwister.cu"
gpuTime = (cutGetTimerValue(hTimer));
# 152 "tests/MersenneTwister/MersenneTwister.cu"
printf("Generated samples : %i \n", RAND_N);
# 153 "tests/MersenneTwister/MersenneTwister.cu"
printf("RandomGPU() time  : %f \n", gpuTime);
# 154 "tests/MersenneTwister/MersenneTwister.cu"
printf("Samples per second: %E \n", RAND_N / (gpuTime * (0.001000000000000000021)));
# 158 "tests/MersenneTwister/MersenneTwister.cu"
printf("Applying Box-Muller transformation on GPU...\n");
# 159 "tests/MersenneTwister/MersenneTwister.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/MersenneTwister/MersenneTwister.cu", 159);
# 160 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckError(cutResetTimer(hTimer), "tests/MersenneTwister/MersenneTwister.cu", 160);
# 161 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckError(cutStartTimer(hTimer), "tests/MersenneTwister/MersenneTwister.cu", 161);
# 162 "tests/MersenneTwister/MersenneTwister.cu"
cudaConfigureCall(32, 128) ? ((void)0) : BoxMullerGPU(d_Rand, N_PER_RNG);
# 163 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckMsg("BoxMullerGPU() execution failed\n", "tests/MersenneTwister/MersenneTwister.cu", 163);
# 164 "tests/MersenneTwister/MersenneTwister.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/MersenneTwister/MersenneTwister.cu", 164);
# 165 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckError(cutStopTimer(hTimer), "tests/MersenneTwister/MersenneTwister.cu", 165);
# 166 "tests/MersenneTwister/MersenneTwister.cu"
gpuTime = (cutGetTimerValue(hTimer));
# 167 "tests/MersenneTwister/MersenneTwister.cu"
printf("Transformed samples : %i \n", RAND_N);
# 168 "tests/MersenneTwister/MersenneTwister.cu"
printf("BoxMullerGPU() time : %f \n", gpuTime);
# 169 "tests/MersenneTwister/MersenneTwister.cu"
printf("Samples per second  : %E \n", RAND_N / (gpuTime * (0.001000000000000000021)));
# 172 "tests/MersenneTwister/MersenneTwister.cu"
printf("Reading back the results...\n");
# 173 "tests/MersenneTwister/MersenneTwister.cu"
__cudaSafeCall(cudaMemcpy(h_RandGPU, d_Rand, RAND_N * sizeof(float), cudaMemcpyDeviceToHost), "tests/MersenneTwister/MersenneTwister.cu", 173);
# 176 "tests/MersenneTwister/MersenneTwister.cu"
printf("Checking GPU results...\n");
# 177 "tests/MersenneTwister/MersenneTwister.cu"
printf("...generating random numbers on CPU using reference generator\n");
# 178 "tests/MersenneTwister/MersenneTwister.cu"
RandomRef(h_RandCPU, N_PER_RNG, SEED);
# 181 "tests/MersenneTwister/MersenneTwister.cu"
printf("...applying Box-Muller transformation on CPU\n");
# 182 "tests/MersenneTwister/MersenneTwister.cu"
BoxMullerRef(h_RandCPU, N_PER_RNG);
# 185 "tests/MersenneTwister/MersenneTwister.cu"
printf("...comparing the results\n");
# 186 "tests/MersenneTwister/MersenneTwister.cu"
max_delta = (0);
# 187 "tests/MersenneTwister/MersenneTwister.cu"
sum_delta = (0);
# 188 "tests/MersenneTwister/MersenneTwister.cu"
sum_ref = (0);
# 189 "tests/MersenneTwister/MersenneTwister.cu"
for (i = 0; i < 4096; i++) {
# 190 "tests/MersenneTwister/MersenneTwister.cu"
for (j = 0; j < N_PER_RNG; j++) {
# 191 "tests/MersenneTwister/MersenneTwister.cu"
rCPU = (h_RandCPU[(i * N_PER_RNG) + j]);
# 192 "tests/MersenneTwister/MersenneTwister.cu"
rGPU = (h_RandGPU[i + (j * 4096)]);
# 193 "tests/MersenneTwister/MersenneTwister.cu"
delta = fabs(rCPU - rGPU);
# 194 "tests/MersenneTwister/MersenneTwister.cu"
sum_delta += delta;
# 195 "tests/MersenneTwister/MersenneTwister.cu"
sum_ref += fabs(rCPU);
# 196 "tests/MersenneTwister/MersenneTwister.cu"
if (delta >= max_delta) { max_delta = delta; }
# 197 "tests/MersenneTwister/MersenneTwister.cu"
} }
# 198 "tests/MersenneTwister/MersenneTwister.cu"
L1norm = ((float)(sum_delta / sum_ref));
# 199 "tests/MersenneTwister/MersenneTwister.cu"
printf("Max absolute error: %E\n", max_delta);
# 200 "tests/MersenneTwister/MersenneTwister.cu"
printf("L1 norm: %E\n", L1norm);
# 201 "tests/MersenneTwister/MersenneTwister.cu"
printf((L1norm < (9.999999999999999547e-07)) ? ("TEST PASSED\n") : ("TEST FAILED\n"));
# 203 "tests/MersenneTwister/MersenneTwister.cu"
printf("Shutting down...\n");
# 204 "tests/MersenneTwister/MersenneTwister.cu"
__cudaSafeCall(cudaFree(d_Rand), "tests/MersenneTwister/MersenneTwister.cu", 204);
# 205 "tests/MersenneTwister/MersenneTwister.cu"
free(h_RandGPU);
# 206 "tests/MersenneTwister/MersenneTwister.cu"
free(h_RandCPU);
# 208 "tests/MersenneTwister/MersenneTwister.cu"
__cutilCheckError(cutDeleteTimer(hTimer), "tests/MersenneTwister/MersenneTwister.cu", 208);
# 210 "tests/MersenneTwister/MersenneTwister.cu"
cudaThreadExit();
# 212 "tests/MersenneTwister/MersenneTwister.cu"
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x00000000000039cd,0x0000006801000002,0x0000000000001750\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000002800000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x654d2f7374736574,0x7754656e6e657372,0x654d2f7265747369\n"
".quad 0x7754656e6e657372,0x75632e7265747369,0x0000000000000000,0x33010102464c457f\n"
".quad 0x0000000000000004,0x0000000100be0002,0x0000000000000000,0x0000000000001638\n"
".quad 0x0000000000000040,0x0038004000140514,0x0001001000400005,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000300000001\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000440,0x0000000000000149\n"
".quad 0x0000000000000000,0x0000000000000004,0x0000000000000000,0x000000030000000b\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000589,0x00000000000000a1\n"
".quad 0x0000000000000000,0x0000000000000001,0x0000000000000000,0x0000000200000013\n"
".quad 0x0000000000000000,0x0000000000000000,0x000000000000062a,0x0000000000000240\n"
".quad 0x0000001100000002,0x0000000000000001,0x0000000000000018,0x000000010000006e\n"
".quad 0x0000000000000006,0x0000000000000000,0x000000000000086a,0x0000000000000368\n"
".quad 0x0000e00100074000,0x0000a0001de75000,0x00001441dc004000,0x000010721c40c800\n"
".quad 0xcfc00071dc405800,0x000020811e005800,0x00001c411c003008,0x000000001de73010\n"
".quad 0xfffffc41dc029000,0x0000fc73dc2339ff,0x0002200025e71a8e,0x0000fc43dc004000\n"
".quad 0x0000400025e7288e,0xfffffc011de24000,0x0001a0001de719ff,0xdfe00043dc804000\n"
".quad 0x00001121dc44298e,0x0000400005e71080,0xcfe000411c204000,0x000100001de75000\n"
".quad 0xdfe00073dc004000,0xd7e00041e400290e,0x000014722400307e,0x00001c826440c800\n"
".quad 0xcfc0008224405800,0x00002491e6005800,0x00002071e400300e,0xcbe0007124403012\n"
".quad 0x000000001de75800,0x0000000000009000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x63c33fb504f30080\n"
".quad 0x72183daaab503b20,0x0a04727fffff3f31,0x00200000000c0008,0x1704000c1903000c\n"
".quad 0x000100000000000c,0x17040011f0000008,0x000000000000000c,0x0d040021f0000000\n"
".quad 0x0020002201980008,0x440400005de40000,0x000094001c042800,0x000084009c042c00\n"
".quad 0xc00140105d032c00,0x40002001dca34800,0x400050001de42004,0xc00010125c032800\n"
".quad 0xc03ffc71dc234800,0x400020021ca31a0e,0x0000000001e75000,0x4000a3f1dc238000\n"
".quad 0x000040011de2188e,0xc00040701ce31800,0x1e259404dde25000,0xb80000709ca319b0\n"
".quad 0x78001000dc432009,0x000030215c854800,0xc00078501c038400,0x000014001c835800\n"
".quad 0x800004035ca36800,0xc00078d01c032026,0x000010935c855800,0x000034001c83c800\n"
".quad 0x800014031ca36800,0xc00078c01c032026,0x000020931c855800,0x000030001c83c800\n"
".quad 0x80002402dca36800,0xc00078b01c032026,0x00003092dc855800,0x00002c001c83c800\n"
".quad 0x800034029ca36800,0xc00078a01c032026,0x000040929c855800,0x000028001c83c800\n"
".quad 0x800044001ca36800,0xc00078019c032026,0x000050901c855800,0x000000619c83c800\n"
".quad 0x800054619ca36800,0xc00078639c032026,0x000060919c855800,0x000018e39c83c800\n"
".quad 0x000020219c856800,0x800064e49ca38400,0xc00079239c032026,0x000070949c855800\n"
".quad 0x000048e39c83c800,0x800074e45ca36800,0xc00079139c032026,0x000080945c855800\n"
".quad 0x000044e39c83c800,0x800084e41ca36800,0xc00079039c032026,0x000090941c855800\n"
".quad 0x000040e3dc83c800,0x800094f3dca36800,0xc00078f39c032026,0x0000a093dc855800\n"
".quad 0x000000915c85c800,0x00003ce39c83c800,0x8000a4e39ca36800,0xc00078e35c032026\n"
".quad 0x0000b0939c855800,0x000038d35c83c800,0x8000b4d35ca36800,0xc00078d31c032026\n"
".quad 0x0000c0935c855800,0x000034c31c83c800,0x8000c4c31ca36800,0xc00078c2dc032026\n"
".quad 0x0000d0931c855800,0x000030b2dc83c800,0x8000d4b2dca36800,0xc00078b29c032026\n"
".quad 0x0000e092dc855800,0x00002ca29c83c800,0x8000e4a29ca36800,0xc00078a01c032026\n"
".quad 0x6625202c37316625,0x636f6c2e0a3b3132,0x2030363133203520,0x33662e6c756d0a33\n"
".quad 0x202c333266252032,0x6625202c32326625,0x636f6c2e0a3b3731,0x3520303536203420\n"
".quad 0x2e6e722e616d660a,0x3432662520323366,0x202c33326625202c,0x6625202c36316625\n"
".quad 0x636f6c2e0a3b3531,0x2032363133203520,0x33662e6464610a33,0x202c353266252032\n"
".quad 0x6625202c34326625,0x636f6c2e0a3b3131,0x2032333233203520,0x6e722e7476630a35\n"
".quad 0x3233732e3233662e,0x25202c3632662520,0x766f6d0a3b363272,0x326625203233662e\n"
".quad 0x3346336630202c37,0x2e0a3b3831323731,0x3536203420636f6c,0x2e616d660a352030\n"
".quad 0x25203233662e6e72,0x326625202c363366,0x2c37326625202c36,0x0a0a3b3532662520\n"
".quad 0x2e0a3a375f314242,0x3531203220636f6c,0x2e6c756d0a312037,0x3832662520323366\n"
".quad 0x202c36336625202c,0x3030303030436630,0x636f6c2e0a3b3030,0x3520313939203420\n"
".quad 0x6e722e747271730a,0x326625203233662e,0x3b38326625202c39,0x203220636f6c2e0a\n"
".quad 0x646c0a3120373531,0x2e6c61626f6c672e,0x3033662520323366,0x2b326c72255b202c\n"
".quad 0x0a3b5d3438333631,0x203233662e6c756d,0x6625202c31336625,0x30346630202c3033\n"
".quad 0x0a3b424446303943,0x35203420636f6c2e,0x736f630a35203237,0x2e786f727070612e\n"
".quad 0x3233662520323366,0x0a3b31336625202c,0x31203220636f6c2e,0x6c756d0a31203735\n"
".quad 0x336625203233662e,0x2c39326625202c33,0x730a3b3233662520,0x6c61626f6c672e74\n"
".quad 0x72255b203233662e,0x336625202c5d326c,0x20636f6c2e0a3b33,0x0a35203036352034\n"
".quad 0x727070612e6e6973,0x25203233662e786f,0x336625202c343366,0x20636f6c2e0a3b31\n"
".quad 0x0a31203735312032,0x203233662e6c756d,0x6625202c35336625,0x34336625202c3932\n"
".quad 0x6f6c672e74730a3b,0x203233662e6c6162,0x36312b326c72255b,0x6625202c5d343833\n"
".quad 0x636f6c2e0a3b3533,0x3220363531203220,0x33732e6464610a36,0x202c333372252032\n"
".quad 0x3b32202c33337225,0x617261702e646c0a,0x7225203233752e6d,0x315a5f5b202c3033\n"
".quad 0x6c6c754d786f4232,0x6966505550477265,0x315f6d617261705f,0x20636f6c2e0a3b5d\n"
".quad 0x0a31203635312032,0x2e746c2e70746573,0x2c38702520323373,0x25202c3333722520\n"
".quad 0x7025400a3b303372,0x4242206172622038,0x42420a0a3b345f31,0x6f6c2e0a3a385f31\n"
".quad 0x2035353120322063,0x732e6464610a3332,0x2c32337225203233,0x25202c3233722520\n"
".quad 0x636f6c2e0a3b3372,0x3120353531203220,0x746c2e707465730a,0x397025203233732e\n"
".quad 0x202c32337225202c,0x25400a3b36393034,0x4220617262203970,0x420a0a3b325f3142\n"
".quad 0x6c2e0a3a395f3142,0x313631203220636f,0x0a3b7465720a3220,0x000000000a0a0a7d\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[1852];
...
# 88 "tests/MersenneTwister/MersenneTwister_kernel.cuh"
