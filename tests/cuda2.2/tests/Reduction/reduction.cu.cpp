...
# 4 "./tests/Reduction/reduction.h"
template< class T> void reduce_sm10(int , int , int , int , T * , T * );
# 8 "./tests/Reduction/reduction.h"
template< class T> void reduce_sm13(int , int , int , int , T * , T * );
# 71 "tests/Reduction/reduction.cu"
enum ReduceType {
# 73 "tests/Reduction/reduction.cu"
REDUCE_INT,
# 74 "tests/Reduction/reduction.cu"
REDUCE_FLOAT,
# 75 "tests/Reduction/reduction.cu"
REDUCE_DOUBLE
# 76 "tests/Reduction/reduction.cu"
};
# 80 "tests/Reduction/reduction.cu"
template< class T> void runTest(int , char ** , ReduceType );
# 88 "tests/Reduction/reduction.cu"
extern "C" bool isPow2(unsigned x)
# 89 "tests/Reduction/reduction.cu"
{
# 90 "tests/Reduction/reduction.cu"
return (x & (x - (1))) == (0);
# 91 "tests/Reduction/reduction.cu"
}
# 98 "tests/Reduction/reduction.cu"
int main(int argc, char **argv)
# 99 "tests/Reduction/reduction.cu"
{
# 100 "tests/Reduction/reduction.cu"
char *typeChoice;
# 101 "tests/Reduction/reduction.cu"
cutGetCmdLineArgumentstr(argc, (const char **)argv, "type", &typeChoice);
# 103 "tests/Reduction/reduction.cu"
if ((0) == typeChoice)
# 104 "tests/Reduction/reduction.cu"
{
# 105 "tests/Reduction/reduction.cu"
typeChoice = ((char *)malloc((4) * sizeof(char)));
# 106 "tests/Reduction/reduction.cu"
strcpy(typeChoice, "int");
# 107 "tests/Reduction/reduction.cu"
}
# 109 "tests/Reduction/reduction.cu"
ReduceType datatype = REDUCE_INT;
# 111 "tests/Reduction/reduction.cu"
if (!(strcasecmp(typeChoice, "float"))) {
# 112 "tests/Reduction/reduction.cu"
datatype = REDUCE_FLOAT; } else {
# 113 "tests/Reduction/reduction.cu"
if (!(strcasecmp(typeChoice, "double"))) {
# 114 "tests/Reduction/reduction.cu"
datatype = REDUCE_DOUBLE; } else {
# 116 "tests/Reduction/reduction.cu"
datatype = REDUCE_INT; } }
# 118 "tests/Reduction/reduction.cu"
printf("Reducing array of type %s.\n", typeChoice);
# 120 "tests/Reduction/reduction.cu"
cudaDeviceProp deviceProp;
# 121 "tests/Reduction/reduction.cu"
(deviceProp.major) = 1;
# 122 "tests/Reduction/reduction.cu"
(deviceProp.minor) = 0;
# 123 "tests/Reduction/reduction.cu"
int desiredMinorRevision = 0;
# 125 "tests/Reduction/reduction.cu"
if (datatype == (REDUCE_DOUBLE))
# 126 "tests/Reduction/reduction.cu"
{
# 127 "tests/Reduction/reduction.cu"
(deviceProp.minor) = 3;
# 128 "tests/Reduction/reduction.cu"
desiredMinorRevision = 3;
# 129 "tests/Reduction/reduction.cu"
}
# 131 "tests/Reduction/reduction.cu"
int dev;
# 133 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaChooseDevice(&dev, &deviceProp), "tests/Reduction/reduction.cu", 133);
# 134 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaGetDeviceProperties(&deviceProp, dev), "tests/Reduction/reduction.cu", 134);
# 136 "tests/Reduction/reduction.cu"
if (((deviceProp.major) > 1) || ((deviceProp.minor) >= desiredMinorRevision))
# 137 "tests/Reduction/reduction.cu"
{
# 138 "tests/Reduction/reduction.cu"
printf("Using Device %d: \"%s\"\n", dev, deviceProp.name);
# 139 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaSetDevice(dev), "tests/Reduction/reduction.cu", 139);
# 140 "tests/Reduction/reduction.cu"
} else {
# 141 "tests/Reduction/reduction.cu"
if (desiredMinorRevision == 3)
# 142 "tests/Reduction/reduction.cu"
{
# 143 "tests/Reduction/reduction.cu"
printf("There is no device supporting compute capability %d.%d.\n\n", 1, desiredMinorRevision);
# 145 "tests/Reduction/reduction.cu"
printf("TEST PASSED");
# 146 "tests/Reduction/reduction.cu"
cudaThreadExit();
# 147 "tests/Reduction/reduction.cu"
__cutilExit(argc, argv);
# 148 "tests/Reduction/reduction.cu"
} }
# 150 "tests/Reduction/reduction.cu"
switch (datatype)
# 151 "tests/Reduction/reduction.cu"
{
# 152 "tests/Reduction/reduction.cu"
default:
# 153 "tests/Reduction/reduction.cu"
case REDUCE_INT:
# 154 "tests/Reduction/reduction.cu"
runTest< int> (argc, argv, datatype);
# 155 "tests/Reduction/reduction.cu"
break;
# 156 "tests/Reduction/reduction.cu"
case REDUCE_FLOAT:
# 157 "tests/Reduction/reduction.cu"
runTest< float> (argc, argv, datatype);
# 158 "tests/Reduction/reduction.cu"
break;
# 159 "tests/Reduction/reduction.cu"
case REDUCE_DOUBLE:
# 160 "tests/Reduction/reduction.cu"
runTest< double> (argc, argv, datatype);
# 161 "tests/Reduction/reduction.cu"
break;
# 162 "tests/Reduction/reduction.cu"
}
# 164 "tests/Reduction/reduction.cu"
cudaThreadExit();
# 165 "tests/Reduction/reduction.cu"
__cutilExit(argc, argv); return 0;
# 166 "tests/Reduction/reduction.cu"
}
# 176 "tests/Reduction/reduction.cu"
template< class T> T
# 177 "tests/Reduction/reduction.cu"
reduceCPU(T *data, int size)
# 178 "tests/Reduction/reduction.cu"
{
# 179 "tests/Reduction/reduction.cu"
T sum = (data[0]);
# 180 "tests/Reduction/reduction.cu"
T c = ((T)(0.0));
# 181 "tests/Reduction/reduction.cu"
for (int i = 1; i < size; i++)
# 182 "tests/Reduction/reduction.cu"
{
# 183 "tests/Reduction/reduction.cu"
T y = ((data[i]) - c);
# 184 "tests/Reduction/reduction.cu"
T t = (sum + y);
# 185 "tests/Reduction/reduction.cu"
c = ((t - sum) - y);
# 186 "tests/Reduction/reduction.cu"
sum = t;
# 187 "tests/Reduction/reduction.cu"
}
# 188 "tests/Reduction/reduction.cu"
return sum;
# 189 "tests/Reduction/reduction.cu"
}
# 191 "tests/Reduction/reduction.cu"
unsigned nextPow2(unsigned x) {
# 192 "tests/Reduction/reduction.cu"
--x;
# 193 "tests/Reduction/reduction.cu"
x |= (x >> 1);
# 194 "tests/Reduction/reduction.cu"
x |= (x >> 2);
# 195 "tests/Reduction/reduction.cu"
x |= (x >> 4);
# 196 "tests/Reduction/reduction.cu"
x |= (x >> 8);
# 197 "tests/Reduction/reduction.cu"
x |= (x >> 16);
# 198 "tests/Reduction/reduction.cu"
return ++x;
# 199 "tests/Reduction/reduction.cu"
}
# 208 "tests/Reduction/reduction.cu"
void getNumBlocksAndThreads(int whichKernel, int n, int maxBlocks, int maxThreads, int &blocks, int &threads)
# 209 "tests/Reduction/reduction.cu"
{
# 213 "tests/Reduction/reduction.cu"
if (whichKernel < 3)
# 214 "tests/Reduction/reduction.cu"
{
# 215 "tests/Reduction/reduction.cu"
threads = ((n < maxThreads) ? nextPow2(n) : (maxThreads));
# 216 "tests/Reduction/reduction.cu"
blocks = (((n + threads) - 1) / threads);
# 217 "tests/Reduction/reduction.cu"
} else
# 219 "tests/Reduction/reduction.cu"
{
# 220 "tests/Reduction/reduction.cu"
threads = ((n < (maxThreads * 2)) ? nextPow2((n + 1) / 2) : (maxThreads));
# 221 "tests/Reduction/reduction.cu"
blocks = ((n + ((threads * 2) - 1)) / (threads * 2));
# 222 "tests/Reduction/reduction.cu"
}
# 225 "tests/Reduction/reduction.cu"
if (whichKernel == 6) {
# 226 "tests/Reduction/reduction.cu"
blocks = min(maxBlocks, blocks); }
# 227 "tests/Reduction/reduction.cu"
}
# 233 "tests/Reduction/reduction.cu"
template< class T> T
# 234 "tests/Reduction/reduction.cu"
benchmarkReduce(int n, int
# 235 "tests/Reduction/reduction.cu"
numThreads, int
# 236 "tests/Reduction/reduction.cu"
numBlocks, int
# 237 "tests/Reduction/reduction.cu"
maxThreads, int
# 238 "tests/Reduction/reduction.cu"
maxBlocks, int
# 239 "tests/Reduction/reduction.cu"
whichKernel, int
# 240 "tests/Reduction/reduction.cu"
testIterations, bool
# 241 "tests/Reduction/reduction.cu"
cpuFinalReduction, int
# 242 "tests/Reduction/reduction.cu"
cpuFinalThreshold, unsigned
# 243 "tests/Reduction/reduction.cu"
timer, bool
# 244 "tests/Reduction/reduction.cu"
useSM13, T *
# 245 "tests/Reduction/reduction.cu"
h_odata, T *
# 246 "tests/Reduction/reduction.cu"
d_idata, T *
# 247 "tests/Reduction/reduction.cu"
d_odata)
# 248 "tests/Reduction/reduction.cu"
{
# 249 "tests/Reduction/reduction.cu"
T gpu_result = (0);
# 250 "tests/Reduction/reduction.cu"
bool needReadBack = true;
# 252 "tests/Reduction/reduction.cu"
for (int i = 0; i < testIterations; ++i)
# 253 "tests/Reduction/reduction.cu"
{
# 254 "tests/Reduction/reduction.cu"
gpu_result = 0;
# 256 "tests/Reduction/reduction.cu"
cudaThreadSynchronize();
# 257 "tests/Reduction/reduction.cu"
__cutilCheckError(cutStartTimer(timer), "tests/Reduction/reduction.cu", 257);
# 260 "tests/Reduction/reduction.cu"
if (useSM13) {
# 261 "tests/Reduction/reduction.cu"
reduce_sm13< T> (n, numThreads, numBlocks, whichKernel, d_idata, d_odata); } else {
# 263 "tests/Reduction/reduction.cu"
reduce_sm10< T> (n, numThreads, numBlocks, whichKernel, d_idata, d_odata); }
# 266 "tests/Reduction/reduction.cu"
__cutilCheckMsg("Kernel execution failed", "tests/Reduction/reduction.cu", 266);
# 268 "tests/Reduction/reduction.cu"
if (cpuFinalReduction)
# 269 "tests/Reduction/reduction.cu"
{
# 272 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(h_odata, d_odata, numBlocks * sizeof(T), cudaMemcpyDeviceToHost), "tests/Reduction/reduction.cu", 272);
# 274 "tests/Reduction/reduction.cu"
for (int i = 0; i < numBlocks; i++)
# 275 "tests/Reduction/reduction.cu"
{
# 276 "tests/Reduction/reduction.cu"
gpu_result += (h_odata[i]);
# 277 "tests/Reduction/reduction.cu"
}
# 279 "tests/Reduction/reduction.cu"
needReadBack = false;
# 280 "tests/Reduction/reduction.cu"
} else
# 282 "tests/Reduction/reduction.cu"
{
# 284 "tests/Reduction/reduction.cu"
int s = numBlocks;
# 285 "tests/Reduction/reduction.cu"
int kernel = ((whichKernel == 6) ? 5 : whichKernel);
# 286 "tests/Reduction/reduction.cu"
while (s > cpuFinalThreshold)
# 287 "tests/Reduction/reduction.cu"
{
# 288 "tests/Reduction/reduction.cu"
int threads = 0, blocks = 0;
# 289 "tests/Reduction/reduction.cu"
getNumBlocksAndThreads(kernel, s, maxBlocks, maxThreads, blocks, threads);
# 291 "tests/Reduction/reduction.cu"
if (useSM13) {
# 292 "tests/Reduction/reduction.cu"
reduce_sm13< T> (s, threads, blocks, kernel, d_odata, d_odata); } else {
# 294 "tests/Reduction/reduction.cu"
reduce_sm10< T> (s, threads, blocks, kernel, d_odata, d_odata); }
# 296 "tests/Reduction/reduction.cu"
if (kernel < 3) {
# 297 "tests/Reduction/reduction.cu"
s = (((s + threads) - 1) / threads); } else {
# 299 "tests/Reduction/reduction.cu"
s = ((s + ((threads * 2) - 1)) / (threads * 2)); }
# 300 "tests/Reduction/reduction.cu"
}
# 302 "tests/Reduction/reduction.cu"
if (s > 1)
# 303 "tests/Reduction/reduction.cu"
{
# 305 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(h_odata, d_odata, s * sizeof(T), cudaMemcpyDeviceToHost), "tests/Reduction/reduction.cu", 305);
# 307 "tests/Reduction/reduction.cu"
for (int i = 0; i < s; i++)
# 308 "tests/Reduction/reduction.cu"
{
# 309 "tests/Reduction/reduction.cu"
gpu_result += (h_odata[i]);
# 310 "tests/Reduction/reduction.cu"
}
# 312 "tests/Reduction/reduction.cu"
needReadBack = false;
# 313 "tests/Reduction/reduction.cu"
}
# 314 "tests/Reduction/reduction.cu"
}
# 316 "tests/Reduction/reduction.cu"
cudaThreadSynchronize();
# 317 "tests/Reduction/reduction.cu"
__cutilCheckError(cutStopTimer(timer), "tests/Reduction/reduction.cu", 317);
# 318 "tests/Reduction/reduction.cu"
}
# 320 "tests/Reduction/reduction.cu"
if (needReadBack)
# 321 "tests/Reduction/reduction.cu"
{
# 323 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(&gpu_result, d_odata, sizeof(T), cudaMemcpyDeviceToHost), "tests/Reduction/reduction.cu", 323);
# 324 "tests/Reduction/reduction.cu"
}
# 326 "tests/Reduction/reduction.cu"
return gpu_result;
# 327 "tests/Reduction/reduction.cu"
}
# 335 "tests/Reduction/reduction.cu"
template< class T> void
# 336 "tests/Reduction/reduction.cu"
shmoo(int minN, int maxN, int maxThreads, int maxBlocks, ReduceType datatype)
# 337 "tests/Reduction/reduction.cu"
{
# 338 "tests/Reduction/reduction.cu"
bool useSM13 = (datatype == (REDUCE_DOUBLE));
# 341 "tests/Reduction/reduction.cu"
unsigned bytes = (maxN * sizeof(T));
# 343 "tests/Reduction/reduction.cu"
T *h_idata = ((T *)malloc(bytes));
# 345 "tests/Reduction/reduction.cu"
for (int i = 0; i < maxN; i++) {
# 347 "tests/Reduction/reduction.cu"
if (datatype == (REDUCE_INT)) {
# 348 "tests/Reduction/reduction.cu"
(h_idata[i]) = ((T)(rand() & 255)); } else {
# 350 "tests/Reduction/reduction.cu"
(h_idata[i]) = ((rand() & 255) / ((T)2147483647)); }
# 351 "tests/Reduction/reduction.cu"
}
# 353 "tests/Reduction/reduction.cu"
int maxNumBlocks = (maxN / maxThreads);
# 356 "tests/Reduction/reduction.cu"
T *h_odata = ((T *)malloc(maxNumBlocks * sizeof(T)));
# 359 "tests/Reduction/reduction.cu"
T *d_idata = (__null);
# 360 "tests/Reduction/reduction.cu"
T *d_odata = (__null);
# 362 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMalloc((void **)(&d_idata), bytes), "tests/Reduction/reduction.cu", 362);
# 363 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMalloc((void **)(&d_odata), maxNumBlocks * sizeof(T)), "tests/Reduction/reduction.cu", 363);
# 366 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(d_idata, h_idata, bytes, cudaMemcpyHostToDevice), "tests/Reduction/reduction.cu", 366);
# 367 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(d_odata, h_idata, maxNumBlocks * sizeof(T), cudaMemcpyHostToDevice), "tests/Reduction/reduction.cu", 367);
# 380 "tests/Reduction/reduction.cu"
int testIterations = 1;
# 383 "tests/Reduction/reduction.cu"
unsigned timer = (0);
# 384 "tests/Reduction/reduction.cu"
__cutilCheckError(cutCreateTimer(&timer), "tests/Reduction/reduction.cu", 384);
# 387 "tests/Reduction/reduction.cu"
printf("Time in milliseconds for various numbers of elements for each kernel\n");
# 388 "tests/Reduction/reduction.cu"
printf("\n\n");
# 389 "tests/Reduction/reduction.cu"
printf("Kernel");
# 390 "tests/Reduction/reduction.cu"
for (int i = minN; i <= maxN; i *= 2)
# 391 "tests/Reduction/reduction.cu"
{
# 392 "tests/Reduction/reduction.cu"
printf(", %d", i);
# 393 "tests/Reduction/reduction.cu"
}
# 395 "tests/Reduction/reduction.cu"
for (int kernel = 0; kernel < 7; kernel++)
# 396 "tests/Reduction/reduction.cu"
{
# 397 "tests/Reduction/reduction.cu"
printf("\n");
# 398 "tests/Reduction/reduction.cu"
printf("%d", kernel);
# 399 "tests/Reduction/reduction.cu"
for (int i = minN; i <= maxN; i *= 2)
# 400 "tests/Reduction/reduction.cu"
{
# 401 "tests/Reduction/reduction.cu"
cutResetTimer(timer);
# 402 "tests/Reduction/reduction.cu"
int numBlocks = 0;
# 403 "tests/Reduction/reduction.cu"
int numThreads = 0;
# 404 "tests/Reduction/reduction.cu"
getNumBlocksAndThreads(kernel, i, maxBlocks, maxThreads, numBlocks, numThreads);
# 407 "tests/Reduction/reduction.cu"
...
# 410 "tests/Reduction/reduction.cu"
float reduceTime = cutGetAverageTimerValue(timer);
# 411 "tests/Reduction/reduction.cu"
printf(", %f", reduceTime);
# 412 "tests/Reduction/reduction.cu"
}
# 414 "tests/Reduction/reduction.cu"
}
# 417 "tests/Reduction/reduction.cu"
__cutilCheckError(cutDeleteTimer(timer), "tests/Reduction/reduction.cu", 417);
# 418 "tests/Reduction/reduction.cu"
free(h_idata);
# 419 "tests/Reduction/reduction.cu"
free(h_odata);
# 421 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaFree(d_idata), "tests/Reduction/reduction.cu", 421);
# 422 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaFree(d_odata), "tests/Reduction/reduction.cu", 422);
# 423 "tests/Reduction/reduction.cu"
}
# 428 "tests/Reduction/reduction.cu"
template< class T> void
# 430 "tests/Reduction/reduction.cu"
runTest(int argc, char **argv, ReduceType datatype)
# 431 "tests/Reduction/reduction.cu"
{
# 432 "tests/Reduction/reduction.cu"
int size = (1 << 20);
# 433 "tests/Reduction/reduction.cu"
int maxThreads = 128;
# 434 "tests/Reduction/reduction.cu"
int whichKernel = 6;
# 435 "tests/Reduction/reduction.cu"
int maxBlocks = 64;
# 436 "tests/Reduction/reduction.cu"
bool cpuFinalReduction = false;
# 437 "tests/Reduction/reduction.cu"
int cpuFinalThreshold = 1;
# 439 "tests/Reduction/reduction.cu"
cutGetCmdLineArgumenti(argc, (const char **)argv, "n", &size);
# 440 "tests/Reduction/reduction.cu"
cutGetCmdLineArgumenti(argc, (const char **)argv, "threads", &maxThreads);
# 441 "tests/Reduction/reduction.cu"
cutGetCmdLineArgumenti(argc, (const char **)argv, "kernel", &whichKernel);
# 442 "tests/Reduction/reduction.cu"
cutGetCmdLineArgumenti(argc, (const char **)argv, "maxblocks", &maxBlocks);
# 444 "tests/Reduction/reduction.cu"
printf("%d elements\n", size);
# 445 "tests/Reduction/reduction.cu"
printf("%d threads (max)\n", maxThreads);
# 447 "tests/Reduction/reduction.cu"
cpuFinalReduction = ((cutCheckCmdLineFlag(argc, (const char **)argv, "cpufinal")) == (CUTTrue));
# 448 "tests/Reduction/reduction.cu"
cutGetCmdLineArgumenti(argc, (const char **)argv, "cputhresh", &cpuFinalThreshold);
# 450 "tests/Reduction/reduction.cu"
bool runShmoo = ((cutCheckCmdLineFlag(argc, (const char **)argv, "shmoo")) == (CUTTrue));
# 452 "tests/Reduction/reduction.cu"
if (runShmoo)
# 453 "tests/Reduction/reduction.cu"
{
# 454 "tests/Reduction/reduction.cu"
shmoo< T> (1, 33554432, maxThreads, maxBlocks, datatype);
# 455 "tests/Reduction/reduction.cu"
} else
# 457 "tests/Reduction/reduction.cu"
{
# 460 "tests/Reduction/reduction.cu"
unsigned bytes = (size * sizeof(T));
# 462 "tests/Reduction/reduction.cu"
T *h_idata = ((T *)malloc(bytes));
# 464 "tests/Reduction/reduction.cu"
for (int i = 0; i < size; i++)
# 465 "tests/Reduction/reduction.cu"
{
# 467 "tests/Reduction/reduction.cu"
if (datatype == (REDUCE_INT)) {
# 468 "tests/Reduction/reduction.cu"
(h_idata[i]) = ((T)(rand() & 255)); } else {
# 470 "tests/Reduction/reduction.cu"
(h_idata[i]) = ((rand() & 255) / ((T)2147483647)); }
# 471 "tests/Reduction/reduction.cu"
}
# 473 "tests/Reduction/reduction.cu"
int numBlocks = 0;
# 474 "tests/Reduction/reduction.cu"
int numThreads = 0;
# 475 "tests/Reduction/reduction.cu"
getNumBlocksAndThreads(whichKernel, size, maxBlocks, maxThreads, numBlocks, numThreads);
# 476 "tests/Reduction/reduction.cu"
if (numBlocks == 1) { cpuFinalThreshold = 1; }
# 479 "tests/Reduction/reduction.cu"
T *h_odata = ((T *)malloc(numBlocks * sizeof(T)));
# 481 "tests/Reduction/reduction.cu"
printf("%d blocks\n", numBlocks);
# 484 "tests/Reduction/reduction.cu"
T *d_idata = (__null);
# 485 "tests/Reduction/reduction.cu"
T *d_odata = (__null);
# 487 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMalloc((void **)(&d_idata), bytes), "tests/Reduction/reduction.cu", 487);
# 488 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMalloc((void **)(&d_odata), numBlocks * sizeof(T)), "tests/Reduction/reduction.cu", 488);
# 491 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(d_idata, h_idata, bytes, cudaMemcpyHostToDevice), "tests/Reduction/reduction.cu", 491);
# 492 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaMemcpy(d_odata, h_idata, numBlocks * sizeof(T), cudaMemcpyHostToDevice), "tests/Reduction/reduction.cu", 492);
# 503 "tests/Reduction/reduction.cu"
int testIterations = 1;
# 506 "tests/Reduction/reduction.cu"
unsigned timer = (0);
# 507 "tests/Reduction/reduction.cu"
__cutilCheckError(cutCreateTimer(&timer), "tests/Reduction/reduction.cu", 507);
# 509 "tests/Reduction/reduction.cu"
T gpu_result = (0);
# 511 "tests/Reduction/reduction.cu"
...
# 516 "tests/Reduction/reduction.cu"
float reduceTime = cutGetAverageTimerValue(timer);
# 517 "tests/Reduction/reduction.cu"
printf("Average time: %f ms\n", reduceTime);
# 518 "tests/Reduction/reduction.cu"
printf("Bandwidth:    %f GB/s\n\n", (size * sizeof(int)) / (reduceTime * (1000000.0)));
# 521 "tests/Reduction/reduction.cu"
T cpu_result = (reduceCPU< T> (h_idata, size));
# 523 "tests/Reduction/reduction.cu"
if (datatype == (REDUCE_INT))
# 524 "tests/Reduction/reduction.cu"
{
# 525 "tests/Reduction/reduction.cu"
printf("GPU result = %d\n", gpu_result);
# 526 "tests/Reduction/reduction.cu"
printf("CPU result = %d\n", cpu_result);
# 528 "tests/Reduction/reduction.cu"
printf("TEST %s\n", (gpu_result == cpu_result) ? ("PASSED") : ("FAILED"));
# 529 "tests/Reduction/reduction.cu"
} else
# 531 "tests/Reduction/reduction.cu"
{
# 532 "tests/Reduction/reduction.cu"
printf("GPU result = %0.12f\n", gpu_result);
# 533 "tests/Reduction/reduction.cu"
printf("CPU result = %0.12f\n", cpu_result);
# 535 "tests/Reduction/reduction.cu"
double threshold = ((datatype == (REDUCE_FLOAT)) ? ((1.000000000000000021e-08) * size) : (9.999999999999999799e-13));
# 536 "tests/Reduction/reduction.cu"
double diff = abs(((double)gpu_result) - ((double)cpu_result));
# 537 "tests/Reduction/reduction.cu"
printf("TEST %s\n", (diff < threshold) ? ("PASSED") : ("FAILED"));
# 538 "tests/Reduction/reduction.cu"
}
# 543 "tests/Reduction/reduction.cu"
__cutilCheckError(cutDeleteTimer(timer), "tests/Reduction/reduction.cu", 543);
# 544 "tests/Reduction/reduction.cu"
free(h_idata);
# 545 "tests/Reduction/reduction.cu"
free(h_odata);
# 547 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaFree(d_idata), "tests/Reduction/reduction.cu", 547);
# 548 "tests/Reduction/reduction.cu"
__cudaSafeCallNoSync(cudaFree(d_odata), "tests/Reduction/reduction.cu", 548);
# 549 "tests/Reduction/reduction.cu"
}
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000366,0x0000005801000002,0x0000000000000278\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000001c00000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x65522f7374736574,0x2f6e6f6974637564,0x6f69746375646572\n"
".quad 0x0000000075632e6e,0x33010102464c457f,0x0000000000000004,0x0000000100be0002\n"
".quad 0x0000000000000000,0x0000000000000208,0x0000000000000040,0x0038004000140114\n"
...
".quad 0x0000006001000001,0x0000000000000036,0x0000003800000000,0x0000001400030000\n"
".quad 0x0000001c00000040,0x0000000000000015,0x0000000000000000,0x0000000000000000\n"
".quad 0x65522f7374736574,0x2f6e6f6974637564,0x6f69746375646572,0x0000000075632e6e\n"
...
extern const unsigned long long fatbinData[111];
