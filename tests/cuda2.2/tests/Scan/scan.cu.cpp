...
# 51 "tests/Scan/scan.cu"
void runTest(int , char ** );
# 55 "tests/Scan/scan.cu"
extern "C" unsigned compare(const float * , const float * , const unsigned );
# 58 "tests/Scan/scan.cu"
extern "C" void computeGold(float * , float * , const unsigned );
# 64 "tests/Scan/scan.cu"
int main(int argc, char **argv)
# 65 "tests/Scan/scan.cu"
{
# 66 "tests/Scan/scan.cu"
runTest(argc, argv);
# 67 "tests/Scan/scan.cu"
__cutilExit(argc, argv); return 0;
# 68 "tests/Scan/scan.cu"
}
# 74 "tests/Scan/scan.cu"
void runTest(int argc, char **argv)
# 75 "tests/Scan/scan.cu"
{
# 77 "tests/Scan/scan.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 78 "tests/Scan/scan.cu"
cutilDeviceInit(argc, argv); } else {
# 80 "tests/Scan/scan.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 82 "tests/Scan/scan.cu"
unsigned num_elements = (512);
# 83 "tests/Scan/scan.cu"
cutGetCmdLineArgumenti(argc, (const char **)argv, "n", (int *)(&num_elements));
# 85 "tests/Scan/scan.cu"
unsigned timer;
# 86 "tests/Scan/scan.cu"
__cutilCheckError(cutCreateTimer(&timer), "tests/Scan/scan.cu", 86);
# 88 "tests/Scan/scan.cu"
const unsigned num_threads = (num_elements / (2));
# 89 "tests/Scan/scan.cu"
const unsigned mem_size = (sizeof(float) * num_elements);
# 92 "tests/Scan/scan.cu"
unsigned extra_space = (num_elements / (16));
# 98 "tests/Scan/scan.cu"
const unsigned shared_mem_size = (sizeof(float) * (num_elements + extra_space));
# 102 "tests/Scan/scan.cu"
float *h_data = ((float *)malloc(mem_size));
# 106 "tests/Scan/scan.cu"
for (unsigned i = (0); i < num_elements; ++i)
# 107 "tests/Scan/scan.cu"
{
# 108 "tests/Scan/scan.cu"
(h_data[i]) = floorf((1000) * ((rand()) / ((float)2147483647)));
# 109 "tests/Scan/scan.cu"
}
# 112 "tests/Scan/scan.cu"
float *reference = ((float *)malloc(mem_size));
# 113 "tests/Scan/scan.cu"
computeGold(reference, h_data, num_elements);
# 116 "tests/Scan/scan.cu"
float *d_idata;
# 117 "tests/Scan/scan.cu"
float *d_odata[3];
# 118 "tests/Scan/scan.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), mem_size), "tests/Scan/scan.cu", 118);
# 119 "tests/Scan/scan.cu"
__cudaSafeCall(cudaMalloc((void **)(&((d_odata)[0])), mem_size), "tests/Scan/scan.cu", 119);
# 120 "tests/Scan/scan.cu"
__cudaSafeCall(cudaMalloc((void **)(&((d_odata)[1])), mem_size), "tests/Scan/scan.cu", 120);
# 121 "tests/Scan/scan.cu"
__cudaSafeCall(cudaMalloc((void **)(&((d_odata)[2])), mem_size), "tests/Scan/scan.cu", 121);
# 124 "tests/Scan/scan.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_data, mem_size, cudaMemcpyHostToDevice), "tests/Scan/scan.cu", 124);
# 133 "tests/Scan/scan.cu"
dim3 grid(1, 1, 1);
# 135 "tests/Scan/scan.cu"
dim3 threads(num_threads * (2), 1, 1);
# 138 "tests/Scan/scan.cu"
__cutilCheckMsg("Kernel execution failed", "tests/Scan/scan.cu", 138);
# 140 "tests/Scan/scan.cu"
printf("Running parallel prefix sum (scan) of %d elements\n", num_elements);
# 141 "tests/Scan/scan.cu"
printf("Comparing 3 versions:\n\n");
# 144 "tests/Scan/scan.cu"
...
# 152 "tests/Scan/scan.cu"
}
# 153 "tests/Scan/scan.cu"
cudaThreadSynchronize();
# 154 "tests/Scan/scan.cu"
cutStopTimer(timer);
# 155 "tests/Scan/scan.cu"
printf("Average time: %f ms\n\n", cutGetTimerValue(timer) / numIterations);
# 156 "tests/Scan/scan.cu"
cutResetTimer(timer);
# 158 "tests/Scan/scan.cu"
(threads.x) /= (2);
# 160 "tests/Scan/scan.cu"
printf("2. scan_workefficient -- Work efficient (O(n) adds), but many bank conflicts.\n");
# 161 "tests/Scan/scan.cu"
cutStartTimer(timer);
# 162 "tests/Scan/scan.cu"
for (unsigned i = (0); i < numIterations; ++i)
# 163 "tests/Scan/scan.cu"
{
# 164 "tests/Scan/scan.cu"
...
# 173 "tests/Scan/scan.cu"
cutStartTimer(timer);
# 174 "tests/Scan/scan.cu"
for (unsigned i = (0); i < numIterations; ++i)
# 175 "tests/Scan/scan.cu"
{
# 176 "tests/Scan/scan.cu"
cudaConfigureCall(grid, threads, shared_mem_size) ? ((void)0) : scan_best((d_odata)[2], d_idata, num_elements);
# 178 "tests/Scan/scan.cu"
}
# 179 "tests/Scan/scan.cu"
cudaThreadSynchronize();
# 180 "tests/Scan/scan.cu"
cutStopTimer(timer);
# 181 "tests/Scan/scan.cu"
printf("Average time: %f ms\n\n", cutGetTimerValue(timer) / numIterations);
# 182 "tests/Scan/scan.cu"
cutResetTimer(timer);
# 185 "tests/Scan/scan.cu"
__cutilCheckMsg("Kernel execution failed", "tests/Scan/scan.cu", 185);
# 187 "tests/Scan/scan.cu"
for (int i = 0; i < 3; ++i)
# 188 "tests/Scan/scan.cu"
{
# 190 "tests/Scan/scan.cu"
__cudaSafeCall(cudaMemcpy(h_data, (d_odata)[i], sizeof(float) * num_elements, cudaMemcpyDeviceToHost), "tests/Scan/scan.cu", 191);
# 194 "tests/Scan/scan.cu"
...
# 200 "tests/Scan/scan.cu"
{
# 206 "tests/Scan/scan.cu"
float epsilon = (0.0F);
# 207 "tests/Scan/scan.cu"
unsigned result_regtest = (cutComparefe(reference, h_data, num_elements, epsilon));
# 208 "tests/Scan/scan.cu"
char *names[] = {((char *)("scan_naive")), ((char *)("scan_workefficient")), ((char *)("scan_best"))};
# 209 "tests/Scan/scan.cu"
printf("%s: Test %s\n", (names)[i], ((1) == result_regtest) ? ("PASSED") : ("FAILED"));
# 210 "tests/Scan/scan.cu"
}
# 211 "tests/Scan/scan.cu"
}
# 213 "tests/Scan/scan.cu"
printf("\nCheck out the CUDA Data Parallel Primitives Library for more on scan.\n");
# 214 "tests/Scan/scan.cu"
printf("http://www.gpgpu.org/developer/cudpp\n");
# 217 "tests/Scan/scan.cu"
free(h_data);
# 218 "tests/Scan/scan.cu"
free(reference);
# 219 "tests/Scan/scan.cu"
__cudaSafeCall(cudaFree(d_idata), "tests/Scan/scan.cu", 219);
# 220 "tests/Scan/scan.cu"
__cudaSafeCall(cudaFree((d_odata)[0]), "tests/Scan/scan.cu", 220);
# 221 "tests/Scan/scan.cu"
__cudaSafeCall(cudaFree((d_odata)[1]), "tests/Scan/scan.cu", 221);
# 222 "tests/Scan/scan.cu"
__cudaSafeCall(cudaFree((d_odata)[2]), "tests/Scan/scan.cu", 222);
# 223 "tests/Scan/scan.cu"
__cutilCheckError(cutDeleteTimer(timer), "tests/Scan/scan.cu", 223);
# 225 "tests/Scan/scan.cu"
cudaThreadExit();
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x00000000000036f0,0x0000005001000002,0x000000000000121c\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000001200000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x63532f7374736574,0x2e6e6163732f6e61,0x0000000000007563\n"
".quad 0x33010102464c457f,0x0000000000000004,0x0000000100be0002,0x0000000000000000\n"
".quad 0x000000000000113c,0x0000000000000040,0x0038004000140514,0x0001001000400004\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000300000001,0x0000000000000000,0x0000000000000000,0x0000000000000440\n"
".quad 0x00000000000001a8,0x0000000000000000,0x0000000000000004,0x0000000000000000\n"
".quad 0x000000030000000b,0x0000000000000000,0x0000000000000000,0x00000000000005e8\n"
".quad 0x0000000000000043,0x0000000000000000,0x0000000000000001,0x0000000000000000\n"
".quad 0x0000000200000013,0x0000000000000000,0x0000000000000000,0x000000000000062b\n"
".quad 0x00000000000001f8,0x0000001200000002,0x0000000000000001,0x0000000000000018\n"
".quad 0x00000001000000b9,0x0000000000100006,0x0000000000000000,0x0000000000000823\n"
".quad 0x00000000000001b0,0x0a00000b00000003,0x0000000000000004,0x0000000000000000\n"
".quad 0x0000000100000131,0x0000000000000002,0x0000000000000000,0x00000000000009d3\n"
".quad 0x0000000000000034,0x0000000400000000,0x0000000000000004,0x0000000000000000\n"
".quad 0x00000001000000d3,0x0000000000000002,0x0000000000000000,0x0000000000000a07\n"
".quad 0x000000000000004c,0x0000000400000000,0x0000000000000001,0x0000000000000000\n"
".quad 0x0000000100000086,0x0000000000100006,0x0000000000000000,0x0000000000000a53\n"
".quad 0x0000000000000358,0x0e00000900000003,0x0000000000000004,0x0000000000000000\n"
".quad 0x0000000100000111,0x0000000000000002,0x0000000000000000,0x0000000000000dab\n"
".quad 0x0000000000000034,0x0000000700000000,0x0000000000000004,0x0000000000000000\n"
".quad 0x00000001000000f0,0x0000000000000002,0x0000000000000000,0x0000000000000ddf\n"
".quad 0x0000000000000004,0x0000000700000000,0x0000000000000004,0x0000000000000000\n"
".quad 0x000000010000009e,0x0000000000000002,0x0000000000000000,0x0000000000000de3\n"
".quad 0x000000000000004c,0x0000000700000000,0x0000000000000001,0x0000000000000000\n"
".quad 0x2c31357225203233,0x34202c3934722520,0x33732e6464610a3b,0x202c323572252032\n"
".quad 0x7225202c31357225,0x636f6c2e0a3b3934,0x3120303431203420,0x3233732e7268730a\n"
".quad 0x25202c3335722520,0x0a3b34202c303572,0x203233732e646461,0x7225202c34357225\n"
".quad 0x30357225202c3335,0x69772e6c756d0a3b,0x25203233732e6564,0x7225202c34326c72\n"
".quad 0x610a3b34202c3235,0x25203436732e6464,0x7225202c36326c72,0x6c7225202c32316c\n"
".quad 0x636f6c2e0a3b3432,0x3120323431203420,0x726168732e646c0a,0x25203233662e6465\n"
".quad 0x6c72255b202c3666,0x6c756d0a3b5d3632,0x33732e656469772e,0x2c37326c72252032\n"
".quad 0x34202c3435722520,0x36732e6464610a3b,0x2c38326c72252034,0x202c32316c722520\n"
".quad 0x2e0a3b37326c7225,0x3431203420636f6c,0x732e646c0a312033,0x33662e6465726168\n"
".quad 0x5b202c3766252032,0x0a3b5d38326c7225,0x65726168732e7473,0x255b203233662e64\n"
".quad 0x25202c5d36326c72,0x636f6c2e0a3b3766,0x3120343431203420,0x726168732e646c0a\n"
".quad 0x25203233662e6465,0x6c72255b202c3866,0x6464610a3b5d3832,0x396625203233662e\n"
".quad 0x25202c386625202c,0x732e74730a3b3666,0x33662e6465726168,0x38326c72255b2032\n"
".quad 0x0a3b396625202c5d,0x3a32315f3242420a,0x3233622e6c68730a,0x25202c3437722520\n"
".quad 0x0a3b31202c343772,0x6d617261702e646c,0x367225203233752e,0x73395a5f5b202c34\n"
".quad 0x747365625f6e6163,0x61705f695f536650,0x0a3b5d325f6d6172,0x31203420636f6c2e\n"
".quad 0x7465730a31203832,0x3233732e746c2e70,0x7225202c37702520,0x34367225202c3437\n"
".quad 0x6220377025400a3b,0x315f324242206172,0x5f3242420a0a3b30,0x636f6c2e0a3a3331\n"
".quad 0x3120383431203420,0x6e79732e7261620a,0x6f6c2e0a3b302063,0x2031353120342063\n"
".quad 0x36622e6c68730a31,0x2c39326c72252034,0x32202c326c722520,0x36732e6464610a3b\n"
".quad 0x2c30336c72252034,0x25202c316c722520,0x646c0a3b39326c72,0x2e6465726168732e\n"
".quad 0x3031662520323366,0x5d336c72255b202c,0x6f6c672e74730a3b,0x203233662e6c6162\n"
".quad 0x2c5d30336c72255b,0x2e0a3b3031662520,0x3531203420636f6c,0x2e6c68730a312032\n"
".quad 0x336c722520343662,0x2c346c7225202c31,0x2e6464610a3b3220,0x336c722520343673\n"
".quad 0x2c316c7225202c32,0x0a3b31336c722520,0x65726168732e646c,0x6625203233662e64\n"
".quad 0x6c72255b202c3131,0x672e74730a3b5d35,0x33662e6c61626f6c,0x32336c72255b2032\n"
".quad 0x3b31316625202c5d,0x203420636f6c2e0a,0x65720a3220333531,0x000a0a0a7d0a3b74\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[1760];
...
# 47 "./tests/Scan/scan_naive_kernel.cu"
...
# 49 "./tests/Scan/scan_workefficient_kernel.cu"
...
# 79 "./tests/Scan/scan_best_kernel.cu"
