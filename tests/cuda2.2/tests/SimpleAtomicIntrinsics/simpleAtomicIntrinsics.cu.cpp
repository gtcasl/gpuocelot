# 1 "/tmp/tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.cpp"
...
# 47 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics_kernel.cu"
void testKernel(int *g_odata) ;
# 54 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
void runTest(int , char ** );
# 57 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
extern "C" int computeGold(int * , const int );
# 63 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
int main(int argc, char **argv)
# 64 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
{
# 65 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
runTest(argc, argv);
# 67 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cutilExit(argc, argv); return 0;
# 68 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
}
# 74 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
void runTest(int argc, char **argv)
# 75 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
{
# 76 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
cudaDeviceProp deviceProp;
# 77 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
(deviceProp.major) = 0;
# 78 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
(deviceProp.minor) = 0;
# 79 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
int dev;
# 82 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 83 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
cutilDeviceInit(argc, argv); } else {
# 85 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
cudaSetDevice(dev = cutGetMaxGflopsDeviceId()); }
# 87 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaChooseDevice(&dev, &deviceProp), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 87);
# 88 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, dev), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 88);
# 90 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
if (((deviceProp.major) > 1) || ((deviceProp.minor) > 0))
# 91 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
{
# 92 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
printf("Using Device %d: \"%s\"\n", dev, deviceProp.name);
# 93 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
} else
# 95 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
{
# 96 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
printf("There is no device supporting CUDA compute capability 1.1.\n");
# 97 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
printf("TEST PASSED");
# 98 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
cudaThreadExit();
# 99 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cutilExit(argc, argv);
# 100 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
}
# 102 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
unsigned timer = (0);
# 103 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cutilCheckError(cutCreateTimer(&timer), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 103);
# 104 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cutilCheckError(cutStartTimer(timer), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 104);
# 106 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
unsigned numThreads = (256);
# 107 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
unsigned numBlocks = (64);
# 108 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
unsigned numData = (11);
# 109 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
unsigned memSize = (sizeof(int) * numData);
# 112 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
int *h_odata = ((int *)malloc(memSize));
# 115 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
for (unsigned i = (0); i < numData; i++) {
# 116 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
(h_odata[i]) = 0; }
# 119 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
(h_odata[8]) = ((h_odata[10]) = 255);
# 122 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
int *d_odata;
# 123 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), memSize), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 123);
# 125 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(d_odata, h_odata, memSize, cudaMemcpyHostToDevice), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 125);
...
# 130 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cutilCheckMsg("Kernel execution failed", "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 130);
# 132 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_odata, memSize, cudaMemcpyDeviceToHost), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 132);
# 134 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cutilCheckError(cutStopTimer(timer), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 134);
# 135 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
printf("Processing time: %f (ms)\n", cutGetTimerValue(timer));
# 136 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cutilCheckError(cutDeleteTimer(timer), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 136);
# 139 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
if (computeGold(h_odata, numThreads * numBlocks)) {
# 140 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
printf("Test PASSED\n"); } else {
# 142 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
printf("Test FAILED\n"); }
# 145 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
free(h_odata);
# 146 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
__cudaSafeCall(cudaFree(d_odata), "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu", 146);
# 148 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
cudaThreadExit();
# 149 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics.cu"
}
# 1 "tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c"
# 1 "tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_00005eb5_00000000-3_simpleAtomicIntrinsics.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000d17,0x0000007001000002,0x000000000000058c\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000003600000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x69532f7374736574,0x6d6f7441656c706d,0x6e6972746e496369\n"
".quad 0x6d69732f73636973,0x696d6f7441656c70,0x736e6972746e4963,0x000075632e736369\n"
".quad 0x33010102464c457f,0x0000000000000004,0x0000000100be0002,0x0000000000000000\n"
".quad 0x000000000000051c,0x0000000000000040,0x0038004000140514,0x0001000800400002\n"
...
".quad 0x000000010000004d,0x0000000000000002,0x0000000000000000,0x0000000000000501\n"
...
".quad 0x00000028025de228,0x00000094001c0418,0x00000084011c042c,0xffffffd8021de22c\n"
".quad 0x0000004401dde21b,0x00000224019de218,0x00000000225c0518,0x08400020001ca314\n"
".quad 0x00000010221c0520,0x00000004015de214,0x0000005021dc6518,0x00000060219c8514\n"
...
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x00000900080a0400,0x0819030008002000,0x000000000c170400,0x21f0000000000000\n"
".quad 0x00000a0008120400,0x0811040000000000,0x0000000000000a00,0x0000000600000000\n"
".quad 0x0000051c00000005,0x0000000000000000,0x0000000000000000,0x0000007000000000\n"
".quad 0x0000007000000000,0x0000000400000000,0x6000000000000000,0x000003e900000a05\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000011800000000,0x0000011800000000\n"
".quad 0x0000000400000000,0x0100000100000000,0x000006a300000078,0x0000000000000000\n"
".quad 0x0003000000000038,0x0000004000000014,0x0000001500000036,0x0000000000000000\n"
".quad 0x0000000000000000,0x7473657400000000,0x656c706d69532f73,0x6e4963696d6f7441\n"
".quad 0x736369736e697274,0x41656c706d69732f,0x746e4963696d6f74,0x2e736369736e6972\n"
".quad 0x0a0a0a0a00007563,0x69737265762e0a0a,0x2e0a302e33206e6f,0x7320746567726174\n"
".quad 0x64612e0a30325f6d,0x69735f7373657264,0x2e0a0a343620657a,0x22203109656c6966\n"
".quad 0x706d742f706d742f,0x303030305f746678,0x3030305f35626535,0x5f372d3030303030\n"
".quad 0x7441656c706d6973,0x72746e4963696d6f,0x632e736369736e69,0x2e0a22692e337070\n"
".quad 0x22203209656c6966,0x69532f7374736574,0x6d6f7441656c706d,0x6e6972746e496369\n"
".quad 0x6d69732f73636973,0x696d6f7441656c70,0x736e6972746e4963,0x6e72656b5f736369\n"
".quad 0x2e0a2275632e6c65,0x22203309656c6966,0x636f6c2f7273752f,0x34616475632f6c61\n"
...
".quad 0x315f6d732f656475,0x63696d6f74615f31,0x6f6974636e75665f,0x2e0a0a22682e736e\n"
".quad 0x5a5f207972746e65,0x654b747365743031,0x0a2869506c656e72,0x2e206d617261702e\n"
".quad 0x30315a5f20343675,0x6e72654b74736574,0x7261705f69506c65,0x7b0a290a305f6d61\n"
".quad 0x732e206765722e0a,0x31323c7225203233,0x206765722e0a3b3e,0x6c7225203436732e\n"
".quad 0x0a0a0a3b3e33313c,0x6d617261702e646c,0x6c7225203436752e,0x30315a5f5b202c31\n"
".quad 0x6e72654b74736574,0x7261705f69506c65,0x630a3b5d305f6d61,0x672e6f742e617476\n"
".quad 0x36752e6c61626f6c,0x202c326c72252034,0x6c2e0a3b316c7225,0x203035203220636f\n"
".quad 0x33752e766f6d0a31,0x25202c3172252032,0x3b782e6469617463,0x3233752e766f6d0a\n"
".quad 0x6e25202c32722520,0x6d0a3b782e646974,0x25203233752e766f,0x64697425202c3372\n"
".quad 0x2e64616d0a3b782e,0x25203233732e6f6c,0x2c317225202c3472,0x7225202c32722520\n"
".quad 0x20636f6c2e0a3b33,0x3520323338312033,0x6c672e6d6f74610a,0x6464612e6c61626f\n"
".quad 0x357225203233752e,0x5d326c72255b202c,0x6c2e0a3b3031202c,0x203036203220636f\n"
".quad 0x36732e6464610a31,0x202c336c72252034,0x3b34202c326c7225,0x203320636f6c2e0a\n"
".quad 0x610a352032333831,0x626f6c672e6d6f74,0x752e6464612e6c61,0x202c367225203233\n"
".quad 0x202c5d336c72255b,0x6f6c2e0a3b30312d,0x3120333620322063,0x3436732e6464610a\n"
".quad 0x25202c346c722520,0x0a3b38202c326c72,0x31203320636f6c2e,0x74610a3520383438\n"
".quad 0x61626f6c672e6d6f,0x622e686378652e6c,0x202c377225203233,0x202c5d346c72255b\n"
".quad 0x6f6c2e0a3b347225,0x3120363620322063,0x3436732e6464610a,0x25202c356c722520\n"
".quad 0x3b3231202c326c72,0x203320636f6c2e0a,0x610a352031383831,0x626f6c672e6d6f74\n"
".quad 0x732e78616d2e6c61,0x202c387225203233,0x202c5d356c72255b,0x6f6c2e0a3b347225\n"
".quad 0x3120393620322063,0x3436732e6464610a,0x25202c366c722520,0x3b3631202c326c72\n"
".quad 0x203320636f6c2e0a,0x610a352035363831,0x626f6c672e6d6f74,0x732e6e696d2e6c61\n"
".quad 0x202c397225203233,0x202c5d366c72255b,0x6f6c2e0a3b347225,0x3120323720322063\n"
".quad 0x3436732e6464610a,0x25202c376c722520,0x3b3032202c326c72,0x203320636f6c2e0a\n"
".quad 0x610a352037393831,0x626f6c672e6d6f74,0x752e636e692e6c61,0x2c30317225203233\n"
".quad 0x2c5d376c72255b20,0x6f6c2e0a3b373120,0x3120353720322063,0x3436732e6464610a\n"
".quad 0x25202c386c722520,0x3b3432202c326c72,0x203320636f6c2e0a,0x610a352031303931\n"
".quad 0x626f6c672e6d6f74,0x752e6365642e6c61,0x2c31317225203233,0x2c5d386c72255b20\n"
".quad 0x6c2e0a3b37333120,0x203837203220636f,0x36732e6464610a31,0x202c396c72252034\n"
".quad 0x3832202c326c7225,0x33732e6464610a3b,0x202c323172252032,0x3b312d202c347225\n"
".quad 0x203320636f6c2e0a,0x610a352035303931,0x626f6c672e6d6f74,0x622e7361632e6c61\n"
".quad 0x2c33317225203233,0x2c5d396c72255b20,0x25202c3231722520,0x636f6c2e0a3b3472\n"
".quad 0x0a31203338203220,0x203436732e646461,0x25202c30316c7225,0x3b3233202c326c72\n"
".quad 0x3233622e6c68730a,0x25202c3431722520,0x6d0a3b31202c3472,0x25203233752e766f\n"
".quad 0x0a3b31202c353172,0x38203220636f6c2e,0x2e6464610a312033,0x3631722520323373\n"
".quad 0x202c34317225202c,0x20636f6c2e0a3b37,0x3520373139312033,0x6c672e6d6f74610a\n"
".quad 0x646e612e6c61626f,0x317225203233622e,0x316c72255b202c37,0x36317225202c5d30\n"
".quad 0x3220636f6c2e0a3b,0x64610a3120363820,0x7225203436732e64,0x6c7225202c31316c\n"
".quad 0x730a3b3633202c32,0x25203233622e6c68,0x317225202c383172,0x0a3b347225202c35\n"
".quad 0x31203320636f6c2e,0x74610a3520333339,0x61626f6c672e6d6f,0x3233622e726f2e6c\n"
".quad 0x5b202c3931722520,0x202c5d31316c7225,0x6c2e0a3b38317225,0x203938203220636f\n"
".quad 0x36732e6464610a31,0x2c32316c72252034,0x34202c326c722520,0x20636f6c2e0a3b30\n"
".quad 0x3520393439312033,0x6c672e6d6f74610a,0x726f782e6c61626f,0x327225203233622e\n"
".quad 0x316c72255b202c30,0x3b347225202c5d32,0x203220636f6c2e0a,0x7465720a32203039\n"
".quad 0x00000a0a0a7d0a3b\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[421];
...
# 3 "/tmp/tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c" 2 3
extern void __device_stub__Z10testKernelPi(int *);
static void __sti____cudaRegisterAll_57_tmpxft_00005eb5_00000000_4_simpleAtomicIntrinsics_cpp1_ii_cab170b3(void) __attribute__((__constructor__));
...
# 48 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics_kernel.cu"
{__device_stub__Z10testKernelPi( __cuda_0);
# 90 "tests/SimpleAtomicIntrinsics/simpleAtomicIntrinsics_kernel.cu"
}
# 1 "/tmp/tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c"
static void __sti____cudaRegisterAll_57_tmpxft_00005eb5_00000000_4_simpleAtomicIntrinsics_cpp1_ii_cab170b3(void) { __cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil); __cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(int *))testKernel), (char*)"_Z10testKernelPi", "_Z10testKernelPi", -1, (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0); }
# 2 "tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c" 2
# 1 "tmpxft_00005eb5_00000000-1_simpleAtomicIntrinsics.cudafe1.stub.c"
