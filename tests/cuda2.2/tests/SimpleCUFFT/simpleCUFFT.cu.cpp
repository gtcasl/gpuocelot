...
# 44 "tests/SimpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexAdd(Complex, Complex);
# 45 "tests/SimpleCUFFT/simpleCUFFT.cu"
...
((h_signal[i]).y) = (0);
# 92 "tests/SimpleCUFFT/simpleCUFFT.cu"
}
# 95 "tests/SimpleCUFFT/simpleCUFFT.cu"
Complex *h_filter_kernel = ((Complex *)malloc(sizeof(Complex) * (11)));
# 97 "tests/SimpleCUFFT/simpleCUFFT.cu"
for (unsigned i = (0); i < (11); ++i) {
# 98 "tests/SimpleCUFFT/simpleCUFFT.cu"
((h_filter_kernel[i]).x) = ((rand()) / ((float)2147483647));
# 99 "tests/SimpleCUFFT/simpleCUFFT.cu"
((h_filter_kernel[i]).y) = (0);
# 100 "tests/SimpleCUFFT/simpleCUFFT.cu"
}
# 103 "tests/SimpleCUFFT/simpleCUFFT.cu"
Complex *h_padded_signal;
# 104 "tests/SimpleCUFFT/simpleCUFFT.cu"
Complex *h_padded_filter_kernel;
# 105 "tests/SimpleCUFFT/simpleCUFFT.cu"
int new_size = PadData(h_signal, &h_padded_signal, 50, h_filter_kernel, &h_padded_filter_kernel, 11);
# 107 "tests/SimpleCUFFT/simpleCUFFT.cu"
int mem_size = (sizeof(Complex) * new_size);
# 110 "tests/SimpleCUFFT/simpleCUFFT.cu"
Complex *d_signal;
# 111 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_signal), mem_size), "tests/SimpleCUFFT/simpleCUFFT.cu", 111);
# 113 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(d_signal, h_padded_signal, mem_size, cudaMemcpyHostToDevice), "tests/SimpleCUFFT/simpleCUFFT.cu", 114);
# 117 "tests/SimpleCUFFT/simpleCUFFT.cu"
Complex *d_filter_kernel;
# 118 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_filter_kernel), mem_size), "tests/SimpleCUFFT/simpleCUFFT.cu", 118);
# 121 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(d_filter_kernel, h_padded_filter_kernel, mem_size, cudaMemcpyHostToDevice), "tests/SimpleCUFFT/simpleCUFFT.cu", 122);
# 125 "tests/SimpleCUFFT/simpleCUFFT.cu"
cufftHandle plan;
# 126 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftPlan1d(&plan, new_size, CUFFT_C2C, 1), "tests/SimpleCUFFT/simpleCUFFT.cu", 126);
# 129 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, -1), "tests/SimpleCUFFT/simpleCUFFT.cu", 129);
# 130 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_filter_kernel, (cufftComplex *)d_filter_kernel, -1), "tests/SimpleCUFFT/simpleCUFFT.cu", 130);
...
# 136 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cutilCheckMsg("Kernel execution failed [ ComplexPointwiseMulAndScale ]", "tests/SimpleCUFFT/simpleCUFFT.cu", 136);
# 139 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, 1), "tests/SimpleCUFFT/simpleCUFFT.cu", 139);
# 142 "tests/SimpleCUFFT/simpleCUFFT.cu"
Complex *h_convolved_signal = h_padded_signal;
# 143 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(h_convolved_signal, d_signal, mem_size, cudaMemcpyDeviceToHost), "tests/SimpleCUFFT/simpleCUFFT.cu", 144);
...
__cufftSafeCall(cufftDestroy(plan), "tests/SimpleCUFFT/simpleCUFFT.cu", 159);
# 162 "tests/SimpleCUFFT/simpleCUFFT.cu"
free(h_signal);
# 163 "tests/SimpleCUFFT/simpleCUFFT.cu"
free(h_filter_kernel);
# 164 "tests/SimpleCUFFT/simpleCUFFT.cu"
...
__cudaSafeCall(cudaFree(d_signal), "tests/SimpleCUFFT/simpleCUFFT.cu", 167);
# 168 "tests/SimpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaFree(d_filter_kernel), "tests/SimpleCUFFT/simpleCUFFT.cu", 168);
# 170 "tests/SimpleCUFFT/simpleCUFFT.cu"
cudaThreadExit();
# 171 "tests/SimpleCUFFT/simpleCUFFT.cu"
}
...
{
# 177 "tests/SimpleCUFFT/simpleCUFFT.cu"
int minRadius = (filter_kernel_size / 2);
# 178 "tests/SimpleCUFFT/simpleCUFFT.cu"
...
# 210 "tests/SimpleCUFFT/simpleCUFFT.cu"
((filtered_signal[i]).x) = (((filtered_signal[i]).y) = (0));
# 212 "tests/SimpleCUFFT/simpleCUFFT.cu"
for (int j = ((-maxRadius) + 1); j <= minRadius; ++j) {
# 213 "tests/SimpleCUFFT/simpleCUFFT.cu"
int k = (i + j);
# 214 "tests/SimpleCUFFT/simpleCUFFT.cu"
if ((k >= 0) && (k < signal_size)) {
# 215 "tests/SimpleCUFFT/simpleCUFFT.cu"
...
{
# 245 "tests/SimpleCUFFT/simpleCUFFT.cu"
Complex c;
# 246 "tests/SimpleCUFFT/simpleCUFFT.cu"
(c.x) = (((a.x) * (b.x)) - ((a.y) * (b.y)));
# 247 "tests/SimpleCUFFT/simpleCUFFT.cu"
(c.y) = (((a.x) * (b.y)) + ((a.y) * (b.x)));
# 248 "tests/SimpleCUFFT/simpleCUFFT.cu"
return c;
# 249 "tests/SimpleCUFFT/simpleCUFFT.cu"
}
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000e08,0x0000006001000002,0x0000000000000654\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000002000000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x69532f7374736574,0x46465543656c706d,0x656c706d69732f54\n"
