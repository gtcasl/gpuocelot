# 1 "/tmp/tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.cpp"
...
int n = ((16 * 1024) * 1024);
# 85 "tests/SimpleStreams/simpleStreams.cu"
...
# 89 "tests/SimpleStreams/simpleStreams.cu"
int niterations;
...
__cudaSafeCall(cudaGetDeviceCount(&num_devices), "tests/SimpleStreams/simpleStreams.cu", 100);
...
niterations = 5; } else {
# 124 "tests/SimpleStreams/simpleStreams.cu"
niterations = 1; }
# 126 "tests/SimpleStreams/simpleStreams.cu"
printf("running on: %s\n\n", device_properties.name);
# 129 "tests/SimpleStreams/simpleStreams.cu"
int c = 5;
# 130 "tests/SimpleStreams/simpleStreams.cu"
int *a = (0);
# 132 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaMallocHost((void **)(&a), nbytes), "tests/SimpleStreams/simpleStreams.cu", 132);
# 135 "tests/SimpleStreams/simpleStreams.cu"
int *d_a = (0), *d_c = (0);
# 136 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_a), nbytes), "tests/SimpleStreams/simpleStreams.cu", 136);
# 137 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_c), sizeof(int)), "tests/SimpleStreams/simpleStreams.cu", 137);
# 138 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaMemcpy(d_c, &c, sizeof(int), cudaMemcpyHostToDevice), "tests/SimpleStreams/simpleStreams.cu", 138);
# 141 "tests/SimpleStreams/simpleStreams.cu"
cudaStream_t *streams = ((cudaStream_t *)malloc(nstreams * sizeof(cudaStream_t)));
# 142 "tests/SimpleStreams/simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 143 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaStreamCreate(&(streams[i])), "tests/SimpleStreams/simpleStreams.cu", 143); }
# 146 "tests/SimpleStreams/simpleStreams.cu"
cudaEvent_t start_event, stop_event;
# 147 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventCreate(&start_event), "tests/SimpleStreams/simpleStreams.cu", 147);
# 148 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventCreate(&stop_event), "tests/SimpleStreams/simpleStreams.cu", 148);
# 151 "tests/SimpleStreams/simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 152 "tests/SimpleStreams/simpleStreams.cu"
cudaMemcpyAsync(a, d_a, nbytes, cudaMemcpyDeviceToHost, streams[0]);
# 153 "tests/SimpleStreams/simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 154 "tests/SimpleStreams/simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 155 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&time_memcpy, start_event, stop_event), "tests/SimpleStreams/simpleStreams.cu", 155);
# 156 "tests/SimpleStreams/simpleStreams.cu"
printf("memcopy:\t%.2f\n", time_memcpy);
# 159 "tests/SimpleStreams/simpleStreams.cu"
threads = dim3(512, 1);
# 160 "tests/SimpleStreams/simpleStreams.cu"
blocks = dim3(n / (threads.x), 1);
# 161 "tests/SimpleStreams/simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 162 "tests/SimpleStreams/simpleStreams.cu"
...
cudaEventSynchronize(stop_event);
# 165 "tests/SimpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&time_kernel, start_event, stop_event), "tests/SimpleStreams/simpleStreams.cu", 165);
# 166 "tests/SimpleStreams/simpleStreams.cu"
printf("kernel:\t\t%.2f\n", time_kernel);
...
cudaEventRecord(start_event, 0);
# 173 "tests/SimpleStreams/simpleStreams.cu"
for (int k = 0; k < nreps; k++)
# 174 "tests/SimpleStreams/simpleStreams.cu"
{
...
__cudaSafeCall(cudaEventElapsedTime(&elapsed_time, start_event, stop_event), "tests/SimpleStreams/simpleStreams.cu", 180);
# 181 "tests/SimpleStreams/simpleStreams.cu"
printf("non-streamed:\t%.2f (%.2f expected)\n", elapsed_time / nreps, time_kernel + time_memcpy);
# 185 "tests/SimpleStreams/simpleStreams.cu"
threads = dim3(512, 1);
...
# 198 "tests/SimpleStreams/simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 199 "tests/SimpleStreams/simpleStreams.cu"
cudaMemcpyAsync(a + ((i * n) / nstreams), d_a + ((i * n) / nstreams), nbytes / nstreams, cudaMemcpyDeviceToHost, streams[i]); }
# 200 "tests/SimpleStreams/simpleStreams.cu"
}
...
__cudaSafeCall(cudaEventElapsedTime(&elapsed_time, start_event, stop_event), "tests/SimpleStreams/simpleStreams.cu", 203);
...
printf("-------------------------------\n");
# 208 "tests/SimpleStreams/simpleStreams.cu"
if (correct_data(a, n, (c * nreps) * niterations)) {
# 209 "tests/SimpleStreams/simpleStreams.cu"
printf("Test PASSED\n"); } else {
# 211 "tests/SimpleStreams/simpleStreams.cu"
printf("Test FAILED\n"); }
...
cudaFree(d_c);
# 222 "tests/SimpleStreams/simpleStreams.cu"
cudaThreadExit();
# 224 "tests/SimpleStreams/simpleStreams.cu"
__cutilExit(argc, argv);
# 226 "tests/SimpleStreams/simpleStreams.cu"
return 0;
# 227 "tests/SimpleStreams/simpleStreams.cu"
}
# 1 "tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.stub.c"
# 1 "tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_00006c7d_00000000-3_simpleStreams.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000b41,0x0000006001000002,0x000000000000060c\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000002400000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x69532f7374736574,0x65727453656c706d,0x706d69732f736d61\n"
".quad 0x6d6165727453656c,0x0000000075632e73,0x33010102464c457f,0x0000000000000004\n"
".quad 0x0000000100be0002,0x0000000000000000,0x000000000000059c,0x0000000000000040\n"
...
".quad 0x0000000000000000,0x0000000000000240,0x0000000000000098,0x0000000000000000\n"
".quad 0x0000000000000004,0x0000000000000000,0x000000030000000b,0x0000000000000000\n"
".quad 0x0000000000000000,0x00000000000002d8,0x0000000000000015,0x0000000000000000\n"
".quad 0x0000000000000001,0x0000000000000000,0x0000000200000013,0x0000000000000000\n"
".quad 0x0000000000000000,0x00000000000002ed,0x0000000000000108,0x0000000a00000002\n"
".quad 0x0000000000000001,0x0000000000000018,0x0000000100000036,0x0000000000000006\n"
".quad 0x0000000000000000,0x00000000000003f5,0x0000000000000118,0x0900000600000003\n"
".quad 0x0000000000000004,0x0000000000000000,0x0000000100000076,0x0000000000000002\n"
".quad 0x0000000000000000,0x000000000000050d,0x0000000000000034,0x0000000400000000\n"
".quad 0x0000000000000004,0x0000000000000000,0x0000000100000059,0x0000000000000002\n"
".quad 0x0000000000000000,0x0000000000000541,0x0000000000000040,0x0000000400000000\n"
".quad 0x0000000000000001,0x0000000000000000,0x0000000100000050,0x0000000000000002\n"
".quad 0x0000000000000000,0x0000000000000581,0x0000000000000018,0x0000000000000000\n"
...
".quad 0x742e006c61626f6c,0x30315a5f2e747865,0x7272615f74696e69,0x00695f5369507961\n"
".quad 0x6f666e692e766e2e,0x666e692e766e2e00,0x6e6930315a5f2e6f,0x79617272615f7469\n"
".quad 0x6e2e00695f536950,0x6174736e6f632e76,0x30315a5f2e30746e,0x7272615f74696e69\n"
".quad 0x00695f5369507961,0x696e6930315a5f00,0x5079617272615f74,0x00000000695f5369\n"
...
".quad 0x0000000000000000,0x0000010000000000,0x0000000004101200,0x0001180000000000\n"
".quad 0x005de40000000000,0x00dde42800440400,0x001c0428004000c0,0x011c042c00000094\n"
".quad 0x31dc232c00000084,0x009de4188ec00004,0x00dde428004000a0,0x001ca328004000b0\n"
".quad 0x0001e72008400020,0x011de48000000000,0x015ce32800400080,0x019de45000c00010\n"
".quad 0x011ca328004000c0,0x61dc232009c00010,0x515c431a0ec00004,0x019de44800400090\n"
".quad 0x401c8528000000fc,0x0021e78400000000,0x21dc8540000001a0,0x619c038400000000\n"
".quad 0x61dc234800c00008,0x021c03188e4000c0,0x61dc03480000001c,0x421c854800c00004\n"
".quad 0x201c859400000000,0x71dc238400000000,0x801c0318804000c0,0x401c854800000000\n"
".quad 0x0001e79400000000,0x61dc234003fffea0,0x0021e7188e4000c0,0x209c858000000000\n"
".quad 0x001c038400000000,0x401c854800000008,0x001de79400000000,0x0000008000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x00000900080a0400,0x1419030014002000\n"
".quad 0x000000000c170400,0x11f0000010000200,0x000000000c170400,0x21f0000008000100\n"
".quad 0x000000000c170400,0x21f0000000000000,0x00000a0008120400,0x0811040000000000\n"
".quad 0x0000000000000a00,0x0000000600000000,0x0000059c00000005,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000007000000000,0x0000007000000000,0x0000000400000000\n"
".quad 0x6000000000000000,0x000003f500000a05,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000018c00000000,0x0000018c00000000,0x0000000400000000,0x0100000100000000\n"
".quad 0x0000046d00000068,0x0000000000000000,0x0003000000000038,0x0000004000000014\n"
".quad 0x0000001500000024,0x0000000000000000,0x0000000000000000,0x7473657400000000\n"
".quad 0x656c706d69532f73,0x2f736d6165727453,0x7453656c706d6973,0x75632e736d616572\n"
...
".quad 0x706d742f706d742f,0x303030305f746678,0x3030305f64376336,0x5f372d3030303030\n"
".quad 0x7453656c706d6973,0x70632e736d616572,0x662e0a22692e3370,0x7422203209656c69\n"
".quad 0x6d69532f73747365,0x6165727453656c70,0x6c706d69732f736d,0x736d616572745365\n"
".quad 0x652e0a0a2275632e,0x315a5f207972746e,0x72615f74696e6930,0x695f536950796172\n"
".quad 0x6d617261702e0a28,0x5a5f203436752e20,0x615f74696e693031,0x5f53695079617272\n"
".quad 0x5f6d617261705f69,0x617261702e0a2c30,0x5f203436752e206d,0x5f74696e6930315a\n"
".quad 0x5369507961727261,0x6d617261705f695f,0x7261702e0a2c315f,0x203233752e206d61\n"
".quad 0x74696e6930315a5f,0x695079617272615f,0x617261705f695f53,0x0a7b0a290a325f6d\n"
".quad 0x72702e206765722e,0x3e333c7025206465,0x2e206765722e0a3b,0x313c722520323373\n"
".quad 0x6765722e0a3b3e39,0x7225203436732e20,0x0a0a0a3b3e373c6c,0x6d617261702e646c\n"
".quad 0x6c7225203436752e,0x30315a5f5b202c34,0x7272615f74696e69,0x5f695f5369507961\n"
".quad 0x5d305f6d61726170,0x7261702e646c0a3b,0x25203436752e6d61,0x5a5f5b202c356c72\n"
".quad 0x615f74696e693031,0x5f53695079617272,0x5f6d617261705f69,0x702e646c0a3b5d31\n"
".quad 0x3233752e6d617261,0x5f5b202c31722520,0x5f74696e6930315a,0x5369507961727261\n"
...
".quad 0x6c7225202c326c72,0x20636f6c2e0a3b35,0x6d0a312031362032,0x25203233752e766f\n"
".quad 0x69746e25202c3872,0x766f6d0a3b782e64,0x397225203233752e,0x646961746325202c\n"
".quad 0x2e766f6d0a3b782e,0x3031722520323375,0x782e64697425202c,0x6f6c2e64616d0a3b\n"
".quad 0x327225203233732e,0x25202c387225202c,0x30317225202c3972,0x3220636f6c2e0a3b\n"
".quad 0x65730a3120333620,0x33732e746c2e7074,0x25202c3170252032,0x400a3b31202c3172\n"
".quad 0x2061726220317025,0x0a0a3b335f304242,0x36203220636f6c2e,0x2e6c756d0a312034\n"
".quad 0x3233732e65646977,0x25202c366c722520,0x610a3b34202c3272,0x25203436732e6464\n"
".quad 0x6c7225202c336c72,0x3b366c7225202c31,0x626f6c672e646c0a,0x25203233752e6c61\n"
".quad 0x72255b202c373172,0x766f6d0a3b5d336c,0x317225203233752e,0x420a0a3b30202c38\n"
".quad 0x6c2e0a3a325f3042,0x203436203220636f,0x6f6c672e646c0a31,0x203233752e6c6162\n"
".quad 0x255b202c33317225,0x64610a3b5d326c72,0x7225203233732e64,0x37317225202c3731\n"
".quad 0x0a3b33317225202c,0x61626f6c672e7473,0x255b203233752e6c,0x7225202c5d336c72\n"
".quad 0x636f6c2e0a3b3731,0x3033203336203220,0x3233732e6464610a,0x25202c3831722520\n"
".quad 0x0a3b31202c383172,0x6d617261702e646c,0x317225203233752e,0x30315a5f5b202c36\n"
".quad 0x7272615f74696e69,0x5f695f5369507961,0x5d325f6d61726170,0x3220636f6c2e0a3b\n"
".quad 0x65730a3120333620,0x33732e746c2e7074,0x25202c3270252032,0x317225202c383172\n"
".quad 0x20327025400a3b36,0x5f30424220617262,0x5f3042420a0a3b32,0x20636f6c2e0a3a33\n"
".quad 0x720a322035362032,0x0a0a0a7d0a3b7465,0x0000000000000000\n"
".text");
...
# 3 "/tmp/tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.stub.c" 2 3
extern void __device_stub__Z10init_arrayPiS_i(int *, int *, int);
static void __sti____cudaRegisterAll_48_tmpxft_00006c7d_00000000_4_simpleStreams_cpp1_ii_2e3ff9cd(void) __attribute__((__constructor__));
...
# 1 "/tmp/tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.stub.c"
static void __sti____cudaRegisterAll_48_tmpxft_00006c7d_00000000_4_simpleStreams_cpp1_ii_2e3ff9cd(void) { __cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil); __cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(int *, int *, int))init_array), (char*)"_Z10init_arrayPiS_i", "_Z10init_arrayPiS_i", -1, (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0); }
# 2 "tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.stub.c" 2
# 1 "tmpxft_00006c7d_00000000-1_simpleStreams.cudafe1.stub.c"
