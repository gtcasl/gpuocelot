...
# 64 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (int i = ((2 * size) / 4); i < ((3 * size) / 4); i++) {
# 65 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = ((i & 1) ? 0 : i); }
# 68 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
# 81 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (i = start; i < end; i++) {
# 82 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("%d", h_result[i]);
# 83 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
...
return sum > 0;
# 87 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
...
# 96 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
if (sum != warp_size) {
# 97 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\t<%s>[%d - %d] = ", voteType, start, end - 1);
...
# 101 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf(" - FAILED!\n");
# 102 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 103 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return sum != warp_size;
# 104 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
...
int error_count = 0;
# 112 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
# 117 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return error_count;
# 118 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 121 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int checkResultsVoteAllKernel2(unsigned *h_result, int size, int warp_size)
# 122 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 123 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int error_count = 0;
# 126 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, 0, (4 * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 127 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, (4 * warp_size) / 4, ((2 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 128 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, ((2 * 4) * warp_size) / 4, ((3 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 129 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, ((3 * 4) * warp_size) / 4, ((4 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 136 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return error_count;
# 137 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
...
if ((hinfo[i]) != (false)) {
# 149 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count++;
...
# 155 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
# 185 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf((error_count == 0) ? ("\tPASSED!\n") : ("\tFAILED!\n"));
# 186 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return error_count;
# 187 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 189 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int main(int argc, char **argv)
# 190 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 191 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
# 204 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaSetDevice(dev = cutGetMaxGflopsDeviceId()); }
# 206 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaChooseDevice(&dev, &deviceProp), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 206);
# 207 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, 0), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 207);
# 210 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
warp_size = 1;
# 225 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
h_input = ((unsigned *)malloc((4 * warp_size) * sizeof(unsigned)));
# 226 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
h_result = ((unsigned *)malloc((4 * warp_size) * sizeof(unsigned)));
# 227 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_input), (4 * warp_size) * sizeof(unsigned)), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 227);
# 228 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_result), (4 * warp_size) * sizeof(unsigned)), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 228);
...
__cudaSafeCall(cudaMemcpy(d_input, h_input, (4 * warp_size) * sizeof(unsigned), cudaMemcpyHostToDevice), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 230);
...
__cudaSafeCall(cudaThreadSynchronize(), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 236);
...
# 239 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaConfigureCall(gridBlock, threadBlock) ? ((void)0) : VoteAnyKernel1(d_input, d_result, 4 * warp_size);
# 240 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cutilCheckMsg("VoteAnyKernel() execution failed\n", "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 240);
# 241 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 241);
# 242 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 243 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(h_result, d_result, (4 * warp_size) * sizeof(unsigned), cudaMemcpyDeviceToHost), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 243);
# 244 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
__cudaSafeCall(cudaThreadSynchronize(), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 250);
# 251 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
dim3 gridBlock(4, 1);
# 252 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
dim3 threadBlock(warp_size, 1);
# 253 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
__cutilCheckMsg("VoteAllKernel() execution failed\n", "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 254);
# 255 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 255);
# 256 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 257 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(h_result, d_result, (4 * warp_size) * sizeof(unsigned), cudaMemcpyDeviceToHost), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 257);
# 258 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
((error_count)[1]) += checkResultsVoteAllKernel2(h_result, 4 * warp_size, warp_size);
# 261 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
hinfo = ((bool *)calloc((warp_size * 3) * 3, sizeof(bool)));
# 262 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
{
# 269 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 269);
# 270 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
__cudaSafeCall(cudaThreadSynchronize(), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 271);
...
# 283 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 284 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("TEST PASSED\n");
# 285 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
} else
# 286 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 287 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("TEST FAILED\n");
# 288 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 291 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaFree(d_input), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 291);
# 292 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaFree(d_result), "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu", 292);
# 293 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
free(h_input);
# 294 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
free(h_result);
# 297 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
free(hinfo); cudaFree(dinfo);
# 299 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\tShutting down...\n");
# 300 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaThreadExit();
# 301 "tests/SimpleVoteIntrinsics/simpleVoteIntrinsics.cu"
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000001976,0x0000007001000002,0x0000000000000ba8\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000003200000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x69532f7374736574,0x65746f56656c706d,0x69736e6972746e49\n"
...
".quad 0x0000000000000ac8,0x0000000000000040,0x0038004000140514,0x0001000e00400004\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000300000001,0x0000000000000000,0x0000000000000000,0x00000000000003c0\n"
".quad 0x0000000000000168,0x0000000000000000,0x0000000000000004,0x0000000000000000\n"
".quad 0x000000030000000b,0x0000000000000000,0x0000000000000000,0x0000000000000528\n"
".quad 0x0000000000000047,0x0000000000000000,0x0000000000000001,0x0000000000000000\n"
".quad 0x0000000200000013,0x0000000000000000,0x0000000000000000,0x000000000000056f\n"
".quad 0x00000000000001c8,0x0000001000000002,0x0000000000000001,0x0000000000000018\n"
".quad 0x00000001000000b9,0x0000000000000006,0x0000000000000000,0x0000000000000737\n"
".quad 0x0000000000000090,0x0700000b00000003,0x0000000000000004,0x0000000000000000\n"
".quad 0x0000000100000142,0x0000000000000002,0x0000000000000000,0x00000000000007c7\n"
".quad 0x0000000000000034,0x0000000400000000,0x0000000000000004,0x0000000000000000\n"
".quad 0x00000001000000d7,0x0000000000000002,0x0000000000000000,0x00000000000007fb\n"
".quad 0x0000000000000040,0x0000000400000000,0x0000000000000001,0x0000000000000000\n"
".quad 0x000000010000007e,0x0000000000000006,0x0000000000000000,0x000000000000083b\n"
".quad 0x00000000000000d8,0x0800000900000003,0x0000000000000004,0x0000000000000000\n"
".quad 0x000000010000011e,0x0000000000000002,0x0000000000000000,0x0000000000000913\n"
".quad 0x000000000000002c,0x0000000700000000,0x0000000000000004,0x0000000000000000\n"
".quad 0x000000010000009a,0x0000000000000002,0x0000000000000000,0x000000000000093f\n"
".quad 0x000000000000003c,0x0000000700000000,0x0000000000000001,0x0000000000000000\n"
".quad 0x0000000100000036,0x0000000000000006,0x0000000000000000,0x000000000000097b\n"
".quad 0x0000000000000090,0x0700000600000003,0x0000000000000004,0x0000000000000000\n"
".quad 0x00000001000000f8,0x0000000000000002,0x0000000000000000,0x0000000000000a0b\n"
".quad 0x6469746e25202c37,0x2e766f6d0a3b782e,0x2c38722520323375,0x3b782e6469742520\n"
".quad 0x2e6f6c2e64616d0a,0x2c39722520323373,0x7225202c36722520,0x0a3b387225202c37\n"
".quad 0x37203220636f6c2e,0x2e6c756d0a312030,0x25203233732e6f6c,0x397225202c303172\n"
".quad 0x7476630a3b33202c,0x3233732e3436732e,0x25202c346c722520,0x6464610a3b303172\n"
".quad 0x6c7225203436732e,0x2c336c7225202c31,0x2e0a3b346c722520,0x3337203220636f6c\n"
".quad 0x6c2e6c756d0a3120,0x7225203233732e6f,0x2c357225202c3131,0x2e7268730a3b3320\n"
".quad 0x3231722520323375,0x202c31317225202c,0x2e64616d0a3b3133,0x25203233732e6f6c\n"
".quad 0x357225202c333172,0x317225202c33202c,0x732e7268730a3b32,0x2c34317225203233\n"
".quad 0x31202c3331722520,0x672e707465730a3b,0x7025203233732e65,0x202c397225202c31\n"
".quad 0x65730a3b34317225,0x25203233752e706c,0x30202c31202c3472,0x0a0a3b317025202c\n"
".quad 0x6765722e0a207b09,0x2520646572702e20,0x65722e0a203b3170,0x20646572702e2067\n"
".quad 0x65730a203b327025,0x33752e656e2e7074,0x25202c3170252032,0x0a203b30202c3472\n"
".quad 0x796e612e65746f76,0x702520646572702e,0x203b317025202c32,0x33732e706c65730a\n"
".quad 0x31202c3172252032,0x327025202c30202c,0x2e090a0a7d0a203b,0x3337203220636f6c\n"
".quad 0x2e707465730a3120,0x25203233732e656e,0x2c317225202c3270,0x706c65730a3b3020\n"
".quad 0x637225203631752e,0x2c30202c31202c31,0x6c2e0a3b32702520,0x203337203220636f\n"
".quad 0x6f6c672e74730a31,0x5b2038752e6c6162,0x25202c5d316c7225,0x6c65730a3b316372\n"
".quad 0x7225203631752e70,0x30202c31202c3263,0x2e0a3b317025202c,0x3637203220636f6c\n"
".quad 0x6c672e74730a3120,0x2038752e6c61626f,0x5d312b316c72255b,0x0a3b32637225202c\n"
".quad 0x65722e0a207b090a,0x20646572702e2067,0x722e0a203b317025,0x646572702e206765\n"
".quad 0x730a203b32702520,0x752e656e2e707465,0x202c317025203233,0x203b30202c347225\n"
".quad 0x6c612e65746f760a,0x2520646572702e6c,0x3b317025202c3270,0x732e706c65730a20\n"
".quad 0x202c337225203233,0x7025202c30202c31,0x090a0a7d0a203b32,0x37203220636f6c2e\n"
".quad 0x707465730a312038,0x203233732e71652e,0x337225202c337025,0x7025400a3b30202c\n"
".quad 0x4242206172622033,0x6f6d0a0a3b325f32,0x7225203631752e76,0x2e0a3b31202c3363\n"
".quad 0x3937203220636f6c,0x6c672e74730a3120,0x2038752e6c61626f,0x5d322b316c72255b\n"
".quad 0x0a3b33637225202c,0x0a3a325f3242420a,0x38203220636f6c2e,0x3b7465720a322031\n"
".quad 0x0000000a0a0a7d0a\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[817];
...
# 49 "tests/SimpleVoteIntrinsics/simpleVote_kernel.cu"
...
# 59 "tests/SimpleVoteIntrinsics/simpleVote_kernel.cu"
...
# 68 "tests/SimpleVoteIntrinsics/simpleVote_kernel.cu"
