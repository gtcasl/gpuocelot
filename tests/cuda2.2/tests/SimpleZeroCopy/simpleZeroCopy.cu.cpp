# 1 "/tmp/tmpxft_00006065_00000000-1_simpleZeroCopy.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00006065_00000000-1_simpleZeroCopy.cudafe1.cpp"
...
# 43 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
void vectorAddGPU(float *a, float *b, float *c, int N) ;
# 50 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
int main(int argc, char **argv)
# 51 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
{
# 52 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
int n, nelem, idev, deviceCount;
# 53 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
char *device = (__null);
# 54 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
unsigned flags;
# 55 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
size_t bytes;
# 56 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
float *a, *b, *c;
# 57 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
float *d_a, *d_b, *d_c;
# 58 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
float errorNorm, refNorm, ref, diff;
# 59 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
cudaDeviceProp deviceProp;
# 61 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "help"))
# 62 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
{
# 63 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
printf("Usage:  simpleZeroCopy [OPTION]\n\n");
# 64 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
printf("Options:\n");
# 65 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
printf("  --device=[device #]  Specify the device to be used\n");
# 66 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cutilExit(argc, argv);
# 67 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
}
# 71 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
if (cutGetCmdLineArgumentstr(argc, (const char **)argv, "device", &device))
# 72 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
{
# 73 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
cudaGetDeviceCount(&deviceCount);
# 74 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
idev = atoi(device);
# 75 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
if ((idev >= deviceCount) || (idev < 0))
# 76 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
{
# 77 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
fprintf(stderr, "Invalid device number %d, using default device 0.\n", idev);
# 79 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
idev = 0;
# 80 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
}
# 81 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
} else
# 83 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
{
# 84 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
idev = 0;
# 85 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
}
# 87 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaSetDevice(idev), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 87);
# 92 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, idev), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 92);
# 95 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
if (!(deviceProp.canMapHostMemory))
# 96 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
{
# 97 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
fprintf(stderr, "Device %d cannot map host memory!\n", idev);
# 98 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
printf("Test PASSED");
# 99 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cutilExit(argc, argv);
# 100 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
}
# 101 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaSetDeviceFlags(8), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 101);
# 110 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
nelem = 1048576;
# 111 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
bytes = (nelem * sizeof(float));
# 113 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
flags = (2);
# 114 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostAlloc((void **)(&a), bytes, flags), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 114);
# 115 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostAlloc((void **)(&b), bytes, flags), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 115);
# 116 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostAlloc((void **)(&c), bytes, flags), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 116);
# 120 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
for (n = 0; n < nelem; n++)
# 121 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
{
# 122 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
(a[n]) = ((rand()) / ((float)2147483647));
# 123 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
(b[n]) = ((rand()) / ((float)2147483647));
# 124 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
}
# 130 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_a), (void *)a, 0), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 130);
# 131 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_b), (void *)b, 0), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 131);
# 132 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_c), (void *)c, 0), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 132);
# 137 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
printf("Adding vectors using mapped CPU memory...\n");
# 138 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
dim3 block(256);
# 139 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
dim3 grid((unsigned)ceil(nelem / ((float)(block.x))));
# 140 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
cudaConfigureCall(grid, block) ? ((void)0) : vectorAddGPU(d_a, d_b, d_c, nelem);
# 141 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 141);
# 142 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cutilCheckMsg("vectorAddGPU() execution failed", "tests/SimpleZeroCopy/simpleZeroCopy.cu", 142);
# 146 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
printf("Checking the results...\n");
# 147 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
errorNorm = (0.0F);
# 148 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
refNorm = (0.0F);
# 149 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
for (n = 0; n < nelem; n++)
# 150 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
{
# 151 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
ref = ((a[n]) + (b[n]));
# 152 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
diff = ((c[n]) - ref);
# 153 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
errorNorm += (diff * diff);
# 154 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
refNorm += (ref * ref);
# 155 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
}
# 156 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
errorNorm = ((float)sqrt((double)errorNorm));
# 157 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
refNorm = ((float)sqrt((double)refNorm));
# 161 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
printf("Releasing CPU memory...\n");
# 163 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaFreeHost(a), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 163);
# 164 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaFreeHost(b), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 164);
# 165 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaFreeHost(c), "tests/SimpleZeroCopy/simpleZeroCopy.cu", 165);
# 168 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
cudaThreadExit();
# 170 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
printf("Test %s\n", ((errorNorm / refNorm) < (9.999999975e-07F)) ? ("PASSED") : ("FAILED"));
# 172 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
__cutilExit(argc, argv); return 0;
# 173 "tests/SimpleZeroCopy/simpleZeroCopy.cu"
}
# 1 "tmpxft_00006065_00000000-1_simpleZeroCopy.cudafe1.stub.c"
# 1 "tmpxft_00006065_00000000-1_simpleZeroCopy.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00006065_00000000-1_simpleZeroCopy.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00006065_00000000-1_simpleZeroCopy.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_00006065_00000000-3_simpleZeroCopy.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000b34,0x0000006001000002,0x00000000000005c0\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000002600000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x69532f7374736574,0x6f72655a656c706d,0x6d69732f79706f43\n"
".quad 0x436f72655a656c70,0x000075632e79706f,0x33010102464c457f,0x0000000000000004\n"
".quad 0x0000000100be0002,0x0000000000000000,0x0000000000000550,0x0000000000000040\n"
...
".quad 0x0000000000000000,0x0000000000000240,0x00000000000000a4,0x0000000000000000\n"
".quad 0x0000000000000004,0x0000000000000000,0x000000030000000b,0x0000000000000000\n"
".quad 0x0000000000000000,0x00000000000002e4,0x0000000000000019,0x0000000000000000\n"
".quad 0x0000000000000001,0x0000000000000000,0x0000000200000013,0x0000000000000000\n"
".quad 0x0000000000000000,0x00000000000002fd,0x0000000000000108,0x0000000a00000002\n"
".quad 0x0000000000000001,0x0000000000000018,0x0000000100000036,0x0000000000000006\n"
".quad 0x0000000000000000,0x0000000000000405,0x0000000000000098,0x0a00000600000003\n"
".quad 0x0000000000000004,0x0000000000000000,0x000000010000007e,0x0000000000000002\n"
".quad 0x0000000000000000,0x000000000000049d,0x000000000000003c,0x0000000400000000\n"
".quad 0x0000000000000004,0x0000000000000000,0x0000000100000054,0x0000000000000002\n"
".quad 0x0000000000000000,0x00000000000004d9,0x000000000000005c,0x0000000400000000\n"
".quad 0x0000000000000001,0x0000000000000000,0x0000000100000075,0x0000000000000002\n"
".quad 0x0000000000000000,0x0000000000000535,0x0000000000000018,0x0000000000000000\n"
...
".quad 0x742e006c61626f6c,0x32315a5f2e747865,0x6441726f74636576,0x5f53665055504764\n"
".quad 0x2e766e2e00695f53,0x315a5f2e6f666e69,0x41726f7463657632,0x5366505550476464\n"
".quad 0x766e2e00695f535f,0x6e2e006f666e692e,0x6174736e6f632e76,0x32315a5f2e30746e\n"
".quad 0x6441726f74636576,0x5f53665055504764,0x315a5f0000695f53,0x41726f7463657632\n"
".quad 0x5366505550476464,0x00000000695f535f,0x0000000000000000,0x0000000000000000\n"
...
".quad 0x0000000004000300,0x0000980000000000,0x0000000000000000,0x0000000006000300\n"
...
".quad 0x0000000004101200,0x0000980000000000,0x005de40000000000,0x001c042800440400\n"
".quad 0x009c042c00000094,0x001ca32c00000084,0x01dc232004400020,0x00a1e7188e4000e0\n"
".quad 0x0141e24000000180,0x0100e31800000010,0x0080a35000c00010,0x40c043200b800080\n"
".quad 0x0200a34800400090,0x20c085200b8000a0,0x4240438400000000,0x0180a348004000b0\n"
".quad 0x808085200b8000c0,0x41c0438400000000,0x30000048004000d0,0x6000855000000008\n"
".quad 0x001de79400000000,0x0000008000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x00000900080a0400,0x1c1903001c002000,0x000000000c170400\n"
".quad 0x11f0000018000300,0x000000000c170400,0x21f0000010000200,0x000000000c170400\n"
".quad 0x21f0000008000100,0x000000000c170400,0x21f0000000000000,0x01000c00080d0400\n"
".quad 0x0812040000000100,0x0000000000000a00,0x00000a0008110400,0x0000000000000000\n"
".quad 0x0000000500000006,0x0000000000000550,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000070,0x0000000000000070,0x0000000000000004,0x00000a0560000000\n"
".quad 0x0000000000000405,0x0000000000000000,0x0000000000000000,0x0000000000000130\n"
".quad 0x0000000000000130,0x0000000000000004,0x0000006801000001,0x00000000000004ac\n"
".quad 0x0000003800000000,0x0000001400030000,0x0000002600000040,0x0000000000000015\n"
".quad 0x0000000000000000,0x0000000000000000,0x69532f7374736574,0x6f72655a656c706d\n"
...
".quad 0x3536303630303030,0x303030303030305f,0x706d69735f372d30,0x6f436f72655a656c\n"
".quad 0x2e337070632e7970,0x656c69662e0a2269,0x7473657422203209,0x656c706d69532f73\n"
...
".quad 0x3436752e206d6172,0x63657632315a5f20,0x5047646441726f74,0x695f535f53665055\n"
".quad 0x305f6d617261705f,0x6d617261702e0a2c,0x5a5f203436752e20,0x726f746365763231\n"
".quad 0x6650555047646441,0x61705f695f535f53,0x2e0a2c315f6d6172,0x752e206d61726170\n"
".quad 0x7632315a5f203436,0x646441726f746365,0x535f536650555047,0x6d617261705f695f\n"
".quad 0x7261702e0a2c325f,0x203233752e206d61,0x7463657632315a5f,0x555047646441726f\n"
".quad 0x5f695f535f536650,0x0a335f6d61726170,0x6765722e0a7b0a29,0x6625203233662e20\n"
".quad 0x65722e0a3b3e343c,0x20646572702e2067,0x2e0a3b3e323c7025,0x3233732e20676572\n"
".quad 0x0a3b3e393c722520,0x36732e206765722e,0x31313c6c72252034,0x2e646c0a0a0a3b3e\n"
".quad 0x36752e6d61726170,0x202c346c72252034,0x63657632315a5f5b,0x5047646441726f74\n"
".quad 0x695f535f53665055,0x305f6d617261705f,0x61702e646c0a3b5d,0x203436752e6d6172\n"
".quad 0x5f5b202c356c7225,0x6f7463657632315a,0x5055504764644172,0x705f695f535f5366\n"
".quad 0x3b5d315f6d617261,0x617261702e646c0a,0x7225203436752e6d,0x315a5f5b202c366c\n"
".quad 0x41726f7463657632,0x5366505550476464,0x7261705f695f535f,0x6c0a3b5d325f6d61\n"
".quad 0x2e6d617261702e64,0x2c32722520323375,0x657632315a5f5b20,0x47646441726f7463\n"
".quad 0x5f535f5366505550,0x5f6d617261705f69,0x617476630a3b5d33,0x626f6c672e6f742e\n"
".quad 0x25203436752e6c61,0x6c7225202c316c72,0x2e617476630a3b36,0x61626f6c672e6f74\n"
".quad 0x7225203436752e6c,0x356c7225202c326c,0x742e617476630a3b,0x6c61626f6c672e6f\n"
".quad 0x6c7225203436752e,0x3b346c7225202c33,0x203220636f6c2e0a,0x766f6d0a31203534\n"
...
".quad 0x203634203220636f,0x6c2e707465730a31,0x7025203233732e74,0x202c317225202c31\n"
".quad 0x7025400a3b327225,0x4242206172622031,0x6c2e0a0a3b325f30,0x203834203220636f\n"
".quad 0x0a0a3b7465720a32,0x2e0a3a325f304242,0x3734203220636f6c,0x772e6c756d0a3120\n"
".quad 0x203233732e656469,0x7225202c376c7225,0x64610a3b34202c31,0x7225203436732e64\n"
".quad 0x336c7225202c386c,0x0a3b376c7225202c,0x203436732e646461,0x7225202c396c7225\n"
".quad 0x376c7225202c326c,0x6f6c672e646c0a3b,0x203233662e6c6162,0x72255b202c316625\n"
".quad 0x2e646c0a3b5d396c,0x662e6c61626f6c67,0x202c326625203233,0x0a3b5d386c72255b\n"
".quad 0x203233662e646461,0x326625202c336625,0x610a3b316625202c,0x25203436732e6464\n"
".quad 0x7225202c30316c72,0x376c7225202c316c,0x6f6c672e74730a3b,0x203233662e6c6162\n"
".quad 0x2c5d30316c72255b,0x6c2e0a3b33662520,0x203834203220636f,0x7d0a3b7465720a32\n"
".quad 0x00000000000a0a0a\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[361];
...
# 3 "/tmp/tmpxft_00006065_00000000-1_simpleZeroCopy.cudafe1.stub.c" 2 3
extern void __device_stub__Z12vectorAddGPUPfS_S_i(float *, float *, float *, int);
static void __sti____cudaRegisterAll_49_tmpxft_00006065_00000000_4_simpleZeroCopy_cpp1_ii_99ae23d1(void) __attribute__((__constructor__));
