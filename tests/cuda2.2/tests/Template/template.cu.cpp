# 1 "/tmp/tmpxft_000060e4_00000000-1_template.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_000060e4_00000000-1_template.cudafe1.cpp"
...
# 79 "tests/Template/template.cu"
cutilDeviceInit(argc, argv); } else {
# 81 "tests/Template/template.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 83 "tests/Template/template.cu"
unsigned timer = (0);
# 84 "tests/Template/template.cu"
__cutilCheckError(cutCreateTimer(&timer), "tests/Template/template.cu", 84);
# 85 "tests/Template/template.cu"
__cutilCheckError(cutStartTimer(timer), "tests/Template/template.cu", 85);
# 87 "tests/Template/template.cu"
unsigned num_threads = (32);
# 88 "tests/Template/template.cu"
unsigned mem_size = (sizeof(float) * num_threads);
# 91 "tests/Template/template.cu"
float *h_idata = ((float *)malloc(mem_size));
# 93 "tests/Template/template.cu"
for (unsigned i = (0); i < num_threads; ++i)
# 94 "tests/Template/template.cu"
{
# 95 "tests/Template/template.cu"
(h_idata[i]) = ((float)i);
# 96 "tests/Template/template.cu"
}
# 99 "tests/Template/template.cu"
float *d_idata;
# 100 "tests/Template/template.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), mem_size), "tests/Template/template.cu", 100);
# 102 "tests/Template/template.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_idata, mem_size, cudaMemcpyHostToDevice), "tests/Template/template.cu", 103);
# 106 "tests/Template/template.cu"
float *d_odata;
# 107 "tests/Template/template.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), mem_size), "tests/Template/template.cu", 107);
# 110 "tests/Template/template.cu"
dim3 grid(1, 1, 1);
# 111 "tests/Template/template.cu"
dim3 threads(num_threads, 1, 1);
# 114 "tests/Template/template.cu"
cudaConfigureCall(grid, threads, mem_size) ? ((void)0) : testKernel(d_idata, d_odata);
# 117 "tests/Template/template.cu"
__cutilCheckMsg("Kernel execution failed", "tests/Template/template.cu", 117);
# 120 "tests/Template/template.cu"
float *h_odata = ((float *)malloc(mem_size));
# 122 "tests/Template/template.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_odata, sizeof(float) * num_threads, cudaMemcpyDeviceToHost), "tests/Template/template.cu", 123);
# 125 "tests/Template/template.cu"
__cutilCheckError(cutStopTimer(timer), "tests/Template/template.cu", 125);
# 126 "tests/Template/template.cu"
printf("Processing time: %f (ms)\n", cutGetTimerValue(timer));
# 127 "tests/Template/template.cu"
__cutilCheckError(cutDeleteTimer(timer), "tests/Template/template.cu", 127);
# 130 "tests/Template/template.cu"
float *reference = ((float *)malloc(mem_size));
# 131 "tests/Template/template.cu"
computeGold(reference, h_idata, num_threads);
# 134 "tests/Template/template.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "regression"))
# 135 "tests/Template/template.cu"
{
# 137 "tests/Template/template.cu"
__cutilCheckError(cutWriteFilef("./data/regression.dat", h_odata, num_threads, (0.0)), "tests/Template/template.cu", 138);
# 139 "tests/Template/template.cu"
} else
# 141 "tests/Template/template.cu"
{
# 144 "tests/Template/template.cu"
CUTBoolean res = cutComparef(reference, h_odata, num_threads);
# 145 "tests/Template/template.cu"
printf("Test %s\n", (1 == res) ? ("PASSED") : ("FAILED"));
# 146 "tests/Template/template.cu"
}
# 149 "tests/Template/template.cu"
free(h_idata);
# 150 "tests/Template/template.cu"
free(h_odata);
# 151 "tests/Template/template.cu"
free(reference);
# 152 "tests/Template/template.cu"
__cudaSafeCall(cudaFree(d_idata), "tests/Template/template.cu", 152);
# 153 "tests/Template/template.cu"
__cudaSafeCall(cudaFree(d_odata), "tests/Template/template.cu", 153);
# 155 "tests/Template/template.cu"
cudaThreadExit();
# 156 "tests/Template/template.cu"
}
# 1 "tmpxft_000060e4_00000000-1_template.cudafe1.stub.c"
# 1 "tmpxft_000060e4_00000000-1_template.cudafe1.stub.c"
# 1 "/tmp/tmpxft_000060e4_00000000-1_template.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_000060e4_00000000-1_template.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_000060e4_00000000-3_template.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000a93,0x0000005801000002,0x000000000000058c\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000001a00000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x65542f7374736574,0x742f6574616c706d,0x2e6574616c706d65\n"
".quad 0x0000000000007563,0x33010102464c457f,0x0000000000000004,0x0000000100be0002\n"
".quad 0x0000000000000000,0x000000000000051c,0x0000000000000040,0x0038004000140514\n"
...
".quad 0x0000000000000240,0x0000000000000095,0x0000000000000000,0x0000000000000004\n"
".quad 0x0000000000000000,0x000000030000000b,0x0000000000000000,0x0000000000000000\n"
".quad 0x00000000000002d5,0x0000000000000014,0x0000000000000000,0x0000000000000001\n"
".quad 0x0000000000000000,0x0000000200000013,0x0000000000000000,0x0000000000000000\n"
".quad 0x00000000000002e9,0x0000000000000108,0x0000000a00000002,0x0000000000000001\n"
".quad 0x0000000000000018,0x0000000100000036,0x0000000000100006,0x0000000000000000\n"
".quad 0x00000000000003f1,0x00000000000000b0,0x0800000600000003,0x0000000000000004\n"
".quad 0x0000000000000000,0x0000000100000074,0x0000000000000002,0x0000000000000000\n"
".quad 0x00000000000004a1,0x0000000000000030,0x0000000400000000,0x0000000000000004\n"
".quad 0x0000000000000000,0x0000000100000058,0x0000000000000002,0x0000000000000000\n"
".quad 0x00000000000004d1,0x0000000000000030,0x0000000400000000,0x0000000000000001\n"
".quad 0x0000000000000000,0x000000010000004f,0x0000000000000002,0x0000000000000000\n"
".quad 0x0000000000000501,0x0000000000000018,0x0000000000000000,0x0000000000000001\n"
...
".quad 0x30315a5f2e747865,0x6e72654b74736574,0x2e005f5366506c65,0x006f666e692e766e\n"
".quad 0x6f666e692e766e2e,0x73657430315a5f2e,0x506c656e72654b74,0x2e766e2e005f5366\n"
".quad 0x746e6174736e6f63,0x657430315a5f2e30,0x6c656e72654b7473,0x5a5f00005f536650\n"
".quad 0x654b747365743031,0x5f5366506c656e72,0x0000000000000000,0x0000000000000000\n"
...
".quad 0x0400030000000000,0x0000000000000000,0x000000000000b000,0x0700030000000000\n"
...
".quad 0x0410120000000100,0x0000000000000000,0x000000000000b000,0x00440400005de400\n"
".quad 0x00000084009c0428,0x7e0000fc1fdc032c,0x00c0000820de0320,0x00c00010201c4360\n"
".quad 0x01400080311c0350,0x00400090015c4348,0x00000000401c8548,0x00000000301c8584\n"
".quad 0xee0000ffffdc04c9,0x00000000301c8550,0x00400021211c04c1,0x00000000401c0018\n"
".quad 0x00000000301c8558,0xee0000ffffdc04c9,0x004000a0001de450,0x00c00078211c0328\n"
".quad 0x01c00010219c0358,0x00000000301c8520,0x004000b041dc43c1,0x00000000601c8548\n"
...
".quad 0x0000000600000000,0x0000051c00000005,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000007000000000,0x0000007000000000,0x0000000400000000,0x6000000000000000\n"
".quad 0x000003f100000a05,0x0000000000000000,0x0000000000000000,0x0000011000000000\n"
".quad 0x0000011000000000,0x0000000400000000,0x0100000100000000,0x0000044f00000060\n"
".quad 0x0000000000000000,0x0003000000000038,0x0000004000000014,0x000000150000001a\n"
".quad 0x0000000000000000,0x0000000000000000,0x7473657400000000,0x616c706d65542f73\n"
".quad 0x6c706d65742f6574,0x000075632e657461,0x0a0a0a0a00000000,0x69737265762e0a0a\n"
...
".quad 0x3030305f34653036,0x5f372d3030303030,0x6574616c706d6574,0x22692e337070632e\n"
".quad 0x3209656c69662e0a,0x747365742f2e2220,0x616c706d65542f73,0x6c706d65742f6574\n"
".quad 0x6e72656b5f657461,0x0a226875632e6c65,0x206e72657478652e,0x206465726168732e\n"
".quad 0x34206e67696c612e,0x6164732038622e20,0x2e0a0a3b5d5b6174,0x5a5f207972746e65\n"
".quad 0x654b747365743031,0x5f5366506c656e72,0x6d617261702e0a28,0x5a5f203436752e20\n"
".quad 0x654b747365743031,0x5f5366506c656e72,0x305f6d617261705f,0x6d617261702e0a2c\n"
".quad 0x5a5f203436752e20,0x654b747365743031,0x5f5366506c656e72,0x315f6d617261705f\n"
".quad 0x65722e0a7b0a290a,0x25203233662e2067,0x722e0a3b3e363c66,0x203233732e206765\n"
".quad 0x2e0a3b3e393c7225,0x3436732e20676572,0x3e32313c6c722520,0x702e646c0a0a0a3b\n"
".quad 0x3436752e6d617261,0x5b202c346c722520,0x7473657430315a5f,0x66506c656e72654b\n"
".quad 0x6d617261705f5f53,0x2e646c0a3b5d305f,0x36752e6d61726170,0x202c356c72252034\n"
".quad 0x73657430315a5f5b,0x506c656e72654b74,0x617261705f5f5366,0x76630a3b5d315f6d\n"
".quad 0x6c672e6f742e6174,0x3436752e6c61626f,0x25202c316c722520,0x6f6c2e0a3b356c72\n"
".quad 0x3120313620322063,0x3233752e766f6d0a,0x7425202c31722520,0x6c2e0a3b782e6469\n"
".quad 0x203836203220636f,0x36752e7476630a31,0x7225203233752e34,0x3b317225202c326c\n"
".quad 0x6f742e617476630a,0x2e6c61626f6c672e,0x366c722520343675,0x0a3b346c7225202c\n"
".quad 0x36203220636f6c2e,0x2e6c756d0a312038,0x3233752e65646977,0x25202c376c722520\n"
".quad 0x610a3b34202c3172,0x25203436732e6464,0x6c7225202c386c72,0x3b376c7225202c36\n"
".quad 0x3436752e766f6d0a,0x73202c396c722520,0x64610a3b61746164,0x7225203436732e64\n"
".quad 0x396c7225202c336c,0x0a3b376c7225202c,0x36203220636f6c2e,0x672e646c0a312038\n"
".quad 0x33662e6c61626f6c,0x5b202c3166252032,0x730a3b5d386c7225,0x6465726168732e74\n"
".quad 0x72255b203233662e,0x316625202c5d336c,0x3220636f6c2e0a3b,0x61620a3120393620\n"
".quad 0x3020636e79732e72,0x3220636f6c2e0a3b,0x6f6d0a3120333620,0x7225203233752e76\n"
".quad 0x6469746e25202c34,0x636f6c2e0a3b782e,0x0a31203237203220,0x662e6e722e747663\n"
".quad 0x25203233752e3233,0x3b347225202c3266,0x726168732e646c0a,0x25203233662e6465\n"
".quad 0x6c72255b202c3366,0x2e6c756d0a3b5d33,0x2c34662520323366,0x6625202c32662520\n"
".quad 0x68732e74730a3b33,0x3233662e64657261,0x2c5d336c72255b20,0x6c2e0a3b34662520\n"
".quad 0x203337203220636f,0x79732e7261620a31,0x6c2e0a3b3020636e,0x203637203220636f\n"
".quad 0x36622e6c68730a31,0x2c30316c72252034,0x32202c326c722520,0x36732e6464610a3b\n"
".quad 0x2c31316c72252034,0x25202c316c722520,0x646c0a3b30316c72,0x2e6465726168732e\n"
".quad 0x2c35662520323366,0x3b5d336c72255b20,0x626f6c672e74730a,0x5b203233662e6c61\n"
".quad 0x202c5d31316c7225,0x6f6c2e0a3b356625,0x3220373720322063,0x0a7d0a3b7465720a\n"
...
# 3 "/tmp/tmpxft_000060e4_00000000-1_template.cudafe1.stub.c" 2 3
extern void __device_stub__Z10testKernelPfS_(float *, float *);
static void __sti____cudaRegisterAll_43_tmpxft_000060e4_00000000_4_template_cpp1_ii_bf2a51c6(void) __attribute__((__constructor__));
...
# 55 "./tests/Template/template_kernel.cuh"
{__device_stub__Z10testKernelPfS_( __cuda_0,__cuda_1);
# 77 "./tests/Template/template_kernel.cuh"
}
# 1 "/tmp/tmpxft_000060e4_00000000-1_template.cudafe1.stub.c"
static void __sti____cudaRegisterAll_43_tmpxft_000060e4_00000000_4_template_cpp1_ii_bf2a51c6(void) { __cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil); __cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(float *, float *))testKernel), (char*)"_Z10testKernelPfS_", "_Z10testKernelPfS_", -1, (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0); }
# 2 "tmpxft_000060e4_00000000-1_template.cudafe1.stub.c" 2
# 1 "tmpxft_000060e4_00000000-1_template.cudafe1.stub.c"
