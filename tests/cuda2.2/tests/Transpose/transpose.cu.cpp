...
# 60 "tests/Transpose/transpose.cu"
void runTest(int , char ** );
# 61 "tests/Transpose/transpose.cu"
extern "C" void computeGold(float * , float * , const unsigned , const unsigned );
# 68 "tests/Transpose/transpose.cu"
int main(int argc, char **argv)
# 69 "tests/Transpose/transpose.cu"
{
# 70 "tests/Transpose/transpose.cu"
runTest(argc, argv);
# 72 "tests/Transpose/transpose.cu"
__cutilExit(argc, argv); return 0;
# 73 "tests/Transpose/transpose.cu"
}
# 79 "tests/Transpose/transpose.cu"
void runTest(int argc, char **argv)
# 80 "tests/Transpose/transpose.cu"
{
# 83 "tests/Transpose/transpose.cu"
const unsigned size_x = (32);
# 84 "tests/Transpose/transpose.cu"
const unsigned size_y = (128);
# 90 "tests/Transpose/transpose.cu"
const unsigned mem_size = ((sizeof(float) * size_x) * size_y);
# 92 "tests/Transpose/transpose.cu"
unsigned timer;
# 93 "tests/Transpose/transpose.cu"
cutCreateTimer(&timer);
# 96 "tests/Transpose/transpose.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 97 "tests/Transpose/transpose.cu"
cutilDeviceInit(argc, argv); } else {
# 99 "tests/Transpose/transpose.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 102 "tests/Transpose/transpose.cu"
float *h_idata = ((float *)malloc(mem_size));
# 104 "tests/Transpose/transpose.cu"
srand(15235911);
# 105 "tests/Transpose/transpose.cu"
for (unsigned i = (0); i < (size_x * size_y); ++i)
# 106 "tests/Transpose/transpose.cu"
{
# 107 "tests/Transpose/transpose.cu"
(h_idata[i]) = ((float)i);
# 108 "tests/Transpose/transpose.cu"
}
# 111 "tests/Transpose/transpose.cu"
float *d_idata;
# 112 "tests/Transpose/transpose.cu"
float *d_odata;
# 113 "tests/Transpose/transpose.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), mem_size), "tests/Transpose/transpose.cu", 113);
# 114 "tests/Transpose/transpose.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), mem_size), "tests/Transpose/transpose.cu", 114);
# 117 "tests/Transpose/transpose.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_idata, mem_size, cudaMemcpyHostToDevice), "tests/Transpose/transpose.cu", 118);
# 121 "tests/Transpose/transpose.cu"
dim3 grid(size_x / (16), size_y / (16), 1);
# 122 "tests/Transpose/transpose.cu"
dim3 threads(16, 16, 1);
# 125 "tests/Transpose/transpose.cu"
cudaConfigureCall(grid, threads) ? ((void)0) : transpose_naive(d_odata, d_idata, size_x, size_y);
# 126 "tests/Transpose/transpose.cu"
cudaConfigureCall(grid, threads) ? ((void)0) : transpose(d_odata, d_idata, size_x, size_y);
# 129 "tests/Transpose/transpose.cu"
cudaThreadSynchronize();
# 131 "tests/Transpose/transpose.cu"
int numIterations = 1;
# 133 "tests/Transpose/transpose.cu"
printf("Transposing a %d by %d matrix of floats...\n", size_x, size_y);
# 136 "tests/Transpose/transpose.cu"
cutStartTimer(timer);
# 137 "tests/Transpose/transpose.cu"
for (int i = 0; i < numIterations; ++i)
# 138 "tests/Transpose/transpose.cu"
{
# 139 "tests/Transpose/transpose.cu"
cudaConfigureCall(grid, threads) ? ((void)0) : transpose_naive(d_odata, d_idata, size_x, size_y);
# 140 "tests/Transpose/transpose.cu"
}
# 141 "tests/Transpose/transpose.cu"
cudaThreadSynchronize();
# 142 "tests/Transpose/transpose.cu"
cutStopTimer(timer);
# 143 "tests/Transpose/transpose.cu"
float naiveTime = cutGetTimerValue(timer);
# 147 "tests/Transpose/transpose.cu"
cutResetTimer(timer);
# 148 "tests/Transpose/transpose.cu"
cutStartTimer(timer);
# 149 "tests/Transpose/transpose.cu"
for (int i = 0; i < numIterations; ++i)
# 150 "tests/Transpose/transpose.cu"
{
# 151 "tests/Transpose/transpose.cu"
cudaConfigureCall(grid, threads) ? ((void)0) : transpose(d_odata, d_idata, size_x, size_y);
# 152 "tests/Transpose/transpose.cu"
}
# 153 "tests/Transpose/transpose.cu"
cudaThreadSynchronize();
# 154 "tests/Transpose/transpose.cu"
cutStopTimer(timer);
# 155 "tests/Transpose/transpose.cu"
float optimizedTime = cutGetTimerValue(timer);
# 157 "tests/Transpose/transpose.cu"
printf("Naive transpose average time:     %0.3f ms\n", naiveTime / numIterations);
# 158 "tests/Transpose/transpose.cu"
printf("Optimized transpose average time: %0.3f ms\n\n", optimizedTime / numIterations);
# 161 "tests/Transpose/transpose.cu"
__cutilCheckMsg("Kernel execution failed", "tests/Transpose/transpose.cu", 161);
# 164 "tests/Transpose/transpose.cu"
float *h_odata = ((float *)malloc(mem_size));
# 165 "tests/Transpose/transpose.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_odata, mem_size, cudaMemcpyDeviceToHost), "tests/Transpose/transpose.cu", 166);
# 169 "tests/Transpose/transpose.cu"
float *reference = ((float *)malloc(mem_size));
# 171 "tests/Transpose/transpose.cu"
computeGold(reference, h_idata, size_x, size_y);
# 174 "tests/Transpose/transpose.cu"
CUTBoolean res = cutComparef(reference, h_odata, size_x * size_y);
# 175 "tests/Transpose/transpose.cu"
printf("Test %s\n", (1 == res) ? ("PASSED") : ("FAILED"));
# 178 "tests/Transpose/transpose.cu"
free(h_idata);
# 179 "tests/Transpose/transpose.cu"
free(h_odata);
# 180 "tests/Transpose/transpose.cu"
free(reference);
# 181 "tests/Transpose/transpose.cu"
__cudaSafeCall(cudaFree(d_idata), "tests/Transpose/transpose.cu", 181);
# 182 "tests/Transpose/transpose.cu"
__cudaSafeCall(cudaFree(d_odata), "tests/Transpose/transpose.cu", 182);
# 183 "tests/Transpose/transpose.cu"
__cutilCheckError(cutDeleteTimer(timer), "tests/Transpose/transpose.cu", 183);
# 185 "tests/Transpose/transpose.cu"
cudaThreadExit();
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000001a12,0x0000005801000002,0x0000000000000a54\n"
".quad 0x0000000000000000,0x0000001400010004,0x0000001c00000038,0x0000000000000015\n"
".quad 0x0000000000000000,0x72542f7374736574,0x2f65736f70736e61,0x736f70736e617274\n"
".quad 0x0000000075632e65,0x33010102464c457f,0x0000000000000004,0x0000000100be0002\n"
".quad 0x69695f5366506576,0x325f6d617261705f,0x61702e646c0a3b5d,0x203233752e6d6172\n"
".quad 0x5a5f5b202c327225,0x70736e6172743531,0x7669616e5f65736f,0x5f69695f53665065\n"
".quad 0x5d335f6d61726170,0x742e617476630a3b,0x6c61626f6c672e6f,0x6c7225203436752e\n"
".quad 0x3b336c7225202c31,0x6f742e617476630a,0x2e6c61626f6c672e,0x326c722520343675\n"
".quad 0x0a3b346c7225202c,0x38203220636f6c2e,0x2e766f6d0a312030,0x2c35722520323375\n"
".quad 0x2e64696174632520,0x752e766f6d0a3b78,0x202c367225203233,0x3b782e6469746e25\n"
".quad 0x3233752e766f6d0a,0x7425202c37722520,0x616d0a3b782e6469,0x3233732e6f6c2e64\n"
".quad 0x7225202c33722520,0x202c367225202c35,0x6f6c2e0a3b377225,0x3120313820322063\n"
".quad 0x3233752e766f6d0a,0x6325202c38722520,0x0a3b792e64696174,0x203233752e766f6d\n"
".quad 0x746e25202c397225,0x6f6d0a3b792e6469,0x7225203233752e76,0x64697425202c3031\n"
".quad 0x2e64616d0a3b792e,0x25203233732e6f6c,0x2c387225202c3472,0x7225202c39722520\n"
".quad 0x636f6c2e0a3b3031,0x0a31203338203220,0x2e746c2e70746573,0x2c31702520323375\n"
".quad 0x7225202c33722520,0x2e707465730a3b31,0x25203233752e746c,0x2c347225202c3270\n"
".quad 0x6e610a3b32722520,0x2520646572702e64,0x2c317025202c3370,0x6c2e0a3b32702520\n"
".quad 0x203338203220636f,0x6220337025400a31,0x325f314242206172,0x20636f6c2e0a0a3b\n"
".quad 0x720a322039382032,0x3142420a0a3b7465,0x702e646c0a3a325f,0x3233752e6d617261\n"
".quad 0x5b202c3531722520,0x6e61727435315a5f,0x616e5f65736f7073,0x695f536650657669\n"
".quad 0x5f6d617261705f69,0x636f6c2e0a3b5d32,0x0a31203538203220,0x732e6f6c2e64616d\n"
".quad 0x2c31317225203233,0x7225202c34722520,0x3b337225202c3531,0x617261702e646c0a\n"
".quad 0x7225203233752e6d,0x315a5f5b202c3631,0x6f70736e61727435,0x657669616e5f6573\n"
".quad 0x705f69695f536650,0x3b5d335f6d617261,0x203220636f6c2e0a,0x64616d0a31203638\n"
".quad 0x203233732e6f6c2e,0x7225202c32317225,0x2c36317225202c33,0x6c2e0a3b34722520\n"
".quad 0x203738203220636f,0x69772e6c756d0a31,0x25203233752e6564,0x317225202c356c72\n"
".quad 0x64610a3b34202c31,0x7225203436732e64,0x326c7225202c366c,0x0a3b356c7225202c\n"
".quad 0x656469772e6c756d,0x6c7225203233752e,0x2c32317225202c37,0x2e6464610a3b3420\n"
".quad 0x386c722520343673,0x202c316c7225202c,0x646c0a3b376c7225,0x2e6c61626f6c672e\n"
".quad 0x2c31662520323366,0x3b5d366c72255b20,0x626f6c672e74730a,0x5b203233662e6c61\n"
".quad 0x25202c5d386c7225,0x636f6c2e0a3b3166,0x0a32203938203220,0x0a0a7d0a3b746572\n"
".quad 0x000000000000000a\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[837];
...
# 51 "tests/Transpose/transpose_kernel.cu"
...
# 79 "tests/Transpose/transpose_kernel.cu"
