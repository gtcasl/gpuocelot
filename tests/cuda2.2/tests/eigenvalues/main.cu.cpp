# 1 "/tmp/tmpxft_00003a71_00000000-22_main.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00003a71_00000000-22_main.cudafe1.cpp"
# 1 "main.cu"
...
__cudaSafeCall(cudaMalloc((void **)(&(input.g_a)), sizeof(float) * mat_size), "main.cu", 124);
__cudaSafeCall(cudaMalloc((void **)(&(input.g_b_raw)), sizeof(float) * mat_size), "main.cu", 125);


__cudaSafeCall(cudaMemcpy(input.g_a, input.a, sizeof(float) * mat_size, cudaMemcpyHostToDevice), "main.cu", 128);
__cudaSafeCall(cudaMemcpy(input.g_b_raw, input.b, sizeof(float) * mat_size, cudaMemcpyHostToDevice), "main.cu", 129);
...
__cudaSafeCall(cudaFree(input.g_a), "main.cu", 144);
(input.g_a) = (__null);
__cudaSafeCall(cudaFree(input.g_b_raw), "main.cu", 146);
...
__cutilCondition((mat_size) < (1 << 16), (char *)("main.cu"), 168);
...
__cutilCheckError(cutCreateTimer(&timer), "main.cu", 253);
__cutilCheckError(cutCreateTimer(&timer_total), "main.cu", 254);
...
# 1 "/tmp/tmpxft_00003a71_00000000-22_main.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00003a71_00000000-24_main.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00003a71_00000000-24_main.fatbin.c" 2
...
0x6d742f706d742f20ull,0x3030305f74667870ull,0x30305f3137613330ull,0x372d303030303030ull,
0x632e6e69616d5f30ull,0x2f2820692e337070ull,0x494263632f706d74ull,0x61555661306b2e23ull,
...
0x6678706d742f706dull,0x6133303030305f74ull,0x30303030305f3137ull,0x6d5f39362d303030ull,
...
0x75665f6863746566ull,0x2e736e6f6974636eull,0x6c69662e090a2268ull,0x752f220934320965ull,
0x6c61636f6c2f7273ull,0x69622f616475632full,0x636e692f2e2e2f6eull,0x74616d2f6564756cull,
0x6974636e75665f68ull,0x5f6c62645f736e6full,0x0a22682e33787470ull,0x0000000000000a0aull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"d52d3f583a48ebb6",(char*)"main.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0xc4021a9b};
# 5 "/tmp/tmpxft_00003a71_00000000-22_main.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00003a71_00000000-22_main.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_40_tmpxft_00003a71_00000000_67_main_cpp1_ii_main(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_40_tmpxft_00003a71_00000000_67_main_cpp1_ii_main(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);}
