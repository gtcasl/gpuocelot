# 1 "/tmp/tmpxft_00005dc5_00000000-1_simpleCUFFT.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005dc5_00000000-1_simpleCUFFT.cudafe1.cpp"
# 1 "simpleCUFFT.cu"
...
static void ComplexPointwiseMulAndScale__entry(Complex *, const Complex *, int, float);


extern void Convolve(const Complex *, int, const Complex *, int, Complex *);


extern int PadData(const Complex *, Complex **, int, const Complex *, Complex **, int);
...
auto Complex *h_signal = ((Complex *)malloc(sizeof(Complex) * (50)));
...
auto Complex *h_filter_kernel = ((Complex *)malloc(sizeof(Complex) * (11)));
...
auto Complex *h_padded_signal;
auto Complex *h_padded_filter_kernel;
auto int new_size = PadData(h_signal, &h_padded_signal, 50, h_filter_kernel, &h_padded_filter_kernel, 11);

auto int mem_size = (sizeof(Complex) * new_size);


auto Complex *d_signal;
__cudaSafeCall(cudaMalloc((void **)(&d_signal), mem_size), "simpleCUFFT.cu", 109);

__cudaSafeCall(cudaMemcpy(d_signal, h_padded_signal, mem_size, cudaMemcpyHostToDevice), "simpleCUFFT.cu", 112);



auto Complex *d_filter_kernel;
__cudaSafeCall(cudaMalloc((void **)(&d_filter_kernel), mem_size), "simpleCUFFT.cu", 116);


__cudaSafeCall(cudaMemcpy(d_filter_kernel, h_padded_filter_kernel, mem_size, cudaMemcpyHostToDevice), "simpleCUFFT.cu", 120);



auto cufftHandle plan;
__cufftSafeCall(cufftPlan1d(&plan, new_size, CUFFT_C2C, 1), "simpleCUFFT.cu", 124);


__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, -1), "simpleCUFFT.cu", 127);
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_filter_kernel, (cufftComplex *)d_filter_kernel, -1), "simpleCUFFT.cu", 128);


cudaConfigureCall(32, 256) ? ((void)0) : ComplexPointwiseMulAndScale__entry(d_signal, d_filter_kernel, new_size, (1.0F) / new_size);


__cutilCheckMsg("Kernel execution failed [ ComplexPointwiseMulAndScale ]", "simpleCUFFT.cu", 134);


__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, 1), "simpleCUFFT.cu", 137);


auto Complex *h_convolved_signal = h_padded_signal;
__cudaSafeCall(cudaMemcpy(h_convolved_signal, d_signal, mem_size, cudaMemcpyDeviceToHost), "simpleCUFFT.cu", 142);



auto Complex *h_convolved_signal_ref = ((Complex *)malloc(sizeof(Complex) * (50)));
...
auto CUTBoolean res = cutCompareL2fe((float *)h_convolved_signal_ref, (float *)h_convolved_signal, 2 * 50, (9.999999747e-06F));
printf("Test %s\n", (1 == res) ? ((const char *)"PASSED") : ((const char *)"FAILED"));


__cufftSafeCall(cufftDestroy(plan), "simpleCUFFT.cu", 157);
...
__cudaSafeCall(cudaFree(d_signal), "simpleCUFFT.cu", 165);
__cudaSafeCall(cudaFree(d_filter_kernel), "simpleCUFFT.cu", 166);
...
{
auto int minRadius = (filter_kernel_size / 2);
auto int maxRadius = (filter_kernel_size - minRadius);
auto int new_size = (signal_size + maxRadius);


auto Complex *new_data = ((Complex *)malloc(sizeof(Complex) * new_size));
...
static void ComplexPointwiseMulAndScale__entry(Complex *a, const Complex *b, int size, float scale);
# 262 "simpleCUFFT.cu"
# 1 "/tmp/tmpxft_00005dc5_00000000-1_simpleCUFFT.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00005dc5_00000000-3_simpleCUFFT.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00005dc5_00000000-3_simpleCUFFT.fatbin.c" 2
...
0x78706d742f706d74ull,0x35303030305f7466ull,0x303030305f356364ull,0x735f372d30303030ull,
0x465543656c706d69ull,0x2e337070632e5446ull,0x2f706d742f282069ull,0x79592e2349426363ull,
0x2f090a2939303041ull,0x2d2d2d2d2d2d2d2full,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x742f706d742f2209ull,0x30305f746678706dull,0x305f356364353030ull,0x2d30303030303030ull,
0x656c706d69735f36ull,0x75632e5446465543ull,0x70672e3265666164ull,0x6c69662e090a2275ull,
...
0x09353109656c6966ull,0x43656c706d697322ull,0x2275632e54464655ull,0x09656c69662e090aull,
0x7273752f22093631ull,0x632f6c61636f6c2full,0x2f6e69622f616475ull,0x756c636e692f2e2eull,
0x6f6d6d6f632f6564ull,0x6974636e75665f6eull,0x090a22682e736e6full,0x373109656c69662eull,
0x6c2f7273752f2209ull,0x6475632f6c61636full,0x2e2e2f6e69622f61ull,0x6564756c636e692full,
0x6e75662f7472632full,0x2e6f7263616d5f63ull,0x6c69662e090a2268ull,0x752f220938310965ull,
0x6c61636f6c2f7273ull,0x69622f616475632full,0x636e692f2e2e2f6eull,0x74616d2f6564756cull,
0x6974636e75665f68ull,0x090a22682e736e6full,0x393109656c69662eull,0x6c2f7273752f2209ull,
...
0x22682e73746e6174ull,0x09656c69662e090aull,0x7273752f22093132ull,0x632f6c61636f6c2full,
0x2f6e69622f616475ull,0x756c636e692f2e2eull,0x31315f6d732f6564ull,0x5f63696d6f74615full,
0x6e6f6974636e7566ull,0x662e090a22682e73ull,0x2209323209656c69ull,0x636f6c2f7273752full,
0x2f616475632f6c61ull,0x692f2e2e2f6e6962ull,0x732f6564756c636eull,0x6f74615f32315f6dull,
0x636e75665f63696dull,0x22682e736e6f6974ull,0x09656c69662e090aull,0x7273752f22093332ull,
0x2039306530653030ull,0x3730303830617830ull,0x783009090a203038ull,0x6466316430303033ull,
0x3031326336783020ull,0x3032783020386337ull,0x3020343063383130ull,0x3165383630303278ull,
0x31783009090a2063ull,0x2033303061303030ull,0x3230303030307830ull,0x3030667830203038ull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"f8df759744a44483",(char*)"simpleCUFFT.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0,0xd9f9d29e};
# 5 "/tmp/tmpxft_00005dc5_00000000-1_simpleCUFFT.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00005dc5_00000000-1_simpleCUFFT.cudafe1.stub.c" 2
struct __T20 {Complex *__par0;const Complex *__par1;int __par2;float __par3;int __dummy_field;volatile char __dummy[4];};
static void __sti____cudaRegisterAll_46_tmpxft_00005dc5_00000000_4_simpleCUFFT_cpp1_ii_main(void) __attribute__((__constructor__));
static void __device_stub__Z27ComplexPointwiseMulAndScaleP6float2PKS_if(Complex *__par0, const Complex *__par1, int __par2, float __par3){auto struct __T20 *__T237;
char __[256]; *(char**)&__T237 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T237->__par0 - (size_t)__T237) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T237->__par1 - (size_t)__T237) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T237->__par2 - (size_t)__T237) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par3, sizeof(__par3), (size_t)&__T237->__par3 - (size_t)__T237) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(Complex *, const Complex *, int, float))ComplexPointwiseMulAndScale__entry)); (void)cudaLaunch(((char *)((void ( *)(Complex *, const Complex *, int, float))ComplexPointwiseMulAndScale__entry))); };}

}
static void ComplexPointwiseMulAndScale__entry( Complex * __cuda_0,const Complex * __cuda_1,int __cuda_2,float __cuda_3)
...
static void __sti____cudaRegisterAll_46_tmpxft_00005dc5_00000000_4_simpleCUFFT_cpp1_ii_main(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(Complex *, const Complex *, int, float))ComplexPointwiseMulAndScale__entry), (char*)"_Z27ComplexPointwiseMulAndScaleP6float2PKS_if", "_Z27ComplexPointwiseMulAndScaleP6float2PKS_if", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}

}
# 262 "simpleCUFFT.cu" 2
