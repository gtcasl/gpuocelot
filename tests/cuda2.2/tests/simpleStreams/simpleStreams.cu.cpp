# 1 "/tmp/tmpxft_00005e7f_00000000-1_simpleStreams.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005e7f_00000000-1_simpleStreams.cudafe1.cpp"
# 1 "simpleStreams.cu"
...
# 59 "simpleStreams.cu"
void init_array__entry(int *g_data, int *factor, int num_iterations);
# 67 "simpleStreams.cu"
...
cudaEventRecord(start_event, 0);
cudaConfigureCall(blocks, threads, 0, streams[0]) ? ((void)0) : init_array__entry(d_a, d_c, niterations);
cudaEventRecord(stop_event, 0);
cudaEventSynchronize(stop_event);
...
{
cudaConfigureCall(blocks, threads) ? ((void)0) : init_array__entry(d_a, d_c, niterations);
...
for (int i = 0; i < nstreams; i++) {
cudaConfigureCall(blocks, threads, 0, streams[i]) ? ((void)0) : init_array__entry(d_a + (i * n) / nstreams, d_c, niterations); }
...
# 1 "/tmp/tmpxft_00005e7f_00000000-1_simpleStreams.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00005e7f_00000000-3_simpleStreams.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00005e7f_00000000-3_simpleStreams.fatbin.c" 2
...
0x78706d742f706d74ull,0x35303030305f7466ull,0x303030305f663765ull,0x735f372d30303030ull,
0x727453656c706d69ull,0x7070632e736d6165ull,0x6d742f2820692e33ull,0x2e23494263632f70ull,
0x0a29446e6f6b5763ull,0x2d2d2d2d2d2f2f09ull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x706d742f22093209ull,0x5f746678706d742full,0x6637653530303030ull,0x303030303030305full,
0x706d69735f362d30ull,0x6d6165727453656cull,0x6566616475632e73ull,0x090a227570672e32ull,
...
0x656c69662e090a22ull,0x6d69732209353109ull,0x6165727453656c70ull,0x090a2275632e736dull,
...
0x090a0a0a22682e33ull,0x5f207972746e652eull,0x5f74696e6930315aull,0x5369507961727261ull,
0x2e09090a2820695full,0x752e206d61726170ull,0x6475635f5f203436ull,0x5a5f5f6d72617061ull,
0x615f74696e693031ull,0x5f53695079617272ull,0x617461645f675f69ull,0x7261702e09090a2cull,
0x203436752e206d61ull,0x6170616475635f5full,0x6930315a5f5f6d72ull,0x617272615f74696eull,
0x665f695f53695079ull,0x090a2c726f746361ull,0x206d617261702e09ull,0x635f5f203233732eull,
0x5f6d726170616475ull,0x74696e6930315a5full,0x695079617272615full,0x5f6d756e5f695f53ull,
0x6f69746172657469ull,0x090a7b090a29736eull,0x31752e206765722eull,0x3e343c6872252036ull,
0x206765722e090a3bull,0x3c7225203233752eull,0x722e090a3b3e3231ull,0x203436752e206765ull,
0x0a3b3e373c647225ull,0x702e206765722e09ull,0x343c702520646572ull,0x636f6c2e090a3b3eull,
0x3009393509353109ull,0x5f5f3142424c240aull,0x5f74696e6930315aull,0x5369507961727261ull,
0x2e646c090a3a695full,0x33732e6d61726170ull,0x202c317225092032ull,0x70616475635f5f5bull,
0x30315a5f5f6d7261ull,0x7272615f74696e69ull,0x5f695f5369507961ull,0x726574695f6d756eull,
0x092020203b387225ull,0x702540090a202f2full,0x2409206172622032ull,0x3937315f305f744cull,
0x2020202020203b34ull,0x0a202f2f09202020ull,0x32315f305f744c24ull,0x6f6c2e090a3a3238ull,
0x0935360935310963ull,0x3b74697865090a30ull,0x2020202020202020ull,0x2020202020202020ull,
0x2020202020202020ull,0x4c240a202f2f0920ull,0x5a5f5f646e655744ull,0x615f74696e693031ull,
0x5f53695079617272ull,0x2f2f207d090a3a69ull,0x696e6930315a5f20ull,0x5079617272615f74ull,
0x00000a0a695f5369ull
};
...
0x6330303032783009ull,0x3430783020353038ull,0x3020303837303032ull,0x3038663030303178ull,
0x3330343078302064ull,0x09090a2030383763ull,0x3230653030647830ull,0x6330387830203930ull,
0x7830203038373030ull,0x3130633030303031ull,0x6330303434783020ull,0x3009090a20303837ull,
0x3030306530306478ull,0x3063303878302031ull,0x3278302030383730ull,0x2064303638313030ull,
0x3030303030307830ull,0x783009090a203330ull,0x3930303030303032ull,0x3830303430783020ull,
0x3033783020303837ull,0x3020646631643330ull,0x6337343132633678ull,0x64783009090a2038ull,
0x2039303230653030ull,0x3730306330617830ull,0x3030317830203038ull,0x7830203330303930ull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"cba1d92427b6f6c8",(char*)"simpleStreams.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0,0xc89df0a4};
# 5 "/tmp/tmpxft_00005e7f_00000000-1_simpleStreams.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00005e7f_00000000-1_simpleStreams.cudafe1.stub.c" 2
struct __T20 {int *__par0;int *__par1;int __par2;int __dummy_field;};
static void __sti____cudaRegisterAll_48_tmpxft_00005e7f_00000000_4_simpleStreams_cpp1_ii_2e3ff9cd(void) __attribute__((__constructor__));
void __device_stub__Z10init_arrayPiS_i(int *__par0, int *__par1, int __par2){auto struct __T20 *__T26;
char __[256]; *(char**)&__T26 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T26->__par0 - (size_t)__T26) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T26->__par1 - (size_t)__T26) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T26->__par2 - (size_t)__T26) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(int *, int *, int))init_array__entry)); (void)cudaLaunch(((char *)((void ( *)(int *, int *, int))init_array__entry))); };}

}
void init_array__entry( int * __cuda_0,int * __cuda_1,int __cuda_2)
...
static void __sti____cudaRegisterAll_48_tmpxft_00005e7f_00000000_4_simpleStreams_cpp1_ii_2e3ff9cd(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(int *, int *, int))init_array__entry), (char*)"_Z10init_arrayPiS_i", "_Z10init_arrayPiS_i", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}
