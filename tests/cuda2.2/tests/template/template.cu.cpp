# 1 "/tmp/tmpxft_0000615c_00000000-1_template.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_0000615c_00000000-1_template.cudafe1.cpp"
# 1 "template.cu"
...
# 54 "./template_kernel.cu"
void testKernel__entry(float *g_idata, float *g_odata);
# 55 "template.cu"
...
__cutilCheckError(cutCreateTimer(&timer), "template.cu", 84);
__cutilCheckError(cutStartTimer(timer), "template.cu", 85);

auto unsigned num_threads = (32);
...
auto float *d_idata;
__cudaSafeCall(cudaMalloc((void **)(&d_idata), mem_size), "template.cu", 100);

__cudaSafeCall(cudaMemcpy(d_idata, h_idata, mem_size, cudaMemcpyHostToDevice), "template.cu", 103);



auto float *d_odata;
__cudaSafeCall(cudaMalloc((void **)(&d_odata), mem_size), "template.cu", 107);
...
cudaConfigureCall(grid, threads, mem_size) ? ((void)0) : testKernel__entry(d_idata, d_odata);


__cutilCheckMsg("Kernel execution failed", "template.cu", 117);


auto float *h_odata = ((float *)malloc(mem_size));

__cudaSafeCall(cudaMemcpy(h_odata, d_odata, sizeof(float) * num_threads, cudaMemcpyDeviceToHost), "template.cu", 123);


__cutilCheckError(cutStopTimer(timer), "template.cu", 125);
printf("Processing time: %f (ms)\n", cutGetTimerValue(timer));
__cutilCheckError(cutDeleteTimer(timer), "template.cu", 127);
...
__cutilCheckError(cutWriteFilef("./data/regression.dat", h_odata, num_threads, (0.0)), "template.cu", 138);
...
auto CUTBoolean res = cutComparef(reference, h_odata, num_threads);
...
free(h_odata);
free(reference);
__cudaSafeCall(cudaFree(d_idata), "template.cu", 152);
__cudaSafeCall(cudaFree(d_odata), "template.cu", 153);

cudaThreadExit();
}

# 1 "/tmp/tmpxft_0000615c_00000000-1_template.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_0000615c_00000000-3_template.fatbin.c" 1
...
# 2 "/tmp/tmpxft_0000615c_00000000-3_template.fatbin.c" 2
...
0x20656d616e090a7bull,0x657430315a5f203dull,0x6c656e72654b7473ull,0x6d6c090a5f536650ull,
0x090a30203d206d65ull,0x33203d206d656d73ull,0x2020676572090a32ull,0x726162090a33203dull,
...
0x3030303278300909ull,0x3078302039303863ull,0x2030383730303234ull,0x3230323030307830ull,
0x3030637830203530ull,0x090a203038373030ull,0x3065303064783009ull,0x3038783020353034ull,
0x3020303837303063ull,0x3030313030343078ull,0x3032346578302031ull,0x09090a2030383734ull,
0x6566663136387830ull,0x3030307830203330ull,0x7830203030303030ull,0x3530303030303030ull,
0x3030303063783020ull,0x3009090a20303837ull,0x3032343030306178ull,0x3032343478302035ull,
0x6378302030383730ull,0x2035303064313034ull,0x3730303230307830ull,0x783009090a203038ull,
0x3130303130303430ull,0x3430323465783020ull,0x3638783020303837ull,0x3020333065666631ull,
0x726170616475635full,0x657430315a5f5f6dull,0x6c656e72654b7473ull,0x6f5f675f5f536650ull,
0x2f093b5d61746164ull,0x2036323a6469202full,0x6170616475635f5full,0x7430315a5f5f6d72ull,
0x656e72654b747365ull,0x5f675f5f5366506cull,0x78302b617461646full,0x752e646461090a30ull,
0x3864722509203436ull,0x202c37647225202cull,0x2020203b32647225ull,0x73090a202f2f0920ull,
0x6c61626f6c672e74ull,0x255b09203233662eull,0x202c5d302b386472ull,0x2f2f09203b356625ull,
0x090a37323a646920ull,0x09353109636f6c2eull,0x7865090a30093737ull,0x20202020203b7469ull,
0x2020202020202020ull,0x2020202020202020ull,0x202f2f0920202020ull,0x646e6557444c240aull,
0x73657430315a5f5full,0x506c656e72654b74ull,0x207d090a3a5f5366ull,0x7430315a5f202f2full,
0x656e72654b747365ull,0x000a0a5f5366506cull
};
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"4c15392e2745c9fe",(char*)"template.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0,0x8f61865f};
# 5 "/tmp/tmpxft_0000615c_00000000-1_template.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_0000615c_00000000-1_template.cudafe1.stub.c" 2
struct __T20 {float *__par0;float *__par1;int __dummy_field;volatile char __dummy[4];};
static void __sti____cudaRegisterAll_43_tmpxft_0000615c_00000000_7_template_cpp1_ii_bf2a51c6(void) __attribute__((__constructor__));
void __device_stub__Z10testKernelPfS_(float *__par0, float *__par1){auto struct __T20 *__T23;
char __[256]; *(char**)&__T23 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T23->__par0 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T23->__par1 - (size_t)__T23) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(float *, float *))testKernel__entry)); (void)cudaLaunch(((char *)((void ( *)(float *, float *))testKernel__entry))); };}

}
void testKernel__entry( float * __cuda_0,float * __cuda_1)
...
static void __sti____cudaRegisterAll_43_tmpxft_0000615c_00000000_7_template_cpp1_ii_bf2a51c6(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(float *, float *))testKernel__entry), (char*)"_Z10testKernelPfS_", "_Z10testKernelPfS_", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);__cudaRegisterShared(__cudaFatCubinHandle, (void**)"sdata");}
