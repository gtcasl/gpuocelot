# 1 "/tmp/tmpxft_00005952_00000000-1_dwtHaar1D.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005952_00000000-1_dwtHaar1D.cudafe1.cpp"
...
# 81 "tests/dwtHaar1D/dwtHaar1D.cu"
static const unsigned LOG_NUM_BANKS = (4);
# 82 "tests/dwtHaar1D/dwtHaar1D.cu"
static const unsigned NUM_BANKS = (16);
# 84 "./tests/dwtHaar1D/dwtHaar1D_kernel.cu"
void dwtHaar1D(float *id, float *od, float *approx_final, const unsigned
# 85 "./tests/dwtHaar1D/dwtHaar1D_kernel.cu"
dlevels, const unsigned
# 86 "./tests/dwtHaar1D/dwtHaar1D_kernel.cu"
slength_step_half, const int
# 87 "./tests/dwtHaar1D/dwtHaar1D_kernel.cu"
bdim) ;
# 90 "tests/dwtHaar1D/dwtHaar1D.cu"
void runTest(int , char ** );
# 91 "tests/dwtHaar1D/dwtHaar1D.cu"
CUTBoolean getLevels(unsigned , unsigned * );
# 97 "tests/dwtHaar1D/dwtHaar1D.cu"
int main(int argc, char **argv)
# 98 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 100 "tests/dwtHaar1D/dwtHaar1D.cu"
runTest(argc, argv);
# 102 "tests/dwtHaar1D/dwtHaar1D.cu"
__cutilExit(argc, argv); return 0;
# 103 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 109 "tests/dwtHaar1D/dwtHaar1D.cu"
void runTest(int argc, char **argv)
# 110 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 111 "tests/dwtHaar1D/dwtHaar1D.cu"
char *s_fname;
# 112 "tests/dwtHaar1D/dwtHaar1D.cu"
char *r_fname;
# 113 "tests/dwtHaar1D/dwtHaar1D.cu"
char *r_gold_fname;
# 114 "tests/dwtHaar1D/dwtHaar1D.cu"
...
# 129 "tests/dwtHaar1D/dwtHaar1D.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 130 "tests/dwtHaar1D/dwtHaar1D.cu"
cutilDeviceInit(argc, argv); } else {
# 132 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 135 "tests/dwtHaar1D/dwtHaar1D.cu"
if (argc == 4)
# 136 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 137 "tests/dwtHaar1D/dwtHaar1D.cu"
...
# 140 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 141 "tests/dwtHaar1D/dwtHaar1D.cu"
fprintf(stderr, "Invalid input syntax.\n%s", usage);
# 142 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 143 "tests/dwtHaar1D/dwtHaar1D.cu"
exit(1);
# 144 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 145 "tests/dwtHaar1D/dwtHaar1D.cu"
} else
# 147 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 148 "tests/dwtHaar1D/dwtHaar1D.cu"
s_fname = cutFindFilePath("signal.dat", argv[0]);
# 149 "tests/dwtHaar1D/dwtHaar1D.cu"
r_fname = cutFindFilePath("regression.dat", argv[0]);
# 150 "tests/dwtHaar1D/dwtHaar1D.cu"
r_gold_fname = cutFindFilePath("regression.gold.dat", argv[0]);
# 151 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 154 "tests/dwtHaar1D/dwtHaar1D.cu"
unsigned slength = (0);
# 155 "tests/dwtHaar1D/dwtHaar1D.cu"
float *signal = (__null);
# 156 "tests/dwtHaar1D/dwtHaar1D.cu"
if (s_fname == (0))
# 157 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 158 "tests/dwtHaar1D/dwtHaar1D.cu"
fprintf(stderr, "Cannot find the file containing the signal.\n%s", usage);
# 159 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 160 "tests/dwtHaar1D/dwtHaar1D.cu"
exit(1);
# 161 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 162 "tests/dwtHaar1D/dwtHaar1D.cu"
if ((cutReadFilef(s_fname, &signal, &slength)) == (CUTTrue)) {
# 163 "tests/dwtHaar1D/dwtHaar1D.cu"
printf("Reading signal from %s\n", s_fname);
# 164 "tests/dwtHaar1D/dwtHaar1D.cu"
} else {
# 165 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 166 "tests/dwtHaar1D/dwtHaar1D.cu"
exit(1);
# 167 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 170 "tests/dwtHaar1D/dwtHaar1D.cu"
unsigned dlevels_complete = (0);
# 171 "tests/dwtHaar1D/dwtHaar1D.cu"
if ((CUTTrue) != (getLevels(slength, &dlevels_complete)))
# 172 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 174 "tests/dwtHaar1D/dwtHaar1D.cu"
fprintf(stderr, "Signal length not supported.\n");
# 176 "tests/dwtHaar1D/dwtHaar1D.cu"
cutFree(signal);
# 177 "tests/dwtHaar1D/dwtHaar1D.cu"
return;
# 178 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 181 "tests/dwtHaar1D/dwtHaar1D.cu"
float *d_idata = (__null);
# 183 "tests/dwtHaar1D/dwtHaar1D.cu"
float *d_odata = (__null);
# 185 "tests/dwtHaar1D/dwtHaar1D.cu"
float *approx_final = (__null);
# 191 "tests/dwtHaar1D/dwtHaar1D.cu"
int approx_is_input;
# 194 "tests/dwtHaar1D/dwtHaar1D.cu"
const unsigned smem_size = (sizeof(float) * slength);
# 195 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), smem_size), "tests/dwtHaar1D/dwtHaar1D.cu", 195);
# 196 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), smem_size), "tests/dwtHaar1D/dwtHaar1D.cu", 196);
# 197 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMalloc((void **)(&approx_final), smem_size), "tests/dwtHaar1D/dwtHaar1D.cu", 197);
# 199 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(d_idata, signal, smem_size, cudaMemcpyHostToDevice), "tests/dwtHaar1D/dwtHaar1D.cu", 200);
# 203 "tests/dwtHaar1D/dwtHaar1D.cu"
float *tmp = ((float *)malloc(smem_size));
# 204 "tests/dwtHaar1D/dwtHaar1D.cu"
for (unsigned i = (0); i < slength; ++i)
# 205 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 206 "tests/dwtHaar1D/dwtHaar1D.cu"
(tmp[i]) = ((0.0));
# 207 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 208 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(d_odata, tmp, smem_size, cudaMemcpyHostToDevice), "tests/dwtHaar1D/dwtHaar1D.cu", 209);
# 210 "tests/dwtHaar1D/dwtHaar1D.cu"
free(tmp);
# 215 "tests/dwtHaar1D/dwtHaar1D.cu"
unsigned num_threads_total_left = (slength / (2));
# 217 "tests/dwtHaar1D/dwtHaar1D.cu"
unsigned dlevels_step = dlevels_complete;
# 220 "tests/dwtHaar1D/dwtHaar1D.cu"
dim3 block_size;
# 221 "tests/dwtHaar1D/dwtHaar1D.cu"
dim3 grid_size;
# 224 "tests/dwtHaar1D/dwtHaar1D.cu"
unsigned dlevels_left = dlevels_complete;
# 229 "tests/dwtHaar1D/dwtHaar1D.cu"
if (dlevels_complete <= (10))
# 230 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 232 "tests/dwtHaar1D/dwtHaar1D.cu"
(block_size.x) = num_threads_total_left;
# 233 "tests/dwtHaar1D/dwtHaar1D.cu"
approx_is_input = 0;
# 234 "tests/dwtHaar1D/dwtHaar1D.cu"
} else
# 236 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 238 "tests/dwtHaar1D/dwtHaar1D.cu"
(grid_size.x) = (num_threads_total_left / (512));
# 239 "tests/dwtHaar1D/dwtHaar1D.cu"
(block_size.x) = (512);
# 242 "tests/dwtHaar1D/dwtHaar1D.cu"
dlevels_step = (10);
# 243 "tests/dwtHaar1D/dwtHaar1D.cu"
dlevels_left -= (10);
# 245 "tests/dwtHaar1D/dwtHaar1D.cu"
approx_is_input = 1;
# 246 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 249 "tests/dwtHaar1D/dwtHaar1D.cu"
while ((0) != num_threads_total_left)
# 250 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 252 "tests/dwtHaar1D/dwtHaar1D.cu"
unsigned mem_shared = (((2) * (block_size.x)) * sizeof(float));
# 254 "tests/dwtHaar1D/dwtHaar1D.cu"
mem_shared += ((((2) * (block_size.x)) / NUM_BANKS) * sizeof(float));
# 257 "tests/dwtHaar1D/dwtHaar1D.cu"
...
# 264 "tests/dwtHaar1D/dwtHaar1D.cu"
if (approx_is_input)
# 265 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 266 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(d_idata, approx_final, (grid_size.x) * (4), cudaMemcpyDeviceToDevice), "tests/dwtHaar1D/dwtHaar1D.cu", 267);
# 268 "tests/dwtHaar1D/dwtHaar1D.cu"
} else
# 270 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 271 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(d_odata, approx_final, (grid_size.x) * (4), cudaMemcpyDeviceToDevice), "tests/dwtHaar1D/dwtHaar1D.cu", 272);
# 273 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 276 "tests/dwtHaar1D/dwtHaar1D.cu"
if (dlevels_left < (10))
# 277 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 279 "tests/dwtHaar1D/dwtHaar1D.cu"
approx_is_input = 0;
# 280 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 283 "tests/dwtHaar1D/dwtHaar1D.cu"
dlevels_step = ((dlevels_left > (10)) ? (dlevels_left - (10)) : dlevels_left);
# 284 "tests/dwtHaar1D/dwtHaar1D.cu"
dlevels_left -= (10);
# 288 "tests/dwtHaar1D/dwtHaar1D.cu"
num_threads_total_left = (num_threads_total_left >> 10);
# 291 "tests/dwtHaar1D/dwtHaar1D.cu"
(grid_size.x) = (((num_threads_total_left / (512)) + ((0) != (num_threads_total_left % (512)))) ? 1 : 0);
# 293 "tests/dwtHaar1D/dwtHaar1D.cu"
if ((grid_size.x) <= (1))
# 294 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 295 "tests/dwtHaar1D/dwtHaar1D.cu"
(block_size.x) = num_threads_total_left;
# 296 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 297 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 301 "tests/dwtHaar1D/dwtHaar1D.cu"
float *odata = ((float *)malloc(smem_size));
# 302 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaMemcpy(odata, d_odata, smem_size, cudaMemcpyDeviceToHost), "tests/dwtHaar1D/dwtHaar1D.cu", 303);
# 306 "tests/dwtHaar1D/dwtHaar1D.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "regression"))
# 307 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 309 "tests/dwtHaar1D/dwtHaar1D.cu"
if (r_fname == (0)) {
# 310 "tests/dwtHaar1D/dwtHaar1D.cu"
fprintf(stderr, "Cannot write the output file storing the result of the wavelet decomposition.\n%s", usage);
# 311 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 312 "tests/dwtHaar1D/dwtHaar1D.cu"
exit(1);
# 313 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 314 "tests/dwtHaar1D/dwtHaar1D.cu"
if ((cutWriteFilef(r_fname, odata, slength, (0.001000000047F), false)) == (CUTTrue)) {
# 315 "tests/dwtHaar1D/dwtHaar1D.cu"
printf("Writing result to %s\n", r_fname); } else
# 316 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 317 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 318 "tests/dwtHaar1D/dwtHaar1D.cu"
exit(1);
# 319 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 320 "tests/dwtHaar1D/dwtHaar1D.cu"
} else
# 322 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 324 "tests/dwtHaar1D/dwtHaar1D.cu"
unsigned len_reference = (0);
# 325 "tests/dwtHaar1D/dwtHaar1D.cu"
float *reference = (__null);
# 326 "tests/dwtHaar1D/dwtHaar1D.cu"
if (r_gold_fname == (0))
# 327 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 328 "tests/dwtHaar1D/dwtHaar1D.cu"
fprintf(stderr, "Cannot read the file containing the reference result of the wavelet decomposition.\n%s", usage);
# 329 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 330 "tests/dwtHaar1D/dwtHaar1D.cu"
exit(1);
# 331 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 332 "tests/dwtHaar1D/dwtHaar1D.cu"
if ((cutReadFilef(r_gold_fname, &reference, &len_reference)) == (CUTTrue)) {
# 333 "tests/dwtHaar1D/dwtHaar1D.cu"
printf("Reading reference result from %s\n", r_gold_fname); } else
# 334 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 335 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 336 "tests/dwtHaar1D/dwtHaar1D.cu"
exit(1);
# 337 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 338 "tests/dwtHaar1D/dwtHaar1D.cu"
__cutilCondition(slength == len_reference, (char *)("tests/dwtHaar1D/dwtHaar1D.cu"), 338);
# 341 "tests/dwtHaar1D/dwtHaar1D.cu"
CUTBoolean res = cutComparefe(reference, odata, slength, (0.001000000047F));
# 342 "tests/dwtHaar1D/dwtHaar1D.cu"
printf("%s\n", (1 == res) ? ("PASSED") : ("FAILED"));
# 343 "tests/dwtHaar1D/dwtHaar1D.cu"
cutFree(reference);
# 344 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 347 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaFree(d_odata), "tests/dwtHaar1D/dwtHaar1D.cu", 347);
# 348 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaFree(d_idata), "tests/dwtHaar1D/dwtHaar1D.cu", 348);
# 349 "tests/dwtHaar1D/dwtHaar1D.cu"
__cudaSafeCall(cudaFree(approx_final), "tests/dwtHaar1D/dwtHaar1D.cu", 349);
# 351 "tests/dwtHaar1D/dwtHaar1D.cu"
cutFree(signal);
# 352 "tests/dwtHaar1D/dwtHaar1D.cu"
free(odata);
# 353 "tests/dwtHaar1D/dwtHaar1D.cu"
cutFree(s_fname);
# 354 "tests/dwtHaar1D/dwtHaar1D.cu"
cutFree(r_fname);
# 355 "tests/dwtHaar1D/dwtHaar1D.cu"
cutFree(r_gold_fname);
# 357 "tests/dwtHaar1D/dwtHaar1D.cu"
cudaThreadExit();
# 359 "tests/dwtHaar1D/dwtHaar1D.cu"
__cutilExit(argc, argv);
# 360 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 373 "tests/dwtHaar1D/dwtHaar1D.cu"
CUTBoolean getLevels(unsigned len, unsigned *levels)
# 374 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 375 "tests/dwtHaar1D/dwtHaar1D.cu"
CUTBoolean retval = CUTFalse;
# 378 "tests/dwtHaar1D/dwtHaar1D.cu"
for (unsigned i = (0); i < (20); ++i)
# 379 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 380 "tests/dwtHaar1D/dwtHaar1D.cu"
if (len == (1 << i))
# 381 "tests/dwtHaar1D/dwtHaar1D.cu"
{
# 382 "tests/dwtHaar1D/dwtHaar1D.cu"
(*levels) = i;
# 383 "tests/dwtHaar1D/dwtHaar1D.cu"
retval = CUTTrue;
# 384 "tests/dwtHaar1D/dwtHaar1D.cu"
break;
# 385 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 386 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 388 "tests/dwtHaar1D/dwtHaar1D.cu"
return retval;
# 389 "tests/dwtHaar1D/dwtHaar1D.cu"
}
# 1 "tmpxft_00005952_00000000-1_dwtHaar1D.cudafe1.stub.c"
# 1 "tmpxft_00005952_00000000-1_dwtHaar1D.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00005952_00000000-1_dwtHaar1D.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00005952_00000000-1_dwtHaar1D.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_00005952_00000000-3_dwtHaar1D.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x000000000000187e,0x0000006001000001,0x0000000000000f96\n"
".quad 0x0000003800000000,0x0000001400030000,0x0000001c00000040,0x0000000000000015\n"
".quad 0x0000000000000000,0x0000000000000000,0x77642f7374736574,0x2f44317261614874\n"
".quad 0x3172616148747764,0x0000000075632e44,0x762e0a0a0a0a0a0a,0x33206e6f69737265\n"
".quad 0x677261742e0a302e,0x30325f6d73207465,0x7365726464612e0a,0x3620657a69735f73\n"
".quad 0x656c69662e0a0a34,0x706d742f22203109,0x5f746678706d742f,0x3235393530303030\n"
".quad 0x303030303030305f,0x487477645f372d30,0x70632e4431726161,0x662e0a22692e3370\n"
".quad 0x2e22203209656c69,0x642f73747365742f,0x4431726161487477,0x726161487477642f\n"
".quad 0x656e72656b5f4431,0x652e0a2275632e6c,0x732e206e72657478,0x612e206465726168\n"
".quad 0x2e2034206e67696c,0x6572616873203862,0x652e0a0a3b5d5b64,0x395a5f207972746e\n"
".quad 0x3172616148747764,0x6a5f535f53665044,0x7261702e0a28696a,0x203436752e206d61\n"
".quad 0x6148747764395a5f,0x5f53665044317261,0x61705f696a6a5f53,0x2e0a2c305f6d6172\n"
".quad 0x752e206d61726170,0x7764395a5f203436,0x5044317261614874,0x696a6a5f535f5366\n"
".quad 0x0000611ca56000c0,0x00ffffdc04c10000,0x0084019c0450ee00,0x001441dd002c0000\n"
".quad 0x0014421c00500000,0x00f0611c03500000,0x00a0025de4480040,0x0010615c23280040\n"
".quad 0x000c40dc035800c0,0x13cc711c02480000,0x0018515c0330fcd4,0x0010329c03480000\n"
".quad 0x001030dc432013c0,0x13cc819c025000c0,0x0008515e0330fcd4,0x00b032dc436000c0\n"
".quad 0x0000519c85480040,0x0000a11c85c90000,0x00ffffdc04940000,0x00e000dde450ee00\n"
".quad 0x000831dc03280040,0x00000001e7188ec0,0x010000dde4800000,0x0094011c04280040\n"
".quad 0x0004019de22c0000,0x000401dde2180000,0x000430dc23180000,0x0050421c035800c0\n"
".quad 0x000c01dc03480040,0x02e000a1e7188e00,0x0018214003400000,0x0010210003480000\n"
".quad 0x00046180035800c0,0x00105240036000c0,0x00084100035800c0,0x0004208003480000\n"
".quad 0x00149280036000c0,0x0008424203480000,0x00203140a36000c0,0x0008a28203200000\n"
".quad 0x000092c0856000c0,0x00a00101e4c10000,0x0000a28085280040,0x000430c003c10000\n"
".quad 0x00105100035800c0,0x00105140432009c0,0x0028b301005000c0,0x0028b28000500000\n"
".quad 0x00b0514043500000,0x13ccc2c002480040,0x13cca2800230fcd4,0x000042c08530fcd4\n"
".quad 0x0000928085940000,0x00fc8fdc03c90000,0x00ffffdc04207e00,0x000471dc0350ee00\n"
".quad 0x00e071dc034800c0,0xfc400001e7188e40,0x0084001c044003ff,0x00fc01dc232c0000\n"
".quad 0x0094000004190e00,0x00c00081e42c0000,0x00100100a3280040,0x00100080e32005c0\n"
".quad 0x0003f000855000c0,0x00d0214043c10000,0x0000400085480040,0x0000001de7940000\n"
".quad 0x0000000000800000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0400000000000000,0x200000000900080a,0x0400241903002400,0x0500000000000c17\n"
".quad 0x040011f000002000,0x0400000000000c17,0x040011f000001c00,0x0300000000000c17\n"
".quad 0x040011f000001800,0x0200000000000c17,0x040021f000001000,0x0100000000000c17\n"
".quad 0x040021f000000800,0x0000000000000c17,0x040021f000000000,0x010002001800080d\n"
".quad 0x0a00081204000000,0x0400000000000000,0x000000000a000811,0x0006000000000000\n"
".quad 0x07c0000000050000,0x0000000000000000,0x0000000000000000,0x0070000000000000\n"
".quad 0x0070000000000000,0x0004000000000000,0x0000000000000000,0x03fd00000a056000\n"
".quad 0x0000000000000000,0x0000000000000000,0x03a8000000000000,0x03a8000000000000\n"
".quad 0x0004000000000000,0x0000000000000000\n"
".text");
...
# 3 "/tmp/tmpxft_00005952_00000000-1_dwtHaar1D.cudafe1.stub.c" 2 3
extern void __device_stub__Z9dwtHaar1DPfS_S_jji(float *, float *, float *, const unsigned, const unsigned, const int);
static void __sti____cudaRegisterAll_44_tmpxft_00005952_00000000_4_dwtHaar1D_cpp1_ii_807bd51f(void) __attribute__((__constructor__));
