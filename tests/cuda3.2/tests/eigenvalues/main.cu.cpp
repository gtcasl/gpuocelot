...
# 26 "tests/eigenvalues/gerschgorin.h"
extern "C" void computeGerschgorin(float * , float * , unsigned , float & , float & );
# 31 "tests/eigenvalues/bisect_small.cuh"
...
# 34 "tests/eigenvalues/main.cu"
const char *sSDKsample = ("CUDA eigenvalues");
# 38 "tests/eigenvalues/main.cu"
void runTest(int , char ** );
# 44 "tests/eigenvalues/main.cu"
int main(int argc, char **argv)
# 45 "tests/eigenvalues/main.cu"
{
# 46 "tests/eigenvalues/main.cu"
printf("[ %s ]\n", sSDKsample);
# 48 "tests/eigenvalues/main.cu"
runTest(argc, argv);
# 50 "tests/eigenvalues/main.cu"
__cutilExit(argc, argv); return 0;
# 51 "tests/eigenvalues/main.cu"
}
# 62 "tests/eigenvalues/main.cu"
void initInputData(InputData &input, char *exec_path, const unsigned
# 63 "tests/eigenvalues/main.cu"
mat_size, const unsigned user_defined)
# 64 "tests/eigenvalues/main.cu"
{
...
# 69 "tests/eigenvalues/main.cu"
if ((1) == user_defined) {
# 72 "tests/eigenvalues/main.cu"
srand(278217421);
# 74 "tests/eigenvalues/main.cu"
for (unsigned i = (0); i < mat_size; ++i) {
# 75 "tests/eigenvalues/main.cu"
((input.a)[i]) = ((float)((2.0) * ((((double)rand()) / ((double)2147483647)) - (0.5))));
# 77 "tests/eigenvalues/main.cu"
((input.b)[i]) = ((float)((2.0) * ((((double)rand()) / ((double)2147483647)) - (0.5))));
# 79 "tests/eigenvalues/main.cu"
}
# 84 "tests/eigenvalues/main.cu"
((input.b)[0]) = (0.0F);
# 85 "tests/eigenvalues/main.cu"
} else
# 86 "tests/eigenvalues/main.cu"
{
# 89 "tests/eigenvalues/main.cu"
unsigned input_data_size = mat_size;
# 90 "tests/eigenvalues/main.cu"
char *diag_path = cutFindFilePath("diagonal.dat", exec_path);
# 91 "tests/eigenvalues/main.cu"
__cutilCondition((0) != diag_path, (char *)("tests/eigenvalues/main.cu"), 91);
# 92 "tests/eigenvalues/main.cu"
__cutilCheckError(cutReadFilef(diag_path, &(input.a), &input_data_size), "tests/eigenvalues/main.cu", 92);
# 94 "tests/eigenvalues/main.cu"
char *sdiag_path = cutFindFilePath("superdiagonal.dat", exec_path);
# 95 "tests/eigenvalues/main.cu"
__cutilCondition((0) != sdiag_path, (char *)("tests/eigenvalues/main.cu"), 95);
# 96 "tests/eigenvalues/main.cu"
__cutilCheckError(cutReadFilef(sdiag_path, &(input.b), &input_data_size, 1), "tests/eigenvalues/main.cu", 97);
# 99 "tests/eigenvalues/main.cu"
cutFree(diag_path);
# 100 "tests/eigenvalues/main.cu"
cutFree(sdiag_path);
# 101 "tests/eigenvalues/main.cu"
}
# 104 "tests/eigenvalues/main.cu"
__cudaSafeCall(cudaMalloc((void **)(&(input.g_a)), sizeof(float) * mat_size), "tests/eigenvalues/main.cu", 104);
# 105 "tests/eigenvalues/main.cu"
__cudaSafeCall(cudaMalloc((void **)(&(input.g_b_raw)), sizeof(float) * mat_size), "tests/eigenvalues/main.cu", 105);
# 108 "tests/eigenvalues/main.cu"
__cudaSafeCall(cudaMemcpy(input.g_a, input.a, sizeof(float) * mat_size, cudaMemcpyHostToDevice), "tests/eigenvalues/main.cu", 108);
# 109 "tests/eigenvalues/main.cu"
__cudaSafeCall(cudaMemcpy(input.g_b_raw, input.b, sizeof(float) * mat_size, cudaMemcpyHostToDevice), "tests/eigenvalues/main.cu", 109);
...
freePtr(input.a);
# 122 "tests/eigenvalues/main.cu"
freePtr(input.b);
# 124 "tests/eigenvalues/main.cu"
__cudaSafeCall(cudaFree(input.g_a), "tests/eigenvalues/main.cu", 124);
# 125 "tests/eigenvalues/main.cu"
(input.g_a) = (__null);
# 126 "tests/eigenvalues/main.cu"
__cudaSafeCall(cudaFree(input.g_b_raw), "tests/eigenvalues/main.cu", 126);
# 127 "tests/eigenvalues/main.cu"
...
if ((__null) != temp) {
# 210 "tests/eigenvalues/main.cu"
filename = ((char *)malloc(sizeof(char) * strlen(temp)));
# 211 "tests/eigenvalues/main.cu"
strcpy(filename, temp);
# 213 "tests/eigenvalues/main.cu"
cutFree(temp);
# 214 "tests/eigenvalues/main.cu"
}
# 216 "tests/eigenvalues/main.cu"
printf("Result filename: \'%s\'\n", filename);
# 217 "tests/eigenvalues/main.cu"
}
...
# 232 "tests/eigenvalues/main.cu"
__cutilCheckError(cutCreateTimer(&timer), "tests/eigenvalues/main.cu", 232);
# 233 "tests/eigenvalues/main.cu"
__cutilCheckError(cutCreateTimer(&timer_total), "tests/eigenvalues/main.cu", 233);
# 236 "tests/eigenvalues/main.cu"
unsigned mat_size = (2048);
# 238 "tests/eigenvalues/main.cu"
unsigned user_defined = (0);
# 240 "tests/eigenvalues/main.cu"
float precision = (9.999999747e-06F);
# 244 "tests/eigenvalues/main.cu"
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000366,0x0000006001000001,0x0000000000000036\n"
".quad 0x0000003800000000,0x0000001400030000,0x0000001900000040,0x0000000000000015\n"
".quad 0x0000000000000000,0x0000000000000000,0x69652f7374736574,0x65756c61766e6567\n"
".quad 0x632e6e69616d2f73,0x0000000000000075,0x762e0a0a0a0a0a0a,0x33206e6f69737265\n"
".quad 0x677261742e0a302e,0x30325f6d73207465,0x7365726464612e0a,0x3620657a69735f73\n"
".quad 0x0002000a0a0a0a34,0x0278000000580100,0x0000000000000000,0x0004000000000000\n"
".quad 0x0038000000140001,0x0015000000190000,0x0000000000000000,0x6574000000000000\n"
".quad 0x656769652f737473,0x2f7365756c61766e,0x0075632e6e69616d,0x457f000000000000\n"
...
".quad 0x0207000000000000,0x0004000000000000,0x0000000000000000\n"
".text");
