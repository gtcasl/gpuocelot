# 1 "/tmp/tmpxft_00007152_00000000-1_scalarProd.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00007152_00000000-1_scalarProd.cudafe1.cpp"
...
# 31 "tests/scalarProd/scalarProd.cu"
extern "C" void scalarProdCPU(float * , float * , float * , int , int );
# 34 "tests/scalarProd/scalarProd_kernel.cu"
void scalarProdGPU(float *
# 35 "tests/scalarProd/scalarProd_kernel.cu"
d_C, float *
# 36 "tests/scalarProd/scalarProd_kernel.cu"
d_A, float *
# 37 "tests/scalarProd/scalarProd_kernel.cu"
d_B, int
# 38 "tests/scalarProd/scalarProd_kernel.cu"
vectorN, int
# 39 "tests/scalarProd/scalarProd_kernel.cu"
elementN) ;
# 52 "tests/scalarProd/scalarProd.cu"
float RandFloat(float low, float high) {
# 53 "tests/scalarProd/scalarProd.cu"
float t = (((float)rand()) / ((float)2147483647));
# 54 "tests/scalarProd/scalarProd.cu"
return (((1.0F) - t) * low) + (t * high);
# 55 "tests/scalarProd/scalarProd.cu"
}
# 64 "tests/scalarProd/scalarProd.cu"
static const int VECTOR_N = 256;
# 68 "tests/scalarProd/scalarProd.cu"
static const int ELEMENT_N = 4096;
# 70 "tests/scalarProd/scalarProd.cu"
static const int DATA_N = (VECTOR_N * ELEMENT_N);
# 72 "tests/scalarProd/scalarProd.cu"
static const int DATA_SZ = (DATA_N * sizeof(float));
# 73 "tests/scalarProd/scalarProd.cu"
static const int RESULT_SZ = (VECTOR_N * sizeof(float));
# 80 "tests/scalarProd/scalarProd.cu"
int main(int argc, char **argv) {
# 81 "tests/scalarProd/scalarProd.cu"
float *h_A, *h_B, *h_C_CPU, *h_C_GPU;
# 82 "tests/scalarProd/scalarProd.cu"
float *d_A, *d_B, *d_C;
# 83 "tests/scalarProd/scalarProd.cu"
double delta, ref, sum_delta, sum_ref, L1norm;
# 84 "tests/scalarProd/scalarProd.cu"
unsigned hTimer;
# 85 "tests/scalarProd/scalarProd.cu"
int i;
# 88 "tests/scalarProd/scalarProd.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 89 "tests/scalarProd/scalarProd.cu"
cutilDeviceInit(argc, argv); } else {
# 91 "tests/scalarProd/scalarProd.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 93 "tests/scalarProd/scalarProd.cu"
__cutilCheckError(cutCreateTimer(&hTimer), "tests/scalarProd/scalarProd.cu", 93);
# 95 "tests/scalarProd/scalarProd.cu"
printf("Initializing data...\n");
# 96 "tests/scalarProd/scalarProd.cu"
printf("...allocating CPU memory.\n");
# 97 "tests/scalarProd/scalarProd.cu"
h_A = ((float *)malloc(DATA_SZ));
# 98 "tests/scalarProd/scalarProd.cu"
h_B = ((float *)malloc(DATA_SZ));
# 99 "tests/scalarProd/scalarProd.cu"
h_C_CPU = ((float *)malloc(RESULT_SZ));
# 100 "tests/scalarProd/scalarProd.cu"
h_C_GPU = ((float *)malloc(RESULT_SZ));
# 102 "tests/scalarProd/scalarProd.cu"
printf("...allocating GPU memory.\n");
# 103 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_A), DATA_SZ), "tests/scalarProd/scalarProd.cu", 103);
# 104 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_B), DATA_SZ), "tests/scalarProd/scalarProd.cu", 104);
# 105 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_C), RESULT_SZ), "tests/scalarProd/scalarProd.cu", 105);
# 107 "tests/scalarProd/scalarProd.cu"
printf("...generating input data in CPU mem.\n");
# 108 "tests/scalarProd/scalarProd.cu"
srand(123);
# 110 "tests/scalarProd/scalarProd.cu"
for (i = 0; i < DATA_N; i++) {
# 111 "tests/scalarProd/scalarProd.cu"
(h_A[i]) = RandFloat((0.0F), (1.0F));
# 112 "tests/scalarProd/scalarProd.cu"
(h_B[i]) = RandFloat((0.0F), (1.0F));
# 113 "tests/scalarProd/scalarProd.cu"
}
# 115 "tests/scalarProd/scalarProd.cu"
printf("...copying input data to GPU mem.\n");
# 117 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaMemcpy(d_A, h_A, DATA_SZ, cudaMemcpyHostToDevice), "tests/scalarProd/scalarProd.cu", 117);
# 118 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaMemcpy(d_B, h_B, DATA_SZ, cudaMemcpyHostToDevice), "tests/scalarProd/scalarProd.cu", 118);
# 119 "tests/scalarProd/scalarProd.cu"
printf("Data init done.\n");
# 122 "tests/scalarProd/scalarProd.cu"
printf("Executing GPU kernel...\n");
# 123 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/scalarProd/scalarProd.cu", 123);
# 124 "tests/scalarProd/scalarProd.cu"
__cutilCheckError(cutResetTimer(hTimer), "tests/scalarProd/scalarProd.cu", 124);
# 125 "tests/scalarProd/scalarProd.cu"
__cutilCheckError(cutStartTimer(hTimer), "tests/scalarProd/scalarProd.cu", 125);
# 126 "tests/scalarProd/scalarProd.cu"
cudaConfigureCall(128, 256) ? ((void)0) : scalarProdGPU(d_C, d_A, d_B, VECTOR_N, ELEMENT_N);
# 127 "tests/scalarProd/scalarProd.cu"
__cutilCheckMsg("scalarProdGPU() execution failed\n", "tests/scalarProd/scalarProd.cu", 127);
# 128 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/scalarProd/scalarProd.cu", 128);
# 129 "tests/scalarProd/scalarProd.cu"
__cutilCheckError(cutStopTimer(hTimer), "tests/scalarProd/scalarProd.cu", 129);
# 130 "tests/scalarProd/scalarProd.cu"
printf("GPU time: %f msecs.\n", cutGetTimerValue(hTimer));
# 132 "tests/scalarProd/scalarProd.cu"
printf("Reading back GPU result...\n");
# 134 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaMemcpy(h_C_GPU, d_C, RESULT_SZ, cudaMemcpyDeviceToHost), "tests/scalarProd/scalarProd.cu", 134);
# 137 "tests/scalarProd/scalarProd.cu"
printf("Checking GPU results...\n");
# 138 "tests/scalarProd/scalarProd.cu"
printf("..running CPU scalar product calculation\n");
# 139 "tests/scalarProd/scalarProd.cu"
scalarProdCPU(h_C_CPU, h_A, h_B, VECTOR_N, ELEMENT_N);
# 141 "tests/scalarProd/scalarProd.cu"
printf("...comparing the results\n");
# 144 "tests/scalarProd/scalarProd.cu"
sum_delta = (0);
# 145 "tests/scalarProd/scalarProd.cu"
sum_ref = (0);
# 146 "tests/scalarProd/scalarProd.cu"
for (i = 0; i < VECTOR_N; i++) {
# 147 "tests/scalarProd/scalarProd.cu"
delta = (fabs((h_C_GPU[i]) - (h_C_CPU[i])));
# 148 "tests/scalarProd/scalarProd.cu"
ref = (h_C_CPU[i]);
# 149 "tests/scalarProd/scalarProd.cu"
sum_delta += delta;
# 150 "tests/scalarProd/scalarProd.cu"
sum_ref += ref;
# 151 "tests/scalarProd/scalarProd.cu"
}
# 152 "tests/scalarProd/scalarProd.cu"
L1norm = (sum_delta / sum_ref);
# 153 "tests/scalarProd/scalarProd.cu"
printf("L1 error: %E\n", L1norm);
# 154 "tests/scalarProd/scalarProd.cu"
printf((L1norm < (9.999999999999999547e-07)) ? ("PASSED\n") : ("FAILED\n"));
# 157 "tests/scalarProd/scalarProd.cu"
printf("Shutting down...\n");
# 158 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaFree(d_C), "tests/scalarProd/scalarProd.cu", 158);
# 159 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaFree(d_B), "tests/scalarProd/scalarProd.cu", 159);
# 160 "tests/scalarProd/scalarProd.cu"
__cudaSafeCall(cudaFree(d_A), "tests/scalarProd/scalarProd.cu", 160);
# 161 "tests/scalarProd/scalarProd.cu"
free(h_C_GPU);
# 162 "tests/scalarProd/scalarProd.cu"
free(h_C_CPU);
# 163 "tests/scalarProd/scalarProd.cu"
free(h_B);
# 164 "tests/scalarProd/scalarProd.cu"
free(h_A);
# 165 "tests/scalarProd/scalarProd.cu"
__cutilCheckError(cutDeleteTimer(hTimer), "tests/scalarProd/scalarProd.cu", 165);
# 167 "tests/scalarProd/scalarProd.cu"
cudaThreadExit();
# 169 "tests/scalarProd/scalarProd.cu"
__cutilExit(argc, argv); return 0;
# 171 "tests/scalarProd/scalarProd.cu"
}
# 1 "tmpxft_00007152_00000000-1_scalarProd.cudafe1.stub.c"
# 1 "tmpxft_00007152_00000000-1_scalarProd.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00007152_00000000-1_scalarProd.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00007152_00000000-1_scalarProd.cudafe1.stub.c" 2 3
".quad 0x0000030000000b00,0x0000000000000000,0x0000000000000000,0x0000000000034f00\n"
".quad 0x0000000000001b00,0x0000000000000000,0x0000000000000100,0x0000000000000000\n"
".quad 0x0000020000001300,0x0000000000000000,0x0000000000000000,0x0000000000036a00\n"
".quad 0x0000000000012000,0x00000b0000000200,0x0000000000000100,0x0000000000001800\n"
".quad 0x0000010000003600,0x0000000010000600,0x0000000000000000,0x0000000000048a00\n"
".quad 0x0000000000032000,0x0000060000000300,0x0000000000000413,0x0000000000000000\n"
".quad 0x000001000000a700,0x0000000000000200,0x0000000000000000,0x000000000007aa00\n"
".quad 0x0000000000004000,0x0000040000000000,0x0000000000000400,0x0000000000000000\n"
".quad 0x0000010000005600,0x0000000000000200,0x0000000000000000,0x000000000007ea00\n"
".quad 0x0000000000006c00,0x0000040000000000,0x0000000000000100,0x0000000000000000\n"
".quad 0x0000080000008200,0x0000000000000300,0x0000000000000000,0x0000000000085600\n"
".quad 0x0000000000100000,0x0000040000000000,0x0000000000000400,0x0000000000000000\n"
".quad 0x0000010000007900,0x0000000000000200,0x0000000000000000,0x0000000000085600\n"
".quad 0x0000000000001800,0x0000000000000000,0x0000000000000100,0x0000000000000000\n"
...
".quad 0x5072616c61637333,0x6650555047646f72,0x2e0069695f535f53,0x2e6f666e692e766e\n"
".quad 0x6c61637333315a5f,0x5047646f72507261,0x695f535f53665055,0x6e692e766e2e0069\n"
".quad 0x732e766e2e006f66,0x5a5f2e6465726168,0x72616c6163733331,0x50555047646f7250\n"
".quad 0x0069695f535f5366,0x736e6f632e766e2e,0x5a5f2e30746e6174,0x72616c6163733331\n"
".quad 0x50555047646f7250,0x0069695f535f5366,0x61637333315a5f00,0x47646f725072616c\n"
".quad 0x5f535f5366505550,0x0000000000006969,0x0000000000000000,0x0000000000000000\n"
...
".quad 0x0000000000000400,0x0000000320000000,0x0300000000000000,0x0000000000000600\n"
...
".quad 0x0000000320000000,0x0400005de4000000,0x0094001c04280044,0x00e001dc232c0000\n"
".quad 0x00000001e71b0e40,0x0084035c04800000,0x00f0009de42c0000,0x00fcd1dc23280040\n"
".quad 0x6000239c23190e00,0x6000009c237000c0,0x008400dc047000c0,0x07400000072c0000\n"
".quad 0x0008e3dca3600000,0x0ffc33dc23500000,0x00f0f29c031a0ec0,0x06a00005e7480040\n"
".quad 0x003402dde4400000,0x05c0000007280000,0x003cb41c03700000,0x002903dc23480000\n"
".quad 0x00400005e7188e00,0x00fc031de4400000,0x0000001de7280000,0x1001009c03b00000\n"
".quad 0x00fc031de44800c0,0x03a0000007280000,0x002823dc23600000,0x03400025e7188e00\n"
".quad 0x0010049de2400000,0x02e0000007180000,0x0011009ce3600000,0x00a1011ca35000c0\n"
".quad 0x1001045c03202580,0x00b0215c434800c0,0x00c1019ca3480040,0x0011125ce3202580\n"
".quad 0x0000415c855000c0,0x00d021dc43840000,0x00a1109ca3480040,0x2001041c03202580\n"
".quad 0x000061dc854800c0,0x00b090dc43840000,0x00c1121ca3480040,0x002903dc23202580\n"
".quad 0x0000209c85188e00,0x00d0925c43840000,0x2001119c03480040,0x0000811c854800c0\n"
".quad 0x002863dc23840000,0x001c50dc00188200,0x0010231c00301800,0xfd400005e7300600\n"
".quad 0x002903dc334003ff,0x00000025e7188e00,0x0010009df2b00000,0x001100dce3180000\n"
".quad 0x00c1011ca35000c0,0x00d0315c43200580,0x00a1009ca3480040,0x0000411c85200580\n"
".quad 0x00b030dc43840000,0x0000209c85480040,0x0010231c00840000,0x0000001de7301800\n"
".quad 0x0008b09e03b00000,0x0020b2dc036000c0,0x0000231c85480040,0x1000b3dc23c90000\n"
".quad 0xf9800005e7188ec0,0x0800009df24003ff,0x00fc00dde4180000,0x00281fdc03280000\n"
".quad 0x01e0000007207e00,0x00ffffdc04600000,0x0008d3dc2350ee00,0x01600005e71b0e00\n"
".quad 0x0034011de4400000,0x0008415c03280000,0x000841de03480000,0x0020411c036000c0\n"
".quad 0x0008515e03480040,0x0000719c856000c0,0x000843dc23c10000,0x0000515c85188e00\n"
".quad 0x0014615c00c10000,0x0000715c85500000,0xfec00005e7c90000,0x000430dc134003ff\n"
".quad 0x002833dc234800c0,0x0004209c231a8ec0,0xfd800005e75800c0,0x00800101e44003ff\n"
".quad 0x001000c0e3280040,0x0003f080855000c0,0x00100100a3c10000,0x0050001c032009c0\n"
".quad 0x0090314043480040,0x00e003dc23480040,0x0000408085188e40,0xf4a00005e7940000\n"
".quad 0x0000001de74003ff,0x0000000000800000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0a00080a04000000,0x0300200020000000,0x00000c1704002019\n"
".quad 0x00001c0004000000,0x00000c17040011f0,0x0000180003000000,0x00000c17040011f0\n"
".quad 0x0000100002000000,0x00000c17040021f0,0x0000080001000000,0x00000c17040021f0\n"
".quad 0x0000000000000000,0xb000080d040021f0,0x0400000020002401,0x000000000b000812\n"
".quad 0x0b00081104000000,0x0000000000000000,0x0000050000000600,0x0000000000087000\n"
".quad 0x0000000000000000,0x0000000000000000,0x000000000000a800,0x000000000000a800\n"
".quad 0x0000000000000400,0x000b056000000000,0x0000000000048a00,0x0000000000000000\n"
".quad 0x0000000000000000,0x000000000003cc00,0x000000000003cc00,0x0000000000000400\n"
".quad 0x000b066000000000,0x0000000000085600,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000100000,0x0000000000000400,0x0000000000000000\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[736];
...
# 3 "/tmp/tmpxft_00007152_00000000-1_scalarProd.cudafe1.stub.c" 2 3
extern void __device_stub__Z13scalarProdGPUPfS_S_ii(float *, float *, float *, int, int);
static void __sti____cudaRegisterAll_45_tmpxft_00007152_00000000_4_scalarProd_cpp1_ii_48817456(void) __attribute__((__constructor__));
