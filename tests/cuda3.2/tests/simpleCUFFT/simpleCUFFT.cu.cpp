# 1 "/tmp/tmpxft_00007e6b_00000000-1_simpleCUFFT.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00007e6b_00000000-1_simpleCUFFT.cudafe1.cpp"
# 1 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
...
# 36 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
typedef float2 Complex;
# 37 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexAdd(Complex, Complex);
# 38 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexScale(Complex, float);
# 39 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexMul(Complex, Complex);
# 40 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
static void ComplexPointwiseMulAndScale(Complex *, const Complex *, int, float);
# 43 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
void Convolve(const Complex *, int, const Complex *, int, Complex *);
# 46 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int PadData(const Complex *, Complex **, int, const Complex *, Complex **, int);
# 51 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
void runTest(int, char **);
# 60 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int main(int argc, char **argv)
# 61 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
{
# 62 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
runTest(argc, argv);
# 64 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cutilExit(argc, argv); return 0;
# 65 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 70 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
void runTest(int argc, char **argv)
# 71 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
{
# 72 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 73 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
cutilDeviceInit(argc, argv); } else {
# 75 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 78 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_signal = ((Complex *)malloc(sizeof(Complex) * (50)));
# 80 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
for (unsigned i = (0); i < (50); ++i) {
# 81 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
((h_signal[i]).x) = ((rand()) / ((float)2147483647));
# 82 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
((h_signal[i]).y) = (0);
# 83 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 86 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_filter_kernel = ((Complex *)malloc(sizeof(Complex) * (11)));
# 88 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
for (unsigned i = (0); i < (11); ++i) {
# 89 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
((h_filter_kernel[i]).x) = ((rand()) / ((float)2147483647));
# 90 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
((h_filter_kernel[i]).y) = (0);
# 91 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 94 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_padded_signal;
# 95 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_padded_filter_kernel;
# 96 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int new_size = PadData(h_signal, &h_padded_signal, 50, h_filter_kernel, &h_padded_filter_kernel, 11);
# 98 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int mem_size = (sizeof(Complex) * new_size);
# 101 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *d_signal;
# 102 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_signal), mem_size), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 102);
# 104 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(d_signal, h_padded_signal, mem_size, cudaMemcpyHostToDevice), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 105);
# 108 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *d_filter_kernel;
# 109 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_filter_kernel), mem_size), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 109);
# 112 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(d_filter_kernel, h_padded_filter_kernel, mem_size, cudaMemcpyHostToDevice), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 113);
# 116 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
cufftHandle plan;
# 117 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftPlan1d(&plan, new_size, CUFFT_C2C, 1), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 117);
# 120 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, -1), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 120);
# 121 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_filter_kernel, (cufftComplex *)d_filter_kernel, -1), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 121);
# 124 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
cudaConfigureCall(32, 256) ? ((void)0) : ComplexPointwiseMulAndScale(d_signal, d_filter_kernel, new_size, (1.0F) / new_size);
# 127 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cutilCheckMsg("Kernel execution failed [ ComplexPointwiseMulAndScale ]", "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 127);
# 130 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, 1), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 130);
# 133 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_convolved_signal = h_padded_signal;
# 134 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(h_convolved_signal, d_signal, mem_size, cudaMemcpyDeviceToHost), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 135);
# 138 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_convolved_signal_ref = ((Complex *)malloc(sizeof(Complex) * (50)));
# 141 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Convolve(h_signal, 50, h_filter_kernel, 11, h_convolved_signal_ref);
# 146 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
CUTBoolean res = cutCompareL2fe((float *)h_convolved_signal_ref, (float *)h_convolved_signal, 2 * 50, (9.999999747e-06F));
# 147 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
printf("%s\n", (1 == res) ? ("PASSED") : ("FAILED"));
# 150 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftDestroy(plan), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 150);
# 153 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
free(h_signal);
# 154 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
free(h_filter_kernel);
# 155 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
free(h_padded_signal);
# 156 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
free(h_padded_filter_kernel);
# 157 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
free(h_convolved_signal_ref);
# 158 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaFree(d_signal), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 158);
# 159 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaFree(d_filter_kernel), "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu", 159);
# 161 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
cudaThreadExit();
# 162 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 165 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int PadData(const Complex *signal, Complex **padded_signal, int signal_size, const Complex *
# 166 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
filter_kernel, Complex **padded_filter_kernel, int filter_kernel_size)
# 167 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
{
# 168 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int minRadius = (filter_kernel_size / 2);
# 169 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int maxRadius = (filter_kernel_size - minRadius);
# 170 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int new_size = (signal_size + maxRadius);
# 173 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex *new_data = ((Complex *)malloc(sizeof(Complex) * new_size));
# 174 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
memcpy(new_data + 0, signal, signal_size * sizeof(Complex));
# 175 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
memset(new_data + signal_size, 0, (new_size - signal_size) * sizeof(Complex));
# 176 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(*padded_signal) = new_data;
# 179 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
new_data = ((Complex *)malloc(sizeof(Complex) * new_size));
# 180 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
memcpy(new_data + 0, filter_kernel + minRadius, maxRadius * sizeof(Complex));
# 181 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
memset(new_data + maxRadius, 0, (new_size - filter_kernel_size) * sizeof(Complex));
# 182 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
memcpy((new_data + new_size) - minRadius, filter_kernel, minRadius * sizeof(Complex));
# 183 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(*padded_filter_kernel) = new_data;
# 185 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
return new_size;
# 186 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 193 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
void Convolve(const Complex *signal, int signal_size, const Complex *
# 194 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
filter_kernel, int filter_kernel_size, Complex *
# 195 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
filtered_signal)
# 196 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
{
# 197 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int minRadius = (filter_kernel_size / 2);
# 198 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int maxRadius = (filter_kernel_size - minRadius);
# 200 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
for (int i = 0; i < signal_size; ++i) {
# 201 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
((filtered_signal[i]).x) = (((filtered_signal[i]).y) = (0));
# 203 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
for (int j = ((-maxRadius) + 1); j <= minRadius; ++j) {
# 204 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
int k = (i + j);
# 205 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
if ((k >= 0) && (k < signal_size)) {
# 206 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(filtered_signal[i]) = ComplexAdd(filtered_signal[i], ComplexMul(signal[k], filter_kernel[minRadius - j])); }
# 207 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 208 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 209 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 216 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexAdd(Complex a, Complex b)
# 217 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
{
# 218 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex c;
# 219 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(c.x) = ((a.x) + (b.x));
# 220 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(c.y) = ((a.y) + (b.y));
# 221 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
return c;
# 222 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 225 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexScale(Complex a, float s)
# 226 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
{
# 227 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex c;
# 228 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(c.x) = (s * (a.x));
# 229 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(c.y) = (s * (a.y));
# 230 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
return c;
# 231 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 234 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexMul(Complex a, Complex b)
# 235 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
{
# 236 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
Complex c;
# 237 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(c.x) = (((a.x) * (b.x)) - ((a.y) * (b.y)));
# 238 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
(c.y) = (((a.x) * (b.y)) + ((a.y) * (b.x)));
# 239 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
return c;
# 240 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
}
# 243 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
static void ComplexPointwiseMulAndScale(Complex *a, const Complex *b, int size, float scale) ;
# 1 "/tmp/tmpxft_00007e6b_00000000-1_simpleCUFFT.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00007e6b_00000000-1_simpleCUFFT.cudafe1.stub.c" 1
...
#pragma pack()
# 2 "/tmp/tmpxft_00007e6b_00000000-1_simpleCUFFT.cudafe1.stub.c" 2
# 1 "/tmp/tmpxft_00007e6b_00000000-3_simpleCUFFT.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00007e6b_00000000-3_simpleCUFFT.fatbin.c" 2
...
".quad 0x676e696c69706d6f,0x6d742f706d742f20,0x3030305f74667870,0x30305f6236653730\n"
".quad 0x372d303030303030,0x43656c706d69735f,0x7070632e54464655,0x6d742f2820692e33\n"
".quad 0x2e23494263632f70,0x0a294d5a7635536d,0x2d2d2d2d2d2f2f09,0x2d2d2d2d2d2d2d2d\n"
".quad 0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d\n"
".quad 0x00000001000000a1,0x0000000000000002,0x0000000000000000,0x000000000000060d\n"
...
".quad 0x0000000000000000,0x0000000004000300,0x0001080000000000,0x0000000000000000\n"
...
".quad 0x0000010000000000,0x0000000004101200,0x0001080000000000,0x005de40000000000\n"
".quad 0x001c042800440400,0x009c042c00000094,0x001c032c00000084,0x01dc232004400020\n"
".quad 0x0001e71b0e4000c0,0x015de28000000000,0x011ce31800000020,0x019de45000c00020\n"
".quad 0x009ca32800400050,0x629c03200b800080,0x40dc435000400020,0x021ca34800400090\n"
".quad 0xa31c43200b8000a0,0xa2de035000c00020,0x425c436000c0000c,0x219ca548004000b0\n"
".quad 0x811ca58400000000,0x001c038400000000,0x821c034800000028,0x01dc23480100002c\n"
".quad 0x925c43188e4000c0,0x635c004800000030,0x439c005800000010,0x711e00580000001c\n"
".quad 0x615c00301a000014,0x411c00301c000014,0x515c0058004000d0,0x211ca558004000d0\n"
".quad 0x209c039400000000,0x30dc43480100002c,0x0001e74800000030,0x001de74003fffe00\n"
...
".quad 0x0000000000000000,0x0000000500000006,0x0000000000000628,0x0000000000000000\n"
...
".quad 0x00000000000001b0,0x00000000000001b0,0x0000000000000004,0x0000000000000000\n"
".text");

extern "C" {

extern const unsigned long long __deviceText_$sm_20$[212];
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000004,0xa14f518d,(char*)"c2b7ac952a803de7",(char*)"/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x47f24676,&__elfEntries1};
# 3 "/tmp/tmpxft_00007e6b_00000000-1_simpleCUFFT.cudafe1.stub.c" 2
...
static void __sti____cudaRegisterAll_46_tmpxft_00007e6b_00000000_4_simpleCUFFT_cpp1_ii_main(void) __attribute__((__constructor__));
static void __device_stub__Z27ComplexPointwiseMulAndScaleP6float2PKS_if(Complex *__par0, const Complex *__par1, int __par2, float __par3){ struct __T20 *__T236 = 0;
if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T236->__par0) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T236->__par1) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T236->__par2) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par3, sizeof(__par3), (size_t)&__T236->__par3) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(Complex *, const Complex *, int, float))ComplexPointwiseMulAndScale)); (void)cudaLaunch(((char *)((void ( *)(Complex *, const Complex *, int, float))ComplexPointwiseMulAndScale))); };}
static void ComplexPointwiseMulAndScale( Complex *__cuda_0,const Complex *__cuda_1,int __cuda_2,float __cuda_3)
# 244 "/home/andrew/repositories/gpuocelot/tests/cuda3.2/tests/simpleCUFFT/simpleCUFFT.cu"
