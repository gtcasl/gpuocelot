# 1 "/tmp/tmpxft_00005dcb_00000000-1_simpleCUFFT.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005dcb_00000000-1_simpleCUFFT.cudafe1.cpp"
...
# 36 "tests/simpleCUFFT/simpleCUFFT.cu"
typedef float2 Complex;
# 37 "tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexAdd(Complex, Complex);
# 38 "tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexScale(Complex, float);
# 39 "tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexMul(Complex, Complex);
# 40 "tests/simpleCUFFT/simpleCUFFT.cu"
static void ComplexPointwiseMulAndScale(Complex *, const Complex *, int, float);
# 43 "tests/simpleCUFFT/simpleCUFFT.cu"
void Convolve(const Complex *, int, const Complex *, int, Complex *);
# 46 "tests/simpleCUFFT/simpleCUFFT.cu"
int PadData(const Complex *, Complex **, int, const Complex *, Complex **, int);
# 51 "tests/simpleCUFFT/simpleCUFFT.cu"
void runTest(int , char ** );
# 60 "tests/simpleCUFFT/simpleCUFFT.cu"
int main(int argc, char **argv)
# 61 "tests/simpleCUFFT/simpleCUFFT.cu"
{
# 62 "tests/simpleCUFFT/simpleCUFFT.cu"
runTest(argc, argv);
# 64 "tests/simpleCUFFT/simpleCUFFT.cu"
__cutilExit(argc, argv); return 0;
# 65 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 70 "tests/simpleCUFFT/simpleCUFFT.cu"
void runTest(int argc, char **argv)
# 71 "tests/simpleCUFFT/simpleCUFFT.cu"
{
# 72 "tests/simpleCUFFT/simpleCUFFT.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 73 "tests/simpleCUFFT/simpleCUFFT.cu"
cutilDeviceInit(argc, argv); } else {
# 75 "tests/simpleCUFFT/simpleCUFFT.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 78 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_signal = ((Complex *)malloc(sizeof(Complex) * (50)));
# 80 "tests/simpleCUFFT/simpleCUFFT.cu"
for (unsigned i = (0); i < (50); ++i) {
# 81 "tests/simpleCUFFT/simpleCUFFT.cu"
((h_signal[i]).x) = ((rand()) / ((float)2147483647));
# 82 "tests/simpleCUFFT/simpleCUFFT.cu"
((h_signal[i]).y) = (0);
# 83 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 86 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_filter_kernel = ((Complex *)malloc(sizeof(Complex) * (11)));
# 88 "tests/simpleCUFFT/simpleCUFFT.cu"
for (unsigned i = (0); i < (11); ++i) {
# 89 "tests/simpleCUFFT/simpleCUFFT.cu"
((h_filter_kernel[i]).x) = ((rand()) / ((float)2147483647));
# 90 "tests/simpleCUFFT/simpleCUFFT.cu"
((h_filter_kernel[i]).y) = (0);
# 91 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 94 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_padded_signal;
# 95 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_padded_filter_kernel;
# 96 "tests/simpleCUFFT/simpleCUFFT.cu"
int new_size = PadData(h_signal, &h_padded_signal, 50, h_filter_kernel, &h_padded_filter_kernel, 11);
# 98 "tests/simpleCUFFT/simpleCUFFT.cu"
int mem_size = (sizeof(Complex) * new_size);
# 101 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *d_signal;
# 102 "tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_signal), mem_size), "tests/simpleCUFFT/simpleCUFFT.cu", 102);
# 104 "tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(d_signal, h_padded_signal, mem_size, cudaMemcpyHostToDevice), "tests/simpleCUFFT/simpleCUFFT.cu", 105);
# 108 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *d_filter_kernel;
# 109 "tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_filter_kernel), mem_size), "tests/simpleCUFFT/simpleCUFFT.cu", 109);
# 112 "tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(d_filter_kernel, h_padded_filter_kernel, mem_size, cudaMemcpyHostToDevice), "tests/simpleCUFFT/simpleCUFFT.cu", 113);
# 116 "tests/simpleCUFFT/simpleCUFFT.cu"
cufftHandle plan;
# 117 "tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftPlan1d(&plan, new_size, CUFFT_C2C, 1), "tests/simpleCUFFT/simpleCUFFT.cu", 117);
# 120 "tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, -1), "tests/simpleCUFFT/simpleCUFFT.cu", 120);
# 121 "tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_filter_kernel, (cufftComplex *)d_filter_kernel, -1), "tests/simpleCUFFT/simpleCUFFT.cu", 121);
# 124 "tests/simpleCUFFT/simpleCUFFT.cu"
cudaConfigureCall(32, 256) ? ((void)0) : ComplexPointwiseMulAndScale(d_signal, d_filter_kernel, new_size, (1.0F) / new_size);
# 127 "tests/simpleCUFFT/simpleCUFFT.cu"
__cutilCheckMsg("Kernel execution failed [ ComplexPointwiseMulAndScale ]", "tests/simpleCUFFT/simpleCUFFT.cu", 127);
# 130 "tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftExecC2C(plan, (cufftComplex *)d_signal, (cufftComplex *)d_signal, 1), "tests/simpleCUFFT/simpleCUFFT.cu", 130);
# 133 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_convolved_signal = h_padded_signal;
# 134 "tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaMemcpy(h_convolved_signal, d_signal, mem_size, cudaMemcpyDeviceToHost), "tests/simpleCUFFT/simpleCUFFT.cu", 135);
# 138 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *h_convolved_signal_ref = ((Complex *)malloc(sizeof(Complex) * (50)));
# 141 "tests/simpleCUFFT/simpleCUFFT.cu"
Convolve(h_signal, 50, h_filter_kernel, 11, h_convolved_signal_ref);
# 146 "tests/simpleCUFFT/simpleCUFFT.cu"
CUTBoolean res = cutCompareL2fe((float *)h_convolved_signal_ref, (float *)h_convolved_signal, 2 * 50, (9.999999747e-06F));
# 147 "tests/simpleCUFFT/simpleCUFFT.cu"
printf("%s\n", (1 == res) ? ("PASSED") : ("FAILED"));
# 150 "tests/simpleCUFFT/simpleCUFFT.cu"
__cufftSafeCall(cufftDestroy(plan), "tests/simpleCUFFT/simpleCUFFT.cu", 150);
# 153 "tests/simpleCUFFT/simpleCUFFT.cu"
free(h_signal);
# 154 "tests/simpleCUFFT/simpleCUFFT.cu"
free(h_filter_kernel);
# 155 "tests/simpleCUFFT/simpleCUFFT.cu"
free(h_padded_signal);
# 156 "tests/simpleCUFFT/simpleCUFFT.cu"
free(h_padded_filter_kernel);
# 157 "tests/simpleCUFFT/simpleCUFFT.cu"
free(h_convolved_signal_ref);
# 158 "tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaFree(d_signal), "tests/simpleCUFFT/simpleCUFFT.cu", 158);
# 159 "tests/simpleCUFFT/simpleCUFFT.cu"
__cudaSafeCall(cudaFree(d_filter_kernel), "tests/simpleCUFFT/simpleCUFFT.cu", 159);
# 161 "tests/simpleCUFFT/simpleCUFFT.cu"
cudaThreadExit();
# 162 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 165 "tests/simpleCUFFT/simpleCUFFT.cu"
int PadData(const Complex *signal, Complex **padded_signal, int signal_size, const Complex *
# 166 "tests/simpleCUFFT/simpleCUFFT.cu"
filter_kernel, Complex **padded_filter_kernel, int filter_kernel_size)
# 167 "tests/simpleCUFFT/simpleCUFFT.cu"
{
# 168 "tests/simpleCUFFT/simpleCUFFT.cu"
int minRadius = (filter_kernel_size / 2);
# 169 "tests/simpleCUFFT/simpleCUFFT.cu"
int maxRadius = (filter_kernel_size - minRadius);
# 170 "tests/simpleCUFFT/simpleCUFFT.cu"
int new_size = (signal_size + maxRadius);
# 173 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex *new_data = ((Complex *)malloc(sizeof(Complex) * new_size));
# 174 "tests/simpleCUFFT/simpleCUFFT.cu"
memcpy(new_data + 0, signal, signal_size * sizeof(Complex));
# 175 "tests/simpleCUFFT/simpleCUFFT.cu"
memset(new_data + signal_size, 0, (new_size - signal_size) * sizeof(Complex));
# 176 "tests/simpleCUFFT/simpleCUFFT.cu"
(*padded_signal) = new_data;
# 179 "tests/simpleCUFFT/simpleCUFFT.cu"
new_data = ((Complex *)malloc(sizeof(Complex) * new_size));
# 180 "tests/simpleCUFFT/simpleCUFFT.cu"
memcpy(new_data + 0, filter_kernel + minRadius, maxRadius * sizeof(Complex));
# 181 "tests/simpleCUFFT/simpleCUFFT.cu"
memset(new_data + maxRadius, 0, (new_size - filter_kernel_size) * sizeof(Complex));
# 182 "tests/simpleCUFFT/simpleCUFFT.cu"
memcpy((new_data + new_size) - minRadius, filter_kernel, minRadius * sizeof(Complex));
# 183 "tests/simpleCUFFT/simpleCUFFT.cu"
(*padded_filter_kernel) = new_data;
# 185 "tests/simpleCUFFT/simpleCUFFT.cu"
return new_size;
# 186 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 193 "tests/simpleCUFFT/simpleCUFFT.cu"
void Convolve(const Complex *signal, int signal_size, const Complex *
# 194 "tests/simpleCUFFT/simpleCUFFT.cu"
filter_kernel, int filter_kernel_size, Complex *
# 195 "tests/simpleCUFFT/simpleCUFFT.cu"
filtered_signal)
# 196 "tests/simpleCUFFT/simpleCUFFT.cu"
{
# 197 "tests/simpleCUFFT/simpleCUFFT.cu"
int minRadius = (filter_kernel_size / 2);
# 198 "tests/simpleCUFFT/simpleCUFFT.cu"
int maxRadius = (filter_kernel_size - minRadius);
# 200 "tests/simpleCUFFT/simpleCUFFT.cu"
for (int i = 0; i < signal_size; ++i) {
# 201 "tests/simpleCUFFT/simpleCUFFT.cu"
((filtered_signal[i]).x) = (((filtered_signal[i]).y) = (0));
# 203 "tests/simpleCUFFT/simpleCUFFT.cu"
for (int j = ((-maxRadius) + 1); j <= minRadius; ++j) {
# 204 "tests/simpleCUFFT/simpleCUFFT.cu"
int k = (i + j);
# 205 "tests/simpleCUFFT/simpleCUFFT.cu"
if ((k >= 0) && (k < signal_size)) {
# 206 "tests/simpleCUFFT/simpleCUFFT.cu"
(filtered_signal[i]) = ComplexAdd(filtered_signal[i], ComplexMul(signal[k], filter_kernel[minRadius - j])); }
# 207 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 208 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 209 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 216 "tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexAdd(Complex a, Complex b)
# 217 "tests/simpleCUFFT/simpleCUFFT.cu"
{
# 218 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex c;
# 219 "tests/simpleCUFFT/simpleCUFFT.cu"
(c.x) = ((a.x) + (b.x));
# 220 "tests/simpleCUFFT/simpleCUFFT.cu"
(c.y) = ((a.y) + (b.y));
# 221 "tests/simpleCUFFT/simpleCUFFT.cu"
return c;
# 222 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 225 "tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexScale(Complex a, float s)
# 226 "tests/simpleCUFFT/simpleCUFFT.cu"
{
# 227 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex c;
# 228 "tests/simpleCUFFT/simpleCUFFT.cu"
(c.x) = (s * (a.x));
# 229 "tests/simpleCUFFT/simpleCUFFT.cu"
(c.y) = (s * (a.y));
# 230 "tests/simpleCUFFT/simpleCUFFT.cu"
return c;
# 231 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 234 "tests/simpleCUFFT/simpleCUFFT.cu"
static inline Complex ComplexMul(Complex a, Complex b)
# 235 "tests/simpleCUFFT/simpleCUFFT.cu"
{
# 236 "tests/simpleCUFFT/simpleCUFFT.cu"
Complex c;
# 237 "tests/simpleCUFFT/simpleCUFFT.cu"
(c.x) = (((a.x) * (b.x)) - ((a.y) * (b.y)));
# 238 "tests/simpleCUFFT/simpleCUFFT.cu"
(c.y) = (((a.x) * (b.y)) + ((a.y) * (b.x)));
# 239 "tests/simpleCUFFT/simpleCUFFT.cu"
return c;
# 240 "tests/simpleCUFFT/simpleCUFFT.cu"
}
# 243 "tests/simpleCUFFT/simpleCUFFT.cu"
static void ComplexPointwiseMulAndScale(Complex *a, const Complex *b, int size, float scale) ;
# 1 "tmpxft_00005dcb_00000000-1_simpleCUFFT.cudafe1.stub.c"
# 1 "tmpxft_00005dcb_00000000-1_simpleCUFFT.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00005dcb_00000000-1_simpleCUFFT.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00005dcb_00000000-1_simpleCUFFT.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_00005dcb_00000000-3_simpleCUFFT.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000e08,0x0000006801000001,0x00000000000006ec\n"
".quad 0x0000003800000000,0x0000001400030000,0x0000002000000040,0x0000000000000015\n"
".quad 0x0000000000000000,0x0000000000000000,0x69732f7374736574,0x46465543656c706d\n"
".quad 0x656c706d69732f54,0x75632e5446465543,0x0000000000000000,0x762e0a0a0a0a0a0a\n"
...
".quad 0x6263643530303030,0x303030303030305f,0x706d69735f372d30,0x2e5446465543656c\n"
".quad 0x0a22692e33707063,0x203209656c69662e,0x732f737473657422,0x465543656c706d69\n"
".quad 0x6c706d69732f5446,0x632e544646554365,0x746e652e0a0a2275,0x4337325a5f207972\n"
".quad 0x6f5078656c706d6f,0x4d65736977746e69,0x616353646e416c75,0x616f6c663650656c\n"
".quad 0x66695f534b503274,0x6d617261702e0a28,0x5a5f203436752e20,0x656c706d6f433732\n"
".quad 0x6977746e696f5078,0x646e416c754d6573,0x663650656c616353,0x534b503274616f6c\n"
".quad 0x617261705f66695f,0x61702e0a2c305f6d,0x3436752e206d6172,0x6d6f4337325a5f20\n"
".quad 0x000000aa00000000,0x0000000200000001,0x0000000000000000,0x0000053500000000\n"
".quad 0x0000003800000000,0x0000000000000000,0x0000000400000004,0x0000000000000000\n"
".quad 0x0000006a00000000,0x0000000200000001,0x0000000000000000,0x0000056d00000000\n"
".quad 0x0000005c00000000,0x0000000000000000,0x0000000100000004,0x0000000000000000\n"
".quad 0x000000a100000000,0x0000000200000001,0x0000000000000000,0x000005c900000000\n"
".quad 0x0000001800000000,0x0000000000000000,0x0000000100000000,0x0000000000000000\n"
...
".quad 0x503274616f6c6636,0x6e2e0066695f534b,0x5f2e6f666e692e76,0x6c706d6f4337325a\n"
".quad 0x77746e696f507865,0x6e416c754d657369,0x3650656c61635364,0x4b503274616f6c66\n"
".quad 0x766e2e0066695f53,0x6e2e006f666e692e,0x6174736e6f632e76,0x37325a5f2e30746e\n"
".quad 0x5078656c706d6f43,0x65736977746e696f,0x6353646e416c754d,0x6f6c663650656c61\n"
".quad 0x695f534b50327461,0x4337325a5f000066,0x6f5078656c706d6f,0x4d65736977746e69\n"
".quad 0x616353646e416c75,0x616f6c663650656c,0x66695f534b503274,0x0000000000000000\n"
...
".quad 0x0000000000000000,0x0400030000000000,0x0000000000000000,0x000000000000d800\n"
...
".quad 0x0000000000000000,0x0410120000000100,0x0000000000000000,0x000000000000d800\n"
".quad 0x00440400005de400,0x00000094001c0428,0x00000084009c042c,0x04400020021ca32c\n"
".quad 0x00400050001de420,0x0e4000c081dc2328,0x00400020001ca31b,0x000000000001e750\n"
".quad 0x00000020031de280,0x00c0002080dce318,0x198000a0829ca350,0x004000b032dc4320\n"
".quad 0x19800080809ca348,0x00000000821c0320,0x00000000a11ca548,0x0040009030dc4384\n"
".quad 0x8e4000c081dc2348,0x00000000219ca518,0x00000010625c0084,0x00000010711c0058\n"
".quad 0x12000014725e0058,0x08000014611c0030,0x004000d0919c0030,0x004000d041dc0058\n"
".quad 0x00000000219ca558,0x03fffde00001e794,0x00000000001de740,0x0000000000000080\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x00000900080a0400,0x1819030018002000\n"
".quad 0x000000000c170400,0x11f0000014000300,0x000000000c170400,0x11f0000010000200\n"
...
".quad 0x0000000000000000,0x0000000500000006,0x00000000000005e4,0x0000000000000000\n"
...
".quad 0x000000000000016c,0x000000000000016c,0x0000000000000004\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[451];
...
# 3 "/tmp/tmpxft_00005dcb_00000000-1_simpleCUFFT.cudafe1.stub.c" 2 3
static void __device_stub__Z27ComplexPointwiseMulAndScaleP6float2PKS_if(Complex *, const Complex *, int, float);
static void __sti____cudaRegisterAll_46_tmpxft_00005dcb_00000000_4_simpleCUFFT_cpp1_ii_main(void) __attribute__((__constructor__));
...
# 244 "tests/simpleCUFFT/simpleCUFFT.cu"
