...
# 32 "tests/simpleStreams/simpleStreams.cu"
...
# 45 "tests/simpleStreams/simpleStreams.cu"
int correct_data(int *a, const int n, const int c)
# 46 "tests/simpleStreams/simpleStreams.cu"
{
# 47 "tests/simpleStreams/simpleStreams.cu"
for (int i = 0; i < n; i++) {
# 48 "tests/simpleStreams/simpleStreams.cu"
if ((a[i]) != c)
# 49 "tests/simpleStreams/simpleStreams.cu"
{
# 50 "tests/simpleStreams/simpleStreams.cu"
printf("%d: %d %d\n", i, a[i], c);
# 51 "tests/simpleStreams/simpleStreams.cu"
return 0;
# 52 "tests/simpleStreams/simpleStreams.cu"
} }
# 54 "tests/simpleStreams/simpleStreams.cu"
return 1;
# 55 "tests/simpleStreams/simpleStreams.cu"
}
# 57 "tests/simpleStreams/simpleStreams.cu"
int main(int argc, char *argv[])
# 58 "tests/simpleStreams/simpleStreams.cu"
{
# 59 "tests/simpleStreams/simpleStreams.cu"
int cuda_device = 0;
# 60 "tests/simpleStreams/simpleStreams.cu"
int nstreams = 4;
# 61 "tests/simpleStreams/simpleStreams.cu"
int nreps = 10;
# 62 "tests/simpleStreams/simpleStreams.cu"
int n = ((16 * 1024) * 1024);
# 63 "tests/simpleStreams/simpleStreams.cu"
int nbytes = (n * sizeof(int));
# 64 "tests/simpleStreams/simpleStreams.cu"
dim3 threads, blocks;
# 65 "tests/simpleStreams/simpleStreams.cu"
float elapsed_time, time_memcpy, time_kernel;
# 66 "tests/simpleStreams/simpleStreams.cu"
float scale_factor = (1.0F);
# 68 "tests/simpleStreams/simpleStreams.cu"
int niterations;
# 70 "tests/simpleStreams/simpleStreams.cu"
printf("[ %s ]\n", sSDKsample);
# 71 "tests/simpleStreams/simpleStreams.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "help"))
# 72 "tests/simpleStreams/simpleStreams.cu"
{
# 73 "tests/simpleStreams/simpleStreams.cu"
printf("Usage: %s [--use_blocking_sync]\n", sSDKsample);
# 74 "tests/simpleStreams/simpleStreams.cu"
printf("\t--use_blocking_sync (optional) enable blocking sync to demontrate\n");
# 75 "tests/simpleStreams/simpleStreams.cu"
printf("\t\t low CPU utilization\n");
# 76 "tests/simpleStreams/simpleStreams.cu"
exit(0);
# 77 "tests/simpleStreams/simpleStreams.cu"
}
# 78 "tests/simpleStreams/simpleStreams.cu"
bool use_blocking_sync = false;
# 79 "tests/simpleStreams/simpleStreams.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "use_blocking_sync"))
# 80 "tests/simpleStreams/simpleStreams.cu"
{
# 81 "tests/simpleStreams/simpleStreams.cu"
printf("Enabling blocking sync, setting reps to 100 to demonstrate steady state\n");
# 82 "tests/simpleStreams/simpleStreams.cu"
nreps = 100;
# 83 "tests/simpleStreams/simpleStreams.cu"
use_blocking_sync = true;
# 84 "tests/simpleStreams/simpleStreams.cu"
}
# 86 "tests/simpleStreams/simpleStreams.cu"
printf("\n> ");
# 87 "tests/simpleStreams/simpleStreams.cu"
cuda_device = cutilChooseCudaDevice(argc, argv);
# 90 "tests/simpleStreams/simpleStreams.cu"
int num_devices = 0;
# 91 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaGetDeviceCount(&num_devices), "tests/simpleStreams/simpleStreams.cu", 91);
# 92 "tests/simpleStreams/simpleStreams.cu"
if (0 == num_devices)
# 93 "tests/simpleStreams/simpleStreams.cu"
{
# 94 "tests/simpleStreams/simpleStreams.cu"
printf("your system does not have a CUDA capable device\n");
# 95 "tests/simpleStreams/simpleStreams.cu"
return 1;
# 96 "tests/simpleStreams/simpleStreams.cu"
}
# 99 "tests/simpleStreams/simpleStreams.cu"
if (cuda_device >= num_devices)
# 100 "tests/simpleStreams/simpleStreams.cu"
{
# 101 "tests/simpleStreams/simpleStreams.cu"
printf("cuda_device=%d is invalid, must choose device ID between 0 and %d\n", cuda_device, num_devices - 1);
# 102 "tests/simpleStreams/simpleStreams.cu"
__cutilExit(argc, argv);
# 103 "tests/simpleStreams/simpleStreams.cu"
return 1;
# 104 "tests/simpleStreams/simpleStreams.cu"
}
# 106 "tests/simpleStreams/simpleStreams.cu"
cudaSetDevice(cuda_device);
# 108 "tests/simpleStreams/simpleStreams.cu"
if (use_blocking_sync) {
# 110 "tests/simpleStreams/simpleStreams.cu"
cudaSetDeviceFlags(4);
# 111 "tests/simpleStreams/simpleStreams.cu"
}
# 113 "tests/simpleStreams/simpleStreams.cu"
cudaDeviceProp deviceProp;
# 115 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, cuda_device), "tests/simpleStreams/simpleStreams.cu", 115);
# 116 "tests/simpleStreams/simpleStreams.cu"
if ((1 == (deviceProp.major)) && ((deviceProp.minor) < 1)) {
# 117 "tests/simpleStreams/simpleStreams.cu"
printf("%s does not have compute capability 1.1 or later\n", deviceProp.name); }
# 118 "tests/simpleStreams/simpleStreams.cu"
if ((deviceProp.major) >= 2) {
# 119 "tests/simpleStreams/simpleStreams.cu"
niterations = 100; } else
# 121 "tests/simpleStreams/simpleStreams.cu"
{
# 122 "tests/simpleStreams/simpleStreams.cu"
if ((deviceProp.minor) > 1) {
# 123 "tests/simpleStreams/simpleStreams.cu"
niterations = 5; } else {
# 125 "tests/simpleStreams/simpleStreams.cu"
niterations = 1; }
# 126 "tests/simpleStreams/simpleStreams.cu"
}
# 132 "tests/simpleStreams/simpleStreams.cu"
scale_factor = max((4.0F) / ((float)(deviceProp.multiProcessorCount)), (1.0F));
# 133 "tests/simpleStreams/simpleStreams.cu"
n = (rint(((float)n) / scale_factor));
# 137 "tests/simpleStreams/simpleStreams.cu"
printf("> CUDA Capable SM %d.%d hardware with %d multi-processors\n", deviceProp.major, deviceProp.minor, deviceProp.multiProcessorCount);
# 138 "tests/simpleStreams/simpleStreams.cu"
printf("> scale_factor = %1.4f\n", (1.0F) / scale_factor);
# 139 "tests/simpleStreams/simpleStreams.cu"
printf("> array_size   = %d\n\n", n);
# 142 "tests/simpleStreams/simpleStreams.cu"
int c = 5;
# 143 "tests/simpleStreams/simpleStreams.cu"
int *a = (0);
# 145 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaMallocHost((void **)(&a), nbytes), "tests/simpleStreams/simpleStreams.cu", 145);
# 148 "tests/simpleStreams/simpleStreams.cu"
int *d_a = (0), *d_c = (0);
# 149 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_a), nbytes), "tests/simpleStreams/simpleStreams.cu", 149);
# 150 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_c), sizeof(int)), "tests/simpleStreams/simpleStreams.cu", 150);
# 151 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaMemcpy(d_c, &c, sizeof(int), cudaMemcpyHostToDevice), "tests/simpleStreams/simpleStreams.cu", 151);
# 154 "tests/simpleStreams/simpleStreams.cu"
cudaStream_t *streams = ((cudaStream_t *)malloc(nstreams * sizeof(cudaStream_t)));
# 155 "tests/simpleStreams/simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 156 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaStreamCreate(&(streams[i])), "tests/simpleStreams/simpleStreams.cu", 156); }
# 160 "tests/simpleStreams/simpleStreams.cu"
cudaEvent_t start_event, stop_event;
# 161 "tests/simpleStreams/simpleStreams.cu"
int eventflags = (use_blocking_sync ? 1 : 0);
# 163 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventCreateWithFlags(&start_event, eventflags), "tests/simpleStreams/simpleStreams.cu", 163);
# 164 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventCreateWithFlags(&stop_event, eventflags), "tests/simpleStreams/simpleStreams.cu", 164);
# 167 "tests/simpleStreams/simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 168 "tests/simpleStreams/simpleStreams.cu"
cudaMemcpyAsync(a, d_a, nbytes, cudaMemcpyDeviceToHost, streams[0]);
# 169 "tests/simpleStreams/simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 170 "tests/simpleStreams/simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 171 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&time_memcpy, start_event, stop_event), "tests/simpleStreams/simpleStreams.cu", 171);
# 172 "tests/simpleStreams/simpleStreams.cu"
printf("memcopy:\t%.2f\n", time_memcpy);
# 175 "tests/simpleStreams/simpleStreams.cu"
threads = dim3(512, 1);
# 176 "tests/simpleStreams/simpleStreams.cu"
blocks = dim3(n / (threads.x), 1);
# 177 "tests/simpleStreams/simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 178 "tests/simpleStreams/simpleStreams.cu"
cudaConfigureCall(blocks, threads, 0, streams[0]) ? ((void)0) : init_array(d_a, d_c, niterations);
# 179 "tests/simpleStreams/simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 180 "tests/simpleStreams/simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 181 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&time_kernel, start_event, stop_event), "tests/simpleStreams/simpleStreams.cu", 181);
# 182 "tests/simpleStreams/simpleStreams.cu"
printf("kernel:\t\t%.2f\n", time_kernel);
# 186 "tests/simpleStreams/simpleStreams.cu"
threads = dim3(512, 1);
# 187 "tests/simpleStreams/simpleStreams.cu"
blocks = dim3(n / (threads.x), 1);
# 188 "tests/simpleStreams/simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 189 "tests/simpleStreams/simpleStreams.cu"
for (int k = 0; k < nreps; k++)
# 190 "tests/simpleStreams/simpleStreams.cu"
{
# 191 "tests/simpleStreams/simpleStreams.cu"
cudaConfigureCall(blocks, threads) ? ((void)0) : init_array(d_a, d_c, niterations);
# 192 "tests/simpleStreams/simpleStreams.cu"
cudaMemcpy(a, d_a, nbytes, cudaMemcpyDeviceToHost);
# 193 "tests/simpleStreams/simpleStreams.cu"
}
# 194 "tests/simpleStreams/simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 195 "tests/simpleStreams/simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 196 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&elapsed_time, start_event, stop_event), "tests/simpleStreams/simpleStreams.cu", 196);
# 197 "tests/simpleStreams/simpleStreams.cu"
printf("non-streamed:\t%.2f (%.2f expected)\n", elapsed_time / nreps, time_kernel + time_memcpy);
# 201 "tests/simpleStreams/simpleStreams.cu"
threads = dim3(512, 1);
# 202 "tests/simpleStreams/simpleStreams.cu"
blocks = dim3(n / (nstreams * (threads.x)), 1);
# 203 "tests/simpleStreams/simpleStreams.cu"
memset(a, 255, nbytes);
# 204 "tests/simpleStreams/simpleStreams.cu"
cudaMemset(d_a, 0, nbytes);
# 205 "tests/simpleStreams/simpleStreams.cu"
cudaEventRecord(start_event, 0);
# 206 "tests/simpleStreams/simpleStreams.cu"
for (int k = 0; k < nreps; k++)
# 207 "tests/simpleStreams/simpleStreams.cu"
{
# 209 "tests/simpleStreams/simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 210 "tests/simpleStreams/simpleStreams.cu"
cudaConfigureCall(blocks, threads, 0, streams[i]) ? ((void)0) : init_array(d_a + ((i * n) / nstreams), d_c, niterations); }
# 214 "tests/simpleStreams/simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 215 "tests/simpleStreams/simpleStreams.cu"
cudaMemcpyAsync(a + ((i * n) / nstreams), d_a + ((i * n) / nstreams), nbytes / nstreams, cudaMemcpyDeviceToHost, streams[i]); }
# 216 "tests/simpleStreams/simpleStreams.cu"
}
# 217 "tests/simpleStreams/simpleStreams.cu"
cudaEventRecord(stop_event, 0);
# 218 "tests/simpleStreams/simpleStreams.cu"
cudaEventSynchronize(stop_event);
# 219 "tests/simpleStreams/simpleStreams.cu"
__cudaSafeCall(cudaEventElapsedTime(&elapsed_time, start_event, stop_event), "tests/simpleStreams/simpleStreams.cu", 219);
# 220 "tests/simpleStreams/simpleStreams.cu"
...
# 223 "tests/simpleStreams/simpleStreams.cu"
printf("-------------------------------\n");
# 224 "tests/simpleStreams/simpleStreams.cu"
if (correct_data(a, n, (c * nreps) * niterations)) {
# 225 "tests/simpleStreams/simpleStreams.cu"
printf("PASSED\n"); } else {
# 227 "tests/simpleStreams/simpleStreams.cu"
printf("FAILED\n"); }
# 230 "tests/simpleStreams/simpleStreams.cu"
for (int i = 0; i < nstreams; i++) {
# 231 "tests/simpleStreams/simpleStreams.cu"
cudaStreamDestroy(streams[i]); }
# 232 "tests/simpleStreams/simpleStreams.cu"
cudaEventDestroy(start_event);
# 233 "tests/simpleStreams/simpleStreams.cu"
cudaEventDestroy(stop_event);
# 234 "tests/simpleStreams/simpleStreams.cu"
cudaFreeHost(a);
# 235 "tests/simpleStreams/simpleStreams.cu"
cudaFree(d_a);
# 236 "tests/simpleStreams/simpleStreams.cu"
cudaFree(d_c);
# 238 "tests/simpleStreams/simpleStreams.cu"
cudaThreadExit();
# 240 "tests/simpleStreams/simpleStreams.cu"
__cutilExit(argc, argv);
# 242 "tests/simpleStreams/simpleStreams.cu"
return 0;
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000b41,0x0000006801000001,0x000000000000046d\n"
".quad 0x0000003800000000,0x0000001400030000,0x0000002400000040,0x0000000000000015\n"
".quad 0x0000000000000000,0x0000000000000000,0x69732f7374736574,0x65727453656c706d\n"
...
".quad 0x6e6930315a5f2034,0x79617272615f7469,0x61705f695f536950,0x2e0a2c305f6d6172\n"
".quad 0x752e206d61726170,0x6930315a5f203436,0x617272615f74696e,0x705f695f53695079\n"
".quad 0x0a2c315f6d617261,0x2e206d617261702e,0x30315a5f20323375,0x7272615f74696e69\n"
".quad 0x5f695f5369507961,0x0a325f6d61726170,0x6765722e0a7b0a29,0x2520646572702e20\n"
".quad 0x722e0a3b3e333c70,0x203233732e206765,0x0a3b3e39313c7225,0x36732e206765722e\n"
".quad 0x3e373c6c72252034,0x702e646c0a0a0a3b,0x3436752e6d617261,0x5b202c346c722520\n"
".quad 0x74696e6930315a5f,0x695079617272615f,0x617261705f695f53,0x646c0a3b5d305f6d\n"
".quad 0x752e6d617261702e,0x2c356c7225203436,0x6e6930315a5f5b20,0x79617272615f7469\n"
".quad 0x61705f695f536950,0x0a3b5d315f6d6172,0x6d617261702e646c,0x317225203233752e\n"
".quad 0x6930315a5f5b202c,0x617272615f74696e,0x705f695f53695079,0x3b5d325f6d617261\n"
".quad 0x6f742e617476630a,0x2e6c61626f6c672e,0x316c722520343675,0x0a3b346c7225202c\n"
".quad 0x2e6f742e61747663,0x752e6c61626f6c67,0x2c326c7225203436,0x2e0a3b356c722520\n"
".quad 0x3933203220636f6c,0x752e766f6d0a3120,0x202c387225203233,0x3b782e6469746e25\n"
".quad 0x3233752e766f6d0a,0x6325202c39722520,0x0a3b782e64696174,0x203233752e766f6d\n"
".quad 0x7425202c30317225,0x616d0a3b782e6469,0x3233732e6f6c2e64,0x7225202c32722520\n"
".quad 0x202c397225202c38,0x6c2e0a3b30317225,0x203134203220636f,0x6c2e707465730a31\n"
".quad 0x7025203233732e74,0x202c317225202c31,0x20317025400a3b31,0x5f30424220617262\n"
".quad 0x636f6c2e0a0a3b33,0x0a31203234203220,0x656469772e6c756d,0x6c7225203233732e\n"
".quad 0x202c327225202c36,0x732e6464610a3b34,0x2c336c7225203436,0x25202c316c722520\n"
".quad 0x2e646c0a3b366c72,0x752e6c61626f6c67,0x2c37317225203233,0x3b5d336c72255b20\n"
".quad 0x3233752e766f6d0a,0x30202c3831722520,0x325f3042420a0a3b,0x3220636f6c2e0a3a\n"
".quad 0x646c0a3120323420,0x2e6c61626f6c672e,0x3331722520323375,0x5d326c72255b202c\n"
".quad 0x33732e6464610a3b,0x202c373172252032,0x7225202c37317225,0x672e74730a3b3331\n"
".quad 0x33752e6c61626f6c,0x5d336c72255b2032,0x0a3b37317225202c,0x34203220636f6c2e\n"
".quad 0x6464610a30332031,0x317225203233732e,0x2c38317225202c38,0x702e646c0a3b3120\n"
".quad 0x3233752e6d617261,0x5b202c3631722520,0x74696e6930315a5f,0x695079617272615f\n"
".quad 0x617261705f695f53,0x6c2e0a3b5d325f6d,0x203134203220636f,0x6c2e707465730a31\n"
".quad 0x7025203233732e74,0x2c38317225202c32,0x400a3b3631722520,0x2061726220327025\n"
".quad 0x0a0a3b325f304242,0x2e0a3a335f304242,0x3334203220636f6c,0x0a3b7465720a3220\n"
".quad 0x000002000a0a0a7d,0x00060c0000006001,0x0000000000000000,0x0100040000000000\n"
".quad 0x0000380000001400,0x0000150000002400,0x0000000000000000,0x7365740000000000\n"
".quad 0x6c706d69732f7374,0x736d616572745365,0x53656c706d69732f,0x632e736d61657274\n"
".quad 0x4c457f0000000075,0x0000043301010246,0xbe00020000000000,0x0000000000000100\n"
".quad 0x00059c0000000000,0x0000400000000000,0x1405140000000000,0x4000020038004000\n"
".quad 0x0000000001000800,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000010000000000,0x0000000000000300,0x0000000000000000,0x0002400000000000\n"
".quad 0x0000980000000000,0x0000000000000000,0x0000040000000000,0x0000000000000000\n"
".quad 0x00000b0000000000,0x0000000000000300,0x0000000000000000,0x0002d80000000000\n"
".quad 0x0000150000000000,0x0000000000000000,0x0000010000000000,0x0000000000000000\n"
".quad 0x0000130000000000,0x0000000000000200,0x0000000000000000,0x0002ed0000000000\n"
".quad 0x0001080000000000,0x0000020000000000,0x0000010000000a00,0x0000180000000000\n"
".quad 0x0000360000000000,0x0000060000000100,0x0000000000000000,0x0003f50000000000\n"
".quad 0x0001180000000000,0x0000030000000000,0x0000040900000600,0x0000000000000000\n"
".quad 0x0000760000000000,0x0000020000000100,0x0000000000000000,0x00050d0000000000\n"
".quad 0x0000340000000000,0x0000000000000000,0x0000040000000400,0x0000000000000000\n"
".quad 0x0000590000000000,0x0000020000000100,0x0000000000000000,0x0005410000000000\n"
".quad 0x0000400000000000,0x0000000000000000,0x0000010000000400,0x0000000000000000\n"
".quad 0x0000500000000000,0x0000020000000100,0x0000000000000000,0x0005810000000000\n"
".quad 0x0000180000000000,0x0000000000000000,0x0000010000000000,0x0000000000000000\n"
".quad 0x732e000000000000,0x0062617472747368,0x006261747274732e,0x006261746d79732e\n"
".quad 0x626f6c672e766e2e,0x0074696e692e6c61,0x626f6c672e766e2e,0x747865742e006c61\n"
".quad 0x696e6930315a5f2e,0x5079617272615f74,0x766e2e00695f5369,0x6e2e006f666e692e\n"
".quad 0x5f2e6f666e692e76,0x5f74696e6930315a,0x5369507961727261,0x632e766e2e00695f\n"
".quad 0x30746e6174736e6f,0x696e6930315a5f2e,0x5079617272615f74,0x5a5f0000695f5369\n"
".quad 0x615f74696e693031,0x5f53695079617272,0x0000000000000069,0x0000000000000000\n"
...
".quad 0x0003000000000000,0x0000000000000004,0x0000000001180000,0x0003000000000000\n"
".quad 0x0000000000000007,0x0000000000000000,0x0003000000000000,0x0000000000000006\n"
".quad 0x0000000000000000,0x0003000000000000,0x0000000000000005,0x0000000000000000\n"
".quad 0x1012000000010000,0x0000000000000004,0x0000000001180000,0x440400005de40000\n"
".quad 0x4000c000dde42800,0x000094001c042800,0x000084011c042c00,0xc0000431dc232c00\n"
".quad 0x4000a0009de4188e,0x4000b000dde42800,0x400020001ca32800,0x0000000001e72008\n"
".quad 0x400080011de48000,0xc00010015ce32800,0x4000c0019de45000,0xc00010011ca32800\n"
".quad 0xc0000461dc232009,0x400090515c431a0e,0x0000fc019de44800,0x000000401c852800\n"
".quad 0x0001a00021e78400,0x00000021dc854000,0xc00008619c038400,0x4000c061dc234800\n"
".quad 0x00001c021c03188e,0xc0000461dc034800,0x000000421c854800,0x000000201c859400\n"
".quad 0x4000c071dc238400,0x000000801c031880,0x000000401c854800,0xfffea00001e79400\n"
".quad 0x4000c061dc234003,0x0000000021e7188e,0x000000209c858000,0x000008001c038400\n"
".quad 0x000000401c854800,0x000000001de79400,0x0000000000008000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0a04000000000000,0x0020000000090008,0x1704001419030014,0x000200000000000c\n"
".quad 0x17040011f0000010,0x000100000000000c,0x17040021f0000008,0x000000000000000c\n"
".quad 0x12040021f0000000,0x00000000000a0008,0x000a000811040000,0x0000000000000000\n"
".quad 0x0000050000000600,0x0000000000059c00,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000007000,0x0000000000007000,0x0000000000000400,0x000a056000000000\n"
".quad 0x000000000003f500,0x0000000000000000,0x0000000000000000,0x0000000000018c00\n"
".quad 0x0000000000018c00,0x0000000000000400,0x0000000000000000\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[363];
...
# 38 "tests/simpleStreams/simpleStreams.cu"
