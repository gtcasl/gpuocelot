# 1 "/tmp/tmpxft_00005e8b_00000000-1_simpleTemplates.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005e8b_00000000-1_simpleTemplates.cudafe1.cpp"
...
# 63 "tests/simpleTemplates/simpleTemplates.cu"
int main(int argc, char **argv)
# 64 "tests/simpleTemplates/simpleTemplates.cu"
{
# 65 "tests/simpleTemplates/simpleTemplates.cu"
printf("[simpleTemplates]\n");
# 67 "tests/simpleTemplates/simpleTemplates.cu"
...
# 72 "tests/simpleTemplates/simpleTemplates.cu"
printf("\n[simpleTemplates] -> Test Results: %d Failures\n", g_TotalFailures);
# 73 "tests/simpleTemplates/simpleTemplates.cu"
printf((g_TotalFailures == 0) ? ("PASSED\n") : ("FAILED\n"));
# 75 "tests/simpleTemplates/simpleTemplates.cu"
__cutilExit(argc, argv); return 0;
# 76 "tests/simpleTemplates/simpleTemplates.cu"
}
# 83 "tests/simpleTemplates/simpleTemplates.cu"
template< class T>
# 84 "tests/simpleTemplates/simpleTemplates.cu"
...
return CUTFalse;
# 91 "tests/simpleTemplates/simpleTemplates.cu"
}
# 92 "tests/simpleTemplates/simpleTemplates.cu"
};
# 96 "tests/simpleTemplates/simpleTemplates.cu"
...
# 102 "tests/simpleTemplates/simpleTemplates.cu"
}
# 103 "tests/simpleTemplates/simpleTemplates.cu"
};
# 107 "tests/simpleTemplates/simpleTemplates.cu"
...
# 113 "tests/simpleTemplates/simpleTemplates.cu"
}
# 114 "tests/simpleTemplates/simpleTemplates.cu"
};
# 117 "tests/simpleTemplates/simpleTemplates.cu"
template< class T>
# 118 "tests/simpleTemplates/simpleTemplates.cu"
...
return CUTFalse;
# 125 "tests/simpleTemplates/simpleTemplates.cu"
}
# 126 "tests/simpleTemplates/simpleTemplates.cu"
};
# 130 "tests/simpleTemplates/simpleTemplates.cu"
...
# 136 "tests/simpleTemplates/simpleTemplates.cu"
}
# 137 "tests/simpleTemplates/simpleTemplates.cu"
};
# 141 "tests/simpleTemplates/simpleTemplates.cu"
...
# 147 "tests/simpleTemplates/simpleTemplates.cu"
}
# 148 "tests/simpleTemplates/simpleTemplates.cu"
};
# 154 "tests/simpleTemplates/simpleTemplates.cu"
template< class T> void
# 156 "tests/simpleTemplates/simpleTemplates.cu"
...
# 161 "tests/simpleTemplates/simpleTemplates.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
...
printf("exiting...\n");
# 165 "tests/simpleTemplates/simpleTemplates.cu"
__cutilExit(argc, argv);
...
# 169 "tests/simpleTemplates/simpleTemplates.cu"
{
# 170 "tests/simpleTemplates/simpleTemplates.cu"
devID = cutGetMaxGflopsDeviceId();
# 171 "tests/simpleTemplates/simpleTemplates.cu"
cudaSetDevice(devID);
# 172 "tests/simpleTemplates/simpleTemplates.cu"
}
# 175 "tests/simpleTemplates/simpleTemplates.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProps, devID), "tests/simpleTemplates/simpleTemplates.cu", 175);
...
__cutilCheckError(cutCreateTimer(&timer), "tests/simpleTemplates/simpleTemplates.cu", 179);
# 180 "tests/simpleTemplates/simpleTemplates.cu"
__cutilCheckError(cutStartTimer(timer), "tests/simpleTemplates/simpleTemplates.cu", 180);
...
# 186 "tests/simpleTemplates/simpleTemplates.cu"
T *h_idata = ((T *)malloc(mem_size));
# 188 "tests/simpleTemplates/simpleTemplates.cu"
for (unsigned i = (0); i < num_threads; ++i)
# 189 "tests/simpleTemplates/simpleTemplates.cu"
{
# 190 "tests/simpleTemplates/simpleTemplates.cu"
(h_idata[i]) = ((T)i);
# 191 "tests/simpleTemplates/simpleTemplates.cu"
}
# 194 "tests/simpleTemplates/simpleTemplates.cu"
T *d_idata;
# 195 "tests/simpleTemplates/simpleTemplates.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), mem_size), "tests/simpleTemplates/simpleTemplates.cu", 195);
# 197 "tests/simpleTemplates/simpleTemplates.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_idata, mem_size, cudaMemcpyHostToDevice), "tests/simpleTemplates/simpleTemplates.cu", 198);
# 201 "tests/simpleTemplates/simpleTemplates.cu"
T *d_odata;
# 202 "tests/simpleTemplates/simpleTemplates.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), mem_size), "tests/simpleTemplates/simpleTemplates.cu", 202);
# 205 "tests/simpleTemplates/simpleTemplates.cu"
dim3 grid(1, 1, 1);
# 206 "tests/simpleTemplates/simpleTemplates.cu"
...
# 212 "tests/simpleTemplates/simpleTemplates.cu"
__cutilCheckMsg("Kernel execution failed", "tests/simpleTemplates/simpleTemplates.cu", 212);
# 215 "tests/simpleTemplates/simpleTemplates.cu"
T *h_odata = ((T *)malloc(mem_size));
# 217 "tests/simpleTemplates/simpleTemplates.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_odata, sizeof(T) * num_threads, cudaMemcpyDeviceToHost), "tests/simpleTemplates/simpleTemplates.cu", 218);
# 220 "tests/simpleTemplates/simpleTemplates.cu"
__cutilCheckError(cutStopTimer(timer), "tests/simpleTemplates/simpleTemplates.cu", 220);
# 221 "tests/simpleTemplates/simpleTemplates.cu"
printf("Processing time: %f (ms)\n", cutGetTimerValue(timer));
# 222 "tests/simpleTemplates/simpleTemplates.cu"
__cutilCheckError(cutDeleteTimer(timer), "tests/simpleTemplates/simpleTemplates.cu", 222);
# 225 "tests/simpleTemplates/simpleTemplates.cu"
T *reference = ((T *)malloc(mem_size));
# 226 "tests/simpleTemplates/simpleTemplates.cu"
computeGold< T> (reference, h_idata, num_threads);
# 228 "tests/simpleTemplates/simpleTemplates.cu"
ArrayComparator< T> comparator;
# 229 "tests/simpleTemplates/simpleTemplates.cu"
ArrayFileWriter< T> writer;
# 232 "tests/simpleTemplates/simpleTemplates.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "regression"))
# 233 "tests/simpleTemplates/simpleTemplates.cu"
{
# 235 "tests/simpleTemplates/simpleTemplates.cu"
__cutilCheckError((writer.write("./data/regression.dat", h_odata, num_threads, (0.0))), "tests/simpleTemplates/simpleTemplates.cu", 236);
...
# 243 "tests/simpleTemplates/simpleTemplates.cu"
printf("Compare %s\n\n", (1 == res) ? ("OK") : ("MISMATCH"));
# 244 "tests/simpleTemplates/simpleTemplates.cu"
g_TotalFailures += (1 != res);
# 245 "tests/simpleTemplates/simpleTemplates.cu"
}
# 248 "tests/simpleTemplates/simpleTemplates.cu"
free(h_idata);
# 249 "tests/simpleTemplates/simpleTemplates.cu"
free(h_odata);
# 250 "tests/simpleTemplates/simpleTemplates.cu"
free(reference);
# 251 "tests/simpleTemplates/simpleTemplates.cu"
__cudaSafeCall(cudaFree(d_idata), "tests/simpleTemplates/simpleTemplates.cu", 251);
# 252 "tests/simpleTemplates/simpleTemplates.cu"
__cudaSafeCall(cudaFree(d_odata), "tests/simpleTemplates/simpleTemplates.cu", 252);
# 254 "tests/simpleTemplates/simpleTemplates.cu"
cudaThreadExit();
# 255 "tests/simpleTemplates/simpleTemplates.cu"
}
# 1 "tmpxft_00005e8b_00000000-1_simpleTemplates.cudafe1.stub.c"
# 1 "tmpxft_00005e8b_00000000-1_simpleTemplates.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00005e8b_00000000-1_simpleTemplates.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00005e8b_00000000-1_simpleTemplates.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_00005e8b_00000000-3_simpleTemplates.fatbin.c" 1 3
...
".quad 0x5f746678706d742f,0x6238653530303030,0x303030303030305f,0x706d69735f372d30\n"
...
# 3 "/tmp/tmpxft_00005e8b_00000000-1_simpleTemplates.cudafe1.stub.c" 2 3
static void __device_stub__Z10testKernelIfEvPT_S1_(float *, float *);
static void __device_stub__Z10testKernelIiEvPT_S1_(int *, int *);
static void __sti____cudaRegisterAll_50_tmpxft_00005e8b_00000000_4_simpleTemplates_cpp1_ii_4d17bf75(void) __attribute__((__constructor__));
