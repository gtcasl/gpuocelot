# 1 "/tmp/tmpxft_00005ee3_00000000-1_simpleVoteIntrinsics.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005ee3_00000000-1_simpleVoteIntrinsics.cudafe1.cpp"
...
# 16 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
static char *sSDKsample = ((char *)("[simpleVoteIntrinsics]\000"));
# 24 "tests/simpleVoteIntrinsics/simpleVote_kernel.cu"
void VoteAnyKernel1(unsigned *input, unsigned *result, int size) ;
# 34 "tests/simpleVoteIntrinsics/simpleVote_kernel.cu"
void VoteAllKernel2(unsigned *input, unsigned *result, int size) ;
# 43 "tests/simpleVoteIntrinsics/simpleVote_kernel.cu"
void VoteAnyKernel3(bool *info, int warp_size) ;
# 29 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
void genVoteTestPattern(unsigned *VOTE_PATTERN, int size)
# 30 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 32 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (int i = 0; i < (size / 4); i++) {
# 33 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = (0); }
# 36 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (int i = ((2 * size) / 8); i < ((4 * size) / 8); i++) {
# 37 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = ((i & 1) ? i : 0); }
# 40 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (int i = ((2 * size) / 4); i < ((3 * size) / 4); i++) {
# 41 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = ((i & 1) ? 0 : i); }
# 44 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (int i = ((3 * size) / 4); i < ((4 * size) / 4); i++) {
# 45 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
(VOTE_PATTERN[i]) = 4294967295U; }
# 46 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 48 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int checkErrors1(unsigned *h_result, int start, int end, int warp_size, char *voteType)
# 49 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 50 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int i, sum = 0;
# 52 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for ((sum = 0), (i = start); i < end; i++) {
# 53 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
sum += (h_result[i]);
# 54 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 55 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
if (sum > 0) {
# 56 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\t<%s>[%d - %d] = ", voteType, start, end - 1);
# 57 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (i = start; i < end; i++) {
# 58 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("%d", h_result[i]);
# 59 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 60 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf(" - FAILED\n", sum);
# 61 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 62 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return sum > 0;
# 63 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 65 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int checkErrors2(unsigned *h_result, int start, int end, int warp_size, char *voteType)
# 66 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 67 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int i, sum = 0;
# 69 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for ((sum = 0), (i = start); i < end; i++) {
# 70 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
sum += (h_result[i]);
# 71 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 72 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
if (sum != warp_size) {
# 73 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\t<%s>[%d - %d] = ", voteType, start, end - 1);
# 74 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (i = start; i < end; i++) {
# 75 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("%d", h_result[i]);
# 76 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 77 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf(" - FAILED\n");
# 78 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 79 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return sum != warp_size;
# 80 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 84 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int checkResultsVoteAnyKernel1(unsigned *h_result, int size, int warp_size)
# 85 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 86 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int error_count = 0;
# 88 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, 0, (4 * warp_size) / 4, warp_size, (char *)("Vote.Any"));
# 89 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, (4 * warp_size) / 4, ((2 * 4) * warp_size) / 4, warp_size, (char *)("Vote.Any"));
# 90 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, ((2 * 4) * warp_size) / 4, ((3 * 4) * warp_size) / 4, warp_size, (char *)("Vote.Any"));
# 91 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, ((3 * 4) * warp_size) / 4, ((4 * 4) * warp_size) / 4, warp_size, (char *)("Vote.Any"));
# 93 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf((error_count == 0) ? ("\tOK\n") : ("\tERROR\n"));
# 94 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return error_count;
# 95 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 98 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int checkResultsVoteAllKernel2(unsigned *h_result, int size, int warp_size)
# 99 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 100 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int error_count = 0;
# 108 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, 0, (4 * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 109 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, (4 * warp_size) / 4, ((2 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 110 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors1(h_result, ((2 * 4) * warp_size) / 4, ((3 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 111 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count += checkErrors2(h_result, ((3 * 4) * warp_size) / 4, ((4 * 4) * warp_size) / 4, warp_size, (char *)("Vote.All"));
# 113 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf((error_count == 0) ? ("\tOK\n") : ("\tERROR\n"));
# 114 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return error_count;
# 115 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 118 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int checkResultsVoteAnyKernel3(bool *hinfo, int size)
# 119 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 120 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int i, error_count = 0;
# 140 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
for (i = 0; i < (size * 3); i++) {
# 141 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
switch (i % 3) {
# 142 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
case 0:
# 144 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
if ((hinfo[i]) != (i >= (size * 1))) {
# 145 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count++;
# 146 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 147 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
break;
# 148 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
case 1:
# 150 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
if ((hinfo[i]) != (i >= ((size * 3) / 2))) {
# 151 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count++;
# 152 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 153 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
break;
# 154 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
case 2:
# 156 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
if ((hinfo[i]) != (i >= (size * 2))) {
# 157 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
error_count++;
# 158 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 159 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
break;
# 160 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 161 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 163 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf((error_count == 0) ? ("\tOK\n") : ("\tERROR\n"));
# 164 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
return error_count;
# 165 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 167 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int main(int argc, char **argv)
# 168 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 169 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
unsigned *h_input, *h_result;
# 170 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
unsigned *d_input, *d_result;
# 172 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
bool *dinfo = (__null), *hinfo = (__null);
# 173 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int error_count[3] = {0, 0, 0};
# 175 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaDeviceProp deviceProp;
# 176 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int devID, warp_size;
# 178 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("%s\n", sSDKsample);
# 181 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
devID = cutilChooseCudaDevice(argc, argv);
# 183 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, devID), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 183);
# 186 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("> GPU device has %d Multi-Processors, SM %d.%d compute capabilities\n\n", deviceProp.multiProcessorCount, deviceProp.major, deviceProp.minor);
# 192 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
int version = (((deviceProp.major) * 16) + (deviceProp.minor));
# 194 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
if (version >= 18)
# 195 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 196 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("%s: Using Device %d: \"%s\"\n", sSDKsample, devID, deviceProp.name);
# 197 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
} else {
# 198 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("%s: requires minimum of Compute Capability 1.2 or higher, waiving test...\n", sSDKsample);
# 199 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("PASSED\n");
# 200 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cutilExit(argc, argv);
# 201 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 202 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
warp_size = (deviceProp.warpSize);
# 205 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
h_input = ((unsigned *)malloc((4 * warp_size) * sizeof(unsigned)));
# 206 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
h_result = ((unsigned *)malloc((4 * warp_size) * sizeof(unsigned)));
# 207 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_input), (4 * warp_size) * sizeof(unsigned)), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 207);
# 208 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_result), (4 * warp_size) * sizeof(unsigned)), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 208);
# 209 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
genVoteTestPattern(h_input, 4 * warp_size);
# 210 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(d_input, h_input, (4 * warp_size) * sizeof(unsigned), cudaMemcpyHostToDevice), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 210);
# 213 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("[VOTE Kernel Test 1/3]\n");
# 214 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\tRunning <<Vote.Any>> kernel1 ...\n");
# 215 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 216 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 216);
# 217 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
dim3 gridBlock(1, 1);
# 218 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
dim3 threadBlock(4 * warp_size, 1);
# 219 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaConfigureCall(gridBlock, threadBlock) ? ((void)0) : VoteAnyKernel1(d_input, d_result, 4 * warp_size);
# 220 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cutilCheckMsg("VoteAnyKernel() execution failed\n", "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 220);
# 221 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 221);
# 222 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 223 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(h_result, d_result, (4 * warp_size) * sizeof(unsigned), cudaMemcpyDeviceToHost), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 223);
# 224 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
((error_count)[0]) += checkResultsVoteAnyKernel1(h_result, 4 * warp_size, warp_size);
# 227 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\n[VOTE Kernel Test 2/3]\n");
# 228 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\tRunning <<Vote.All>> kernel2 ...\n");
# 229 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 230 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 230);
# 231 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
dim3 gridBlock(1, 1);
# 232 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
dim3 threadBlock(4 * warp_size, 1);
# 233 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaConfigureCall(gridBlock, threadBlock) ? ((void)0) : VoteAllKernel2(d_input, d_result, 4 * warp_size);
# 234 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cutilCheckMsg("VoteAllKernel() execution failed\n", "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 234);
# 235 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 235);
# 236 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 237 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaMemcpy(h_result, d_result, (4 * warp_size) * sizeof(unsigned), cudaMemcpyDeviceToHost), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 237);
# 238 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
((error_count)[1]) += checkResultsVoteAllKernel2(h_result, 4 * warp_size, warp_size);
# 241 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
hinfo = ((bool *)calloc((warp_size * 3) * 3, sizeof(bool)));
# 242 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaMalloc((void **)(&dinfo), ((warp_size * 3) * 3) * sizeof(bool));
# 243 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaMemcpy(dinfo, hinfo, ((warp_size * 3) * 3) * sizeof(bool), cudaMemcpyHostToDevice);
# 246 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\n[VOTE Kernel Test 3/3]\n");
# 247 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\tRunning <<Vote.Any>> kernel3 ...\n");
# 248 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 249 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 249);
# 250 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaConfigureCall(1, warp_size * 3) ? ((void)0) : VoteAnyKernel3(dinfo, warp_size);
# 251 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 251);
# 252 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 254 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaMemcpy(hinfo, dinfo, ((warp_size * 3) * 3) * sizeof(bool), cudaMemcpyDeviceToHost);
# 257 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
((error_count)[2]) = checkResultsVoteAnyKernel3(hinfo, warp_size * 3);
# 259 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\n%s - Test Summary\n", sSDKsample);
# 260 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
if (((((error_count)[0]) == 0) && (((error_count)[1]) == 0)) && (((error_count)[2]) == 0))
# 263 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 264 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("PASSED\n");
# 265 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
} else
# 266 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
{
# 267 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("FAILED\n");
# 268 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 271 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaFree(d_input), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 271);
# 272 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cudaSafeCall(cudaFree(d_result), "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu", 272);
# 273 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
free(h_input);
# 274 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
free(h_result);
# 277 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
free(hinfo); cudaFree(dinfo);
# 279 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
printf("\tShutting down...\n");
# 280 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
cudaThreadExit();
# 281 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
__cutilExit(argc, argv); return 0;
# 282 "tests/simpleVoteIntrinsics/simpleVoteIntrinsics.cu"
}
# 1 "tmpxft_00005ee3_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c"
# 1 "tmpxft_00005ee3_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00005ee3_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_00005ee3_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_00005ee3_00000000-3_simpleVoteIntrinsics.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x000000000000185a,0x0000007801000001,0x0000000000000bfa\n"
".quad 0x0000003800000000,0x0000001400030000,0x0000003200000040,0x0000000000000015\n"
".quad 0x0000000000000000,0x0000000000000000,0x69732f7374736574,0x65746f56656c706d\n"
".quad 0x69736e6972746e49,0x6c706d69732f7363,0x746e4965746f5665,0x2e736369736e6972\n"
...
".quad 0x706d742f22203109,0x5f746678706d742f,0x3365653530303030,0x303030303030305f\n"
".quad 0x706d69735f372d30,0x6e4965746f56656c,0x736369736e697274,0x22692e337070632e\n"
".quad 0x3209656c69662e0a,0x2f73747365742220,0x6f56656c706d6973,0x6e6972746e496574\n"
".quad 0x6d69732f73636973,0x5f65746f56656c70,0x632e6c656e72656b,0x656c69662e0a2275\n"
".quad 0x7273752f22203309,0x632f6c61636f6c2f,0x632f312e34616475,0x6d76766e2f616475\n"
".quad 0x6c636e695f69632f,0x0a0a22682e656475,0x5f207972746e652e,0x4165746f5634315a\n"
".quad 0x6c656e72654b796e,0x0a28695f536a5031,0x2e206d617261702e,0x34315a5f20343675\n"
".quad 0x4b796e4165746f56,0x6a50316c656e7265,0x617261705f695f53,0x61702e0a2c305f6d\n"
".quad 0x3436752e206d6172,0x746f5634315a5f20,0x6e72654b796e4165,0x695f536a50316c65\n"
".quad 0x0000000000000000,0x000000000a4f0000,0x0000000000480000,0x0000000000000000\n"
".quad 0x0000000000010000,0x0000000000000000,0x747368732e000000,0x74732e0062617472\n"
".quad 0x79732e0062617472,0x766e2e006261746d,0x2e6c61626f6c672e,0x766e2e0074696e69\n"
".quad 0x006c61626f6c672e,0x5a5f2e747865742e,0x6c4165746f563431,0x326c656e72654b6c\n"
".quad 0x6e2e00695f536a50,0x2e006f666e692e76,0x2e6f666e692e766e,0x65746f5634315a5f\n"
".quad 0x656e72654b6c6c41,0x00695f536a50326c,0x5a5f2e747865742e,0x6e4165746f563431\n"
".quad 0x336c656e72654b79,0x2e766e2e00696250,0x315a5f2e6f666e69,0x796e4165746f5634\n"
".quad 0x50336c656e72654b,0x747865742e006962,0x746f5634315a5f2e,0x6e72654b796e4165\n"
".quad 0x695f536a50316c65,0x666e692e766e2e00,0x6f5634315a5f2e6f,0x72654b796e416574\n"
".quad 0x5f536a50316c656e,0x6f632e766e2e0069,0x2e30746e6174736e,0x65746f5634315a5f\n"
".quad 0x656e72654b6c6c41,0x00695f536a50326c,0x736e6f632e766e2e,0x5a5f2e30746e6174\n"
".quad 0x6e4165746f563431,0x336c656e72654b79,0x2e766e2e00696250,0x746e6174736e6f63\n"
".quad 0x6f5634315a5f2e30,0x72654b796e416574,0x5f536a50316c656e,0x5634315a5f000069\n"
".quad 0x654b6c6c4165746f,0x536a50326c656e72,0x5634315a5f00695f,0x654b796e4165746f\n"
".quad 0x696250336c656e72,0x746f5634315a5f00,0x6e72654b796e4165,0x695f536a50316c65\n"
...
".quad 0x0000000000008000,0x0d00030000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0c00030000000000,0x0000000000000000,0x0000000000000000,0x0700030000000000\n"
".quad 0x0000000000000000,0x000000000000c800,0x0900030000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0400030000000000,0x0000000000000000,0x0000000000008000\n"
".quad 0x0600030000000000,0x0000000000000000,0x0000000000000000,0x0b00030000000000\n"
...
".quad 0x0a10120000000100,0x0000000000000000,0x0000000000008000,0x0710120000001900\n"
".quad 0x0000000000000000,0x000000000000c800,0x0410120000002f00,0x0000000000000000\n"
".quad 0x0000000000008000,0x00440400005de400,0x00000084009c0428,0x00000010019de22c\n"
".quad 0x00c0001020dce318,0x0d800080211ca350,0x00400090315c4320,0x0d8000a0209ca348\n"
".quad 0x00000000401c8520,0x004000b030dc4384,0x00c00007f01c2348,0x8e0000fc01dc0331\n"
".quad 0x000000000fdc241a,0x10c00007f01c0448,0x00c00007f01c2320,0x00000000201c8531\n"
".quad 0x00000000001de794,0x0000000000000080,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x080a040000000000\n"
".quad 0x1400200000000f00,0x0c17040014190300,0x1000020000000000,0x0c17040011f00000\n"
".quad 0x0800010000000000,0x0c17040021f00000,0x0000000000000000,0x005de40021f00000\n"
".quad 0x009de42800440400,0x201ca328004000a0,0x001c035000c0000c,0x209ca35800c0007c\n"
".quad 0x001c042000c0000c,0x209c232c00000084,0x01dc235800c00004,0x001ca31b0e000008\n"
".quad 0xf09c045000c0000c,0x011c232010c00007,0x019c037000c0047c,0x21dc034801400080\n"
".quad 0x41dc431a8e0000fc,0x0fdc044800400090,0x0fdc244840000000,0x609c054800000000\n"
".quad 0xf0dc049400000004,0xf01c042012c00007,0x31dc232010c00007,0xf01c23190e0000fc\n"
".quad 0x00e1e23100c00007,0x601c051800000004,0x60e0059400000000,0x001de79400000008\n"
".quad 0x0000008000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x00000e00080a0400,0x0c1903000c002000\n"
".quad 0x000000000c170400,0x11f0000008000100,0x000000000c170400,0x21f0000000000000\n"
".quad 0x01000c00080d0400,0x005de40000000100,0x009c042800440400,0x019de22c00000084\n"
".quad 0x20dce31800000010,0x211ca35000c00010,0x315c43200d800080,0x209ca34800400090\n"
".quad 0x401c85200d8000a0,0x30dc438400000000,0xf01c2348004000b0,0x01dc033100c00007\n"
".quad 0x0fdc041a8e0000fc,0xf01c044800000000,0xf01c232010c00007,0x201c853100c00007\n"
".quad 0x001de79400000000,0x0000008000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x00000d00080a0400,0x1419030014002000,0x000000000c170400,0x11f0000010000200\n"
...
".quad 0x0811040000000000,0x0000000000001100,0x0000100008120400,0x0811040000000000\n"
".quad 0x0000000000001000,0x0005000000060000,0x000000000a980000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000e00000,0x0000000000e00000,0x0000000000040000\n"
".quad 0x1205600000000000,0x0000000007370000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0000000000f40000,0x0000000000f40000,0x0000000000040000,0x1105600000000000\n"
".quad 0x00000000082b0000,0x0000000000000000,0x0000000000000000,0x0000000001300000\n"
".quad 0x0000000001300000,0x0000000000040000,0x1005600000000000,0x00000000095b0000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000f40000,0x0000000000f40000\n"
".quad 0x0000000000040000,0x0000000000000000\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[782];
...
# 3 "/tmp/tmpxft_00005ee3_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c" 2 3
...
static void __sti____cudaRegisterAll_55_tmpxft_00005ee3_00000000_4_simpleVoteIntrinsics_cpp1_ii_9a59ed6c(void) __attribute__((__constructor__));
...
# 25 "tests/simpleVoteIntrinsics/simpleVote_kernel.cu"
{__device_stub__Z14VoteAnyKernel1PjS_i( __cuda_0,__cuda_1,__cuda_2);



}
# 1 "/tmp/tmpxft_00005ee3_00000000-1_simpleVoteIntrinsics.cudafe1.stub.c"
...
# 35 "tests/simpleVoteIntrinsics/simpleVote_kernel.cu"
