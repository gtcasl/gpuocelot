...
# 26 "tests/simpleZeroCopy/simpleZeroCopy.cu"
int main(int argc, char **argv)
# 27 "tests/simpleZeroCopy/simpleZeroCopy.cu"
{
# 28 "tests/simpleZeroCopy/simpleZeroCopy.cu"
int n, nelem, idev, deviceCount;
# 29 "tests/simpleZeroCopy/simpleZeroCopy.cu"
char *device = (__null);
# 30 "tests/simpleZeroCopy/simpleZeroCopy.cu"
unsigned flags;
# 31 "tests/simpleZeroCopy/simpleZeroCopy.cu"
size_t bytes;
# 32 "tests/simpleZeroCopy/simpleZeroCopy.cu"
float *a, *b, *c;
# 33 "tests/simpleZeroCopy/simpleZeroCopy.cu"
float *d_a, *d_b, *d_c;
# 34 "tests/simpleZeroCopy/simpleZeroCopy.cu"
float errorNorm, refNorm, ref, diff;
# 35 "tests/simpleZeroCopy/simpleZeroCopy.cu"
cudaDeviceProp deviceProp;
# 37 "tests/simpleZeroCopy/simpleZeroCopy.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "help"))
# 38 "tests/simpleZeroCopy/simpleZeroCopy.cu"
{
# 39 "tests/simpleZeroCopy/simpleZeroCopy.cu"
printf("Usage:  simpleZeroCopy [OPTION]\n\n");
# 40 "tests/simpleZeroCopy/simpleZeroCopy.cu"
printf("Options:\n");
# 41 "tests/simpleZeroCopy/simpleZeroCopy.cu"
printf("  --device=[device #]  Specify the device to be used\n");
# 42 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cutilExit(argc, argv);
# 43 "tests/simpleZeroCopy/simpleZeroCopy.cu"
}
# 47 "tests/simpleZeroCopy/simpleZeroCopy.cu"
if (cutGetCmdLineArgumentstr(argc, (const char **)argv, "device", &device))
# 48 "tests/simpleZeroCopy/simpleZeroCopy.cu"
{
# 49 "tests/simpleZeroCopy/simpleZeroCopy.cu"
...
{
# 60 "tests/simpleZeroCopy/simpleZeroCopy.cu"
idev = 0;
# 61 "tests/simpleZeroCopy/simpleZeroCopy.cu"
}
# 63 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaSetDevice(idev), "tests/simpleZeroCopy/simpleZeroCopy.cu", 63);
# 68 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, idev), "tests/simpleZeroCopy/simpleZeroCopy.cu", 68);
...
__cudaSafeCall(cudaSetDeviceFlags(8), "tests/simpleZeroCopy/simpleZeroCopy.cu", 77);
# 86 "tests/simpleZeroCopy/simpleZeroCopy.cu"
nelem = 1048576;
# 87 "tests/simpleZeroCopy/simpleZeroCopy.cu"
bytes = (nelem * sizeof(float));
# 89 "tests/simpleZeroCopy/simpleZeroCopy.cu"
flags = (2);
# 90 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostAlloc((void **)(&a), bytes, flags), "tests/simpleZeroCopy/simpleZeroCopy.cu", 90);
# 91 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostAlloc((void **)(&b), bytes, flags), "tests/simpleZeroCopy/simpleZeroCopy.cu", 91);
# 92 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostAlloc((void **)(&c), bytes, flags), "tests/simpleZeroCopy/simpleZeroCopy.cu", 92);
...
# 106 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_a), (void *)a, 0), "tests/simpleZeroCopy/simpleZeroCopy.cu", 106);
# 107 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_b), (void *)b, 0), "tests/simpleZeroCopy/simpleZeroCopy.cu", 107);
# 108 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_c), (void *)c, 0), "tests/simpleZeroCopy/simpleZeroCopy.cu", 108);
...
# 117 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaThreadSynchronize(), "tests/simpleZeroCopy/simpleZeroCopy.cu", 117);
# 118 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cutilCheckMsg("vectorAddGPU() execution failed", "tests/simpleZeroCopy/simpleZeroCopy.cu", 118);
...
refNorm = (0.0F);
# 125 "tests/simpleZeroCopy/simpleZeroCopy.cu"
for (n = 0; n < nelem; n++)
# 126 "tests/simpleZeroCopy/simpleZeroCopy.cu"
{
# 127 "tests/simpleZeroCopy/simpleZeroCopy.cu"
ref = ((a[n]) + (b[n]));
# 128 "tests/simpleZeroCopy/simpleZeroCopy.cu"
diff = ((c[n]) - ref);
# 129 "tests/simpleZeroCopy/simpleZeroCopy.cu"
errorNorm += (diff * diff);
...
# 133 "tests/simpleZeroCopy/simpleZeroCopy.cu"
refNorm = ((float)sqrt((double)refNorm));
# 137 "tests/simpleZeroCopy/simpleZeroCopy.cu"
printf("Releasing CPU memory...\n");
# 139 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaFreeHost(a), "tests/simpleZeroCopy/simpleZeroCopy.cu", 139);
# 140 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaFreeHost(b), "tests/simpleZeroCopy/simpleZeroCopy.cu", 140);
# 141 "tests/simpleZeroCopy/simpleZeroCopy.cu"
__cudaSafeCall(cudaFreeHost(c), "tests/simpleZeroCopy/simpleZeroCopy.cu", 141);
# 144 "tests/simpleZeroCopy/simpleZeroCopy.cu"
cudaThreadExit();
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000b34,0x0000006801000001,0x00000000000004ac\n"
".quad 0x0000003800000000,0x0000001400030000,0x0000002600000040,0x0000000000000015\n"
".quad 0x0000000000000000,0x0000000000000000,0x69732f7374736574,0x6f72655a656c706d\n"
...
".quad 0x6c7225203436752e,0x3b346c7225202c33,0x203220636f6c2e0a,0x766f6d0a31203132\n"
...
".quad 0x203232203220636f,0x6c2e707465730a31,0x7025203233732e74,0x202c317225202c31\n"
".quad 0x7025400a3b327225,0x4242206172622031,0x6c2e0a0a3b325f30,0x203432203220636f\n"
".quad 0x0a0a3b7465720a32,0x2e0a3a325f304242,0x3332203220636f6c,0x772e6c756d0a3120\n"
...
".quad 0x2c5d30316c72255b,0x6c2e0a3b33662520,0x203432203220636f,0x7d0a3b7465720a32\n"
".quad 0x01000002000a0a0a,0x000005c000000060,0x0000000000000000,0x0001000400000000\n"
".quad 0x0000003800000014,0x0000001500000026,0x0000000000000000,0x7473657400000000\n"
".quad 0x656c706d69732f73,0x79706f436f72655a,0x5a656c706d69732f,0x2e79706f436f7265\n"
".quad 0x464c457f00007563,0x0000000433010102,0x00be000200000000,0x0000000000000001\n"
".quad 0x0000055000000000,0x0000004000000000,0x0014051400000000,0x0040000200380040\n"
...
".quad 0x000000a400000000,0x0000000000000000,0x0000000400000000,0x0000000000000000\n"
".quad 0x0000000b00000000,0x0000000000000003,0x0000000000000000,0x000002e400000000\n"
".quad 0x0000001900000000,0x0000000000000000,0x0000000100000000,0x0000000000000000\n"
".quad 0x0000001300000000,0x0000000000000002,0x0000000000000000,0x000002fd00000000\n"
".quad 0x0000010800000000,0x0000000200000000,0x000000010000000a,0x0000001800000000\n"
".quad 0x0000003600000000,0x0000000600000001,0x0000000000000000,0x0000040500000000\n"
".quad 0x0000009800000000,0x0000000300000000,0x000000040a000006,0x0000000000000000\n"
".quad 0x0000007e00000000,0x0000000200000001,0x0000000000000000,0x0000049d00000000\n"
".quad 0x0000003c00000000,0x0000000000000000,0x0000000400000004,0x0000000000000000\n"
".quad 0x0000005400000000,0x0000000200000001,0x0000000000000000,0x000004d900000000\n"
".quad 0x0000005c00000000,0x0000000000000000,0x0000000100000004,0x0000000000000000\n"
".quad 0x0000007500000000,0x0000000200000001,0x0000000000000000,0x0000053500000000\n"
...
".quad 0x7463657632315a5f,0x555047646441726f,0x00695f535f536650,0x6f666e692e766e2e\n"
".quad 0x63657632315a5f2e,0x5047646441726f74,0x695f535f53665055,0x666e692e766e2e00\n"
".quad 0x6f632e766e2e006f,0x2e30746e6174736e,0x7463657632315a5f,0x555047646441726f\n"
".quad 0x00695f535f536650,0x63657632315a5f00,0x5047646441726f74,0x695f535f53665055\n"
...
".quad 0x0000000000009800,0x00440400005de400,0x00000094001c0428,0x00000084009c042c\n"
".quad 0x04400020001ca32c,0x8e4000e001dc2320,0x0000018000a1e718,0x000000100141e240\n"
".quad 0x00c000100100e318,0x0b8000800080a350,0x0040009040c04320,0x0b8000a00200a348\n"
".quad 0x0000000020c08520,0x004000b042404384,0x0b8000c00180a348,0x0000000080808520\n"
".quad 0x004000d041c04384,0x0000000830000048,0x0000000060008550,0x00000000001de794\n"
...
".quad 0x1c00200000000900,0x0c1704001c190300,0x1800030000000000,0x0c17040011f00000\n"
".quad 0x1000020000000000,0x0c17040021f00000,0x0800010000000000,0x0c17040021f00000\n"
".quad 0x0000000000000000,0x080d040021f00000,0x0000010001000c00,0x00000a0008120400\n"
".quad 0x0811040000000000,0x0000000000000a00,0x0000000600000000,0x0000055000000005\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000007000000000,0x0000007000000000\n"
".quad 0x0000000400000000,0x6000000000000000,0x0000040500000a05,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000013000000000,0x0000013000000000,0x0000000400000000\n"
...
# 20 "tests/simpleZeroCopy/simpleZeroCopy.cu"
