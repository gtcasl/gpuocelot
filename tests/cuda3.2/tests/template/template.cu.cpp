# 1 "/tmp/tmpxft_0000736b_00000000-1_template.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_0000736b_00000000-1_template.cudafe1.cpp"
# 1 "tests/template/template.cu"
...
# 30 "./tests/template/template_kernel.cu"
void testKernel(float *g_idata, float *g_odata) ;
# 31 "tests/template/template.cu"
void runTest(int , char ** );
# 34 "tests/template/template.cu"
extern "C" void computeGold(float * , float * , const unsigned );
# 40 "tests/template/template.cu"
int main(int argc, char **argv)
# 41 "tests/template/template.cu"
{
# 42 "tests/template/template.cu"
runTest(argc, argv);
# 44 "tests/template/template.cu"
__cutilExit(argc, argv); return 0;
# 45 "tests/template/template.cu"
}
# 51 "tests/template/template.cu"
void runTest(int argc, char **argv)
# 52 "tests/template/template.cu"
{
# 54 "tests/template/template.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "device")) {
# 55 "tests/template/template.cu"
cutilDeviceInit(argc, argv); } else {
# 57 "tests/template/template.cu"
cudaSetDevice(cutGetMaxGflopsDeviceId()); }
# 59 "tests/template/template.cu"
unsigned timer = (0);
# 60 "tests/template/template.cu"
__cutilCheckError(cutCreateTimer(&timer), "tests/template/template.cu", 60);
# 61 "tests/template/template.cu"
__cutilCheckError(cutStartTimer(timer), "tests/template/template.cu", 61);
# 63 "tests/template/template.cu"
unsigned num_threads = (32);
# 64 "tests/template/template.cu"
unsigned mem_size = (sizeof(float) * num_threads);
# 67 "tests/template/template.cu"
float *h_idata = ((float *)malloc(mem_size));
# 69 "tests/template/template.cu"
for (unsigned i = (0); i < num_threads; ++i)
# 70 "tests/template/template.cu"
{
# 71 "tests/template/template.cu"
(h_idata[i]) = ((float)i);
# 72 "tests/template/template.cu"
}
# 75 "tests/template/template.cu"
float *d_idata;
# 76 "tests/template/template.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_idata), mem_size), "tests/template/template.cu", 76);
# 78 "tests/template/template.cu"
__cudaSafeCall(cudaMemcpy(d_idata, h_idata, mem_size, cudaMemcpyHostToDevice), "tests/template/template.cu", 79);
# 82 "tests/template/template.cu"
float *d_odata;
# 83 "tests/template/template.cu"
__cudaSafeCall(cudaMalloc((void **)(&d_odata), mem_size), "tests/template/template.cu", 83);
# 86 "tests/template/template.cu"
dim3 grid(1, 1, 1);
# 87 "tests/template/template.cu"
dim3 threads(num_threads, 1, 1);
# 90 "tests/template/template.cu"
cudaConfigureCall(grid, threads, mem_size) ? ((void)0) : testKernel(d_idata, d_odata);
# 93 "tests/template/template.cu"
__cutilCheckMsg("Kernel execution failed", "tests/template/template.cu", 93);
# 96 "tests/template/template.cu"
float *h_odata = ((float *)malloc(mem_size));
# 98 "tests/template/template.cu"
__cudaSafeCall(cudaMemcpy(h_odata, d_odata, sizeof(float) * num_threads, cudaMemcpyDeviceToHost), "tests/template/template.cu", 99);
# 101 "tests/template/template.cu"
__cutilCheckError(cutStopTimer(timer), "tests/template/template.cu", 101);
# 102 "tests/template/template.cu"
printf("Processing time: %f (ms)\n", cutGetTimerValue(timer));
# 103 "tests/template/template.cu"
__cutilCheckError(cutDeleteTimer(timer), "tests/template/template.cu", 103);
# 106 "tests/template/template.cu"
float *reference = ((float *)malloc(mem_size));
# 107 "tests/template/template.cu"
computeGold(reference, h_idata, num_threads);
# 110 "tests/template/template.cu"
if (cutCheckCmdLineFlag(argc, (const char **)argv, "regression"))
# 111 "tests/template/template.cu"
{
# 113 "tests/template/template.cu"
__cutilCheckError(cutWriteFilef("./data/regression.dat", h_odata, num_threads, (0.0)), "tests/template/template.cu", 114);
# 115 "tests/template/template.cu"
} else
# 117 "tests/template/template.cu"
{
# 120 "tests/template/template.cu"
CUTBoolean res = cutComparef(reference, h_odata, num_threads);
# 121 "tests/template/template.cu"
printf("%s\n", (1 == res) ? ("PASSED") : ("FAILED"));
# 122 "tests/template/template.cu"
}
# 125 "tests/template/template.cu"
free(h_idata);
# 126 "tests/template/template.cu"
free(h_odata);
# 127 "tests/template/template.cu"
free(reference);
# 128 "tests/template/template.cu"
__cudaSafeCall(cudaFree(d_idata), "tests/template/template.cu", 128);
# 129 "tests/template/template.cu"
__cudaSafeCall(cudaFree(d_odata), "tests/template/template.cu", 129);
# 131 "tests/template/template.cu"
cudaThreadExit();
# 132 "tests/template/template.cu"
}
# 1 "tmpxft_0000736b_00000000-1_template.cudafe1.stub.c"
# 1 "tmpxft_0000736b_00000000-1_template.cudafe1.stub.c"
# 1 "/tmp/tmpxft_0000736b_00000000-1_template.cudafe1.stub.c" 1 3
# 1 "/usr/local/cuda4.1/cuda/include/crt/host_runtime.h" 1 3
...
#pragma pack()
# 2 "/tmp/tmpxft_0000736b_00000000-1_template.cudafe1.stub.c" 2 3
# 1 "/tmp/tmpxft_0000736b_00000000-3_template.fatbin.c" 1 3
...
".align 8\n"
"fatbinData:\n"
".quad 0x00100001ba55ed50,0x0000000000000a92,0x0000006001000001,0x000000000000044e\n"
".quad 0x0000003800000000,0x0000001400030000,0x0000001a00000040,0x0000000000000015\n"
".quad 0x0000000000000000,0x0000000000000000,0x65742f7374736574,0x742f6574616c706d\n"
".quad 0x2e6574616c706d65,0x0000000000007563,0x762e0a0a0a0a0a0a,0x33206e6f69737265\n"
".quad 0x677261742e0a302e,0x30325f6d73207465,0x7365726464612e0a,0x3620657a69735f73\n"
".quad 0x656c69662e0a0a34,0x706d742f22203109,0x5f746678706d742f,0x6236333730303030\n"
".quad 0x303030303030305f,0x706d65745f372d30,0x7070632e6574616c,0x69662e0a22692e33\n"
".quad 0x7261620a31203934,0x3b3020636e79732e,0x203220636f6c2e0a,0x6c68730a31203235\n"
".quad 0x6c7225203436622e,0x326c7225202c3031,0x6464610a3b32202c,0x6c7225203436732e\n"
".quad 0x316c7225202c3131,0x3b30316c7225202c,0x726168732e646c0a,0x25203233662e6465\n"
".quad 0x6c72255b202c3566,0x672e74730a3b5d33,0x33662e6c61626f6c,0x31316c72255b2032\n"
".quad 0x0a3b356625202c5d,0x35203220636f6c2e,0x3b7465720a322033,0x0002000a0a0a7d0a\n"
".quad 0x058c000000580100,0x0000000000000000,0x0004000000000000,0x0038000000140001\n"
".quad 0x00150000001a0000,0x0000000000000000,0x6574000000000000,0x706d65742f737473\n"
".quad 0x6d65742f6574616c,0x75632e6574616c70,0x457f000000000000,0x000433010102464c\n"
".quad 0x0002000000000000,0x00000000000100be,0x051c000000000000,0x0040000000000000\n"
...
".quad 0x0000000000000000,0x0240000000000000,0x0095000000000000,0x0000000000000000\n"
".quad 0x0004000000000000,0x0000000000000000,0x000b000000000000,0x0000000000030000\n"
".quad 0x0000000000000000,0x02d5000000000000,0x0014000000000000,0x0000000000000000\n"
".quad 0x0001000000000000,0x0000000000000000,0x0013000000000000,0x0000000000020000\n"
".quad 0x0000000000000000,0x02e9000000000000,0x0108000000000000,0x0002000000000000\n"
".quad 0x00010000000a0000,0x0018000000000000,0x0036000000000000,0x0006000000010000\n"
".quad 0x0000000000000010,0x03f1000000000000,0x00b0000000000000,0x0003000000000000\n"
".quad 0x0004080000060000,0x0000000000000000,0x0074000000000000,0x0002000000010000\n"
".quad 0x0000000000000000,0x04a1000000000000,0x0030000000000000,0x0000000000000000\n"
".quad 0x0004000000040000,0x0000000000000000,0x0058000000000000,0x0002000000010000\n"
".quad 0x0000000000000000,0x04d1000000000000,0x0030000000000000,0x0000000000000000\n"
".quad 0x0001000000040000,0x0000000000000000,0x004f000000000000,0x0002000000010000\n"
".quad 0x0000000000000000,0x0501000000000000,0x0018000000000000,0x0000000000000000\n"
...
".quad 0x6f6c672e766e2e00,0x7865742e006c6162,0x657430315a5f2e74,0x6c656e72654b7473\n"
".quad 0x766e2e005f536650,0x6e2e006f666e692e,0x5f2e6f666e692e76,0x4b7473657430315a\n"
".quad 0x5366506c656e7265,0x6f632e766e2e005f,0x2e30746e6174736e,0x7473657430315a5f\n"
".quad 0x66506c656e72654b,0x30315a5f00005f53,0x6e72654b74736574,0x00005f5366506c65\n"
...
".quad 0x0000000000000000,0x0100000000000000,0x0000041012000000,0xb000000000000000\n"
".quad 0xe400000000000000,0x042800440400005d,0x032c00000084009c,0x03207e0000fc1fdc\n"
".quad 0x436000c0000820de,0x035000c00010201c,0x434801400080311c,0x854800400090015c\n"
".quad 0x858400000000401c,0x04c900000000301c,0x8550ee0000ffffdc,0x04c100000000301c\n"
".quad 0x001800400021211c,0x855800000000401c,0x04c900000000301c,0xe450ee0000ffffdc\n"
".quad 0x0328004000a0001d,0x035800c00078211c,0x852001c00010219c,0x43c100000000301c\n"
".quad 0x8548004000b041dc,0xe79400000000601c,0x008000000000001d,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000000000,0x0000000000000000\n"
".quad 0x0400000000000000,0x200000000900080a,0x0400101903001000,0x0100000000000c17\n"
".quad 0x040021f000000800,0x0000000000000c17,0x040021f000000000,0x000000000a000812\n"
".quad 0x0a00081104000000,0x0000000000000000,0x0005000000060000,0x00000000051c0000\n"
".quad 0x0000000000000000,0x0000000000000000,0x0000000000700000,0x0000000000700000\n"
".quad 0x0000000000040000,0x0a05600000000000,0x0000000003f10000,0x0000000000000000\n"
".quad 0x0000000000000000,0x0000000001100000,0x0000000001100000,0x0000000000040000\n"
".quad 0x0000000000000000\n"
".text");

extern "C" {

extern const unsigned long long fatbinData[341];
...
# 3 "/tmp/tmpxft_0000736b_00000000-1_template.cudafe1.stub.c" 2 3
extern void __device_stub__Z10testKernelPfS_(float *, float *);
static void __sti____cudaRegisterAll_43_tmpxft_0000736b_00000000_4_template_cpp1_ii_bf2a51c6(void) __attribute__((__constructor__));
void __device_stub__Z10testKernelPfS_(float *__par0, float *__par1){if (cudaSetupArgument((void *)(char *)&__par0, sizeof(__par0), (size_t)0UL) != cudaSuccess) return;if (cudaSetupArgument((void *)(char *)&__par1, sizeof(__par1), (size_t)8UL) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(float *, float *))testKernel)); (void)cudaLaunch(((char *)((void ( *)(float *, float *))testKernel))); };}
# 30 "./tests/template/template_kernel.cu"
void testKernel( float *__cuda_0,float *__cuda_1)
# 31 "./tests/template/template_kernel.cu"
{__device_stub__Z10testKernelPfS_( __cuda_0,__cuda_1);
# 53 "./tests/template/template_kernel.cu"
}
# 1 "/tmp/tmpxft_0000736b_00000000-1_template.cudafe1.stub.c"
static void __sti____cudaRegisterAll_43_tmpxft_0000736b_00000000_4_template_cpp1_ii_bf2a51c6(void) { __cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil); __cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(float *, float *))testKernel), (char*)"_Z10testKernelPfS_", "_Z10testKernelPfS_", -1, (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0); }
# 2 "tmpxft_0000736b_00000000-1_template.cudafe1.stub.c" 2
# 1 "tmpxft_0000736b_00000000-1_template.cudafe1.stub.c"
