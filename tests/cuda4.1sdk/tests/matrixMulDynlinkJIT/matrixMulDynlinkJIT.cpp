...
int main(int argc, char **argv)
{
    ...
    int block_size = 0;
    cutilDrvSafeCallNoSync(initCUDA(argc, argv, &matrixMul, &block_size ));
	...
	{ // This is the new CUDA 4.0 API for Kernel Parameter passing and Kernel Launching (simpler method)
        ...
        cutilDrvSafeCallNoSync(cuLaunchKernel( matrixMul, (WC/block_size), (HC/block_size), 1, 
    ...
    cutilDrvSafeCallSync( cuCtxSynchronize() );
