# 1 "/tmp/tmpxft_000052a4_00000000-1_bisect_util.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_000052a4_00000000-1_bisect_util.cudafe1.cpp"
# 1 "bisect_util.cu"
...
# 158 "./util.h"
# 1 "/tmp/tmpxft_000052a4_00000000-1_bisect_util.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_000052a4_00000000-3_bisect_util.fatbin.c" 1
...
# 2 "/tmp/tmpxft_000052a4_00000000-3_bisect_util.fatbin.c" 2
...
0x78706d742f706d74ull,0x35303030305f7466ull,0x303030305f346132ull,0x625f372d30303030ull,
0x74755f7463657369ull,0x2e337070632e6c69ull,0x2f706d742f282069ull,0x414a2e2349426363ull,
0x2f090a29626b3179ull,0x2d2d2d2d2d2d2d2full,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x742f706d742f2209ull,0x30305f746678706dull,0x305f346132353030ull,0x2d30303030303030ull,
0x7463657369625f36ull,0x75632e6c6974755full,0x70672e3265666164ull,0x6c69662e090a2275ull,
...
0x09353109656c6966ull,0x5f74636573696222ull,0x2275632e6c697475ull,0x09656c69662e090aull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"6157342dbf42579d",(char*)"bisect_util.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0,0xe84889c6};
# 5 "/tmp/tmpxft_000052a4_00000000-1_bisect_util.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_000052a4_00000000-1_bisect_util.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_46_tmpxft_000052a4_00000000_4_bisect_util_cpp1_ii_7621fe01(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_46_tmpxft_000052a4_00000000_4_bisect_util_cpp1_ii_7621fe01(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);}
