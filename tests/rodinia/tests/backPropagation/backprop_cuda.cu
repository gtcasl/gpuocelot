...
extern "C"
void bpnn_train_cuda(BPNN *net, float eta, float momentum, float *eo, float *eh)
{
  int in, hid, out;
  ...
  bpnn_adjust_weights(net->output_delta, out, net->hidden_units, hid, net->hidden_weights, net->hidden_prev_weights, 0.3, 0.3);
