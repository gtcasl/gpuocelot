# 1 "/tmp/tmpxft_00005704_00000000-1_lud.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00005704_00000000-1_lud.cudafe1.cpp"
# 1 "lud.cu"
...
# 1 "/tmp/tmpxft_00005704_00000000-1_lud.cudafe1.stub.c"
# 1 "/tmp/tmpxft_00005704_00000000-1_lud.cudafe1.stub.c" 1
...
#pragma pack()
# 2 "/tmp/tmpxft_00005704_00000000-1_lud.cudafe1.stub.c" 2
# 1 "/tmp/tmpxft_00005704_00000000-3_lud.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00005704_00000000-3_lud.fatbin.c" 2

asm(
".section .rodata\n"
".align 32\n"
"__deviceText_$sm_10$:\n"
".quad 0x33010101464c457f,0x0000000000000002,0x0000000100be0002,0x0000016c00000000\n"
".quad 0x000a010a00000034,0x0028000200200034,0x0000000000010004,0x0000000000000000\n"
...
extern const unsigned long long __deviceText_$sm_10$[54];
...
".quad 0x30305f3430373530,0x372d303030303030,0x7070632e64756c5f,0x6d742f2820692e33\n"
".quad 0x2e23494263632f70,0x0a29374453314b68,0x2d2d2d2d2d2f2f09,0x2d2d2d2d2d2d2d2d\n"
".quad 0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d,0x2d2d2d2d2d2d2d2d\n"
...
".quad 0x703a746567726154,0x3a415349202c7874,0x45202c30315f6d73,0x696c3a6e6169646e\n"
".quad 0x6f50202c656c7474,0x6953207265746e69,0x2f090a32333a657a,0x2809334f2d20202f\n"
...
".quad 0x656c69662e090a22,0x706d742f22093209,0x5f746678706d742f,0x3430373530303030\n"
".quad 0x303030303030305f,0x2e64756c5f362d30,0x2e32656661647563,0x662e090a22757067\n"
".quad 0x2f22093309656c69,0x2f62696c2f727375,0x363834692f636367,0x672d78756e696c2d\n"
...
".quad 0x6f6d6d6f632f6564,0x6974636e75665f6e,0x090a22682e736e6f,0x373109656c69662e\n"
...
".quad 0x6174736e6f635f68,0x090a22682e73746e,0x393109656c69662e,0x6c2f7273752f2209\n"
...
".quad 0x636e75665f63696d,0x22682e736e6f6974,0x09656c69662e090a,0x7273752f22093132\n"
...
".quad 0x00000a0a0a22682e\n"
".text");

extern "C" {

extern const unsigned long long __deviceText_$compute_10$[285];
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000004,0xa14f518d,(char*)"515b5fbd73b69138",(char*)"lud.cu",(char*)" ",__ptxEntries,__cubinEntries,&__debugEntries0,0,0,0,0,0,0x3ae5da27,&__elfEntries1};
# 3 "/tmp/tmpxft_00005704_00000000-1_lud.cudafe1.stub.c" 2
static void __sti____cudaRegisterAll_38_tmpxft_00005704_00000000_4_lud_cpp1_ii_main(void) __attribute__((__constructor__));
static void __sti____cudaRegisterAll_38_tmpxft_00005704_00000000_4_lud_cpp1_ii_main(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)&__fatDeviceText); atexit(__cudaUnregisterBinaryUtil);}
# 1 "/tmp/tmpxft_00005704_00000000-1_lud.cudafe1.stub.c" 2
