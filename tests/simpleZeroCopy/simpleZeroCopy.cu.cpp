# 1 "/tmp/tmpxft_00006061_00000000-1_simpleZeroCopy.cudafe1.cpp"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "/tmp/tmpxft_00006061_00000000-1_simpleZeroCopy.cudafe1.cpp"
# 1 "simpleZeroCopy.cu"
...
# 43 "simpleZeroCopy.cu"
void vectorAddGPU__entry(float *a, float *b, float *c, int N);
# 50 "simpleZeroCopy.cu"
int main(int argc, char **argv)
{
auto int n; auto int nelem; auto int idev; auto int deviceCount;
auto char *device = (__null);
auto unsigned flags;
auto size_t bytes;
auto float *a; auto float *b; auto float *c;
auto float *d_a; auto float *d_b; auto float *d_c;
auto float errorNorm; auto float refNorm; auto float ref; auto float diff;
...
__cudaSafeCall(cudaSetDevice(idev), "simpleZeroCopy.cu", 87);




__cudaSafeCall(cudaGetDeviceProperties(&deviceProp, idev), "simpleZeroCopy.cu", 92);
...
__cudaSafeCall(cudaSetDeviceFlags(8), "simpleZeroCopy.cu", 101);
# 110 "simpleZeroCopy.cu"
nelem = 1048576;
bytes = nelem * sizeof(float);

flags = (2);
__cudaSafeCall(cudaHostAlloc((void **)(&a), bytes, flags), "simpleZeroCopy.cu", 114);
__cudaSafeCall(cudaHostAlloc((void **)(&b), bytes, flags), "simpleZeroCopy.cu", 115);
__cudaSafeCall(cudaHostAlloc((void **)(&c), bytes, flags), "simpleZeroCopy.cu", 116);
...
# 130 "simpleZeroCopy.cu"
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_a), (void *)a, 0), "simpleZeroCopy.cu", 130);
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_b), (void *)b, 0), "simpleZeroCopy.cu", 131);
__cudaSafeCall(cudaHostGetDevicePointer((void **)(&d_c), (void *)c, 0), "simpleZeroCopy.cu", 132);
...
auto dim3 block(256);
auto dim3 grid((unsigned)ceil(nelem / (float)(block.x)));
cudaConfigureCall(grid, block) ? ((void)0) : vectorAddGPU__entry(d_a, d_b, d_c, nelem);
__cudaSafeCall(cudaThreadSynchronize(), "simpleZeroCopy.cu", 141);
__cutilCheckMsg("vectorAddGPU() execution failed", "simpleZeroCopy.cu", 142);
...
__cudaSafeCall(cudaFreeHost(a), "simpleZeroCopy.cu", 163);
__cudaSafeCall(cudaFreeHost(b), "simpleZeroCopy.cu", 164);
__cudaSafeCall(cudaFreeHost(c), "simpleZeroCopy.cu", 165);


cudaThreadExit();

printf("Test %s\n", ((errorNorm / refNorm) < (9.999999975e-07F)) ? ((const char *)"PASSED") : ((const char *)"FAILED"));

__cutilExit(argc, argv); return 0;
}

# 1 "/tmp/tmpxft_00006061_00000000-1_simpleZeroCopy.cudafe1.stub.c" 1

extern "C" {

# 1 "/tmp/tmpxft_00006061_00000000-3_simpleZeroCopy.fatbin.c" 1
...
# 2 "/tmp/tmpxft_00006061_00000000-3_simpleZeroCopy.fatbin.c" 2
...
0x78706d742f706d74ull,0x36303030305f7466ull,0x303030305f313630ull,0x735f372d30303030ull,
0x72655a656c706d69ull,0x70632e79706f436full,0x742f2820692e3370ull,0x23494263632f706dull,
0x29473979324d482eull,0x2d2d2d2d2f2f090aull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,0x2d2d2d2d2d2d2d2dull,
...
0x6d742f2209320965ull,0x746678706d742f70ull,0x363036303030305full,0x3030303030305f31ull,
0x203233662e6c6162ull,0x302b386472255b09ull,0x203b336625202c5dull,0x323a6469202f2f09ull,
0x5f305f744c240a37ull,0x2e090a3a36323031ull,0x3409353109636f6cull,0x697865090a300938ull,
0x2020202020203b74ull,0x2020202020202020ull,0x2020202020202020ull,0x0a202f2f09202020ull,
0x5f646e6557444c24ull,0x7463657632315a5full,0x555047646441726full,0x3a695f535f536650ull,
0x5f202f2f207d090aull,0x6f7463657632315aull,0x5055504764644172ull,0x0a0a695f535f5366ull,
...
0x20656d616e090a7bull,0x657632315a5f203dull,0x47646441726f7463ull,0x5f535f5366505550ull,
0x206d656d6c090a69ull,0x656d73090a30203dull,0x090a3434203d206dull,0x34203d2020676572ull,
...
0x2064663564303030ull,0x3763303263367830ull,0x783009090a203863ull,0x3330303030303033ull,
0x3030303030783020ull,0x3033783020303832ull,0x3020393030303230ull,0x3837303031346378ull,
0x32783009090a2030ull,0x2030303865323031ull,0x6365323031327830ull,0x3030647830206330ull,
0x7830203530303065ull,0x3038373030633038ull,0x3064783009090a20ull,0x3020313036306530ull,
0x3837303063303878ull,0x3030306278302030ull,0x3278302034303230ull,0x2030303066323031ull,
...
static __cudaFatCudaBinary __fatDeviceText __attribute__ ((section (".nvFatBinSegment")))= {0x1ee55a01,0x00000003,0x8ecc680c,(char*)"d832eef481de66b5",(char*)"simpleZeroCopy.cu",(char*)" ",__ptxEntries,__cubinEntries,__debugEntries,0,0,0,0,0,0x75f89656};
# 5 "/tmp/tmpxft_00006061_00000000-1_simpleZeroCopy.cudafe1.stub.c" 2
...
# 6 "/tmp/tmpxft_00006061_00000000-1_simpleZeroCopy.cudafe1.stub.c" 2
struct __T20 {float *__par0;float *__par1;float *__par2;int __par3;int __dummy_field;};
static void __sti____cudaRegisterAll_49_tmpxft_00006061_00000000_4_simpleZeroCopy_cpp1_ii_99ae23d1(void) __attribute__((__constructor__));
void __device_stub__Z12vectorAddGPUPfS_S_i(float *__par0, float *__par1, float *__par2, int __par3){auto struct __T20 *__T23;
char __[256]; *(char**)&__T23 = __;if (cudaSetupArgument((void*)(char*)&__par0, sizeof(__par0), (size_t)&__T23->__par0 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par1, sizeof(__par1), (size_t)&__T23->__par1 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par2, sizeof(__par2), (size_t)&__T23->__par2 - (size_t)__T23) != cudaSuccess) return;if (cudaSetupArgument((void*)(char*)&__par3, sizeof(__par3), (size_t)&__T23->__par3 - (size_t)__T23) != cudaSuccess) return;{ volatile static char *__f; __f = ((char *)((void ( *)(float *, float *, float *, int))vectorAddGPU__entry)); (void)cudaLaunch(((char *)((void ( *)(float *, float *, float *, int))vectorAddGPU__entry))); };}

}
void vectorAddGPU__entry( float * __cuda_0,float * __cuda_1,float * __cuda_2,int __cuda_3)
...
static void __sti____cudaRegisterAll_49_tmpxft_00006061_00000000_4_simpleZeroCopy_cpp1_ii_99ae23d1(void){__cudaFatCubinHandle = __cudaRegisterFatBinary((void*)(&__fatDeviceText)); atexit(__cudaUnregisterBinaryUtil);__cudaRegisterFunction(__cudaFatCubinHandle, (const char*)((void ( *)(float *, float *, float *, int))vectorAddGPU__entry), (char*)"_Z12vectorAddGPUPfS_S_i", "_Z12vectorAddGPUPfS_S_i", (-1), (uint3*)0, (uint3*)0, (dim3*)0, (dim3*)0, (int*)0);}

}
# 175 "simpleZeroCopy.cu" 2
